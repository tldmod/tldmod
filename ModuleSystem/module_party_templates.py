...
("dale_scouts"     ,"Dale Scouts"          ,icon_gray_knight  |carries_goods(2)|pf_show_faction,0,fac_dale    ,scout_personality,[(trp_dale_veteran_warrior,1,1),(trp_dale_man_at_arms,2,6),(trp_dale_militia,4,8)]), #25-49 weak
...
("gondor_raiders"  ,"Gondor Foragers"    ,icon_knight_gondor|carries_goods(1),0,fac_gondor  ,soldier_personality,[(trp_veteran_squire_of_gondor,1,1),(trp_footmen_of_gondor,6,12),(trp_bowmen_of_gondor,6,12)]), #78-150
("rohan_raiders"   ,"Rohan Foragers"     ,icon_knight_rohan |carries_goods(1),0,fac_rohan   ,soldier_personality,[(trp_elite_rider_of_rohan,1,1),(trp_rider_of_rohan,3,8),(trp_skirmisher_of_rohan,3,8),(trp_squire_of_rohan,5,10)]), #72-152
("imladris_raiders","Rivendell Foragers" ,icon_rivendell_elf|carries_goods(2),0,fac_imladris,soldier_personality,[(trp_rivendell_royal_infantry,1,1),(trp_rivendell_sentinel,6,12),(trp_rivendell_infantry,6,12)]), #91-163
("lorien_raiders"  ,"Lothlorien Foragers",icon_lorien_elf_a |carries_goods(2),0,fac_lorien  ,soldier_personality,[(trp_lothlorien_veteran_warden,1,1),(trp_lothlorien_archer,7,16),(trp_lothlorien_infantry,6,15)]), #71-152
("woodelf_raiders" ,"Mirkwood Foragers"  ,icon_mirkwood_elf |carries_goods(2),0,fac_woodelf ,soldier_personality,[(trp_greenwood_royal_spearman,1,1),(trp_greenwood_veteran_spearman,4,10),(trp_greenwood_archer,5,10)]), #73-150
("dale_raiders"    ,"Dale Foragers"      ,icon_gray_knight  |carries_goods(2),0,fac_dale    ,soldier_personality,[(trp_girions_guard_of_dale,1,1),(trp_merchant_squire_or_dale,4,10),(trp_dale_man_at_arms,4,10),(trp_laketown_scout,4,12)]), #64-144
("dwarf_raiders"   ,"Dwarven Foragers"   ,icon_dwarf        |carries_goods(2),0,fac_dwarf   ,soldier_personality,[(trp_dwarven_expert_axeman,1,1),(trp_dwarven_hardened_warrior,4,12),(trp_dwarven_lookout,5,15)]), #66-162
("ranger_raiders"  ,"Ranger Raiders"   ,icon_ithilien_ranger|carries_goods(1),0,fac_gondor  ,soldier_personality,[(trp_master_ranger_of_ithilien,1,1),(trp_veteran_ranger_of_ithilien,3,6),(trp_ranger_of_ithilien,5,10)]), #118-211 real raiders have more punch
...
("morgul_raiders"  ,"Mordor Raiders"    ,icon_orc           |carries_goods(1),0,fac_mordor  ,soldier_personality,[(trp_fell_morgul_orc,1,1),(trp_morgul_orc,15,30),(trp_orc_archer_of_mordor,15,30)]), #98-188 better raiders
("mordor_raiders"  ,"Mordor Raiders"    ,icon_orc           |carries_goods(1),0,fac_mordor  ,soldier_personality,[(trp_fell_orc_of_mordor,1,1),(trp_orc_of_mordor,13,26),(trp_orc_archer_of_mordor,13,26)]), #86-164
("isengard_raiders","Isengard Raiders"  ,icon_uruk_isengard |carries_goods(1),0,fac_isengard,soldier_personality,[(trp_fighting_uruk_hai_champion,1,1),(trp_large_uruk_hai_of_isengard,3,8),(trp_large_uruk_hai_tracker,8,13),(trp_uruk_snaga_of_isengard,8,13)]), #98-168
("dunland_raiders" ,"Dunlending Raiders",icon_dunlander     |carries_goods(2),0,fac_dunland ,soldier_personality,[(trp_dunnish_wolf_guard,1,1),(trp_dunnish_wolf_warrior,3,6),(trp_dunnish_vet_warrior,6,12),(trp_dunnish_warrior,8,16)]), #111-206 D good at raiding
("harad_raiders"   ,"Haradrim Raiders"  ,icon_harad_horseman|carries_goods(2),0,fac_harad   ,soldier_personality,[(trp_harad_tiger_guard,1,1),(trp_harad_skirmisher,10,20),(trp_harad_desert_warrior,11,20)]), #98-176
("khand_raiders"   ,"Khand Raiders"     ,icon_cataphract    |carries_goods(2),0,fac_khand   ,soldier_personality,[(trp_easterling_horsemaster,1,1),(trp_easterling_rider,5,10),(trp_easterling_veteran_horseman,5,15)]), #81-191
("umbar_raiders"   ,"Umbar Raiders"     ,icon_umbar_corsair |carries_goods(2),0,fac_umbar   ,soldier_personality,[(trp_corsair_night_raider,1,1),(trp_corsair_veteran_raider,4,8),(trp_corsair_pikeman,4,8),(trp_corsair_warrior,6,15)]), #100-196 good at it
("moria_raiders"   ,"Moria Raiders"     ,icon_orc           |carries_goods(2),0,fac_moria   ,soldier_personality,[(trp_fell_goblin_archer_of_moria,1,1),(trp_large_goblin_archer_of_moria,3,9),(trp_large_goblin_of_moria,5,15),(trp_archer_snaga_of_moria,8,16)]), #72-176
("guldur_raiders"  ,"Dol Guldur Raiders",icon_orc_tribal    |carries_goods(2),0,fac_guldur  ,soldier_personality,[(trp_fell_orc_tracker_of_mordor,1,1),(trp_large_orc_of_mordor,4,10),(trp_orc_of_guldur,8,16),(trp_orc_archer_of_mordor,8,16),(trp_orc_snaga_of_guldur,15,30)]), #91-184
("gundabad_raiders","Gundabad Raiders"  ,icon_orc_tribal    |carries_goods(2),0,fac_gundabad,soldier_personality,[(trp_goblin_north_clan_rider,1,1),(trp_keen_eyed_goblin_archer_gundabad,5,10),(trp_goblin_bowmen_gundabad,10,15),(trp_orc_gundabad,10,20)]), #93-163
("rhun_raiders"    ,"Rhun Raiders"      ,icon_gray_knight   |carries_goods(1),0,fac_rhun    ,soldier_personality,[(trp_rhun_heavy_noble_cavalry,1,1),(trp_rhun_horse_archer,6,12),(trp_rhun_light_cavalry,8,16)]), #100-184


####TLD Patrols
#MV: in general, average strength should be 300-600, Mordor and Isengard about 20% better than Gondor and Rohan
("gondor_patrol"  ,"Gondor Patrol"    ,icon_footman_gondor |carries_goods(2),0,fac_gondor  ,soldier_personality,[(trp_veteran_knight_of_gondor,1,1),(trp_veteran_archer_of_gondor,3,6),(trp_gondor_veteran_swordsmen,3,6),(trp_archer_of_gondor,8,20),(trp_gondor_swordsmen,8,20)]), #256-568
("rohan_patrol"   ,"Rohan Patrol"     ,icon_knight_rohan   |carries_goods(2),0,fac_rohan   ,soldier_personality,[(trp_thengel_guard_of_rohan,1,1),(trp_elite_skirmisher_of_rohan,3,6),(trp_lancer_of_rohan,3,6),(trp_veteran_skirmisher_of_rohan,6,14),(trp_skirmisher_of_rohan,6,14),(trp_rider_of_rohan,8,20)]), #238-505 fast!
("imladris_patrol","Dunedain Patrol"  ,icon_rivendell_elf  |carries_goods(0),0,fac_imladris,soldier_personality,[(trp_knight_of_arnor,1,1),(trp_arnor_horsemen,4,10),(trp_high_swordsman_of_arnor,3,5),(trp_arnor_master_at_arms,8,20),(trp_arnor_man_at_arms,8,20)]), #252-554
("lorien_patrol"  ,"Lothlorien Patrol",icon_lorien_elf_b   |carries_goods(2),0,fac_lorien  ,soldier_personality,[(trp_galadhrim_royal_archer,1,1),(trp_lothlorien_master_archer,3,6),(trp_lothlorien_veteran_archer,4,10),(trp_lothlorien_elite_infantry,8,16),(trp_lothlorien_archer,8,16),(trp_lothlorien_veteran_infantry,10,20)]), #312-615
("woodelf_patrol" ,"Mirkwood Patrol"  ,icon_mirkwood_elf   |carries_goods(2),0,fac_woodelf ,soldier_personality,[(trp_thranduils_royal_marksman,1,1),(trp_greenwood_master_archer,3,6),(trp_greenwood_veteran_archer,4,10),(trp_greenwood_royal_spearman,4,10),(trp_greenwood_veteran_spearman,4,10),(trp_greenwood_archer,8,16)]), #250-525
("dale_patrol"    ,"Dale Patrol"      ,icon_gray_knight    |carries_goods(2),0,fac_dale    ,soldier_personality,[(trp_girions_guard_of_dale,1,1),(trp_dale_marchwarden,4,8),(trp_barding_bowmen_of_esgaroth,3,8),(trp_dale_billman,4,10),(trp_laketown_archer,6,12),(trp_laketown_scout,6,12)]), #242-518
("dwarf_patrol"   ,"Dwarven Patrol"   ,icon_dwarf          |carries_goods(2),0,fac_dwarf   ,soldier_personality,[(trp_longbeard_axeman,1,1),(trp_dwarven_bowman,8,16),(trp_dwarven_spearman,5,10),(trp_dwarven_axeman,8,20),(trp_dwarven_lookout,10,25)]), #257-542

("ranger_patrol"  ,"Ranger Patrol"    ,icon_ithilien_ranger|carries_goods(0),0,fac_gondor  ,soldier_personality,[(trp_ithilien_leader,1,1),(trp_master_ranger_of_ithilien,4,8),(trp_veteran_ranger_of_ithilien,6,12),(trp_ranger_of_ithilien,8,20)]), #299-603
("amroth_patrol"  ,"Gondor Patrol"   ,icon_knight_dolamroth|carries_goods(2),0,fac_gondor  ,soldier_personality,[(trp_dol_amroth_leader,1,1),(trp_swan_knight_of_dol_amroth,2,6),(trp_knight_of_dol_amroth,6,14),(trp_veteran_squire_of_dol_amroth,8,20),(trp_squire_of_dol_amroth,16,30)]), #241-541
("pelargir_patrol","Gondor Patrol"    ,icon_footman_gondor |carries_goods(2),0,fac_gondor  ,soldier_personality,[(trp_pelargir_leader,1,1),(trp_pelargir_vet_marine,3,8),(trp_pelargir_vet_infantry,3,8),(trp_pelargir_marine,6,14),(trp_pelargir_infantry,6,14)]), #229-533
("lossarnach_patrol","Gondor Patrol",icon_lossarnach_axeman_icon|carries_goods(2),0,fac_gondor  ,soldier_personality,[(trp_lossarnach_leader,1,1),(trp_axemaster_of_lossarnach,3,8),(trp_heavy_lossarnach_axeman,4,10),(trp_archer_of_gondor,8,20),(trp_axeman_of_lossarnach,8,20)]), #213-503
("brv_patrol"     ,"Gondor Patrol"    ,icon_ithilien_ranger|carries_goods(2),0,fac_gondor  ,soldier_personality,[(trp_blackroot_leader,1,1),(trp_master_blackroot_vale_archer,4,8),(trp_veteran_blackroot_vale_archer,6,12),(trp_footman_of_blackroot_vale,8,16),(trp_blackroot_vale_archer,10,20)]), #255-485
("pinnath_patrol" ,"Gondor Patrol"    ,icon_footman_gondor |carries_goods(2),0,fac_gondor  ,soldier_personality,[(trp_pinnath_leader,1,1),(trp_pinnath_gelin_archer,3,6),(trp_warrior_of_pinnath_gelin,3,6),(trp_pinnath_gelin_bowman,6,16),(trp_pinnath_gelin_spearman,8,20)]), #247-541
("lamedon_patrol" ,"Gondor Patrol"   ,icon_lamedon_horseman|carries_goods(2),0,fac_gondor  ,soldier_personality,[(trp_lamedon_leader,1,1),(trp_knight_of_lamedon,3,6),(trp_champion_of_lamedon,3,6),(trp_warrior_of_lamedon,8,20),(trp_veteran_of_lamedon,10,24)]), #253-541

# Used as patrols, except Dale 
("mordor_war_party"  ,"Mordor_War_Party"  ,icon_uruk_x6          |carries_goods(3),0,fac_mordor  ,soldier_personality,[(trp_uruk_mordor_standard_bearer,1,2),(trp_large_uruk_of_mordor,10,22),(trp_large_orc_archer_of_mordor,10,22),(trp_uruk_of_mordor,16,36),(trp_orc_of_mordor,20,40),(trp_orc_archer_of_mordor,20,40)]), #310-658
("isengard_war_party","Isengard_War_Party",icon_wargrider_walk_x4|carries_goods(3),0,fac_isengard,soldier_personality,[(trp_urukhai_standard_bearer,1,2),(trp_fighting_uruk_hai_berserker,2,4),(trp_fighting_uruk_hai_champion,2,4),(trp_fighting_uruk_hai_tracker,10,20),(trp_large_uruk_hai_of_isengard,15,30),(trp_wolf_rider_of_isengard,5,10)]), #275-550
("harad_war_party"   ,"Harad_War_Party"   ,icon_harad_horseman_x3|carries_goods(3),0,fac_harad   ,soldier_personality,[(trp_harad_tiger_guard,2,4),(trp_fang_heavy_cavalry,2,4),(trp_gold_serpent_horse_archer,2,4),(trp_harad_archer,8,16),(trp_harondor_rider,10,20),(trp_harad_desert_warrior,20,40)]), #268-536
("dunland_war_party" ,"Dunlending_Warband",icon_dunlander_x3     |carries_goods(3),0,fac_dunland ,soldier_personality,[(trp_dunnish_wolf_guard,2,4),(trp_dunnish_veteran_pikeman,8,16),(trp_dunnish_warrior,12,24),(trp_dunnish_raven_rider,10,20),(trp_dunnish_wildman,20,50)]), #232-484 weak
("khand_war_party"   ,"Variag_War_Party"   ,icon_cataphract_x3   |carries_goods(3),0,fac_khand   ,soldier_personality,[(trp_easterling_axe_master,2,4),(trp_easterling_horsemaster,2,4),(trp_easterling_veteran_axeman,5,10),(trp_easterling_axeman,8,16),(trp_easterling_rider,10,20),(trp_easterling_warrior,20,40)]), #277-554
...
("moria_war_party"   ,"Moria_War_Party"   ,icon_orc_tribal_x4    |carries_goods(3),0,fac_moria   ,soldier_personality,[(trp_fell_goblin_of_moria,5,10),(trp_large_goblin_archer_of_moria,10,20),(trp_large_goblin_of_moria,12,24),(trp_goblin_of_moria,15,30),(trp_snaga_of_moria,20,50),(trp_troll_of_moria,1,2)]), #262-534
#Northern war
("dale_war_party"  ,"Dale_War_Party"   ,icon_gray_knight       |carries_goods(3),0,fac_dale   ,soldier_personality,[(trp_dale_man_at_arms,8,13),(trp_dale_veteran_warrior,8,20),(trp_barding_bowmen_of_esgaroth,8,16),(trp_laketown_archer,5,20),(trp_dale_billman,10,25),(trp_merchant_squire_or_dale,4,15)]), # NOT USED and unbalanced 383-953
...
("rhun_war_party"  ,"Rhun_War_Party"   ,icon_easterling_horseman_x3|carries_goods(3),0,fac_rhun   ,soldier_personality,[(trp_dorwinion_noble_of_rhun,2,4),(trp_rhun_heavy_noble_cavalry,3,8),(trp_rhun_veteran_swift_horseman,5,10),(trp_rhun_veteran_horse_archer,5,10),(trp_rhun_tribal_warrior,10,20),(trp_rhun_tribesman,16,32)]), #260-552

####TLD Companies (only Gondorian used, as a MT patrol)
("gondor_company"  ,"Minas Tirith Patrol",icon_knight_gondo_trot_x3,0,fac_gondor  ,soldier_personality,[(trp_captain_of_gondor,1,1),(trp_veteran_knight_of_gondor,2,4),(trp_knight_of_gondor,4,8),(trp_gondor_veteran_swordsmen,10,20),(trp_veteran_archer_of_gondor,10,20),(trp_gondor_veteran_spearmen,10,20)]), #573-1121 elite, rare, overpowered
...
("isengard_caravan","Isengard Supply Train",icon_supply_isengard|carries_goods(2),0,fac_isengard,prisoner_train_personality, [(trp_warg_rider_of_isengard, 3, 8), (trp_large_uruk_hai_of_isengard, 6, 16), (trp_uruk_hai_of_isengard, 6, 10), (trp_uruk_hai_tracker, 6, 10), (trp_orc_of_isengard, 20, 40)]), # strength 159-336
...
("rohan_p_train"   ,"Rohan Prisoner Train"     ,icon_supply_rohan ,0,fac_rohan   ,prisoner_train_personality,[(trp_footman_of_rohan,2,4), (trp_dismounted_skirmisher_of_rohan,4,6), (trp_squire_of_rohan,4,6), (trp_guardsman_of_rohan,8,12), (trp_rohan_youth,24,30)]), # strength 132-192
