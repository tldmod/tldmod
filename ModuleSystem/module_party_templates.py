...
("isengard_recruits"  ,"_",0,0,fac_commoners,0,[(trp_uruk_snaga_of_isengard,1,2),(trp_orc_snaga_of_isengard,1,3),(trp_dunnish_wildman,2,4)]), #two T1
("morannon_recruits"  ,"_",0,0,fac_commoners,0,[(trp_uruk_snaga_of_mordor,0,2),(trp_orc_snaga_of_mordor,3,5),(trp_black_numenorean_renegade,1,1),(trp_easterling_youth,1,4),]), #two T1 & prize
("mordor_recruits"    ,"_",0,0,fac_commoners,0,[(trp_uruk_snaga_of_mordor,0,2),(trp_orc_snaga_of_mordor,3,5)]), #two T1
("morgul_recruits"    ,"_",0,0,fac_commoners,0,[(trp_uruk_snaga_of_mordor,1,2),(trp_morgul_orc,1,2),(trp_harad_desert_warrior,1,2)]), #T1 T2
