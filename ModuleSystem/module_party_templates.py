...
("ranger_patrol"  ,"Ranger Patrol"    ,icon_ithilien_ranger|carries_goods(0)|pf_show_faction,0,fac_gondor  ,soldier_personality,[(trp_ithilien_captain,1,1),(trp_a6_ithilien_master_ranger,5,9),(trp_a5_ithilien_vet_ranger,8,14),(trp_a4_ithilien_ranger,8,25)]), #299-603 #InVain 410-820 can attack lone hosts
("amroth_patrol" ,"Dol Amroth Patrol",icon_knight_dolamroth|carries_goods(2)|pf_show_faction,0,fac_gondor  ,soldier_personality,[(trp_amroth_captain,1,1),(trp_c6_amroth_swan_knight,2,6),(trp_c4_amroth_knight,6,14),(trp_c3_amroth_vet_squire,8,20),(trp_c2_amroth_squire,16,30)]), #241-541
("pelargir_patrol","Pelargir Patrol"  ,icon_footman_gondor |carries_goods(2)|pf_show_faction,0,fac_gondor  ,soldier_personality,[(trp_pel_captain,1,1),(trp_a3_pel_vet_marine,3,8),(trp_i3_pel_vet_infantry,3,8),(trp_a2_pel_marine,6,14),(trp_i2_pel_infantry,6,14)]), #229-533
("lossarnach_patrol","Lossarnach Patrol",icon_lossarnach_axeman_icon|carries_goods(2)|pf_show_faction,0,fac_gondor  ,soldier_personality,[(trp_loss_captain,1,1),(trp_i5_loss_axemaster,3,8),(trp_i4_loss_heavy_axeman,4,10),(trp_a4_gon_archer,8,20),(trp_i2_loss_axeman,8,20)]), #213-503
...
("pinnath_patrol" ,"Pinnath Patrol"   ,icon_footman_pinnath|carries_goods(2)|pf_show_faction,0,fac_gondor  ,soldier_personality,[(trp_pinnath_captain,1,1),(trp_a3_pinnath_archer,3,6),(trp_c3_pinnath_knight,3,6),(trp_a2_pinnath_bowman,6,16),(trp_c2_pinnath_rider,8,20)]), #247-541
("lamedon_patrol" ,"Lamedon Patrol"  ,icon_lamedon_horseman|carries_goods(2)|pf_show_faction,0,fac_gondor  ,soldier_personality,[(trp_lam_captain,1,1),(trp_c5_lam_knight,6,14),(trp_i5_lam_champion,3,6),(trp_i4_lam_warrior,8,20),(trp_i3_lam_veteran,10,24)]), #253-541 #InVain 270-600, added more cavalry
...
("gondor_company" ,"Minas Tirith Patrol",icon_knight_gondor |carries_goods(4)|pf_show_faction,0,fac_gondor  ,soldier_personality,[(trp_gondor_captain,1,1),(trp_c5_gon_vet_knight,2,4),(trp_c4_gon_knight,8,16),(trp_i5_gon_vet_swordsman,10,20),(trp_a5_gon_vet_archer,10,20),(trp_i5_gon_vet_spearman,10,20)]), #573-1121 elite, rare, overpowered #InVain 754-1474 (new formula) added a few more knights
("gundabad_war_party"   ,"Gundabad_War_Party"   ,icon_orc_tribal_x4    |carries_goods(3)|pf_show_faction,0,fac_gundabad   ,soldier_personality,[(trp_c5_gunda_clan_rider,5,10),(trp_c3_gunda_goblin_rider,10,20),(trp_i3_gunda_orc_fighter,12,24),(trp_i2_gunda_orc,15,30),(trp_i1_gunda_goblin,20,50),(trp_gunda_troll,1,3)]), #262-534
#("rohan_company"   ,"Rohan Company"     ,icon_knight_rohan        ,0,fac_rohan   ,soldier_personality,[(trp_c5_elite_rider_of_rohan,25,25),(trp_ac5_elite_skirmisher_of_rohan,25,25),(trp_i5_elite_footman_of_rohan,25,25),(trp_c6_rider_guard_of_rohan,12,12),(trp_ac6_skirmisher_guard_of_rohan,12,12),(trp_rohan_captain,1,1)]),
("imladris_company","Rivendell Company" ,icon_rivendell_elf       ,0,fac_imladris,soldier_personality,[(trp_i3_riv_swordbearer,20,33),(trp_i4_riv_vet_swordbearer,20,33),(trp_i5_riv_swordmaster,20,33),(trp_i6_riv_champion,3,6),(trp_riv_captain,1,1)]),
("lorien_company"  ,"Lothlorien Company",icon_lorien_elf_b        ,0,fac_lorien  ,soldier_personality,[(trp_a3_lorien_vet_archer,30,30),(trp_a4_lorien_gal_archer,30,30),(trp_i4_lorien_gal_inf,30,30),(trp_i5_lorien_gal_royal_inf,5,5),(trp_a5_lorien_gal_royal_archer,5,5),(trp_lorien_captain,1,1)]),
...
("gondor_elite_company"  ,"Gondor Elite Company"    ,icon_knight_gondo_trot_x3,0,fac_gondor  ,soldier_personality,[(trp_i6_gon_tower_spearman,15,30),(trp_c6_gon_tower_knight,15,30),(trp_a6_gon_tower_archer,15,30),(trp_i6_gon_tower_swordsman,15,30),(trp_gondor_captain,1,1)]),
("rohan_elite_company"   ,"Rohan Elite Company"     ,icon_knight_rohan_x3     ,0,fac_rohan   ,soldier_personality,[(trp_c6_rider_guard_of_rohan        ,10,20),(trp_ac6_skirmisher_guard_of_rohan,10,20),(trp_i6_footman_guard_of_rohan,10,20),(trp_i6_warden_of_methuseld,10,20),(trp_i6_frealaf_raider,10,20),(trp_rohan_captain,1,1)]),
("imladris_elite_company","Rivendell Elite Company" ,icon_knight_rivendell    ,0,fac_imladris,soldier_personality,[(trp_i6_riv_champion   ,25,50),(trp_ac6_riv_knight,25,50),(trp_riv_captain,1,1)]),
...
("woodelf_elite_company" ,"Mirkwood Elite Company"  ,icon_mirkwood_elf_x3     ,0,fac_woodelf ,soldier_personality,[(trp_i4_greenwood_elite_infantry   ,20,40),(trp_a6_greenwood_chosen_marksman,20,40),(trp_greenwood_captain,0,0)]),
...
("legion_minas_morgul","Legion_of_Minas_Morgul",icon_uruk_x4|carries_goods(3), 0, fac_mordor, soldier_personality,[(trp_mordor_captain,1,1),(trp_mordor_olog_hai,10,10),(trp_i4_mordor_fell_uruk,30,60),(trp_i4_mordor_fell_morgul_orc,25,55),(trp_i2_mordor_morgul_orc, 25, 50),(trp_a3_mordor_large_orc_archer, 25, 50)]),
("legion_udun","Legion_of_Udun",icon_uruk_x4|carries_goods(3), 0, fac_mordor, soldier_personality,[(trp_mordor_captain,1,1),(trp_c4_mordor_great_warg_rider,20,30),(trp_a4_mordor_fell_orc_archer,30,45),(trp_i4_mordor_fell_uruk_slayer, 30, 45),(trp_i3_mordor_large_orc,30,90),(trp_mordor_olog_hai,10,10)]),
("legion_gorgoroth","Legion_of_Gorgoroth",icon_uruk_x4|carries_goods(3), 0, fac_mordor, soldier_personality,[(trp_mordor_captain,1,1),(trp_c5_mordor_num_knight,30,30),(trp_mordor_olog_hai,10,10),(trp_c3_mordor_warg_rider,30,50),(trp_i3_mordor_large_orc,40,90),(trp_a3_mordor_large_orc_archer,20,40)]),
("legion_barad_dur","Legion_of_Barad-Dur",icon_uruk_x4|carries_goods(3), 0, fac_mordor, soldier_personality,[(trp_mordor_captain,5,5),(trp_i5_mordor_black_uruk,60,60),(trp_i4_mordor_fell_orc,90,90),(trp_a4_mordor_fell_orc_archer,60,60),(trp_mordor_olog_hai,15,15)]),
