...
##  ("peasant","Peasant",icon_peasant,0,fac_commoners,merchant_personality,[(trp_farmer,1,6),(trp_peasant_woman,0,7)]),
  ...
  ("forest_bandits"  ,"Orc Raiders"       ,icon_orc_tribal|carries_goods(2),0,fac_outlaws,bandit_personality,[(trp_tribal_orc,5,52),(trp_mountain_goblin,2,40)]),
  ("mountain_bandits","Orc Stragglers"    ,icon_orc_tribal|carries_goods(2),0,fac_outlaws,bandit_personality,[(trp_mountain_goblin,2,40)]),
...
("woodelf_scouts"  ,"Mirkwood Elven Scouts",icon_mirkwood_elf |carries_goods(1)|pf_show_faction,0,fac_woodelf ,scout_personality,[(trp_greenwood_veteran_scout,2,4),(trp_greenwood_archer,2,4),(trp_greenwood_spearman,2,4),(trp_greenwood_veteran_archer,1,1)]),
("imladris_scouts" ,"Rivendell Scouts"     ,icon_rivendell_elf|carries_goods(1)|pf_show_faction,0,fac_imladris,scout_personality,[(trp_rivendell_scout,3,5),(trp_rivendell_veteran_scout,3,5),(trp_arnor_man_at_arms,1,1)]),
("dale_scouts"     ,"Dale Scouts"          ,icon_gray_knight  |carries_goods(2)|pf_show_faction,0,fac_dale    ,scout_personality,[(trp_laketown_scout,3,5),(trp_dale_warrior,3,5),(trp_dale_marchwarden,1,1)]),
("dwarf_scouts"    ,"Dwarven Lookouts"     ,icon_axeman       |carries_goods(2)|pf_show_faction,0,fac_dwarf   ,scout_personality,[(trp_dwarven_lookout,3,5),(trp_dwarven_hardened_warrior,3,5),(trp_dwarven_archer,1,1)]),
("beorn_scouts"    ,"Beorning Scouts"      ,icon_axeman       |carries_goods(1)|pf_show_faction,0,fac_beorn   ,scout_personality,[(trp_beorning_warrior,3,6),(trp_beorning_sentinel,3,5),(trp_beorning_carrock_berserker,1,1)]),
...
("gundabad_scouts"  ,"Gundabad Scouts"     ,icon_orc_tribal         |carries_goods(1)|pf_show_faction,0,fac_gundabad,scout_personality,[(trp_orc_gundabad,3,6),(trp_keen_eyed_goblin_archer_gundabad,3,5),(trp_goblin_north_clan_rider,1,1)]),
...
("moria_raiders"   ,"Moria Raiders"     ,icon_orc           |carries_goods(2),0,fac_moria   ,soldier_personality,[(trp_dwarven_hardened_warrior,5,15),(trp_dwarven_lookout,5,15),(trp_dwarven_expert_axeman,1,1)]),
...
("gundabad_raiders","Gundabad Raiders"  ,icon_orc_tribal    |carries_goods(2),0,fac_gundabad,soldier_personality,[(trp_dwarven_hardened_warrior,5,15),(trp_dwarven_lookout,5,15),(trp_dwarven_expert_axeman,1,1)]),
...
("lorien_war_party"   ,"lorien_war_party"   ,icon_lorien_elf_b_x3 |carries_goods(3),0,fac_lorien  ,soldier_personality,[(trp_lothlorien_scout,8,13),(trp_lothlorien_archer,8,20),(trp_galadhrim_royal_marksman,8,16),(trp_lothlorien_veteran_infantry,5,20),(trp_galadhrim_royal_swordsman,4,15),(trp_lothlorien_warden,4,15)]),
("woodelf_war_party"  ,"woodelf_war_party"  ,icon_mirkwood_elf_x3 |carries_goods(3),0,fac_woodelf ,soldier_personality,[(trp_greenwood_scout,8,13),(trp_greenwood_royal_spearman,8,20),(trp_greenwood_master_archer,8,16),(trp_greenwood_spearman,5,20),(trp_greenwood_veteran_spearman,4,15),(trp_greenwood_royal_spearman,4,15)]),
("imladris_war_party" ,"Rivendell_War_Party",icon_rivendell_elf_x3|carries_goods(3),0,fac_imladris,soldier_personality,[(trp_rivendell_scout,8,13),(trp_rivendell_sentinel,8,20),(trp_rivendell_veteran_sentinel,8,16),(trp_knight_of_rivendell,5,20),(trp_rivendell_elite_sentinel,4,15),(trp_rivendell_veteran_scout,4,15)]),
...
("mordor_war_party"   ,"Mordor_War_Party"  ,icon_uruk_x6          |carries_goods(3),0,fac_mordor ,soldier_personality,[(trp_large_orc_of_mordor,20,50),(trp_fell_morgul_orc,15,30),(trp_orc_archer_of_mordor,13,36),(trp_black_numenorean_warrior,15,30),(trp_black_numenorean_horsemaster,5,40),(trp_olog_hai,1,2)]),#(trp_uruk_snaga_of_mordor,5,20), ,(trp_black_numenorean_captain,1,1)
("isengard_war_party" ,"Isengard_War_Party",icon_wargrider_walk_x4|carries_goods(3),0,fac_isengard,soldier_personality,[(trp_fighting_uruk_hai_scout,20,50),(trp_fighting_uruk_hai_champion,10,30),(trp_large_uruk_hai_of_isengard,13,36),(trp_wolf_rider_of_isengard,5,30),(trp_fighting_uruk_hai_berserker,10,40),(trp_troll_of_moria,1,2)]),#(trp_fighting_uruk_hai_pikeman,5,20),
...
#Beornings
  ("beorn_reinf_a", "beorn_reinf_a", 0,0,fac_commoners, 0, [(trp_beorning_vale_man,4,8),(trp_beorning_vale_man,2,4)]),
  ("beorn_reinf_b", "beorn_reinf_b", 0,0,fac_commoners, 0, [(trp_beorning_vale_man,1,3),(trp_beorning_warrior,3,5),(trp_beorning_vale_man,2,5)]),
  ("beorn_reinf_c", "beorn_reinf_c", 0,0,fac_commoners, 0, [(trp_beorning_vale_man,3,6)]),
#Mt. Gundabad
