...
("mordor_war_party"   ,"Mordor_War_Party"  ,icon_uruk_x6          |carries_goods(3),0,fac_mordor  ,soldier_personality,[(trp_large_orc_of_mordor    ,20,50),(trp_fell_morgul_orc,15,30),(trp_orc_archer_of_mordor,13,36),(trp_black_numenorean_warrior,15,30),(trp_black_numenorean_veteran_warrior,5,40),(trp_olog_hai,1,2)]),#(trp_uruk_snaga_of_mordor,5,20), ,(trp_black_numenorean_captain,1,1)
