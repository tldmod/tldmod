...
("spy_partners_evil", "Suspicious Travellers", icon_generic_knight|carries_goods(3)|pf_default_behavior|pf_quest_party,0,fac_neutral,merchant_personality,[(trp_spy_partner_evil,1,1),(trp_ac2_dun_crebain_rider,5,11)]),
...
("gondor_scouts"      ,"Gondorian Scouts",icon_footman_gondor|carries_goods(1)|pf_show_faction,0,fac_gondor,scout_personality,[(trp_c2_gon_squire,1,1),(trp_a3_gon_bowman,3,5),(trp_i2_gon_watchman,3,5)]), #34-74
("blackroot_auxila" ,"Blackroot Auxilia",icon_ithilien_ranger|carries_goods(1)|pf_show_faction,0,fac_gondor,scout_personality,[(trp_a3_blackroot_archer,1,1),(trp_a2_blackroot_bowman,0,3),(trp_a1_blackroot_hunter,4,7)]), #32-71
("lamedon_auxila"  ,"Lamedon Auxilia"   ,icon_footman_lamedon|carries_goods(1)|pf_show_faction,0,fac_gondor,scout_personality,[(trp_i4_lam_warrior,1,1),(trp_i3_lam_veteran,1,5),(trp_i2_lam_footman,4,8)]), #31-71
("lossarnach_auxila","Lossarnach Auxilia",icon_lossarnach_axeman_icon|carries_goods(1)|pf_show_faction,0,fac_gondor,scout_personality,[(trp_i4_loss_heavy_axeman,1,1),(trp_i3_loss_vet_axeman,0,3),(trp_i2_loss_axeman,2,4),(trp_i1_loss_woodsman,4,8)]), #25-71
("pinnath_gelin_auxila","Pinnath Gelin Auxilia",icon_footman_pinnath|carries_goods(1)|pf_show_faction,0,fac_gondor,scout_personality,[(trp_a2_pinnath_bowman,1,3),(trp_c2_pinnath_rider,1,2),(trp_i1_pinnath_plainsman,3,6)]), #30-69
("ranger_scouts"       ,"Ranger Scouts" ,icon_ithilien_ranger|carries_goods(0)|pf_show_faction,0,fac_gondor,scout_personality,[(trp_a5_ithilien_vet_ranger,1,2),(trp_a4_ithilien_ranger,1,4)]), #43-102 more punch for rangers, elites operating in enemy territory

("rohan_scouts"    ,"Rohirrim Scouts"      ,icon_knight_rohan |carries_goods(1)|pf_show_faction,0,fac_rohan   ,scout_personality,[(trp_ac5_elite_skirmisher_of_rohan,1,1),(trp_ac4_veteran_skirmisher_of_rohan,1,4),(trp_ac3_skirmisher_of_rohan,3,5)]), #43-82 rohan good at scouting
("lorien_scouts"   ,"Lothlorien Scouts"    ,icon_lorien_elf_a |carries_goods(1)|pf_show_faction,0,fac_lorien  ,scout_personality,[(trp_lothlorien_veteran_warden,1,2),(trp_lothlorien_veteran_scout,3,4),(trp_lothlorien_scout,3,4)]), #31-62
...
("beorn_scouts"    ,"Beorning Scouts"      ,icon_axeman       |carries_goods(1)|pf_show_faction,0,fac_beorn   ,scout_personality,[(trp_i5_beorning_carrock_berserker,1,1),(trp_i4_beorning_sentinel,3,5),(trp_i2_beorning_warrior,3,8)]), #55-93 stronger, no raiders/patrols
("woodmen_scouts"  ,"Woodmen Scouts"       ,icon_axeman       |carries_goods(1)|pf_show_faction,0,fac_beorn   ,scout_personality,[(trp_a5_woodmen_night_stalker,1,1),(trp_a3_woodmen_scout,2,3),(trp_i3_woodmen_skilled_forester,3,6)]), #46-70

("mordor_scouts"    ,"Mordor Scouts"       ,icon_orc             |carries_goods(1)|pf_show_faction,0,fac_mordor  ,scout_personality,[(trp_fell_orc_archer_of_mordor,1,1),(trp_large_orc_of_mordor,1,3),(trp_orc_archer_of_mordor,2,5),(trp_orc_of_mordor,2,6)]), #29-66
("morgul_scouts"    ,"Morgul Scouts"       ,icon_orc             |carries_goods(1)|pf_show_faction,0,fac_mordor  ,scout_personality,[(trp_fell_orc_archer_of_mordor,1,1),(trp_fell_morgul_orc,1,2),(trp_orc_archer_of_mordor,2,5),(trp_morgul_orc,3,5)]), #29-66
...
("khand_scouts"     ,"Easterling Scouts"   ,icon_cataphract      |carries_goods(1)|pf_show_faction,0,fac_umbar   ,scout_personality,[(trp_ac4_khand_vet_skirmisher,1,3),(trp_c3_khand_horseman,2,4),(trp_c2_khand_pony_rider,3,6)]), #33-57 fast and capable
...
("imladris_raiders","Rivendell Foragers" ,icon_knight_rivendell|carries_goods(2)|pf_show_faction,0,fac_imladris,soldier_personality,[(trp_knight_of_rivendell,2,4),(trp_rivendell_cavalry,3,8),(trp_rivendell_infantry,6,12)]), #97-194 # less but stronger troops, cavalry
...
("imladris_patrol","Dunedain Patrol"  ,icon_knight_rivendell  |carries_goods(0)|pf_show_faction,0,fac_imladris,soldier_personality,[(trp_knight_of_arnor,1,1),(trp_arnor_horsemen,4,10),(trp_high_swordsman_of_arnor,3,5),(trp_arnor_master_at_arms,8,20),(trp_arnor_man_at_arms,8,20)]), #252-554
...
("gunda_caravan"   ,"Gundabad Supply Train",icon_supply_isengard|carries_goods(10)|pf_show_faction,0,fac_gundabad,prisoner_train_personality, [(trp_c5_goblin_north_clan_rider, 1, 2), (trp_ca4_warg_skirmisher_gundabad, 6, 16), (trp_i4_orc_beserker_gundabad, 6, 10), (trp_i2_orc_gundabad, 20, 30)]),
...
#rohan	
("rohan_reinf_a"   ,"_",0,0,fac_commoners,0,[(trp_c2_squire_of_rohan,1,2),(trp_i2_guardsman_of_rohan,2,4),(trp_i1_rohan_youth,4,8),]),
...
("umbar_reinf_b"   ,"_",0,0,fac_commoners,0,[(trp_black_numenorean_renegade,1,2),(trp_i3_corsair_swordsman,1,2),(trp_i3_corsair_spearman,1,2),(trp_a3_corsair_marksman,2,4)]),
("umbar_reinf_c"   ,"_",0,0,fac_commoners,0,[(trp_black_numenorean_warrior,1,2),(trp_i4_corsair_veteran_swordsman,1,2),(trp_i4_corsair_veteran_spearman,1,2),(trp_a4_corsair_veteran_marksman,1,2),]),
...
("imladris_reinf_a","_",0,0,fac_commoners,0,[(trp_rivendell_infantry,1,3),(trp_dunedain_trained_scout,0,1),(trp_rivendell_scout,1,2),(trp_dunedain_scout,2,4)]), #InVain: Fewer archers, more inf
("imladris_reinf_b","_",0,0,fac_commoners,0,[(trp_rivendell_sentinel,2,4),(trp_dunedain_ranger,1,2),(trp_rivendell_veteran_infantry,1,2),(trp_arnor_man_at_arms,0,1),]),
...
("moria_reinf_a"   ,"_",0,0,fac_commoners,0,[(trp_i1_snaga_of_moria,4,8),(trp_i2_goblin_of_moria,2,4),]), #InVain: traded some t1 for t2 = more infantry for hosts
("moria_reinf_b"   ,"_",0,0,fac_commoners,0,[(trp_a3_large_goblin_archer_of_moria,4,7),(trp_i2_goblin_of_moria,1,2),(trp_i3_large_goblin_of_moria,2,4),(trp_i4_fell_goblin_of_moria,1,2)]), #InVain: t3 archers, t3 inf, some t4 inf
("moria_reinf_c"   ,"_",0,0,fac_commoners,0,[(trp_c3_wolf_rider_of_moria,2,4),(trp_i3_large_goblin_of_moria,1,2),(trp_troll_of_moria,1,1),]), #InVain: removed archers, because B has so many, less cav, fewer t3
...
("guldur_reinf_b"  ,"_",0,0,fac_commoners,0,[(trp_orc_of_guldur,4,7),(trp_orc_of_mordor,3,6),]),
("guldur_reinf_c"  ,"_",0,0,fac_commoners,0,[(trp_warg_rider_of_gorgoroth,1,2),(trp_orc_tracker_of_mordor,2,4),(trp_large_orc_of_mordor,1,2),(trp_olog_hai,0,1),]),
...
("dunland_reinf_c" ,"_",0,0,fac_commoners,0,[(trp_ac2_dun_crebain_rider,1,2),(trp_i4_dun_wolf_warrior,2,4),(trp_i4_dun_vet_pikeman,1,2),]),
...
##Kham Orc Horde
("orc_horde"   ,"Orc Horde"     ,icon_orc_x4           |carries_goods(6)|pf_show_faction,0,fac_moria   ,soldier_personality,[(trp_i3_large_goblin_of_moria,40,50),(trp_i1_snaga_of_moria,50,80)]), 
