...
############################################# "Elves kick ass"
       ...
       (set_visitor, 0, "$g_player_troop"),
		...
		(set_visitors, 1, "trp_lothlorien_scout",					5),
		(set_visitors, 2, "trp_lothlorien_veteran_scout",			5),
		(set_visitors, 3, "trp_lothlorien_archer",					5),
		(set_visitors, 4, "trp_lothlorien_veteran_archer",			5),
		(set_visitors, 5, "trp_lothlorien_master_archer",			5),
		(set_visitors, 6, "trp_galadhrim_royal_archer",				5),
		(set_visitors, 7, "trp_galadhrim_royal_marksman",			5),
		(set_visitors, 8, "trp_noldorin_mounted_archer",			5),
		(set_visitors, 9, "trp_lothlorien_infantry",				5),
		(set_visitors, 10, "trp_lothlorien_veteran_infantry",		5),
		(set_visitors, 11, "trp_lothlorien_elite_infantry",			5),
		(set_visitors, 12, "trp_galadhrim_royal_swordsman",			5),
		(set_visitors, 13, "trp_lothlorien_warden",					5),
...
## ENEMY
		(set_visitors, 16, "trp_uruk_hai_tracker",							6),
		(set_visitors, 17, "trp_large_uruk_hai_tracker",					6),
		(set_visitors, 18, "trp_fighting_uruk_hai_tracker",					6),
		(set_visitors, 19, "trp_fighting_uruk_hai_berserker",				16),
		(set_visitors, 20, "trp_uruk_snaga_of_isengard",					30),
		(set_visitors, 21, "trp_uruk_hai_of_isengard",						30),
		(set_visitors, 22, "trp_large_uruk_hai_of_isengard",				20),
		(set_visitors, 23, "trp_fighting_uruk_hai_warrior",					10),
...
## ENEMY
		(set_visitors, 16, "trp_greenwood_scout",						5),
		(set_visitors, 17, "trp_greenwood_veteran_scout",				5),
		(set_visitors, 18, "trp_greenwood_archer",						5),
		(set_visitors, 19, "trp_greenwood_veteran_archer",				3),
		(set_visitors, 20, "trp_greenwood_master_archer",				3),
		(set_visitors, 21, "trp_thranduils_royal_marksman",				3),
		(set_visitors, 22, "trp_noldorin_mounted_archer",				3),
		(set_visitors, 23, "trp_rivendell_scout",						3),
		(set_visitors, 24, "trp_rivendell_veteran_scout",				3),
		(set_visitors, 25, "trp_rivendell_sentinel",					3),
		(set_visitors, 26, "trp_greenwood_royal_spearman",				3),
		(set_visitors, 27, "trp_greenwood_veteran_spearman",			3),
