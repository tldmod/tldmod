...
attr_tier_6 = str_20|agi_18|int_20|cha_20|level(42) # Super elite Rohan, Gondor, some captains
...
attr_elf_tier_6 = str_30|agi_30|int_20|cha_20|level(48)
...
attr_dwarf_tier_6 = str_30|agi_18| int_20| cha_20|level(46)
...
attr_orc_tier_4 = str_11| agi_9| int_7| cha_7|level(18) #elite orcs
...
wp_tier_1 = wp(70) | wp_throwing(45)
wp_tier_2 = wp(100) | wp_throwing(65)
wp_tier_3 = wp(135) | wp_throwing(90)
wp_tier_4 = wp(170) | wp_throwing(115)
wp_tier_5 = wp(200) | wp_throwing(130)
wp_tier_6 = wp(300) | wp_throwing(200)
wp_tier_7 = wp(400) | wp_throwing(265)
...
wp_dwarf_tier_1 = wp_melee(100) | wp_archery(140) | wp_throwing(65)
wp_dwarf_tier_2 = wp_melee(160) | wp_archery(160) | wp_throwing(105)
wp_dwarf_tier_3 = wp_melee(210) | wp_archery(190) | wp_throwing(140)
wp_dwarf_tier_4 = wp(240) | wp_throwing(160)
wp_dwarf_tier_5 = wp(300) | wp_throwing(200)
wp_dwarf_tier_6 = wp(350) | wp_throwing(230)

wp_orc_tier_1 = wp(70)| wp_throwing(45)
wp_orc_tier_2 = wp(95)| wp_throwing(60)
wp_orc_tier_3 = wp(125)| wp_throwing(85)
wp_orc_tier_4 = wp(150)| wp_throwing(100)
wp_orc_tier_5 = wp(170)| wp_throwing(115)
wp_orc_tier_6 = wp(300)| wp_throwing(200)

wp_orc_tier_bow_2 = wp_archery(95) | wp_melee(70)| wp_throwing(60)
wp_orc_tier_bow_3 = wp_archery(125) | wp_melee(95)| wp_throwing(85)
wp_orc_tier_bow_4 = wp_archery(150) | wp_melee(115)| wp_throwing(100)
wp_orc_tier_bow_5 = wp_archery(170) | wp_melee(130) | wp_throwing(115)
...
if is_a_wb_troop == 0:
    ...
    itm_spider_mount = itm_spider
    itm_bear_strong = itm_bear
    itm_wolf_strong = itm_wolf
    itm_boar = itm_no_item
    itm_boar_strong = itm_no_item
    itm_beast = itm_no_item
    itm_beast_strong = itm_no_item
    itm_kine = itm_no_item
    itm_kine_strong = itm_no_item
...
itm_leather_gloves_reinf =     (itm_leather_gloves, imod_reinforced) #Narf demi gauntlets
itm_leather_gloves_good = 		(itm_leather_gloves, imod_thick) #CWE lord gloves
itm_leather_gloves_bad = 		(itm_leather_gloves, imod_crude)
itm_mail_mittens_good =         (itm_mail_mittens, imod_reinforced) #future blackened mittens
itm_evil_gauntlets_a_good = 	(itm_evil_gauntlets_a, imod_thick) #CWE lord gloves
itm_evil_gauntlets_a_lordly = 	(itm_evil_gauntlets_a, imod_reinforced) #CWE arabian lamellar gauntlets
itm_evil_gauntlets_a_bad = 		(itm_evil_gauntlets_a, imod_crude)
itm_evil_gauntlets_b_good = 	(itm_evil_gauntlets_b, imod_thick) #narf wisby gauntlets
itm_evil_gauntlets_b_bad = 		(itm_evil_gauntlets_b, imod_crude) 
itm_orc_mittens_good = 	        (itm_orc_mittens, imod_reinforced) #narf plate mittens retextures
itm_orc_mittens_bad = 		    (itm_orc_mittens, imod_crude) #leather mittens
...
itm_rohan_shoes_good = 			(itm_rohan_shoes, imod_thick)
itm_furry_boots_bad = 			(itm_furry_boots, imod_rusty)
itm_furry_boots_good = 			(itm_furry_boots, imod_thick)
itm_hunter_boots_reward = 		(itm_hunter_boots, imod_lordly)
...
itm_mail_coif_good = (itm_mail_coif, imod_reinforced)
...
#Orc helm variants
itm_orc_skullcap_good = (itm_orc_skullcap, imod_reinforced)
itm_orc_skullcap_bad = (itm_orc_skullcap, imod_cracked)
...
itm_orc_skullhelm_good = (itm_orc_skullhelm, imod_reinforced)
itm_orc_skullhelm_bad = (itm_orc_skullhelm, imod_cracked)
itm_orc_barbuta_good = (itm_orc_barbuta, imod_reinforced)
itm_orc_barbuta_bad = (itm_orc_barbuta, imod_cracked)

#Orc weapon variants
itm_uruk_falchion_a_heavy = (itm_uruk_falchion_a, imod_heavy)
itm_orc_bastard_scimitar_heavy = (itm_orc_bastard_scimitar, imod_heavy)
itm_orc_bastard_scimitar_bad = (itm_orc_bastard_scimitar, imod_crude)
itm_orc_cleaver_a_heavy = (itm_orc_cleaver_a, imod_heavy)
itm_orc_scimitar_b_heavy = (itm_orc_scimitar_b, imod_heavy)
itm_orc_sabre_b_heavy = (itm_orc_sabre_b, imod_heavy)
itm_orc_mangler_heavy = (itm_orc_mangler, imod_heavy)
itm_orc_mangler_bad = (itm_orc_mangler, imod_crude)
itm_bone_cudgel_heavy = (itm_bone_cudgel, imod_heavy)
itm_orc_club_b_heavy = (itm_orc_club_b, imod_heavy)
itm_orc_club_c = (itm_orc_mace, imod_crude) #spiked club
itm_orc_mace_bad = (itm_orc_mace, imod_crude) #spiked club
itm_orc_mace_heavy = (itm_orc_mace, imod_heavy)
...
itm_orc_axe_heavy = (itm_orc_axe, imod_heavy)
...
itm_umb_armor_a_lordly = (itm_umb_armor_a, imod_lordly)
itm_umb_armor_c_lordly = (itm_umb_armor_c, imod_lordly)
itm_umb_armor_f_lordly = (itm_umb_armor_f, imod_lordly)
itm_umb_shield_a_good	= (itm_umb_shield_a, imod_thick)
itm_umb_shield_b_bad = (itm_umb_shield_b, imod_cracked)
itm_umb_shield_b_good = (itm_umb_shield_b, imod_thick)
...
#Gondor Super Warhorse
itm_gondor_warhorse_heavy = (itm_gondor_warhorse, imod_heavy)
...
itm_khand_mail_good = (itm_khand_mail, imod_reinforced)
itm_khand_mail_bad = (itm_khand_mail, imod_cracked)
itm_khand_heavy_lam_good = (itm_khand_heavy_lam, imod_reinforced)
itm_khand_heavy_lam_bad = (itm_khand_heavy_lam, imod_cracked)
itm_khand_noble_lam_good = (itm_khand_noble_lam, imod_reinforced)
itm_khand_noble_lam_bad = (itm_khand_noble_lam, imod_cracked)
...
#itm_mirkwood_heavy_scale_good = (itm_mirkwood_heavy_scale, imod_lordly) #unused
...
# harad armors
itm_harad_tunic_good = (itm_harad_tunic, imod_reinforced)
itm_harad_tunic_bad = (itm_harad_tunic, imod_cracked)
itm_harad_padded_good = (itm_harad_padded, imod_reinforced)
itm_harad_padded_bad = (itm_harad_padded, imod_cracked)
itm_harad_lamellar_good = (itm_harad_lamellar, imod_reinforced)
itm_harad_lamellar_bad = (itm_harad_lamellar, imod_cracked)
itm_harad_heavy_lamellar_good = (itm_harad_heavy_lamellar, imod_reinforced)
itm_harad_heavy_lamellar_lordly = (itm_harad_heavy_lamellar, imod_lordly)
itm_harad_heavy_lamellar_bad = (itm_harad_heavy_lamellar, imod_cracked)
itm_harad_heavy_good = (itm_harad_heavy, imod_reinforced)
itm_harad_heavy_bad = (itm_harad_heavy, imod_cracked)
itm_harad_scale_good = (itm_harad_scale, imod_reinforced)
itm_harad_scale_bad = (itm_harad_scale, imod_cracked)
itm_harad_pectoral_good = (itm_harad_pectoral, imod_reinforced)
...
itm_arnor_light_a_cloak			= (itm_arnor_light_a, imod_cloak)
itm_arnor_light_a_good			= (itm_arnor_light_a, imod_thick)
itm_arnor_light_a_good_cloak	= (itm_arnor_light_a, imod_lordly)
itm_arnor_light_b_bad			= (itm_arnor_light_b, imod_crude)
itm_arnor_light_b_cloak			= (itm_arnor_light_b, imod_cloak)
itm_arnor_light_b_good			= (itm_arnor_light_b, imod_reinforced)
itm_arnor_light_b_good_cloak	= (itm_arnor_light_b, imod_lordly)
itm_arnor_med_a_bad			    = (itm_arnor_med_a, imod_crude)
itm_arnor_med_a_cloak			= (itm_arnor_med_a, imod_cloak)
itm_arnor_med_a_good			= (itm_arnor_med_a, imod_reinforced)
itm_arnor_med_a_good_cloak	    = (itm_arnor_med_a, imod_lordly)
itm_arnor_med_b_bad			    = (itm_arnor_med_b, imod_cracked)
itm_arnor_med_b_cloak			= (itm_arnor_med_b, imod_cloak)
itm_arnor_med_b_good			= (itm_arnor_med_b, imod_thick)
itm_arnor_med_b_good_cloak	    = (itm_arnor_med_b, imod_lordly)
itm_arnor_heavy_bad			    = (itm_arnor_heavy, imod_cracked)
itm_arnor_heavy_cloak			= (itm_arnor_heavy, imod_cloak)
itm_arnor_heavy_good			= (itm_arnor_heavy, imod_reinforced)
itm_arnor_heavy_good_cloak	    = (itm_arnor_heavy, imod_lordly)

# arnor helms
itm_arnor_helm_a_good = (itm_arnor_helm_a, imod_reinforced)
itm_arnor_helm_a_bad = (itm_arnor_helm_a, imod_crude)
itm_arnor_helm_b_good = (itm_arnor_helm_b, imod_reinforced)
itm_arnor_helm_b_bad = (itm_arnor_helm_b, imod_crude)
itm_arnor_helm_c_good = (itm_arnor_helm_c, imod_reinforced)
itm_arnor_helm_c_bad = (itm_arnor_helm_c, imod_crude)

#Arnor Super Warhorse
itm_dunedain_warhorse_heavy = (itm_dunedain_warhorse, imod_heavy)

# Dunland armors
itm_dunland_tunic_1_bad = (itm_dunland_tunic_1, imod_crude)
itm_dunland_tunic_1_good = (itm_dunland_tunic_1, imod_reinforced)
itm_dunland_tunic_2_bad = (itm_dunland_tunic_2, imod_crude)
itm_dunland_tunic_2_good = (itm_dunland_tunic_2, imod_reinforced)
itm_dunland_fur_1_bad = (itm_dunland_fur_1, imod_crude)
itm_dunland_fur_1_good = (itm_dunland_fur_1, imod_reinforced)
itm_dunland_fur_2_bad = (itm_dunland_fur_2, imod_crude)
itm_dunland_fur_2_good = (itm_dunland_fur_2, imod_reinforced)
itm_dunland_mail_1_bad = (itm_dunland_mail_1, imod_crude)
itm_dunland_mail_1_good = (itm_dunland_mail_1, imod_reinforced)
itm_dunland_mail_2_bad = (itm_dunland_mail_2, imod_crude)
itm_dunland_mail_2_good = (itm_dunland_mail_2, imod_reinforced)
itm_dunland_chieftain_bad = (itm_dunland_chieftain, imod_cracked) #make it a bit weaker for regular troops
itm_dunland_chieftain_good = (itm_dunland_chieftain, imod_reinforced)

itm_dun_helm_a_bad = (itm_dun_helm_a, imod_crude) #wolf cap
itm_dun_helm_a_good = (itm_dun_helm_a, imod_reinforced)
itm_dun_helm_b_bad = (itm_dun_helm_b, imod_crude) #fur cap
itm_dun_helm_b_good = (itm_dun_helm_b, imod_reinforced)
itm_dun_helm_c_bad = (itm_dun_helm_c, imod_crude) #tall helm
itm_dun_helm_c_good = (itm_dun_helm_c, imod_reinforced)
itm_dun_helm_d_bad = (itm_dun_helm_d, imod_crude) #low helm
itm_dun_helm_d_good = (itm_dun_helm_d, imod_reinforced)

itm_dun_berserker_bad = (itm_dun_berserker, imod_crude) #no special asset
itm_dun_berserker_heavy = (itm_dun_berserker, imod_heavy)
itm_dunnish_war_axe_bad = (itm_dunnish_war_axe, imod_crude)
itm_dunnish_war_axe_heavy = (itm_dunnish_war_axe, imod_heavy)
itm_dunnish_axe_bad = (itm_dunnish_axe, imod_crude)
itm_dunnish_axe_heavy = (itm_dunnish_axe, imod_heavy)
itm_dunnish_long_axe_bad = (itm_dunnish_long_axe, imod_crude)
itm_dunnish_long_axe_heavy = (itm_dunnish_long_axe, imod_heavy)
itm_dun_shortsword_bad = (itm_dun_shortsword, imod_crude) #no special asset
itm_dun_shortsword_heavy = (itm_dun_shortsword, imod_heavy)
...
["townsman","Townsman","Townsmen",tfg_boots| tfg_armor,0,0,fac_dale,
   [itm_corsair_boots, itm_leather_boots,itm_leather_boots_dark_bad, itm_rohan_shoes,itm_civ_fine_shoes, itm_pelt_coat, 
   itm_fur_coat_tld, itm_leather_jerkin_wb, itm_black_tunic_wb, itm_lossarnach_shirt, itm_nobleman_outfit_b_new_wb, itm_peasant_man_a_wb, itm_white_tunic_c_wb, itm_red_tunic_wb, itm_sar_robe_b_wb, itm_leather_jacket,
   itm_hood_black, itm_hood_grey_bad, itm_fur_hat_a_new_wb, itm_noel_hat_a_wb, itm_felt_hat, itm_felt_hat_b, itm_fur_hat, ],
...
["watchman","Townswoman","Townswomen",tf_female| tfg_boots| tfg_armor,0,0,fac_dale,
   [itm_gondor_ranger_hood, itm_wimple_a_wb, itm_wimple_with_veil, itm_fur_hat_a_new_wb, itm_wimple_a, itm_wimple_with_veil, 
...
["i5_woodmen_night_guard","Night_Guard_of_Mirkwood","Night_Guards_of_Mirkwood",tfg_armor| tfg_helm| tfg_boots| tfg_gloves,0,0,fac_beorn,[itm_north_leather_skullcap_good, itm_north_skullcap, itm_north_nasal_helm_good,itm_woodmen_heavy,itm_leather_boots,itm_leather_boots,itm_2_handed_axe,itm_marker_night_troop,],attr_tier_5,wp_tier_5,knows_common|knows_athletics_5|knows_power_strike_6|knows_ironflesh_6,rohan_face_middle_1,rohan_face_old_2],
...
["i3_dale_swordsman","Dale_Swordsman","Dale_Swordsmen",tfg_shield| tfg_boots| tfg_armor| tfg_helm,0,0,fac_dale,[itm_north_skullcap, itm_north_skullcap_good, itm_north_nasal_helm, itm_dale_helmet_a, itm_dale_helmet_a_good,itm_mail_coif_good,itm_dale_med_d,itm_leather_boots,itm_leather_boots_dark,itm_dale_sword,itm_dale_shield_a, itm_dale_shield_b,],attr_tier_3,wp_tier_3,knows_common|knows_athletics_1|knows_power_strike_2|knows_ironflesh_3|knows_shield_2,swadian_face_young_1,swadian_face_old_2],
...
["i5_dale_hearthman","Hearthman_of_Dale","Hearthmen_of_Dale",tfg_shield| tfg_boots| tfg_armor| tfg_helm,0,0,fac_dale,[itm_dale_helmet_c, itm_dale_helmet_c_good, itm_dale_helmet_e,itm_dale_heavy_a_good,itm_leather_gloves_good,itm_splinted_greaves,itm_dale_sword_broad, itm_axe_d,itm_dale_shield_b_good,],attr_tier_5,wp_tier_5,knows_common|knows_athletics_3|knows_power_strike_4|knows_ironflesh_5|knows_shield_5,swadian_face_middle_1,swadian_face_older_2],
...
["dwarf_items","{!}BUG","{!}",tf_hero,0,0,fac_dwarf,
   [itm_pony, itm_dwarf_shield_b,itm_dwarf_sword_c,itm_dwarf_sword_d,itm_dwarf_great_mattock,itm_dwarf_hand_axe,itm_dwarf_throwing_axe,itm_dwarf_spear,itm_metal_scraps_bad,itm_metal_scraps_medium,itm_metal_scraps_good,],
      0,0,0,0],
...
["steward_guard","Steward's_Guard","Steward's_Guards",tf_gondor| tfg_gloves| tfg_armor| tfg_helm| tfg_boots,0,0,fac_gondor,[itm_gondor_leader_helm,itm_gon_steward_guard,itm_mail_mittens,itm_gondor_heavy_greaves,itm_gondor_tower_spear,itm_gondor_citadel_sword,itm_gondor_2h_sword,itm_gon_tab_shield_b,],attr_tier_6,wp_tier_6,knows_common|knows_athletics_4|knows_shield_6|knows_power_strike_6|knows_ironflesh_4,gondor_face1,gondor_face3],
#Rangers
...
["a5_ithilien_vet_ranger","Veteran_Ranger_of_Ithilien","Veteran_Rangers_of_Ithilien",tf_gondor| tfg_ranged| tfg_armor| tfg_helm| tfg_boots,0,subfac_rangers,fac_gondor,[itm_gondor_ranger_hood,itm_gon_ranger_cloak,itm_gon_ranger_skirt,itm_leather_gloves,itm_gondor_light_greaves,itm_ithilien_arrows,itm_gondor_bow,itm_gondor_ranger_sword,],attr_tier_5,wp(220),knows_common|knows_pathfinding_2|knows_riding_1|knows_athletics_7|knows_power_draw_4|knows_power_strike_4|knows_ironflesh_4,gondor_face1,gondor_face2],
...
["i5_lam_champion","Champion_of_Lamedon","Champions_of_Lamedon",tf_gondor| tfg_gloves| tfg_armor| tfg_helm| tfg_boots,0,subfac_ethring,fac_gondor,[itm_gondor_lamedon_helm,itm_mail_coif_good,itm_lamedon_vet_warrior,itm_mail_mittens,itm_gondor_heavy_greaves,itm_gondor_2h_sword,itm_gondor_2h_sword,itm_loss_war_axe,],attr_tier_5,wp_tier_5,knows_common|knows_athletics_5|knows_power_strike_5|knows_ironflesh_6,gondor_face1,gondor_face2],
...
["i3_blackroot_spearman","Spearman_of_Blackroot_Vale","Spearmen_of_Blackroot_Vale",tf_gondor| tfg_gloves| tfg_armor| tfg_helm| tfg_boots,0,subfac_blackroot,fac_gondor,[itm_gondor_auxila_helm,itm_mail_coif,itm_blackroot_warrior,itm_leather_gloves,itm_gondor_med_greaves,itm_gondor_spear,itm_gon_tab_shield_d,],attr_fief_tier_4,wp_tier_4,knows_common|knows_athletics_5|knows_power_strike_5|knows_ironflesh_5,gondor_face1,gondor_face2],
["a5_blackroot_shadow_hunter","Morthond_Shadow_Hunter","Morthond_Shadow_Hunters",tf_gondor| tfg_ranged| tfg_armor| tfg_helm| tfg_boots,0,subfac_blackroot,fac_gondor,[itm_hood_black,itm_blackroot_leader,itm_leather_gloves_good,itm_gondor_med_greaves,itm_gondor_arrows,itm_gondor_bow,itm_gon_tab_shield_c,itm_gondor_spear,itm_marker_night_troop,],attr_tier_5,wp_melee(200)|wp_archery(200),knows_common|knows_athletics_7|knows_power_draw_5|knows_power_strike_5|knows_ironflesh_5,gondor_face1,gondor_face3],
#Dol Amroth
...
["a2_lorien_archer","Lothlorien_Archer","Lothlorien_Archers",tf_lorien| tfg_ranged| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_lorien,[itm_lorien_helm_a,itm_lorien_light,itm_leather_gloves,itm_lorien_boots,itm_woodelf_leather_boots_good,itm_elven_bow,itm_elven_arrows,itm_lorien_sword_b,],attr_elf_tier_2,wp_elf_tier_bow_2,knows_common|knows_ironflesh_1|knows_power_strike_2|knows_power_draw_3|knows_weapon_master_1|knows_athletics_3|knows_tactics_1|knows_pathfinding_1|knows_spotting_1|knows_wound_treatment_1|knows_surgery_1|knows_persuasion_2,lorien_elf_face_1,lorien_elf_face_2],
...
["lorien_items","{!}BUG","{!}",tf_hero,0,0,fac_lorien,
   [itm_sumpter_horse, itm_saddle_horse,itm_short_bow,itm_regular_bow,itm_arrows,itm_metal_scraps_bad,itm_metal_scraps_medium,itm_metal_scraps_good,],
      0,0,0,0],
...
["a3_greenwood_archer","Greenwood_Archer","Greenwood_Archers",tf_woodelf| tfg_ranged| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_woodelf,[itm_mirkwood_helm_a_bad,itm_mirkwood_pad,itm_leather_boots, itm_leather_boots_dark,itm_woodelf_leather_boots,itm_elven_bow,itm_woodelf_arrows,itm_mirkwood_short_spear,],attr_elf_tier_3,wp_elf_tier_bow_3,knows_common|knows_athletics_5|knows_power_draw_5|knows_power_strike_3|knows_ironflesh_3,mirkwood_elf_face_1,mirkwood_elf_face_2],
...
["i3_greenwood_vet_infantry","Greenwood_Veteran_Infantry","Greenwood_Veteran_Infantry",tf_woodelf| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_woodelf,[itm_mirkwood_helm_b_good,itm_mirkwood_helm_c,itm_mirkwood_scale,itm_leather_gloves,itm_mirkwood_boots,itm_woodelf_leather_boots_good,itm_mirkwood_war_spear,itm_mirkwood_axe,itm_mirkwood_sword,itm_mirkwood_spear_shield_a,],attr_elf_tier_3,wp_elf_tier_3,knows_common|knows_athletics_6|knows_shield_3|knows_power_strike_4|knows_ironflesh_4,mirkwood_elf_face_1,mirkwood_elf_face_2],
...
["woodelf_items","{!}BUG","{!}",tf_hero,0,0,fac_woodelf,
   [itm_leather_boots,itm_mirkwood_axe_2h,itm_leather_gloves,itm_short_bow,itm_regular_bow,itm_arrows,itm_sumpter_horse,itm_saddle_horse,itm_metal_scraps_bad,itm_metal_scraps_medium,itm_metal_scraps_good,],
      0,0,0,0],
#Rivendell #Imladris
...
["a4_riv_vet_archer","Rivendell_Veteran_Archer","Rivendell_Veteran_Archers",tf_imladris| tfg_ranged| tfg_gloves| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_imladris,[itm_riv_helm_b,itm_riv_foot_mail_cloak,itm_leather_gloves,itm_riv_boots,itm_woodelf_leather_boots_good,itm_riv_bow,itm_elven_arrows,itm_riv_1h_sword,],attr_elf_tier_4,wp_elf_tier_4,knows_common|knows_athletics_5|knows_power_draw_4|knows_power_strike_3|knows_ironflesh_4,rivendell_elf_face_1,rivendell_elf_face_2],
...
#Dunedain #Arnor
["a1_arnor_scout","Dunedain_Scout","Dunedain_Scouts",tf_dunedain| tfg_armor| tfg_boots,0,0,fac_imladris,[itm_hood_grey_bad,itm_arnor_light_a_cloak, itm_leather_gloves,itm_leather_boots_dark_bad,itm_short_bow,itm_arrows,itm_arnor_sword_f,],attr_tier_2,wp_tier_2,knows_common|knows_ironflesh_2|knows_power_strike_1|knows_power_draw_2|knows_athletics_1|knows_tracking_1|knows_tactics_1|knows_pathfinding_1|knows_spotting_1|knows_wound_treatment_1|knows_persuasion_1|knows_leadership_1,arnor_face_middle_1,arnor_face_middle_2],
["a2_arnor_vet_scout","Dunedain_Tracker","Dunedain_Trackers",tf_dunedain| tfg_armor| tfg_boots,0,0,fac_imladris,[itm_hood_grey,itm_arnor_light_a_good_cloak, itm_arnor_med_a_cloak,itm_leather_gloves,itm_leather_boots,itm_leather_boots_dark_bad,itm_regular_bow,itm_arrows,itm_arnor_sword_f,],attr_tier_3,wp_tier_3,knows_common|knows_ironflesh_2|knows_power_strike_3|knows_power_draw_2|knows_athletics_2|knows_tracking_1|knows_tactics_1|knows_pathfinding_1|knows_spotting_1|knows_wound_treatment_1|knows_persuasion_1|knows_leadership_1,arnor_face_middle_1,arnor_face_middle_2],
["i3_arnor_swordsman","Dunedain_Swordsman","Dunedain_Swordsmen",tf_dunedain| tfg_armor| tfg_helm| tfg_boots,0,0,fac_imladris,[itm_arnor_helm_a, itm_arnor_helm_b_bad,itm_mail_coif,itm_arnor_light_b_good,itm_arnor_med_a_good, itm_arnor_med_b_bad,itm_leather_gloves,itm_leather_boots, itm_leather_boots_dark,itm_arnor_sword_f,itm_arnor_sword_a,itm_arnor_shield_a,],attr_tier_4,wp_tier_4,knows_common|knows_athletics_4|knows_shield_3|knows_power_strike_3|knows_ironflesh_4,arnor_face_middle_1,arnor_face_middle_2],
["i4_arnor_vet_swordsman","Dunedain_Veteran_Swordsman","Dunedain_Veteran_Swordsmen",tf_dunedain| tfg_gloves| tfg_armor| tfg_helm| tfg_boots,0,0,fac_imladris,[itm_arnor_helm_a_good, itm_arnor_helm_b,itm_mail_coif_good,itm_arnor_med_b_good, itm_arnor_heavy_bad, itm_leather_gloves,itm_leather_boots, itm_leather_boots_dark,itm_arnor_sword_a,itm_arnor_shield_a,],attr_tier_5,wp_elf_tier_3,knows_common|knows_athletics_5|knows_shield_4|knows_power_strike_4|knows_ironflesh_5,arnor_face_middle_1,arnor_face_middle_2],
["i5_arnor_champion","Champion_of_Arnor","Champions_of_Arnor",tf_dunedain| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_imladris,[itm_arnor_helm_c,itm_arnor_heavy_cloak,itm_mail_mittens,itm_arnor_greaves,itm_arnor_sword_c,itm_arnor_sword_a,itm_arnor_shield_a,itm_arnor_shield_c,],attr_tier_6,wp_elf_tier_4,knows_common|knows_athletics_5|knows_shield_5|knows_power_strike_6|knows_ironflesh_7,arnor_face_older_1,arnor_face_older_2],
["c4_arnor_horseman","Dunedain_Horseman","Dunedain_Horsemen",tf_dunedain| tf_mounted| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_imladris,[itm_arnor_helm_b_good,itm_mail_coif_good,itm_arnor_heavy, itm_arnor_med_b_good, itm_mail_mittens,itm_arnor_greaves,itm_arnor_sword_a,itm_arnor_shield_c,itm_dunedain_warhorse,],attr_tier_5,wp_elf_tier_3,knows_common|knows_riding_4|knows_shield_2|knows_athletics_4|knows_power_strike_6|knows_ironflesh_4,arnor_face_older_1,arnor_face_older_2],
["c5_arnor_knight","Knight_of_Arnor","Knights_of_Arnor",tf_dunedain| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm,0,0,fac_imladris,[itm_arnor_helm_c_good,itm_arnor_heavy_good,itm_mail_mittens,itm_arnor_greaves,itm_leather_boots_dark,itm_lance,itm_arnor_sword_c,itm_arnor_shield_c,itm_dunedain_warhorse_heavy,],attr_tier_6,wp_elf_tier_4,knows_common|knows_riding_5|knows_shield_3|knows_athletics_5|knows_power_strike_7|knows_ironflesh_5,arnor_face_older_1,arnor_face_older_2],
["a3_arnor_ranger","Dunedain_Ranger","Dunedain_Rangers",tf_dunedain| tfg_ranged| tfg_gloves| tfg_armor| tfg_boots,0,0,fac_imladris,[itm_hood_grey,itm_arnor_med_a_good_cloak, itm_arnor_light_b_cloak,itm_leather_gloves,itm_leather_boots,itm_leather_boots_dark_bad,itm_elven_bow,itm_ithilien_arrows,itm_arnor_sword_f,itm_riv_spear,itm_arnor_shield_a,],attr_tier_4,wp_archery(170)|wp(170),knows_common|knows_athletics_6|knows_shield_2|knows_power_draw_3|knows_power_strike_4|knows_ironflesh_4,arnor_face_middle_1,arnor_face_middle_2],
["a4_arnor_vet_ranger","Dunedain_Veteran_Ranger","Dunedain_Veteran_Rangers",tf_dunedain| tfg_ranged| tfg_gloves| tfg_armor| tfg_boots,0,0,fac_imladris,[itm_hood_grey,itm_arnor_helm_a,itm_arnor_light_b_good_cloak, itm_arnor_med_b_cloak,itm_leather_gloves,itm_leather_boots,itm_leather_boots_dark_bad,itm_elven_bow,itm_ithilien_arrows,itm_arnor_sword_f,itm_riv_spear,itm_arnor_shield_a,],attr_tier_5,wp(220),knows_common|knows_athletics_6|knows_shield_3|knows_power_draw_4|knows_power_strike_4|knows_ironflesh_5,arnor_face_older_1,arnor_face_older_2],
["a5_arnor_master_ranger","Master_Ranger_of_Arnor","Master_Rangers_of_Arnor",tf_dunedain| tfg_ranged| tfg_gloves| tfg_armor| tfg_boots,0,0,fac_imladris,[itm_arnor_helm_c_bad,itm_arnor_med_b_good_cloak,itm_leather_gloves,itm_leather_boots,itm_leather_boots_dark_bad,itm_elven_bow,itm_ithilien_arrows,itm_arnor_sword_f,itm_arnor_sword_a,itm_riv_spear,itm_arnor_shield_a,],attr_tier_6,wp_melee(360)|wp_archery(300),knows_common|knows_athletics_8|knows_shield_3|knows_power_draw_5|knows_power_strike_5|knows_ironflesh_6,arnor_face_older_1,arnor_face_older_2],


["imladris_items","{!}BUG","{!}BUG",tf_hero,0,0,fac_imladris,
   [itm_leather_boots,itm_leather_gloves,itm_mail_coif,itm_short_bow,itm_regular_bow,itm_arrows,itm_metal_scraps_bad,itm_metal_scraps_medium,itm_metal_scraps_good,itm_sumpter_horse, itm_saddle_horse, itm_arnor_light_a, itm_arnor_light_b, itm_arnor_med_a, itm_arnor_med_b, ],
      0,0,0,0],
#ROHAN
["i1_rohan_youth","Rohan_Youth","Rohan_Youths",tf_rohan| tfg_armor| tfg_boots,0,0,fac_rohan,[itm_hood_green_bad, itm_hood_grey_bad,itm_rohan_recruit_bad, itm_rohan_recruit, itm_rohan_recruit_good, itm_rohan_leather_bad,itm_north_leather_bad,itm_north_leather_ok,itm_rohan_tunic_a,itm_rohan_tunic_b,itm_rohan_shoes,itm_rohirrim_short_axe,itm_spear,itm_metal_scraps_bad,itm_metal_scraps_medium,itm_metal_scraps_good,],attr_tier_1,wp_tier_1,knows_common|knows_power_strike_1|knows_athletics_1|knows_riding_2|knows_horse_archery_1|knows_looting_1|knows_tactics_1|knows_pathfinding_1|knows_spotting_1|knows_inventory_management_1|knows_prisoner_management_1|knows_leadership_1|knows_trade_1,rohan_face_younger_1,rohan_face_middle_2],
["i2_guardsman_of_rohan","Guardsman_of_Rohan","Guardsmen_of_Rohan",tf_rohan| tfg_armor| tfg_boots,0,0,fac_rohan,[itm_rohan_light_helmet_a_bad,itm_rohan_light_helmet_b_bad,itm_rohan_recruit_good, itm_rohan_leather, itm_rohan_leather_cloak,itm_dale_light_b_bad,itm_north_leather_ok,itm_dale_light_b_cloak,itm_rohan_shoes,itm_leather_boots_bad,itm_spear,itm_rohan_sword_c,itm_rohan_shield_a,itm_rohan_shield_b,itm_rohan_shield_c,],attr_tier_2,wp_tier_2,knows_common|knows_ironflesh_2|knows_power_strike_2|knows_shield_1|knows_athletics_1|knows_riding_1|knows_looting_1|knows_tactics_1|knows_pathfinding_1|knows_spotting_1|knows_inventory_management_1|knows_prisoner_management_1|knows_leadership_1|knows_trade_1,rohan_face_young_1,rohan_face_old_2],
["i3_footman_of_rohan","Footman_of_Rohan","Footmen_of_Rohan",tf_rohan| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_rohan,[itm_rohan_light_helmet_b,itm_rohan_light_helmet_a,itm_rohan_mail,itm_rohan_mail_cloak, itm_dale_med_a_bad,itm_dale_light_b_lordly,itm_rohan_light_greaves,itm_leather_boots,itm_rohirrim_short_axe,itm_spear,itm_rohan_sword_c,itm_rohan_shield_a,itm_rohan_shield_b,itm_rohan_shield_c,],attr_tier_3,wp_tier_3,knows_common|knows_athletics_2|knows_shield_2|knows_power_strike_2|knows_ironflesh_1,rohan_face_middle_1,rohan_face_old_2],
["i4_veteran_footman_of_rohan","Veteran_Footman_of_Rohan","Veteran_Footmen_of_Rohan",tf_rohan| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_rohan,[itm_rohan_inf_helmet_b_bad,itm_mail_coif,itm_rohan_mail_cloak,itm_rohan_mail_good, itm_rohan_rider_bad,itm_dale_med_a_cloak,itm_rohan_light_greaves,itm_rohirrim_short_axe,itm_rohan_spear,itm_rohan_sword_c,itm_rohan_shield_d,itm_rohan_shield_e,itm_rohan_shield_f,],attr_tier_4,wp_tier_4,knows_common|knows_athletics_2|knows_shield_2|knows_power_strike_3|knows_ironflesh_2,rohan_face_middle_1,rohan_face_old_2],
["i5_elite_footman_of_rohan","Elite_Footman_of_Rohan","Elite_Footmen_of_Rohan",tf_rohan| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_rohan,[itm_rohan_inf_helmet_b,itm_mail_coif,itm_rohan_scale_bad, itm_rohan_scale_cloak, itm_rohan_scale_good,itm_rohan_rider_good_cloak, itm_rohan_rider_good,itm_dale_med_a_good,itm_dale_med_a_lordly,itm_rohirrim_war_greaves,itm_rohirrim_long_hafted_axe,itm_rohirrim_short_axe,itm_rohan_spear,itm_rohan_sword_c,itm_rohan_shield_d,itm_rohan_shield_e,itm_rohan_shield_f,],attr_tier_5,wp_tier_5,knows_common|knows_athletics_3|knows_shield_2|knows_power_strike_3|knows_ironflesh_2,rohan_face_middle_1,rohan_face_old_2],
["i6_footman_guard_of_rohan","Folcwine_Guard_of_Rohan","Folcwine_Guards_of_Rohan",tf_rohan| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_rohan,[itm_rohan_inf_helmet_b_good,itm_mail_coif_good,itm_rohan_surcoat_cloak,itm_rohan_surcoat_good_cloak,itm_leather_gloves,itm_rohirrim_war_greaves,itm_rohirrim_long_hafted_axe,itm_rohirrim_short_axe,itm_rohan_sword_c,itm_heavy_throwing_spear,itm_heavy_throwing_spear,itm_rohirrim_throwing_axe,itm_rohan_shield_d,itm_rohan_shield_e,itm_rohan_shield_f,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_3|knows_shield_4|knows_power_throw_4|knows_power_strike_6|knows_ironflesh_4,rohan_face_middle_1,rohan_face_old_2],
["i6_frealaf_raider","Frealaf_Raider","Frealaf_Raiders",tf_rohan| tfg_armor| tfg_helm| tfg_boots,0,0,fac_rohan,[itm_rohan_light_helmet_b,itm_rohan_light_helmet_a,itm_rohan_rider_cloak,itm_rohan_rider_good_cloak,itm_dale_med_a_good,itm_dale_med_a_lordly,itm_rohan_light_greaves,itm_rohirrim_long_hafted_axe,itm_rohirrim_short_axe,itm_heavy_throwing_spear,itm_heavy_throwing_spear,itm_rohirrim_throwing_axe,itm_rohirrim_throwing_axe,itm_rohan_shield_a,itm_rohan_shield_b,itm_rohan_shield_c,itm_marker_night_troop,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_7|knows_shield_3|knows_power_throw_6|knows_power_strike_6|knows_ironflesh_5,rohan_face_middle_1,rohan_face_old_2],
...
["c6_rider_guard_of_rohan","Eorl_Guard_of_Rohan","Eorl_Guards_of_Rohan",tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_guard_bad, itm_rohan_guard,itm_rohan_guard_cloak, itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_spear,itm_rohan_inf_sword,itm_rohan_inf_sword,itm_rohan_cav_sword,itm_rohirrim_long_hafted_axe,itm_rohirrim_long_hafted_axe,itm_rohan_shield_d,itm_rohan_shield_e,itm_rohan_shield_f,itm_rohan_shield_g,itm_thengel_warhorse,],attr_evil_tier_6,wp_tier_6,knows_common|knows_horse_archery_4|knows_riding_8|knows_shield_3|knows_power_throw_5|knows_power_strike_6|knows_ironflesh_6,rohan_face_middle_1,rohan_face_old_2],
["i6_2h_guard_of_rohan","Helm_Guard_of_Rohan","Helm_Guards_of_Rohan",tf_rohan| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_mail_coif_good,itm_rohan_guard_bad,itm_rohan_guard_cloak,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_2h_sword, itm_rohirrim_long_hafted_axe,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_6|knows_power_strike_7|knows_ironflesh_8,rohan_face_middle_1,rohan_face_old_2],

##Rohan Siege battle dismounted troops #moved out of troop factionization.
["ac3_dism_skirmisher_of_rohan2","Skirmisher_of_Rohan","Skirmishers_of_Rohan",tf_rohan| tfg_ranged|  tfg_armor|  tfg_boots,0,0,fac_rohan,[itm_rohan_light_helmet_a,itm_rohan_light_helmet_b,itm_rohan_light_helmet_b_good,itm_rohan_recruit_good, itm_rohan_leather_bad, itm_rohan_leather,itm_dale_light_b_bad,itm_north_leather_good,itm_rohan_shoes,itm_leather_boots_bad,itm_nomad_bow,itm_khergit_arrows,itm_rohan_sword_c,itm_spear,itm_rohirrim_courser,],attr_tier_3,wp_tier_bow_3,knows_common|knows_horse_archery_3|knows_shield_1| knows_riding_3|knows_power_draw_1,rohan_face_young_1,rohan_face_middle_2],
["ac4_dism_veteran_skirmisher_of_rohan2","Veteran_Skirmisher_of_Rohan","Veteran_Skirmishers_of_Rohan",tf_rohan| tfg_ranged|  tfg_armor| tfg_helm|  tfg_boots,0,0,fac_rohan,[itm_rohan_light_helmet_a,itm_rohan_light_helmet_b_good,itm_rohan_archer_helmet_a_bad,itm_rohan_leather_good,itm_rohan_mail_bad, itm_rohan_mail,itm_dale_light_b,itm_leather_boots,itm_nomad_bow,itm_khergit_arrows,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohirrim_courser,itm_rohirrim_hunter,],attr_tier_4,wp_tier_bow_4,knows_common|knows_horse_archery_5|knows_riding_4|knows_power_draw_3|knows_power_strike_2|knows_ironflesh_1,rohan_face_middle_1,rohan_face_old_2],
["ac5_dism_elite_skirmisher_of_rohan2","Elite_Skirmisher_of_Rohan","Elite_Skirmishers_of_Rohan",tf_rohan| tfg_ranged|  tfg_armor| tfg_helm|  tfg_boots,0,0,fac_rohan,[itm_rohan_archer_helmet_a,itm_rohan_light_helmet_a,itm_rohan_mail_good, itm_rohan_rider,itm_rohan_rider_bad,itm_dale_light_b_good,itm_leather_gloves,itm_rohan_light_greaves,itm_leather_boots,itm_strong_bow,itm_khergit_arrows,itm_rohan_spear,itm_rohan_sword_c,itm_rohirrim_long_hafted_axe,itm_rohirrim_courser2,],attr_tier_5,wp_tier_bow_5,knows_common|knows_horse_archery_6|knows_riding_6|knows_power_draw_4|knows_power_strike_2|knows_ironflesh_2,rohan_face_middle_1,rohan_face_old_2],
...
["ac4_harondor_horse_archer","Harondor_Horse_Archer","Harondor_Horse_Archers",tf_harad| tfg_ranged| tf_mounted| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_harad,[itm_harad_heavy_inf_helm,itm_harad_padded_good,itm_harad_lamellar_greaves,itm_harad_leather_greaves,itm_nomad_bow,itm_harad_arrows,itm_horandor_a,itm_black_snake_sword,itm_harad_horse,],attr_evil_tier_4,wp_tier_bow_4,knows_common|knows_horse_archery_4|knows_riding_4|knows_power_draw_3|knows_power_strike_2|knows_ironflesh_1,haradrim_face_1,haradrim_face_2],
["ac5_harondor_black_snake","Black_Snake_Horse_Archer","Black_Snake_Horse_Archers",tf_harad| tfg_ranged| tf_mounted| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_harad,[itm_black_snake_helm,itm_black_snake_armor,itm_harad_leather_greaves,itm_nomad_bow,itm_harad_arrows,itm_black_snake_sword_good,itm_harad_heavy_sword,itm_harad_warhorse,],attr_evil_tier_5,wp_tier_bow_5,knows_common|knows_ironflesh_3|knows_power_strike_4|knows_power_draw_5|knows_riding_7|knows_horse_archery_7 ,haradrim_face_1,haradrim_face_2],
#FAR HARAD
...
["i1_dun_wildman","Dunnish_Wildman","Dunnish_Wildmen",tf_dunland| tf_randomize_face| tfg_armor| tfg_boots,0,0,fac_dunland,[itm_gundabad_helm_a, itm_dun_helm_b_bad,itm_dun_helm_d_bad,itm_dunland_tunic_1_bad, itm_dunland_tunic_2_bad, itm_dunland_fur_1_bad, itm_dunland_fur_2_bad,itm_dunland_wolfboots,itm_wood_club,itm_orc_slasher,itm_orc_axe,itm_dunland_spear,itm_dunnish_axe_bad,itm_orc_shield_a, itm_orc_shield_b,itm_dunland_javelin,],attr_evil_tier_1,wp_tier_1,knows_common|knows_ironflesh_2|knows_power_strike_1|knows_power_throw_1|knows_shield_1|knows_athletics_3|knows_looting_1|knows_tracking_1|knows_pathfinding_2|knows_spotting_1|knows_wound_treatment_1|knows_persuasion_1,dunland_face1,dunland_face2],
["i2_dun_warrior","Dunnish_Warrior","Dunnish_Warriors",tf_dunland| tf_randomize_face| tfg_armor| tfg_boots| tfg_polearm,0,0,fac_dunland,[itm_gundabad_helm_a, itm_gundabad_helm_b, itm_dun_helm_b,itm_dun_helm_d,itm_dunland_tunic_1, itm_dunland_tunic_2, itm_dunland_fur_1,itm_dunland_fur_2,itm_dunland_wolfboots,itm_dunnish_axe,itm_wood_club,itm_dunland_spear, itm_dunnish_war_axe_bad,itm_orc_shield_b,itm_dun_shield_b,itm_dunland_javelin,itm_dunland_javelin,],attr_evil_tier_2,wp_tier_2,knows_common|knows_ironflesh_2|knows_power_strike_1|knows_power_throw_2|knows_shield_2|knows_athletics_4|knows_looting_1|knows_tracking_1|knows_pathfinding_2|knows_spotting_1|knows_wound_treatment_1|knows_persuasion_1,dunland_face1,dunland_face2],
["i3_dun_pikeman","Dunnish_Pikeman","Dunnish_Pikemen",tf_dunland| tf_randomize_face| tfg_armor| tfg_boots,0,0,fac_dunland,[itm_gundabad_helm_b, itm_dun_helm_b, itm_dun_helm_c_bad,itm_dun_helm_d,itm_dunland_tunic_1_good, itm_dunland_tunic_2_good, itm_dunland_fur_1_good, itm_dunland_fur_2_good,itm_leather_gloves,itm_dunland_wolfboots,itm_dunnish_pike,itm_orc_shield_b,itm_orc_shield_c,itm_dun_shield_b,],attr_evil_tier_3,wp_tier_3,knows_common|knows_athletics_5|knows_shield_2|knows_power_strike_2|knows_ironflesh_4,dunland_face1,dunland_face2],
["i4_dun_vet_pikeman","Dunnish_Veteran_Pikeman","Dunnish_Veteran_Pikemen",tf_dunland| tf_randomize_face| tfg_armor| tfg_helm| tfg_boots,0,0,fac_dunland,[itm_dun_helm_b_good, itm_dun_helm_c_good,itm_dun_helm_d_good,itm_dunland_mail_1, itm_dunland_mail_2,itm_leather_gloves,itm_fur_gloves_reward,itm_dunland_wolfboots,itm_leather_boots_dark_bad,itm_dunnish_pike,itm_dun_shield_b,],attr_evil_tier_4,wp_tier_4,knows_common|knows_athletics_6|knows_shield_3|knows_power_strike_3|knows_ironflesh_6,dunland_face1,dunland_face2],
["ac4_dun_crebain_rider","Dunnish_Crebain_Rider","Dunnish_Crebain_Riders",tf_dunland| tf_randomize_face| tf_mounted| tfg_armor| tfg_horse| tfg_boots| tfg_ranged,0,0,fac_dunland,[itm_dun_helm_c,itm_dunland_fur_1_good, itm_dunland_fur_2_good,itm_dunland_wolfboots,itm_dunland_javelin_big,itm_dunland_javelin_big,itm_twohand_wood_club,itm_dunland_spear,itm_dunnish_long_axe_bad,itm_orc_shield_b, itm_dun_shield_a,itm_saddle_horse],attr_evil_tier_4,wp_tier_3,knows_common|knows_ironflesh_1|knows_power_throw_3|knows_athletics_2|knows_riding_4|knows_horse_archery_3,dunland_face1,dunland_face2],
["i3_dun_vet_warrior","Dunnish_Veteran_Warrior","Dunnish_Veteran_Warriors",tf_dunland| tf_randomize_face| tfg_shield| tfg_armor| tfg_boots| tfg_ranged,0,0,fac_dunland,[itm_gundabad_helm_b, itm_dun_helm_b, itm_dun_helm_c_bad,itm_dun_helm_d,itm_dunland_tunic_1_good, itm_dunland_tunic_2_good, itm_dunland_fur_1_good, itm_dunland_fur_2_good,itm_leather_gloves,itm_dunland_wolfboots,itm_leather_boots_dark_bad,itm_dunnish_axe_heavy,itm_dunnish_war_axe,itm_dunland_javelin,itm_dunland_javelin,itm_dunland_javelin,itm_dunnish_long_axe_bad,itm_dun_shield_a,itm_dun_shield_b,],attr_evil_tier_3,wp_tier_3,knows_common|knows_athletics_4|knows_shield_2|knows_power_strike_2|knows_ironflesh_1|knows_power_throw_3,dunland_face1,dunland_face2],
["i4_dun_wolf_warrior","Dunnish_Wolf_Warrior","Dunnish_Wolf_Warriors",tf_dunland| tf_randomize_face| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tfg_ranged,0,0,fac_dunland,[itm_dun_helm_a_bad,itm_dunland_mail_1_bad, itm_dunland_mail_2_bad,itm_leather_gloves,itm_dunland_wolfboots,itm_leather_boots_dark,itm_dunnish_axe_heavy,itm_dunnish_war_axe,itm_dun_shortsword,itm_dunland_javelin,itm_dunland_javelin,itm_dunland_javelin,itm_dunnish_long_axe,itm_dun_shield_a,],attr_evil_tier_4,wp_tier_4,knows_common|knows_athletics_5|knows_shield_3|knows_power_strike_3|knows_ironflesh_4|knows_power_throw_4,dunland_face1,dunland_face2],
["i5_dun_wolf_guard","Dunnish_Wolf_Guard","Dunnish_Wolf_Guards",tf_dunland| tf_randomize_face| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_dunland,[itm_dun_helm_a_good,itm_dunland_mail_1_good, itm_dunland_mail_2_good,itm_leather_gloves,itm_fur_gloves_reward,itm_dunland_wolfboots,itm_leather_boots_dark,itm_dunnish_war_axe_heavy,itm_dun_berserker,itm_dunnish_long_axe_heavy,itm_dun_shield_a,],attr_evil_tier_5,wp_tier_5,knows_common|knows_athletics_6|knows_shield_5|knows_power_strike_4|knows_ironflesh_6,dunland_face1,dunland_face2],
["ac5_dun_raven_rider","Dunnish_Night_Raven","Dunnish_Night_Ravens",tf_dunland| tf_randomize_face| tf_mounted| tfg_shield| tfg_armor| tfg_horse| tfg_helm| tfg_boots| tfg_ranged,0,0,fac_dunland,[itm_dun_helm_c, itm_dun_helm_b,itm_dunland_mail_1, itm_dunland_mail_2,itm_fur_gloves_reward,itm_splinted_greaves,itm_leather_boots_dark,itm_dun_berserker_bad,itm_dunland_javelin_big,itm_dunland_javelin_big,itm_dunnish_antler_axe,itm_dunnish_long_axe,itm_dunland_spear,itm_dun_shield_a,itm_hunter,itm_marker_night_troop,],attr_evil_tier_5,wp_tier_5,knows_common|knows_ironflesh_3|knows_riding_5|knows_shield_2|knows_power_strike_3|knows_power_throw_6|knows_horse_archery_6,dunland_face1,dunland_face2],



["dunland_items","{!}BUG","{!}",tf_hero,0,0,fac_dunland,
...
["i5_khand_war_master","Variag_War_Master","Variag_War_Masters",tf_evil_man| tfg_armor| tfg_helm| tfg_boots,0,0,fac_khand,[itm_khand_inf_helm_c1_good, itm_khand_inf_helm_c2_good,itm_khand_foot_lam_good,itm_khand_mail_good,itm_mail_mittens,itm_splinted_greaves,itm_khand_axe_great,itm_khand_2h_tulwar,itm_khand_throwing_axe,],attr_evil_tier_5,wp_tier_5,knows_common|knows_athletics_2|knows_power_throw_5|knows_power_strike_5|knows_ironflesh_4,khand_man1,khand_man2],
...
["i5_khand_pit_master","Variag_Master_of_the_Pits","Variag_Masters_of_the_Pits",tf_evil_man| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_khand,[itm_khand_helm_mask_good,itm_khand_light,itm_khand_light_good,itm_leather_boots_dark_bad,itm_javelin,itm_khand_tulwar,itm_khand_pitsword,itm_khand_trident,itm_easterling_hawk_shield,itm_marker_berserker],attr_evil_tier_5,wp_tier_5,knows_common|knows_athletics_6|knows_shield_4|knows_power_throw_4|knows_power_strike_5|knows_ironflesh_6,khand_man1,khand_man2],
...
["khand_items","{!}BUG","{!}",tf_hero,0,0,fac_khand,
   [itm_leather_boots,itm_leather_gloves,itm_sumpter_horse,itm_saddle_horse,itm_metal_scraps_bad,itm_metal_scraps_medium,itm_metal_scraps_good,],
      0,0,0,0],
#UMBAR #CORSAIRS
["i1_corsair_youth","Umbar_Sailor","Umbar_Sailors",tfg_armor,0,0,fac_umbar,[itm_hood_black,itm_umb_armor_a_bad, itm_umb_armor_a, itm_umb_armor_a_cloak,itm_umb_armor_b_bad,itm_corsair_boots,itm_leather_boots_dark_bad,itm_shortened_spear,itm_corsair_sword,],attr_evil_tier_1,wp_tier_1,knows_common|knows_power_throw_1|knows_power_draw_1|knows_weapon_master_1|knows_athletics_2|knows_looting_2|knows_tactics_2|knows_spotting_1|knows_inventory_management_1|knows_prisoner_management_1|knows_trade_1,bandit_face1,bandit_face2],
["i2_corsair_warrior","Umbar_Warrior","Umbar_Warriors",tfg_armor,0,0,fac_umbar,[itm_hood_black,itm_umb_helm_d,itm_umb_armor_a_good, itm_umb_armor_a_cloak,itm_umb_armor_b,itm_umb_armor_b_cloak,itm_corsair_boots,itm_leather_boots_dark_bad,itm_shortened_spear,itm_corsair_sword,itm_umbar_rapier,itm_umb_shield_b_bad,],attr_evil_tier_2,wp_tier_2,knows_common|knows_power_strike_1|knows_power_throw_1|knows_power_draw_1|knows_weapon_master_1|knows_shield_1|knows_athletics_3|knows_looting_2|knows_tactics_2|knows_spotting_1|knows_inventory_management_1|knows_prisoner_management_1|knows_trade_1,bandit_face1,bandit_face2],
["i3_corsair_spearman","Spearman_of_Umbar","Spearmen_of_Umbar",tfg_armor| tfg_helm| tfg_boots,0,0,fac_umbar,[itm_umb_helm_d,itm_umb_helm_c,itm_umb_armor_b_good, itm_umb_armor_c, itm_umb_armor_c_bad,itm_corsair_boots,itm_leather_boots_dark_bad,itm_shortened_spear,itm_umb_shield_a,],attr_evil_tier_3,wp_tier_3,knows_common|knows_athletics_2|knows_shield_2|knows_power_strike_2,bandit_face1,bandit_face2],
["i4_corsair_raider","Corsair_Raider","Corsair_Raiders",tfg_armor| tfg_boots,0,0,fac_umbar,[itm_hood_black,itm_umb_armor_a_good,itm_umb_armor_a_lordly,itm_umb_armor_b_good, itm_umb_armor_b_cloak,itm_corsair_boots,itm_umbar_rapier,itm_corsair_harpoon,itm_corsair_harpoon,itm_umb_shield_b_bad, itm_umb_shield_b,],attr_evil_tier_4,wp_tier_4,knows_common|knows_athletics_6|knows_shield_2|knows_power_throw_3|knows_power_strike_3,bandit_face1,bandit_face2],
["i5_corsair_night_raider","Corsair_Night_Raider","Corsair_Night_Raiders",tfg_armor| tfg_helm| tfg_boots,0,0,fac_umbar,[itm_hood_black_good,itm_umb_armor_d, itm_umb_armor_d_cloak,itm_umb_armor_c_lordly,itm_leather_gloves,itm_corsair_boots,itm_umbar_rapier,itm_corsair_harpoon,itm_corsair_harpoon,itm_umb_shield_b,itm_marker_night_troop,],attr_evil_tier_5,wp_tier_5,knows_common|knows_athletics_8|knows_shield_4|knows_power_strike_4|knows_ironflesh_3|knows_power_throw_5,bandit_face1,bandit_face2],
["a2_corsair_marine","Umbar_Marine","Umbar_Marines",tfg_ranged| tfg_armor,0,0,fac_umbar,[itm_hood_black,itm_umb_armor_a_bad, itm_umb_armor_a, itm_umb_armor_a_cloak,itm_umb_armor_b_bad,itm_corsair_boots,itm_short_bow, itm_regular_bow,itm_corsair_arrows,itm_corsair_throwing_dagger,itm_corsair_sword,itm_umb_shield_b_bad,],attr_evil_tier_2,wp_tier_bow_2,knows_common|knows_ironflesh_1|knows_power_throw_1|knows_power_draw_2|knows_weapon_master_1|knows_athletics_3|knows_looting_2|knows_tactics_2|knows_spotting_1|knows_inventory_management_1|knows_prisoner_management_1|knows_trade_1,bandit_face1,bandit_face2],
["a3_corsair_marksman","Marksman_of_Umbar","Marksmen_of_Umbar",tfg_ranged| tfg_armor| tfg_boots,0,0,fac_umbar,[itm_umb_helm_d,itm_umb_helm_c,itm_umb_armor_b, itm_umb_armor_b_cloak, itm_umb_armor_a_good,itm_corsair_boots,itm_regular_bow,itm_corsair_arrows,itm_corsair_sword,],attr_evil_tier_3,wp_tier_bow_3,knows_common|knows_athletics_3|knows_power_draw_2|knows_ironflesh_1,bandit_face1,bandit_face2],
["a4_corsair_veteran_marksman","Veteran_Marksman_of_Umbar","Veteran_Marksmen_of_Umbar",tfg_ranged| tfg_armor| tfg_helm| tfg_boots,0,0,fac_umbar,[itm_umb_helm_d,itm_umb_helm_c,itm_umb_armor_b_good, itm_umb_armor_c_bad,itm_umb_armor_d_bad,itm_corsair_boots,itm_corsair_bow,itm_corsair_arrows,itm_umbar_cutlass,],attr_evil_tier_4,wp_tier_bow_4,knows_common|knows_athletics_4|knows_power_draw_4|knows_ironflesh_1,bandit_face1,bandit_face2],
["a5_corsair_master_marksman","Corsair_Master_Marksman","Corsair_Master_Marksmen",tfg_ranged| tfg_armor| tfg_helm| tfg_boots,0,0,fac_umbar,[itm_umb_helm_c_good,itm_umb_armor_c, itm_umb_armor_d, itm_umb_armor_c_cloak, itm_umb_armor_d_cloak,itm_leather_gloves,itm_corsair_boots,itm_corsair_bow,itm_corsair_arrows,itm_corsair_arrows,itm_umbar_cutlass,],attr_evil_tier_5,wp_tier_bow_5,knows_common|knows_athletics_6|knows_power_draw_5|knows_ironflesh_2,bandit_face1,bandit_face2],
["i3_corsair_swordsman","Swordsman_of_Umbar","Swordsmen_of_Umbar",tfg_armor| tfg_helm| tfg_boots|tfg_shield,0,0,fac_umbar,[itm_umb_helm_d,itm_umb_helm_c,itm_umb_armor_b_good, itm_umb_armor_c, itm_umb_armor_d_bad,  itm_umb_armor_c_cloak,itm_corsair_boots,itm_leather_boots_dark,itm_umbar_cutlass,itm_umbar_rapier,itm_umb_shield_b_bad, itm_umb_shield_b,],attr_evil_tier_3,wp_tier_3,knows_common|knows_athletics_3|knows_shield_2|knows_power_strike_2,bandit_face1,bandit_face2],
["i4_corsair_veteran_swordsman","Veteran_Swordsman_of_Umbar","Veteran_Swordsmen_of_Umbar",tfg_armor| tfg_helm| tfg_boots|tfg_shield,0,0,fac_umbar,[itm_umb_helm_b,itm_umb_armor_c_good, itm_umb_armor_e_bad, itm_umb_armor_d, itm_umb_armor_d_cloak,itm_leather_gloves,itm_corsair_boots,itm_leather_boots_dark,itm_umbar_cutlass,itm_umb_shield_b,],attr_evil_tier_4,wp_tier_4,knows_common|knows_athletics_4|knows_shield_2|knows_power_throw_1|knows_power_strike_3,bandit_face1,bandit_face2],
["i5_corsair_master_swordsman","Corsair_Swordmaster","Corsair_Swordmasters",tfg_gloves| tfg_armor| tfg_helm| tfg_boots|tfg_shield,0,0,fac_umbar,[itm_umb_helm_b_good,itm_umb_armor_f_bad,itm_umb_armor_e_good, itm_umb_armor_f, itm_umb_armor_f_cloak,itm_leather_gloves,itm_corsair_boots,itm_kraken,itm_umb_shield_b_good,],attr_evil_tier_5,wp_tier_5,knows_common|knows_athletics_6|knows_shield_2|knows_power_throw_2|knows_power_strike_4|knows_ironflesh_3,bandit_face1,bandit_face2],
["i6_corsair_guard","Captain's Guard of Umbar","Captain's Guards of Umbar",tfg_gloves| tfg_armor| tfg_helm| tfg_boots|tfg_shield,0,0,fac_umbar,[itm_umb_helm_a_good,itm_umb_helm_b_good,itm_umb_armor_f_lordly,itm_umb_armor_f_good,itm_evil_gauntlets_a_lordly,itm_splinted_greaves_good,itm_kraken,itm_umb_shield_c, itm_corsair_harpoon,itm_marker_hp_shield,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_4|knows_shield_4|knows_power_strike_4|knows_power_throw_5|knows_ironflesh_5,bandit_face1,bandit_face2],["a5_corsair_master_assassin","Corsair_Assassin","Corsair_Assassins",tfg_ranged| tfg_armor| tfg_helm| tfg_boots,0,0,fac_umbar,[itm_hood_black_good,itm_umb_helm_a,itm_umb_armor_d_cloak, itm_umb_armor_d,itm_evil_gauntlets_a,itm_corsair_boots,itm_leather_boots_dark_bad,itm_corsair_bow,itm_corsair_arrows,itm_kraken,itm_umb_shield_b,itm_marker_night_troop,],attr_evil_tier_5,wp_archery(150) | wp_melee(200),knows_common|knows_athletics_8|knows_power_draw_5|knows_power_strike_4|knows_ironflesh_4,bandit_face1,bandit_face2],
["i4_corsair_veteran_spearman","Veteran_Spearman_of_Umbar","Veteran_Spearmen_of_Umbar",tfg_armor| tfg_helm| tfg_boots|tfg_shield,0,0,fac_umbar,[itm_umb_helm_b,itm_umb_armor_d_good, itm_corsair_boots,itm_umbar_spear,itm_umb_shield_a,],attr_evil_tier_4,wp_tier_4,knows_common|knows_athletics_3|knows_shield_2|knows_power_strike_2,bandit_face1,bandit_face2],
["i5_corsair_master_spearman","Spearmaster_of_Umbar","Spearmasters_of_Umbar",tfg_armor| tfg_helm| tfg_boots|tfg_shield,0,0,fac_umbar,[itm_umb_helm_a,itm_umb_armor_e_good, itm_umb_armor_f, itm_splinted_greaves,itm_umbar_spear,itm_umb_shield_a_good,],attr_evil_tier_5,wp_tier_5,knows_common|knows_athletics_4|knows_shield_2|knows_power_throw_1|knows_power_strike_3,bandit_face1,bandit_face2],
["i5_corsair_master_pikeman","Pikemaster_of_Umbar","Pikemasters_of_Umbar",tfg_gloves| tfg_armor| tfg_helm| tfg_boots,0,0,fac_umbar,[itm_umb_helm_b_good,itm_umb_armor_f_good, itm_evil_gauntlets_a_lordly,itm_splinted_greaves,itm_umbar_pike,],attr_evil_tier_5,wp_tier_5,knows_common|knows_athletics_4|knows_shield_2|knows_power_throw_2|knows_power_strike_6|knows_ironflesh_3,bandit_face1,bandit_face2],

["umbar_items","{!}BUG","{!}",tf_hero,0,0,fac_umbar,
...
["i4_isen_fell_orc_despoiler","Fell_Orc_Despoiler","Fell_Orc_Despoilers",tf_orc| tfg_armor| tfg_helm| tfg_boots| tfg_gloves| tf_no_capture_alive,0,0,fac_isengard,[itm_isen_orc_helm_a_good,itm_isen_orc_mail_a, itm_isen_orc_mail_b_bad,itm_orc_mittens,itm_orc_greaves,itm_isengard_mallet,itm_orc_sledgehammer,itm_isengard_hammer,itm_twohand_wood_club,],attr_orc_tier_4,wp_orc_tier_4,knows_common|knows_athletics_4|knows_power_strike_5,orc_face3,orc_face6],
...
# new ghost warg range at the end of the list
["free_warg_ghost_1b","{!}Warg","{!}Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive ,0,0,fac_isengard,
...
["free_warg_ghost_1c","{!}Warg","{!}Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
...
["free_warg_ghost_1d","{!}Warg","{!}Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
...
["free_warg_ghost_a1b","{!}Warg","{!}Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_wargarmored_1b],
      str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_2,orc_face1,orc_face2],
["free_warg_ghost_a1c","{!}Armored Warg","{!}Armored Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_wargarmored_1c],
     str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_2,orc_face1,orc_face2],
["free_warg_ghost_a2b","{!}Armored Warg","{!}Armored Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_wargarmored_2b],
      str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_2,orc_face1,orc_face2],
["free_warg_ghost_a2c","{!}Armored Warg","{!}Armored Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_wargarmored_2c],
      str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_2,orc_face1,orc_face2],
["free_warg_ghost_a3a","{!}Armored Warg","{!}Armored Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_wargarmored_3a],
      str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_2,orc_face1,orc_face2],
["free_warg_ghost_h","{!}Huge Warg","{!}Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
...
["i6_isen_uruk_berserker","Fighting_Uruk_Hai_Berserker","Fighting_Uruk_Hai_Berserkers",tf_urukhai| tf_mounted| tfg_armor| tfg_helm| tf_no_capture_alive,0,0,fac_isengard,[itm_isen_tracker_helm_good,itm_isen_uruk_light_c_bad, itm_isen_uruk_light_c,itm_evil_gauntlets_b,itm_orc_mittens_good,itm_uruk_chain_greaves,itm_uruk_ragwrap,itm_isengard_heavy_axe,itm_isengard_mallet,itm_isengard_heavy_sword,itm_marker_berserker,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_7|knows_power_strike_6|knows_ironflesh_10,uruk_hai_face1,uruk_hai_face2],
...
["i3_isen_large_uruk","Large_Uruk_Hai_of_Isengard","Large_Uruk_Hai_of_Isengard",tf_urukhai| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_isengard,[itm_isen_uruk_helm_a_bad,itm_isen_uruk_light_b_good, itm_isen_uruk_med_a, itm_isen_uruk_med_b,itm_evil_gauntlets_a,itm_orc_mittens,itm_uruk_ragwrap,itm_uruk_greaves,itm_isengard_axe,itm_isengard_sword,itm_isen_orc_shield_a,itm_isen_orc_shield_b,],attr_evil_tier_3,wp_tier_3,knows_common|knows_athletics_2|knows_power_strike_3|knows_ironflesh_4|knows_shield_1,uruk_hai_face1,uruk_hai_face2],
["i4_isen_fighting_uruk_warrior","Fighting_Uruk_Hai_Warrior","Fighting_Uruk_Hai_Warriors",tf_urukhai|tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_isengard,[itm_isen_uruk_helm_a,itm_isen_uruk_med_b_good, itm_isen_uruk_heavy_a_bad, itm_isen_uruk_heavy_b,itm_evil_gauntlets_b, itm_orc_mittens,itm_uruk_greaves,itm_isengard_sword,itm_isen_uruk_shield_b,],attr_evil_tier_4,wp_tier_4,knows_common|knows_athletics_2|knows_power_strike_5|knows_ironflesh_5|knows_shield_2,uruk_hai_face1,uruk_hai_face2],
["i5_isen_fighting_uruk_champion","Fighting_Uruk_Hai_Champion","Fighting_Uruk_Hai_Champions",tf_urukhai|tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_isengard,[itm_isen_uruk_helm_a_good,itm_isen_uruk_heavy_b_good, itm_isen_uruk_heavy_c,itm_evil_gauntlets_b, itm_orc_mittens_good,itm_uruk_chain_greaves,itm_isengard_sword,itm_isen_uruk_shield_b,],attr_evil_tier_5,wp_tier_5,knows_common|knows_athletics_3|knows_power_strike_6|knows_ironflesh_6|knows_shield_3,uruk_hai_face1,uruk_hai_face2],
["i3_isen_uruk_pikeman","Uruk_Hai_Pikeman","Uruk_Hai_Pikemen",tf_urukhai| tf_mounted|tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_isengard,[itm_isen_uruk_helm_a,itm_isen_uruk_med_a_good, itm_isen_uruk_heavy_a_bad, itm_isen_uruk_heavy_b_bad,itm_evil_gauntlets_a, itm_orc_mittens,itm_uruk_chain_greaves,itm_isengard_pike,],attr_evil_tier_3,wp_tier_3,knows_common|knows_athletics_2|knows_power_strike_3|knows_ironflesh_4,uruk_hai_face1,uruk_hai_face2],
["i4_isen_fighting_uruk_pikeman","Fighting_Uruk_Hai_Pikeman","Fighting_Uruk_Hai_Pikemen",tf_urukhai|tf_mounted| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_isengard,[itm_isen_uruk_helm_a_good,itm_isen_uruk_heavy_c_good, itm_isen_uruk_heavy_b_good,itm_evil_gauntlets_b, itm_orc_mittens_good,itm_uruk_chain_greaves,itm_isengard_pike,itm_isengard_halberd,],attr_evil_tier_4,wp_tier_4,knows_common|knows_athletics_2|knows_power_strike_5|knows_ironflesh_5,uruk_hai_face1,uruk_hai_face2],
["i5_isen_uruk_standard_bearer","Uruk_Hai_Standard_Bearer","Uruk_Hai_Standard_Bearers",tf_urukhai|tf_mounted| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_isengard,[itm_isen_uruk_helm_a_good,itm_isen_uruk_heavy_c_good,itm_evil_gauntlets_b,itm_orc_mittens_good,itm_uruk_chain_greaves,itm_isengard_banner,],attr_evil_tier_5,wp_tier_5,knows_common|knows_athletics_2|knows_power_strike_5|knows_ironflesh_10,uruk_hai_face1,uruk_hai_face2],
...
["armoured_troll","Armored_Troll","Armored_Trolls",tf_orc| tfg_helm| tfg_boots| tfg_armor| tfg_gloves| tf_no_capture_alive,0,0,fac_isengard,
...
["olog_hai","Olog_Hai_of_Mordor","Olog_Hai_of_Mordor",tf_orc|tfg_shield| tfg_helm| tfg_boots| tfg_armor| tfg_gloves| tf_no_capture_alive,0,0,fac_mordor,
...
["ent_old","Ent","Ents",tf_orc| tfg_helm| tfg_boots| tfg_armor| tfg_gloves| tf_no_capture_alive,0,0,fac_commoners,
...
# Dol Guldur Orcs
["i1_guldur_orc_snaga","Orc_Snaga_of_Dol_Guldur","Orc_Snagas_of_Dol_Guldur",tf_orc| tf_no_capture_alive,0,0,fac_guldur,[itm_orc_skullcap_bad, itm_orc_skullcap,itm_m_orc_light_a,itm_m_orc_light_b,itm_m_orc_light_c,itm_wood_club,itm_orc_slasher,itm_orc_simple_spear,itm_orc_axe,itm_metal_scraps_bad,itm_metal_scraps_medium,itm_metal_scraps_good,],attr_orc_tier_1,wp_orc_tier_1,knows_common|knows_ironflesh_1|knows_power_draw_1|knows_athletics_3|knows_looting_1|knows_tracking_1|knows_tactics_1|knows_pathfinding_2|knows_spotting_1|knows_surgery_1|knows_persuasion_1,orc_face5,orc_face4],
["a2_guldur_orc_tracker","Orc_Tracker_of_Dol_Guldur","Orc_Trackers_of_Dol_Guldur",tf_orc| tfg_ranged| tfg_armor| tf_no_capture_alive,0,0,fac_guldur,[itm_orc_skullcap, itm_orc_skullcap_good, itm_orc_nosehelm_bad, itm_orc_nosehelm,itm_m_orc_light_a,itm_m_orc_light_b,itm_m_orc_light_c,itm_orc_ragwrap,itm_orc_bow,itm_orc_hook_arrow,itm_wood_club,itm_orc_simple_spear,itm_orc_axe,],attr_orc_tier_2,wp_orc_tier_2,knows_common|knows_ironflesh_1|knows_power_strike_2|knows_power_draw_1|knows_athletics_4|knows_looting_1|knows_tracking_1|knows_tactics_1|knows_pathfinding_2|knows_spotting_1|knows_surgery_1|knows_persuasion_1,orc_face3,orc_face8],

#MORDOR Orcs
["i1_mordor_orc_snaga","Orc_Snaga_of_Mordor","Orc_Snagas_of_Mordor",tf_orc| tf_no_capture_alive,0,0,fac_mordor,[itm_orc_coif_bad, itm_orc_coif, itm_orc_nosehelm_bad,itm_orc_skullcap_bad,itm_m_orc_light_a,itm_m_orc_light_b,itm_m_orc_light_c,itm_orc_ragwrap,itm_wood_club,itm_orc_slasher,itm_orc_axe,itm_metal_scraps_bad,itm_metal_scraps_medium,itm_metal_scraps_good,],attr_orc_tier_1,wp_orc_tier_1,knows_common|knows_power_strike_1|knows_power_throw_1|knows_shield_1|knows_athletics_1|knows_looting_1|knows_trainer_1|knows_tactics_1|knows_inventory_management_1|knows_wound_treatment_1|knows_prisoner_management_2|knows_leadership_1|knows_trade_1,orc_face1,orc_face2],
["i2_mordor_orc","Orc_of_Mordor","Orcs_of_Mordor",tf_orc| tfg_armor| tf_no_capture_alive,0,0,fac_mordor,[itm_orc_coif_bad, itm_orc_coif, itm_orc_nosehelm, itm_orc_nosehelm_bad, itm_orc_visorhelm_bad,itm_orc_skullcap,itm_orc_barbuta_bad,itm_m_orc_light_b,itm_m_orc_light_c,itm_m_orc_light_d,itm_m_orc_light_e,itm_orc_ragwrap,itm_wood_club,itm_orc_falchion_bad,itm_orc_slasher_heavy,itm_orc_slasher,itm_orc_axe,itm_mordor_orc_shield_b,itm_mordor_orc_shield_c,itm_mordor_orc_shield_a,],attr_orc_tier_2,wp_orc_tier_2,knows_common|knows_power_strike_2|knows_power_throw_1|knows_weapon_master_1|knows_shield_1|knows_athletics_1|knows_looting_1|knows_trainer_1|knows_tactics_1|knows_inventory_management_1|knows_wound_treatment_1|knows_prisoner_management_2|knows_leadership_1|knows_trade_1,orc_face7,orc_face8],
["i3_mordor_large_orc","Large_Orc_of_Mordor","Large_Orcs_of_Mordor",tf_orc| tfg_shield| tfg_armor| tfg_boots| tf_no_capture_alive,0,0,fac_mordor,[itm_orc_nosehelm_good,itm_orc_kettlehelm_bad, itm_orc_kettlehelm, itm_orc_morion_bad, itm_orc_morion, itm_orc_visorhelm,itm_orc_coif,itm_orc_barbuta,itm_m_orc_light_d,itm_m_orc_light_e,itm_m_orc_heavy_a,itm_m_orc_heavy_b,itm_orc_mittens,itm_orc_greaves,itm_orc_falchion,itm_orc_slasher_heavy,itm_orc_axe_heavy,itm_orc_sabre_b,itm_mordor_orc_shield_b,itm_mordor_orc_shield_c,],attr_orc_tier_3,wp_orc_tier_3,knows_common|knows_athletics_2|knows_power_strike_3|knows_power_throw_3,orc_face3,orc_face6],
["i4_mordor_fell_orc","Fell_Orc_of_Mordor","Fell_Orcs_of_Mordor",tf_orc| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_mordor,[itm_orc_visorhelm_good, itm_orc_buckethelm_bad, itm_orc_buckethelm, itm_orc_kettlehelm_good,itm_orc_barbuta_good,itm_m_orc_heavy_b,itm_m_orc_heavy_c,itm_m_orc_heavy_d,itm_m_orc_heavy_e,itm_evil_gauntlets_a, itm_orc_mittens,itm_orc_greaves,itm_orc_falchion_heavy,itm_orc_two_handed_axe,itm_orc_axe_heavy,itm_uruk_falchion_a,itm_orc_sabre_b_heavy,itm_orc_cleaver_a,itm_mordor_orc_shield_b,itm_mordor_orc_shield_c,itm_mordor_orc_shield_e,],attr_orc_tier_4,wp_orc_tier_4,knows_common|knows_athletics_2|knows_power_strike_4|knows_power_throw_4,orc_face7,orc_face4],
["c3_mordor_warg_rider","Warg_Rider_of_Gorgoroth","Warg_Riders_of_Gorgoroth",tf_orc| tf_mounted| tfg_ranged| tfg_armor| tfg_horse| tf_no_capture_alive,0,0,fac_mordor,[itm_orc_coif_bad, itm_orc_coif, itm_orc_nosehelm_bad, itm_orc_nosehelm,itm_orc_visorhelm_bad,itm_m_orc_light_a,itm_m_orc_light_b,itm_m_orc_light_c,itm_orc_mittens_bad,itm_orc_throwing_arrow,itm_orc_throwing_arrow,itm_orc_scimitar_b, itm_orc_sabre_b_heavy, itm_uruk_falchion_a,itm_orc_club_b,itm_warg_1d,itm_warg_1b,itm_warg_1c,],attr_orc_tier_3,wp_orc_tier_3,knows_common|knows_horse_archery_2|knows_riding_4|knows_power_throw_3|knows_power_strike_4,orc_face5,orc_face8],
["c4_mordor_great_warg_rider","Great_Warg_Rider_of_Udun","Great_Warg_Riders_of_Udun",tf_orc| tf_mounted| tfg_ranged| tfg_armor| tfg_horse| tf_no_capture_alive,0,0,fac_mordor,[itm_orc_visorhelm, itm_orc_nosehelm,itm_orc_coif,itm_m_orc_light_b,itm_m_orc_light_c,itm_m_orc_light_d,itm_m_orc_light_e,itm_evil_gauntlets_a, itm_orc_mittens,itm_orc_ragwrap,itm_orc_throwing_arrow,itm_orc_throwing_arrow,itm_orc_scimitar_b_heavy,itm_orc_sabre_b_heavy,itm_orc_cleaver_a,itm_orc_club_b_heavy,itm_wargarmored_1b, itm_wargarmored_1c,],attr_orc_tier_4,wp_orc_tier_4,knows_common|knows_riding_5|knows_horse_archery_3|knows_power_throw_4|knows_power_strike_4,orc_face7,orc_face8],
["i2_mordor_morgul_orc","Orc_of_Minas_Morgul","Orcs_of_Minas_Morgul",tf_orc| tfg_armor| tfg_boots|tfg_polearm| tf_no_capture_alive,0,0,fac_mordor,[itm_orc_kettlehelm_bad,itm_orc_morion_bad,itm_orc_visorhelm_bad,itm_orc_coif,itm_m_orc_light_b,itm_m_orc_light_c,itm_m_orc_light_d,itm_m_orc_light_e,itm_orc_ragwrap,itm_orc_simple_spear,itm_orc_bill_bad,itm_orc_mangler_bad,itm_wood_club,itm_orc_slasher,itm_orc_slasher,itm_mordor_orc_shield_c,itm_mordor_orc_shield_d,],attr_orc_tier_2,wp_orc_tier_2,knows_common|knows_athletics_2|knows_power_strike_3,orc_face5,orc_face4],
["i4_mordor_fell_morgul_orc","Fell_Orc_of_Minas_Morgul","Fell_Orcs_of_Minas_Morgul",tf_orc| tfg_armor| tfg_helm| tfg_boots|tfg_polearm| tf_no_capture_alive,0,0,fac_mordor,[itm_orc_kettlehelm_good, itm_orc_morion_good, itm_orc_buckethelm_good,itm_orc_coif_good,itm_m_orc_heavy_b,itm_m_orc_heavy_c,itm_m_orc_heavy_d,itm_m_orc_heavy_e,itm_orc_ragwrap,itm_orc_bill_heavy, itm_orc_simple_spear_heavy,itm_orc_mangler,itm_orc_slasher,itm_orc_slasher,itm_mordor_uruk_shield_c,],attr_orc_tier_4,wp_orc_tier_4,knows_common|knows_athletics_2|knows_shield_1|knows_power_strike_4,orc_face5,orc_face4],

#Changed these two below to Guldur
["a3_guldur_large_orc_tracker","Large_Orc_Tracker_of_Dol_Guldur","Large_Orc_Trackers_of_Dol_Guldur",tf_orc| tfg_ranged| tfg_armor| tfg_boots| tf_no_capture_alive,0,0,fac_guldur,[itm_orc_skullcap_bad, itm_orc_nosehelm_bad,itm_m_orc_light_b,itm_m_orc_light_c,itm_orc_ragwrap,itm_orc_bow,itm_orc_hook_arrow,itm_orc_mace_bad,],attr_orc_tier_3,wp_orc_tier_3,knows_common|knows_riding_1|knows_athletics_5|knows_power_draw_3|knows_power_strike_2,orc_face9,orc_face4],
["a4_guldur_fell_orc_tracker","Fell_Orc_Tracker_of_Dol_Guldur","Fell_Orc_Trackers_of_Dol_Guldur",tf_orc| tfg_ranged| tfg_helm| tfg_armor| tfg_boots| tf_no_capture_alive,0,0,fac_guldur,[itm_orc_skullcap_good, itm_orc_nosehelm_bad, itm_orc_nosehelm,itm_m_orc_light_c,itm_m_orc_light_d,itm_m_orc_light_e,itm_m_orc_light_c,itm_evil_gauntlets_a,itm_orc_furboots,itm_uruk_bow,itm_black_arrows_reward,itm_orc_mace,],str_12| agi_11| int_7| cha_7|level(20),wp_orc_tier_5,knows_common|knows_riding_1|knows_athletics_7|knows_power_draw_4|knows_power_strike_3|knows_ironflesh_2,orc_face1,orc_face4],

["a2_mordor_orc_archer","Orc_Archer_of_Mordor","Orc_Archers_of_Mordor",tf_orc| tfg_ranged| tfg_armor| tf_no_capture_alive,0,0,fac_mordor,[itm_orc_coif_bad, itm_orc_nosehelm_bad,itm_orc_skullcap_bad,itm_m_orc_light_b,itm_m_orc_light_c,itm_m_orc_light_d,itm_m_orc_light_e,itm_orc_bow,itm_orc_hook_arrow,itm_wood_club,itm_orc_slasher,itm_orc_axe,],attr_orc_tier_2,wp_orc_tier_bow_2,knows_common|knows_power_throw_1|knows_power_draw_2|knows_weapon_master_1|knows_shield_1|knows_athletics_1|knows_looting_1|knows_trainer_1|knows_tactics_1|knows_inventory_management_1|knows_wound_treatment_1|knows_prisoner_management_2|knows_leadership_1|knows_trade_1,orc_face7,orc_face6],
["a3_mordor_large_orc_archer","Large_Orc_Archer_of_Mordor","Large_Orc_Archers_of_Mordor",tf_orc| tfg_ranged| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_mordor,[itm_orc_kettlehelm_bad, itm_orc_coif, itm_orc_nosehelm,itm_orc_skullcap,itm_m_orc_light_b,itm_m_orc_light_c,itm_m_orc_light_d,itm_m_orc_light_e,itm_orc_ragwrap,itm_orc_bow,itm_orc_hook_arrow,itm_orc_slasher_heavy,itm_orc_falchion_bad,itm_orc_axe,],attr_orc_tier_3,wp_orc_tier_bow_3,knows_common|knows_athletics_2|knows_power_draw_3|knows_power_strike_2,orc_face9,orc_face4],
...
["a4_moria_fell_goblin_archer","Fell_Goblin_Archer_of_Moria","Fell_Goblin_Archers_of_Moria",tf_orc| tfg_ranged| tfg_armor| tfg_boots| tfg_helm| tf_no_capture_alive,0,0,fac_moria,[itm_orc_bughelm_good, itm_orc_beakhelm_good,itm_moria_armor_d,itm_moria_armor_c,itm_moria_armor_d, itm_evil_gauntlets_a,itm_orc_ragwrap,itm_uruk_bow,itm_orc_hook_arrow,itm_orc_falchion_heavy,itm_orc_pick,itm_moria_orc_shield_b,itm_moria_orc_shield_c,],attr_orc_tier_4,wp_orc_tier_bow_4,knows_common|knows_ironflesh_4|knows_athletics_7|knows_power_draw_4|knows_power_strike_3,orc_face5,orc_face6],
...
["i1_gunda_goblin","Gundabad_Goblin","Gundabad_Goblins",tf_orc| tf_no_capture_alive,0,0,fac_gundabad,[itm_gundabad_helm_a,itm_orc_skullcap_bad,itm_gundabad_armor_a,itm_orc_tribal_a,itm_wood_club,itm_orc_slasher,itm_orc_sabre_b,itm_orc_simple_spear,itm_orc_simple_spear,itm_bone_cudgel,],attr_orc_tier_1,wp_orc_tier_1,knows_common|knows_power_strike_1|knows_power_throw_1|knows_athletics_4|knows_riding_1|knows_horse_archery_1|knows_looting_2|knows_tracking_1|knows_pathfinding_1|knows_spotting_1|knows_persuasion_1,orc_face1,orc_face2],
["i2_gunda_orc","Gundabad_Orc","Gundabad_Orcs",tf_orc| tfg_armor| tf_no_capture_alive,0,0,fac_gundabad,[itm_gundabad_helm_a,itm_gundabad_helm_b,itm_orc_skullcap,itm_gundabad_armor_b,itm_gundabad_armor_c,itm_orc_ragwrap,itm_orc_slasher,itm_wood_club,itm_orc_simple_spear,itm_orc_skull_spear,itm_orc_axe,itm_orc_sabre_b,itm_orc_scimitar_b,itm_orc_scimitar_bad,itm_orc_sabre_bad,itm_orc_shield_a,itm_orc_shield_b,],attr_orc_tier_2,wp_orc_tier_2,knows_common|knows_power_strike_2|knows_power_throw_2|knows_power_draw_1|knows_athletics_5|knows_riding_1|knows_horse_archery_1|knows_looting_2|knows_tracking_1|knows_pathfinding_1|knows_spotting_1|knows_persuasion_1,orc_face7,orc_face6],
["i3_gunda_orc_fighter","Gundabad_Orc_Fighter","Gundabad_Orc_Fighters",tf_orc| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_gundabad,[itm_gundabad_helm_c,itm_gundabad_helm_b, itm_orc_coif_bad,itm_gundabad_armor_d,itm_gundabad_armor_c, itm_evil_gauntlets_a,itm_orc_furboots,itm_orc_scimitar,itm_orc_sabre,itm_orc_skull_spear,itm_orc_scimitar_b_heavy,itm_orc_throwing_arrow,itm_orc_throwing_axes,itm_orc_throwing_axes,itm_orc_shield_b,itm_orc_shield_a,],attr_orc_tier_3,wp_orc_tier_3,knows_common|knows_athletics_7|knows_power_draw_2|knows_power_throw_2|knows_power_strike_3,orc_face5,orc_face6],
["i4_gunda_orc_warrior","Gundabad_Orc_Warrior","Gundabad_Orc_Warriors",tf_orc| tfg_shield| tfg_armor| tfg_helm|tfg_boots| tf_no_capture_alive,0,0,fac_gundabad,[itm_gundabad_helm_c,itm_gundabad_helm_b, itm_orc_coif,itm_gundabad_armor_d,itm_gundabad_armor_c, itm_evil_gauntlets_a,itm_orc_furboots,itm_orc_scimitar_heavy,itm_orc_sabre_heavy,itm_orc_skull_spear_heavy,itm_orc_javelin,itm_orc_throwing_arrow,itm_orc_throwing_axes,itm_orc_shield_b,itm_orc_shield_a,],attr_orc_tier_4,wp_orc_tier_4,knows_common|knows_athletics_8|knows_power_throw_3|knows_power_strike_4|knows_ironflesh_2|knows_shield_2,orc_face3,orc_face8],
["i5_gunda_orc_berserker","Gundabad_Orc_Berserker","Gundabad_Orc_Berserkers",tf_orc| tfg_armor|tfg_boots| tf_no_capture_alive,0,0,fac_gundabad,[itm_orc_skullhelm,itm_orc_skullhelm_bad,itm_gundabad_armor_d,itm_gundabad_armor_e, itm_evil_gauntlets_a,itm_orc_furboots,itm_orc_two_handed_axe,itm_orc_battle_axe,itm_orc_bastard_scimitar_bad,itm_orc_bastard_scimitar_heavy, itm_orc_skull_spear_heavy, itm_orc_club_b,itm_twohand_wood_club,itm_orc_sledgehammer,itm_marker_berserker,],attr_orc_tier_5,wp_orc_tier_5,knows_common|knows_athletics_10|knows_power_throw_6|knows_power_strike_7|knows_ironflesh_7,orc_face3,orc_face8],
["ca4_gunda_skirmisher","Gundabad_Skirmisher","Gundabad_Skirmishers",tf_orc| tf_mounted| tfg_ranged| tfg_armor| tfg_boots| tfg_horse| tf_no_capture_alive,0,0,fac_gundabad,[itm_gundabad_helm_a,itm_gundabad_helm_b,itm_gundabad_armor_b,itm_gundabad_armor_c,itm_orc_furboots,itm_orc_ragwrap,itm_uruk_bow,itm_orc_hook_arrow,itm_orc_scimitar_bad, itm_orc_scimitar_b,itm_orc_sabre_bad,itm_warg_1c,itm_warg_1d,itm_warg_1b,itm_warg_1d,],attr_orc_tier_4,wp_orc_tier_bow_4,knows_common|knows_athletics_6|knows_horse_archery_3|knows_riding_4|knows_power_draw_3|knows_power_throw_3|knows_power_strike_1,orc_face1,orc_face6],
["ca5_gunda_clan_skirmisher","Goblin_North_Clan_Skirmisher","Goblin_North_Clan_Skirmishers",tf_orc| tf_mounted| tfg_ranged| tfg_armor| tfg_boots| tfg_horse| tf_no_capture_alive,0,0,fac_gundabad,[itm_gundabad_helm_d,itm_gundabad_helm_e,itm_gundabad_armor_d, itm_evil_gauntlets_a,itm_orc_furboots,itm_uruk_bow,itm_orc_hook_arrow,itm_orc_scimitar,itm_orc_scimitar_b_heavy,itm_orc_sabre,itm_warg_1d,itm_warg_1b,itm_warg_1d,],attr_orc_tier_5,wp_orc_tier_bow_5,knows_common|knows_athletics_7|knows_horse_archery_6|knows_riding_6|knows_power_draw_4|knows_power_throw_4|knows_power_strike_2,orc_face3,orc_face6],
["c3_gunda_goblin_rider","Gundabad_Goblin_Rider","Gundabad_Goblin_Riders",tf_orc| tf_mounted| tfg_armor| tfg_horse| tf_no_capture_alive,0,0,fac_gundabad,[itm_gundabad_helm_a,itm_orc_skullcap_bad,itm_gundabad_armor_b,itm_orc_ragwrap,itm_uruk_bow,itm_orc_hook_arrow,itm_wood_club,itm_twohand_wood_club,itm_orc_scimitar_b,itm_warg_1d,itm_warg_1b,itm_warg_1c,],attr_orc_tier_3,wp_orc_tier_3,knows_common|knows_athletics_5|knows_riding_3|knows_horse_archery_3|knows_power_throw_2|knows_power_draw_2|knows_power_strike_1,orc_face9,orc_face8],
["c4_gunda_warg_rider","Gundabad_Warg_Rider","Gundabad_Warg_Riders",tf_orc| tf_mounted| tfg_armor| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_gundabad,[itm_gundabad_helm_b,itm_gundabad_helm_c,itm_gundabad_armor_b,itm_gundabad_armor_b,itm_orc_furboots,itm_orc_ragwrap,itm_orc_scimitar_heavy,itm_orc_sabre,itm_twohand_wood_club,itm_orc_club_b,itm_orc_bastard_scimitar_bad,itm_orc_shield_b,itm_orc_shield_b,itm_wargarmored_2b, itm_wargarmored_2c,],attr_orc_tier_4,wp_orc_tier_4,knows_common|knows_athletics_6|knows_riding_4|knows_power_strike_4|knows_ironflesh_4,orc_face1,orc_face6],
["c5_gunda_clan_rider","Goblin_North_Clan_Rider","Goblin_North_Clan_Riders",tf_orc| tf_mounted| tfg_armor| tfg_shield| tfg_helm| tfg_horse| tfg_boots|tfg_gloves| tf_no_capture_alive,0,0,fac_gundabad,[itm_gundabad_helm_e,itm_gundabad_helm_d,itm_gundabad_armor_d,itm_gundabad_armor_e, itm_evil_gauntlets_a,itm_orc_furboots,itm_orc_sabre_heavy,itm_orc_scimitar_heavy,itm_orc_skull_spear,itm_orc_club_b,itm_orc_club_b_heavy,itm_orc_bastard_scimitar,itm_orc_shield_b,itm_orc_shield_b,itm_wargarmored_3a,],attr_orc_tier_5,wp_orc_tier_5,knows_common|knows_athletics_7|knows_riding_6|knows_power_strike_5|knows_ironflesh_6,orc_face3,orc_face6],
["i5_gunda_orc_champion_new","Gundabad_Orc_Champion","Gundabad_Orc_Champions",tf_orc| tfg_shield| tfg_armor| tfg_helm|tfg_boots| tf_no_capture_alive,0,0,fac_gundabad,[itm_gundabad_helm_c,itm_gundabad_helm_d, itm_gundabad_armor_d,itm_gundabad_armor_e, itm_evil_gauntlets_a,itm_orc_furboots,itm_orc_scimitar_heavy,itm_orc_sabre_heavy,itm_orc_club_b_heavy,itm_orc_bastard_scimitar,itm_orc_javelin,  itm_orc_throwing_axes,itm_orc_shield_b,itm_orc_shield_c,],attr_orc_tier_5,wp_orc_tier_4,knows_common|knows_athletics_8|knows_power_throw_6|knows_power_strike_5|knows_ironflesh_4|knows_shield_6,orc_face3,orc_face8],

#move this one here before we swap it with new troop above eventually. (Savegame compatibility.)	  
...
["gundabad_items","{!}BUG","{!}",tf_hero|tf_orc| tfg_shield| tfg_armor| tfg_helm|tfg_boots| tf_no_capture_alive,0,0,fac_gundabad,
...
#Numenorean
["i2_mordor_num_renegade","Black_Numenorean_Renegade","Black_Numenorean_Renegades",tf_evil_man| tfg_armor| tfg_boots,0,0,fac_mordor,[itm_hood_black_bad,itm_orc_coif_bad,itm_evil_light_armor, itm_evil_gauntlets_a, itm_orc_mittens,itm_uruk_ragwrap,itm_orc_simple_spear_heavy,itm_uruk_falchion_a,itm_orc_falchion,],attr_tier_2,wp_tier_2,knows_common|knows_power_strike_1|knows_power_throw_1|knows_weapon_master_1|knows_athletics_1|knows_riding_1|knows_trainer_2|knows_tactics_1|knows_spotting_1|knows_surgery_1|knows_first_aid_1|knows_leadership_2,mordor_man1,mordor_man2],
["i3_mordor_num_warrior","Black_Numenorean_Warrior","Black_Numenorean_Warriors",tf_evil_man| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_mordor,[itm_hood_black,itm_orc_coif,itm_evil_light_armor,itm_m_armor_a, itm_evil_gauntlets_a, itm_orc_mittens,itm_uruk_ragwrap,itm_mordor_sword,itm_uruk_pike_b,itm_orc_falchion_heavy,itm_mordor_orc_shield_b,],attr_tier_3,wp_tier_3,knows_common|knows_ironflesh_2|knows_power_strike_2|knows_power_throw_1|knows_weapon_master_1|knows_athletics_1|knows_riding_2|knows_trainer_2|knows_tactics_1|knows_spotting_1|knows_surgery_1|knows_first_aid_1|knows_leadership_2,mordor_man1,mordor_man2],
["i4_mordor_num_vet_warrior","Black_Numenorean_Veteran_Warrior","Black_Numenorean_Veteran_Warriors",tf_evil_man| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_mordor,[itm_mordor_helm,itm_orc_coif_good,itm_m_armor_a,itm_m_armor_b, itm_evil_gauntlets_a, itm_orc_mittens,itm_uruk_greaves,itm_mordor_longsword,itm_mordor_sword,itm_mordor_man_shield_b,],attr_tier_4,wp_tier_4,knows_common|knows_athletics_2|knows_shield_3|knows_power_strike_4|knows_ironflesh_4,mordor_man1,mordor_man2],
["i5_mordor_num_champion","Black_Numenorean_Champion","Black_Numenorean_Champions",tf_evil_man| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_mordor,[itm_black_num_helm,itm_black_num_armor, itm_evil_gauntlets_b,itm_uruk_greaves,itm_mordor_longsword,itm_orc_mace,itm_mordor_man_shield_a,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_3|knows_shield_4|knows_power_strike_5|knows_ironflesh_5,mordor_man1,mordor_man2],
["i5_mordor_num_assassin","Black_Numenorean_Assassin","Black_Numenorean_Assassins",tf_evil_man| tfg_gloves| tfg_armor| tfg_boots,0,0,fac_mordor,[itm_mordor_helm,itm_hood_black,itm_hood_black_good,itm_m_armor_a,itm_m_armor_b,itm_black_num_armor, itm_evil_gauntlets_a,itm_uruk_chain_greaves,itm_corsair_throwing_dagger, itm_corsair_throwing_dagger, itm_corsair_throwing_dagger,itm_mordor_sword,itm_mordor_longsword,itm_marker_night_troop,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_7|knows_shield_2|knows_power_strike_6|knows_power_throw_8|knows_ironflesh_7,mordor_man1,mordor_man2],
...
["c5_mordor_num_knight","Black_Numenorean_Horsemaster","Black_Numenorean_Horsemasters",tf_evil_man| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_mordor,[itm_black_num_helm,itm_black_num_armor, itm_evil_gauntlets_b_good, itm_orc_mittens_good, itm_uruk_greaves,itm_mordor_longsword,itm_orc_simple_spear_heavy, itm_uruk_pike_b,itm_mordor_man_shield_a,itm_mordor_warhorse,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_5|knows_athletics_3|knows_shield_4|knows_power_strike_5|knows_ironflesh_5,mordor_man1,mordor_man2],
...
#unused Nov 2024
["lorien_captain2","{!}lorien_captain","{!}Elf_Captains_of_Lothlorien",tf_lorien| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_lorien,
...
["lothlorien_lieutenant","{!}lorien_captain","{!}Elf_Captains_of_Lothlorien",tf_lorien| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_lorien,
   [itm_lorien_bow,itm_elven_arrows,itm_lorien_heavy_good_cloak,itm_lorien_helm_b,itm_lorien_shield_b,itm_lorien_boots,itm_lorien_sword_a,itm_lorien_warhorse,],
      attr_elf_tier_6,wp_elf_tier_6,knows_inventory_management_1|knows_power_draw_6|knows_tactics_4|knows_tracking_1|knows_horse_archery_5|knows_riding_5|knows_athletics_5|knows_power_strike_5|knows_ironflesh_5,lorien_elf_face_1,lorien_elf_face_2],

#Captains and lieutenants of all factions      
["greenwood_captain","Greenwood_Captain","Greenwood_Captains",tf_woodelf| tfg_gloves| tfg_armor| tfg_helm| tfg_boots |tfg_ranged| tf_no_capture_alive,0,0,fac_woodelf,[itm_mirkwood_helm_d_good,itm_mirkwood_heavy_scale_cloak,itm_leather_gloves_reward,itm_mirkwood_boots,itm_mirkwood_great_spear,itm_mirkwood_sword,itm_mirkwood_bow,itm_woodelf_arrows,],attr_elf_tier_6,wp_elf_tier_6,knows_common|knows_athletics_8|knows_power_strike_7|knows_ironflesh_7|knows_power_draw_6,mirkwood_elf_face_1,mirkwood_elf_face_2],
["lorien_captain","Lothlorien_Captain","Lothlorien_Captains",tf_lorien| tf_mounted| tfg_ranged| tfg_shield| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_lorien,[itm_lorien_helm_b_good,itm_lorien_heavy_good_cloak,itm_leather_gloves_reward,itm_lorien_boots,(itm_lorien_bow_reward, imod_balanced), itm_elven_arrows,itm_lorien_sword_c,],attr_elf_tier_6,wp_melee(460)|wp_archery(320),knows_common|knows_athletics_9|knows_shield_5|knows_power_draw_6|knows_power_strike_6|knows_ironflesh_7,lorien_elf_face_1,lorien_elf_face_2],
["riv_captain","Rivendell_Elf_Lord","Rivendell_Elf_Lords",tf_imladris| tfg_ranged| tf_mounted| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_imladris,[itm_riv_helm_c,itm_riv_tiara,itm_riv_armor_reward,itm_leather_gloves_reward,itm_riv_boots,(itm_lorien_bow_reward, imod_balanced), itm_elven_arrows,itm_riv_bas_sword,itm_riv_shield_b_good,itm_riv_spear,itm_riv_riding_sword,itm_riv_warhorse2,],attr_elf_tier_6,wp_elf_tier_6,knows_common|knows_riding_6|knows_shield_4|knows_horse_archery_9|knows_athletics_5|knows_power_draw_5|knows_power_strike_5|knows_ironflesh_4,rivendell_elf_face_1,rivendell_elf_face_2],
["arnor_captain","Captain_of_Arnor","Captains_of_Arnor",tf_dunedain| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm,0,0,fac_imladris,[itm_arnor_helm_c_good,itm_arnor_heavy_good_cloak,itm_mail_mittens,itm_arnor_greaves,itm_leather_boots_dark,itm_lance,itm_arnor_sword_c,itm_arnor_shield_c,itm_dunedain_warhorse_heavy,],attr_tier_6,wp_elf_tier_5,knows_common|knows_riding_5|knows_shield_3|knows_athletics_6|knows_power_strike_7|knows_ironflesh_7,arnor_face_older_1,arnor_face_older_2],
["arnor_ranger_captain","Ranger_Captain_of_Arnor","Ranger_Captains_of_Arnor",tf_dunedain| tfg_ranged| tfg_gloves| tfg_armor| tfg_boots,0,0,fac_imladris,[itm_arnor_helm_c_bad,itm_arnor_med_b_good_cloak,itm_leather_gloves,itm_leather_boots,itm_leather_boots_dark_bad,itm_elven_bow,itm_ithilien_arrows,itm_arnor_sword_f,itm_arnor_sword_a,],attr_tier_6,wp_melee(360)|wp_archery(300),knows_common|knows_athletics_8|knows_shield_3|knows_power_draw_5|knows_power_strike_6|knows_ironflesh_6,arnor_face_older_1,arnor_face_older_2],
["rohan_captain","Captain_of_Rohan","Captains_of_Rohan",tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,rohan_face_old_1,rohan_face_older_2],
["beorning_captain","Beorning_Chieftain","Beorning_Chieftains",tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_beorn,[itm_beorn_helmet,itm_beorn_chief,itm_leather_gloves_good,itm_leather_boots, itm_leather_boots_dark,itm_splinted_greaves,itm_beorn_axe_reward,itm_beorn_shield_reward,itm_rohirrim_throwing_axe,],attr_tier_6,wp_tier_6,knows_common|knows_athletics_5|knows_power_strike_7|knows_ironflesh_10|knows_shield_7|knows_power_throw_4,beorn_face1,beorn_face2],
["woodmen_captain","Woodmen_Chieftain","Woodmen_Chieftains",tfg_armor| tfg_helm| tfg_boots| tfg_gloves|tfg_ranged,0,0,fac_beorn,[itm_north_leather_skullcap_good, itm_north_skullcap, itm_north_nasal_helm_good,itm_woodmen_heavy_cloak,itm_leather_gloves_good,itm_evil_gauntlets_a_good,itm_leather_boots,itm_2_handed_axe,itm_elven_bow,itm_arrows,],attr_tier_6,wp_elf_tier_bow_4,knows_common|knows_athletics_7|knows_shield_5|knows_power_draw_6|knows_power_strike_5|knows_ironflesh_6,rohan_face_middle_1,rohan_face_old_2],
["isen_captain","Captain_of_Isengard","Captains_of_Isengard",tf_urukhai|tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_isengard,[itm_isen_uruk_helm_d,itm_isen_uruk_heavy_reward,itm_evil_gauntlets_b,itm_uruk_chain_greaves,itm_isengard_sword,itm_isen_uruk_shield_b,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_3|knows_power_strike_6|knows_ironflesh_6|knows_shield_5,uruk_hai_face1,uruk_hai_face2],
["isen_tracker_captain","Isengard_Tracker_Captain","Isengard_Tracker_Captains",tf_urukhai| tf_mounted| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_isengard,[itm_isen_tracker_helm_good,itm_isen_uruk_heavy_b_good, itm_isen_uruk_heavy_c,itm_evil_gauntlets_b,itm_uruk_chain_greaves,itm_isengard_large_bow,itm_isengard_arrow,itm_isengard_heavy_axe,itm_isengard_heavy_sword,],attr_evil_tier_6,wp_elf_tier_bow_4,knows_common|knows_athletics_7|knows_power_draw_6|knows_power_strike_5|knows_ironflesh_6,uruk_hai_face1,uruk_hai_face2],
["mordor_uruk_captain","Mordor_Uruk_Captain","Mordor_Uruk_Captains",tf_uruk| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_mordor,[itm_uruk_helm_e,itm_m_uruk_heavy_c_good,itm_evil_gauntlets_b,itm_uruk_chain_greaves,itm_orc_two_handed_axe_heavy,itm_uruk_falchion_a,itm_orc_bastard_scimitar,itm_mordor_uruk_shield_c,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_4|knows_power_strike_7|knows_ironflesh_9|knows_shield_4,uruk_hai_face1,uruk_hai_face2],
["mordor_captain","Captain_of_Mordor","Captains_of_Mordor",tf_evil_man| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_mordor,[itm_mordor_cap_helm,itm_m_cap_armor, itm_evil_gauntlets_b, itm_uruk_greaves,itm_mordor_longsword,itm_orc_simple_spear_heavy, itm_uruk_pike_b,itm_mordor_man_shield_a,itm_mordor_warhorse2,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_5|knows_athletics_3|knows_shield_4|knows_power_strike_6|knows_ironflesh_6,mordor_man1,mordor_man2],
["umbar_captain","Captain_of_Umbar","Captains_of_Umbar",tfg_gloves| tfg_armor| tfg_helm| tfg_boots|tfg_shield,0,0,fac_umbar,[itm_umb_helm_b_good,itm_umb_helm_a_good,itm_umb_armor_f_good, itm_evil_gauntlets_b,itm_corsair_boots,itm_kraken,itm_umb_shield_c,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_6|knows_shield_2|knows_power_throw_4|knows_power_strike_5|knows_ironflesh_5,bandit_face1,bandit_face2],
["khand_captain","Variag_War_Chief","Variag_War_Chiefs",tf_evil_man| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_khand,[itm_khand_inf_helm_a_good, itm_khand_cav_helm_a_good,itm_khand_noble_lam,itm_mail_mittens,itm_splinted_greaves_good,itm_khand_mace1, itm_khand_mace2,itm_easterling_round_horseman,itm_variag_kataphrakt,],attr_evil_tier_6,wp_tier_6,knows_common|knows_ironflesh_7|knows_power_strike_5|knows_shield_3|knows_riding_7,khand_man1,khand_man2],
["rhun_captain","Rhun_Chieftain","Rhun_Chieftains",tf_evil_man| tf_mounted| tfg_boots| tfg_armor| tfg_horse| tfg_shield|tfg_helm,0,0,fac_rhun,[itm_rhun_helm_chieftain,itm_rhun_armor_p_good,itm_rhun_armor_k_good,itm_evil_gauntlets_b_good,itm_splinted_greaves_good,itm_rhun_sword,itm_rhun_greatfalchion,itm_rhun_bull3_shield,itm_rhun_horse_g,],attr_evil_tier_6,wp_tier_6,knows_common|knows_ironflesh_7|knows_power_strike_6|knows_riding_7,rhun_man1,rhun_man2],
["moria_captain","Uruk_Chieftain_of_Moria","Uruk_Chieftains_of_Moria",tf_uruk| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_moria,[itm_uruk_helm_e,itm_m_uruk_heavy_c_good,itm_evil_gauntlets_b,itm_uruk_chain_greaves,itm_orc_two_handed_axe_heavy,itm_uruk_falchion_a,itm_orc_bastard_scimitar,itm_mordor_uruk_shield_a,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_5|knows_power_strike_7|knows_ironflesh_9|knows_shield_3,uruk_hai_face1,uruk_hai_face2],
["dwarf_captain","Dwarf_Captain","Dwarf_Captains",tf_dwarf| tfg_armor| tfg_gloves| tfg_shield| tfg_helm| tfg_boots,0,0,fac_dwarf,[itm_dwarf_helm_sallet_lordly,itm_dwarf_armor_c,itm_mail_mittens,itm_dwarf_scale_boots,itm_dwarf_great_axe,itm_dwarf_throwing_axe,itm_dwarf_throwing_axe,itm_dwarf_shield_b_good,],attr_dwarf_tier_6,wp_dwarf_tier_6,knows_common_dwarf|knows_athletics_4|knows_power_throw_7|knows_power_strike_8|knows_ironflesh_10|knows_shield_6,dwarf_face_7,dwarf_face_7],
["dale_captain","Captain_of_Dale","Captains_of_Dale",tfg_shield| tfg_boots| tfg_armor| tfg_helm,0,0,fac_dale,[itm_dale_helmet_c, itm_dale_helmet_c_good, itm_dale_helmet_e,itm_dale_heavy_a_good,itm_dale_heavy_b_pelt,itm_evil_gauntlets_a,itm_splinted_greaves,itm_dale_sword_broad,itm_dale_shield_b_good,],attr_tier_6,wp_tier_6,knows_common|knows_athletics_5|knows_power_strike_6|knows_ironflesh_7|knows_shield_7,swadian_face_middle_1,swadian_face_older_2],
["harad_captain","Haradrim_Noble","Haradrim_Nobles",tf_harad| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots|tfg_polearm,0,0,fac_harad,[itm_harad_dragon_helm,itm_harad_heavy_good,itm_leather_gloves,itm_harad_lamellar_greaves,itm_harad_long_spear,itm_harad_heavy_sword_good,itm_harad_yellow_shield,itm_harad_warhorse],attr_evil_tier_6,wp_tier_6,knows_common|knows_ironflesh_7|knows_power_strike_5|knows_shield_3|knows_riding_7,haradrim_face_1,haradrim_face_2],
["far_harad_captain","Far_Harad_Chief","Far_Harad_Chiefs",tf_harad| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots|tfg_polearm,0,0,fac_harad,[itm_harad_dragon_helm,itm_harad_heavy_good,itm_leather_gloves,itm_harad_lamellar_greaves,itm_harad_long_spear,itm_harad_heavy_sword_good,itm_harad_yellow_shield,itm_harad_warhorse],attr_evil_tier_6,wp_tier_6,knows_common|knows_ironflesh_7|knows_power_strike_5|knows_shield_3|knows_riding_7,haradrim_face_1,haradrim_face_2],
["dun_captain","Dunnish_Hetman","Dunnish_Hetmen",tf_dunland| tf_randomize_face| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_dunland,[itm_dun_helm_a, itm_dun_helm_c,itm_dunland_mail_1_good, itm_dunland_mail_2_good,itm_dunland_chieftain_good,itm_leather_gloves,itm_fur_gloves_reward,itm_dunland_wolfboots,itm_leather_boots_dark,itm_dunnish_war_axe,itm_dun_berserker,itm_dun_shield_a,],attr_evil_tier_6,wp_tier_6,knows_common|knows_athletics_8|knows_shield_5|knows_power_strike_6|knows_ironflesh_6,dunland_face1,dunland_face2],
["gunda_captain","Gundabad_Chieftain","Gundabad_Chieftains",tf_orc| tf_mounted| tfg_armor| tfg_shield| tfg_helm| tfg_horse| tfg_boots|tfg_gloves| tf_no_capture_alive,0,0,fac_gundabad,[itm_gundabad_helm_e,itm_gundabad_armor_e, itm_evil_gauntlets_a,itm_orc_furboots,itm_orc_sabre_heavy,itm_orc_scimitar_heavy,itm_orc_skull_spear,itm_orc_club_b,itm_orc_club_b_heavy,itm_orc_bastard_scimitar_bad,itm_orc_shield_b,itm_orc_shield_b,itm_wargarmored_3a,],attr_orc_tier_6,wp_orc_tier_6,knows_common|knows_athletics_7|knows_riding_6|knows_power_strike_5|knows_ironflesh_8,orc_face3,orc_face6],
["gondor_captain","Captain_of_Gondor","Captains_of_Gondor",tf_gondor| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_gondor,[itm_gondor_leader_helm,itm_gon_leader_surcoat_cloak,itm_mail_mittens,itm_gondor_heavy_greaves,itm_gondor_citadel_sword,itm_gondor_shield_e,],attr_tier_6,wp_tier_6,knows_common|knows_riding_8|knows_athletics_4|knows_shield_3|knows_power_strike_5|knows_ironflesh_6,gondor_face1,gondor_face2],
["pel_captain","Captain_of_Pelargir","Captains_of_Pelargir",tf_gondor| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,subfac_pelargir,fac_gondor,[itm_gondor_leader_helm,itm_pel_leader,itm_mail_mittens,itm_pelargir_greaves,itm_pelargir_sword,itm_gon_tab_shield_c,],attr_tier_6,wp_tier_6,knows_common|knows_athletics_5|knows_shield_9|knows_power_strike_6|knows_ironflesh_6,gondor_face1,gondor_face2],
["amroth_captain","Knight_Captain_of_Dol_Amroth","Knights_Captain_of_Dol_Amroth",tf_gondor| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm,0,subfac_dol_amroth,fac_gondor,[itm_gondor_leader_helm,itm_dol_very_heavy_mail,itm_mail_mittens,itm_dol_greaves,itm_amroth_bastard,itm_amroth_lance_banner,itm_gon_tab_shield_c,itm_dol_amroth_warhorse2,],attr_tier_6,wp_tier_6,knows_common|knows_riding_8|knows_shield_9|knows_power_strike_8|knows_ironflesh_8,gondor_face1,gondor_face3],
["lam_captain","Captain_of_Lamedon","Captains_of_Lamedon",tf_gondor| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,subfac_ethring,fac_gondor,[itm_gondor_lamedon_leader_helm,itm_lamedon_leader_surcoat_cloak,itm_mail_mittens,itm_gondor_heavy_greaves,itm_gondor_cav_sword,itm_gon_tab_shield_c,itm_gondor_lam_horse,],attr_tier_6,wp_tier_6,knows_common|knows_riding_8|knows_shield_9|knows_power_strike_8|knows_ironflesh_7,gondor_face1,gondor_face3],
["loss_captain","Captain_of_Lossarnach","Captains_of_Lossarnach",tf_gondor| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,subfac_lossarnach,fac_gondor,[itm_gondor_leader_helm,itm_lossarnach_leader,itm_mail_mittens,itm_lossarnach_greaves,itm_gondor_cav_sword,itm_loss_axe,itm_gon_tab_shield_a,],attr_tier_6,wp_tier_6,knows_common|knows_athletics_5|knows_shield_9|knows_power_strike_7|knows_ironflesh_7,gondor_face1,gondor_face3],
["pinnath_captain","Captain_of_Pinnath_Gelin","Captains_of_Pinnath_Gelin",tf_gondor| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,subfac_pinnath_gelin,fac_gondor,[itm_gondor_leader_helm,itm_pinnath_leader,itm_mail_mittens,itm_gondor_med_greaves,itm_gondor_heavy_greaves,itm_gondor_cav_sword,itm_gon_tab_shield_c,itm_gondor_warhorse,],attr_tier_6,wp_tier_6,knows_common|knows_riding_8|knows_shield_9|knows_power_strike_6|knows_ironflesh_6,gondor_face1,gondor_face3],
["blackroot_captain","Captain_of_Blackroot_Vale","Captains_of_Blackroot_Vale",tf_gondor| tfg_ranged| tfg_armor| tfg_helm| tfg_boots,0,subfac_blackroot,fac_gondor,[itm_gondor_leader_helm,itm_blackroot_leader,itm_leather_gloves_good,itm_gondor_med_greaves,itm_gondor_arrows,itm_gondor_bow,itm_gondor_spear,],attr_tier_6,wp_elf_tier_5,knows_common|knows_athletics_7|knows_power_draw_5|knows_power_strike_6|knows_ironflesh_7,gondor_face1,gondor_face3],
["ithilien_captain","Captain_of_Ithilien_Rangers","Captains_of_Ithilien_Rangers",tf_gondor| tfg_ranged| tfg_armor| tfg_helm| tfg_boots,0,subfac_rangers,fac_gondor,[itm_gondor_ranger_hood_mask,(itm_gon_ranger_skirt, imod_lordly),itm_leather_gloves,itm_gondor_light_greaves,itm_ithilien_arrows,itm_ithilien_arrows,itm_gondor_bow,itm_gondor_ranger_sword,],attr_tier_6,wp_elf_tier_bow_5,knows_common|knows_pathfinding_4|knows_athletics_9|knows_shield_9|knows_power_draw_9|knows_power_strike_8|knows_ironflesh_8,gondor_face1,gondor_face2],

["future_captain_01","{!}BUG","{!}BUG",0,0,0,fac_no_faction,   [],      0,0,0,0],
["future_captain_02","{!}BUG","{!}BUG",0,0,0,fac_no_faction,   [],      0,0,0,0],
["future_captain_03","{!}BUG","{!}BUG",0,0,0,fac_no_faction,   [],      0,0,0,0],
["future_captain_04","{!}BUG","{!}BUG",0,0,0,fac_no_faction,   [],      0,0,0,0],
["future_captain_05","{!}BUG","{!}BUG",0,0,0,fac_no_faction,   [],      0,0,0,0],
["future_captain_06","{!}BUG","{!}BUG",0,0,0,fac_no_faction,   [],      0,0,0,0],
...
#used in party templates and village quest
...
#TLD walkers - WB
["walker_man_gondor_black","Townsman","{!}",tf_gondor| tfg_boots| tfg_armor,0,0,fac_gondor,
...
["walker_man_gondor_white","Townsman","{!}",tf_gondor| tfg_boots| tfg_armor,0,0,fac_gondor,
   [itm_corsair_boots, itm_civ_fine_shoes, 
...
["walker_man_gondor_blue","Townsman","{!}",tf_gondor| tfg_boots| tfg_armor,0,0,fac_gondor,
   [itm_hood_black_bad,itm_hood_grey_bad, itm_felt_hat_b, 
   itm_peasant_man_a_wb, itm_white_tunic_c_wb, itm_white_tunic_a_wb, itm_black_tunic_wb, 
   itm_leather_boots_dark_bad, itm_rohan_shoes_bad],
      attr_tier_1,wp_tier_1,knows_common,man_face_young_1,man_face_old_2],
# Linhir, Edhellond, Lossarnach, Tarnost, Erech, Pinnath, Calembel
["walker_man_gondor_green","Townsman","{!}",tf_gondor| tfg_boots| tfg_armor,0,0,fac_gondor,
   [itm_hood_green_bad, itm_hood_black, itm_hood_grey, itm_lossarnach_cloth_cap, itm_felt_hat, itm_felt_hat_b, 
   ...
   itm_leather_boots_bad, itm_corsair_boots, itm_rohan_shoes, ],
      attr_tier_1,wp_tier_1,knows_common,man_face_young_1,man_face_old_2],
["walker_man_rohan_t","Rohan_Townsman","{!}",tf_rohan| tfg_boots| tfg_armor,0,0,fac_rohan,
   [itm_fur_hat_a_new_wb, itm_leather_cap, 
...
["walker_man_rohan_d","Rohan_Townsman","{!}",tf_rohan| tfg_boots| tfg_armor,0,0,fac_rohan,
   [itm_hood_grey, itm_hood_green, itm_nomad_cap_b, itm_leather_steppe_cap_a, 
   itm_tabard_b_wb, itm_peasant_man_a_wb, itm_leather_jerkin_wb, itm_white_tunic_c_wb, itm_rohan_fine_outfit_dale_dress_wb, itm_rohan_tunic_a_wb, itm_rohan_tunic_b_wb, itm_sar_robe_b_wb, itm_nomad_vest, itm_ragged_outfit, 
   itm_leather_boots_bad,itm_rohan_shoes_bad],
   attr_tier_1,wp_tier_1,knows_common,rohan_face_middle_1,rohan_face_older_2],
["walker_woman_rohan_t","Rohan_Maiden","{!}",tf_female| tfg_boots| tfg_armor,0,0,fac_rohan,
   [itm_hood_green_bad, itm_wimple_with_veil, itm_headcloth, 
   ...
   itm_rohan_shoes_bad,itm_leather_boots_bad],
      attr_tier_1,wp_tier_1,knows_common,rohan_woman_face_1,rohan_woman_face_2],
["walker_woman_rohan_d","Rohan_Maiden","{!}",tf_female| tfg_boots| tfg_armor,0,0,fac_rohan,
   [itm_hood_grey, itm_hood_green, itm_fur_hat_a_new_wb, itm_nomad_cap_b, itm_leather_steppe_cap_a, 
   itm_robe_generic_dress_wb,itm_rohan_fine_outfit_dale_dress_wb, itm_green_dress_wb, itm_black_dress_wb, itm_green_tunic_wb, itm_leather_jerkin_wb, itm_black_tunic_wb,itm_peasant_man_a_wb, itm_nomad_vest, itm_ragged_outfit, 
   itm_leather_boots,itm_rohan_shoes],
      attr_tier_1,wp_tier_1,knows_common,rohan_woman_face_1,rohan_woman_face_2],
# all except MT
["walker_woman_gondor_b","Gondor_Woman","{!}",tf_female| tfg_boots| tfg_armor| tfg_helm,0,0,fac_gondor,
   [itm_hood_black_bad,itm_hood_grey_bad, itm_headcloth, 
...
["walker_woman_gondor_bw","Gondor_Woman","{!}",tf_female| tfg_boots| tfg_armor| tfg_helm,0,0,fac_gondor,
   [itm_wimple_a_wb, itm_wimple_with_veil_wb, itm_fine_hat_wb, itm_wimple_a, itm_wimple_with_veil, 
   ...
   itm_civ_fine_shoes],
      attr_tier_1,wp_tier_1,knows_common,woman_face_1,woman_face_2],
# Minas Tirith only
["walker_woman_gondor_w","Gondor_Noble","{!}",tf_male| tfg_boots| tfg_armor,0,0,fac_gondor,
...
["mirkwood_walker_1","Greenwood_Elf","{!}",tf_woodelf| tfg_armor| tfg_boots| tf_no_capture_alive,0,0,fac_woodelf,
    ...
    itm_mirkwood_leather_bad, itm_mirkwood_pad_bad, itm_leather_vest, 
...
["dwarf_walker","Dwarf","{!}",tf_dwarf| tfg_armor| tfg_boots,0,0,fac_dwarf,
    [itm_dwarf_hood, itm_fur_hat_a_new_wb, itm_dwarf_miner, itm_leather_cap, itm_noel_hat_a_wb, itm_nomad_cap_b,
    itm_dwarf_vest,itm_dwarf_vest_lordly,itm_fur_coat_tld,itm_white_tunic_c_wb,
    itm_dwarf_pad_boots,],
        attr_dwarf_tier_1,wp_dwarf_tier_1,knows_common,dwarf_face_1,dwarf_face_7],
["beorn_walker","Vale_Man","{!}",tfg_boots| tfg_armor,0,0,fac_beorn,
   [itm_leather_boots,itm_leather_boots_dark_bad, itm_rohan_shoes, itm_hunter_boots, itm_furry_boots, itm_nomad_vest, 
   ...
   itm_hood_black, itm_hood_grey_bad, itm_fur_hat_a_new_wb, itm_felt_hat,itm_nomad_cap_b,itm_leather_steppe_cap_a,],
      attr_tier_1,wp_tier_1,knows_common,swadian_face_younger_1,swadian_face_old_2],
["beorn_walker_fem","Vale_Woman","{!}",tf_female| tfg_boots| tfg_armor,0,0,fac_beorn,
    [itm_hood_green_bad,itm_nomad_cap_b,itm_leather_steppe_cap_a,
    itm_robe_generic_dress_wb,itm_green_dress_wb, itm_black_dress_wb,itm_woodman_tunic_bad, itm_woodman_scout_bad,itm_beorn_tunic_bad, itm_leather_vest, itm_nomad_vest, 
    itm_rohan_shoes_bad,itm_furry_boots,itm_leather_boots_bad],
        attr_tier_1,wp_tier_1,knows_common,rohan_woman_face_1,rohan_woman_face_2],
                ...
                ["walker_man_gondor_blue","Townsman","{!}",tf_gondor| tfg_boots| tfg_armor,0,0,fac_gondor,[itm_hood_black,itm_pelargir_hood,itm_gondor_fine_outfit_dress, itm_blue_tunic, itm_white_tunic_a, itm_gon_jerkin, itm_leather_jerkin, itm_black_tunic,itm_leather_apron,itm_lossarnach_shirt, itm_leather_boots,], attr_tier_1,wp_tier_1,knows_common,man_face_young_1,man_face_old_2],
                ["walker_man_gondor_green","Townsman","{!}",tf_gondor| tfg_boots| tfg_armor,0,0,fac_gondor,[itm_hood_black,itm_blue_tunic, itm_white_tunic_a, itm_leather_jerkin, itm_black_tunic, itm_leather_apron, itm_leather_boots,itm_rohan_shoes],attr_tier_1,wp_tier_1,knows_common,man_face_young_1,man_face_old_2],
                ["walker_man_rohan_t","Rohan_Townsman","{!}",tf_rohan| tfg_boots| tfg_armor,0,0,fac_rohan,[itm_rohan_tunic_a,itm_rohan_tunic_b, itm_rohan_fine_outfit_dale_dress, itm_white_tunic_a, itm_leather_jerkin, itm_black_tunic, itm_leather_apron, itm_leather_boots,itm_rohan_shoes],attr_tier_1,wp_tier_1,knows_common,rohan_face_middle_1,rohan_face_older_2],
                ["walker_man_rohan_d","Rohan_Townsman","{!}",tf_rohan| tfg_boots| tfg_armor,0,0,fac_rohan,[itm_gondor_ranger_hood,itm_rohan_tunic_a,itm_rohan_tunic_b, itm_rohan_fine_outfit_dale_dress, itm_white_tunic_a, itm_leather_jerkin, itm_black_tunic, itm_leather_apron,  itm_rohan_shoes,],attr_tier_1,wp_tier_1,knows_common,rohan_face_middle_1,rohan_face_older_2],
                ["walker_woman_rohan_t","Rohan_Maiden","{!}",tf_female| tfg_boots| tfg_armor,0,0,fac_rohan,[itm_gondor_ranger_hood,itm_robe_generic_dress,itm_green_dress, itm_black_dress,itm_rohan_fine_outfit_dale_dress,itm_rohan_shoes,itm_leather_boots],attr_tier_1,wp_tier_1,knows_common,rohan_woman_face_1,rohan_woman_face_2],
                ["walker_woman_rohan_d","Rohan_Maiden","{!}",tf_female| tfg_boots| tfg_armor,0,0,fac_rohan,[itm_robe_generic_dress,itm_rohan_fine_outfit_dale_dress, itm_green_dress, itm_black_dress, itm_green_tunic, itm_white_tunic_a,itm_leather_jerkin, itm_black_tunic, itm_leather_apron,itm_leather_boots,itm_rohan_shoes],attr_tier_1,wp_tier_1,knows_common,rohan_woman_face_1,rohan_woman_face_2],
                ["walker_woman_gondor_b","Gondor_Woman","{!}",tf_female| tfg_boots| tfg_armor| tfg_helm,0,0,fac_gondor,[itm_robe_generic_dress,itm_rohan_fine_outfit_dale_dress,itm_black_dress, itm_wimple_a, itm_wimple_with_veil ,itm_leather_boots,],attr_tier_1,wp_tier_1,knows_common,woman_face_1,woman_face_2],
                ["walker_woman_gondor_bw","Gondor_Woman","{!}",tf_female| tfg_boots| tfg_armor| tfg_helm,0,0,fac_gondor,[itm_robe_generic_dress,itm_black_dress,itm_black_dress, itm_blackwhite_dress,itm_wimple_a, itm_wimple_with_veil, itm_fine_hat,itm_leather_boots,],attr_tier_1,wp_tier_1,knows_common,woman_face_1,woman_face_2],
                ["walker_woman_gondor_w","Gondor_Noble","{!}",tf_male| tfg_boots| tfg_armor,0,0,fac_gondor,[itm_gondor_fine_outfit_dress,itm_gondor_fine_outfit_dress,itm_gondor_fine_outfit_dress,itm_denethor_robe,itm_leather_boots,itm_corsair_boots],attr_tier_1,wp_tier_1,knows_common,woman_face_1,woman_face_2],
                ["mirkwood_walker_1","Greenwood_Elf","Greenwood_Elves",tf_woodelf| tfg_armor| tfg_boots| tf_no_capture_alive,0,0,fac_woodelf,[itm_hood_green_bad, itm_mirkwood_leather_bad,itm_rohan_shoes,itm_leather_boots_dark_bad,itm_woodelf_leather_boots],attr_elf_tier_1,wp_elf_tier_bow_1,knows_common,mirkwood_elf_face_1,mirkwood_elf_face_2],
                ["mirkwood_walker_2","Greenwood_Elf","Greenwood_Elves",tf_female| tfg_armor| tfg_boots| tf_no_capture_alive,0,0,fac_woodelf,[itm_hood_green_bad, itm_mirkwood_leather_bad,itm_rohan_shoes,itm_leather_boots_dark_bad,itm_woodelf_leather_boots],attr_elf_tier_1,wp_elf_tier_bow_1,knows_common,mirkwood_elf_face_1,mirkwood_elf_face_2],
                ["lorien_walker_1","Lothlorien_Elf","Lothlorien_Elves",tf_lorien| tfg_armor| tfg_boots| tf_no_capture_alive,0,0,fac_lorien,[itm_hood_grey,itm_lorien_archer,itm_woodelf_leather_boots,],attr_elf_tier_1,wp_elf_tier_1,knows_common,lorien_elf_face_1,lorien_elf_face_2],
                ["lorien_walker_2","Lothlorien_Elf","Lothlorien_Elves",tf_female| tfg_armor| tfg_boots| tf_no_capture_alive,0,0,fac_lorien,[itm_hood_grey,itm_lorien_archer,itm_woodelf_leather_boots,],attr_elf_tier_1,wp_elf_tier_1,knows_common,lorien_elf_face_1,lorien_elf_face_2],
                ["dwarf_walker","Dwarf","Dwarves",tf_dwarf| tfg_armor| tfg_boots,0,0,fac_dwarf,[itm_dwarf_hood, itm_dwarf_miner,itm_dwarf_vest,itm_dwarf_vest_lordly,itm_dwarf_pad_boots,],attr_dwarf_tier_1,wp_dwarf_tier_1,knows_common,dwarf_face_1,dwarf_face_7],
                ["beorn_walker","Peasant_Woman","Peasant_Women",tf_female| tfg_boots| tfg_armor,0,0,fac_beorn,[itm_gondor_ranger_hood,itm_black_tunic, itm_rohan_shoes,itm_leather_boots],attr_tier_1,wp_tier_1,knows_common,rohan_woman_face_1,rohan_woman_face_2],             
                ["beorn_walker_fem","Peasant_Woman","Peasant_Women",tf_female| tfg_boots| tfg_armor,0,0,fac_beorn,[itm_gondor_ranger_hood,itm_black_tunic, itm_rohan_shoes,itm_leather_boots],attr_tier_1,wp_tier_1,knows_common,rohan_woman_face_1,rohan_woman_face_2],             
                ]) + [ 

["trainer_4","Trainer","{!}",tf_hero, 0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],

#TRAINERS
["trainer_gondor","Trainer","{!}",tf_hero| tf_gondor| tfg_armor| tfg_boots, scn_gondor_arena|entry(1),0,fac_commoners,
   [itm_gon_tower_guard,itm_gondor_heavy_greaves,itm_gondor_citadel_sword,itm_mail_mittens],
      attr_tier_7,0,0,gondor_face2],
["trainer_rohan","Trainer","{!}",tf_hero| tf_rohan| tfg_armor| tfg_boots, scn_rohan_arena|entry(1),0,fac_commoners,
   [itm_rohan_light_greaves,itm_mail_mittens,itm_rohan_leather,itm_rohan_spear,],
      attr_tier_7,0,0,rohan_face_old_2],
["trainer_dale","Trainer","{!}",tf_hero| tfg_armor| tfg_boots, scn_dale_arena|entry(1),0,fac_commoners,
   [itm_blue_tunic,itm_leather_boots,],
      attr_tier_7,0,0,gondor_face2],
["trainer_elf","Trainer","{!}",tf_hero| tf_lorien| tfg_armor| tfg_boots, scn_elf_arena|entry(1),0,fac_commoners,
   [itm_whiterobe,itm_leather_boots,],
      attr_tier_7,0,0,lorien_elf_face_2],
["trainer_beorn","Trainer","{!}",tf_hero| tfg_armor| tfg_boots, scn_beorn_arena|entry(1),0,fac_commoners,
   [itm_beorn_padded,itm_rohan_shoes,],
      attr_tier_7,0,0,beorn_face2],
["trainer_dwarf","Trainer","{!}",tf_hero| tf_dwarf| tfg_armor| tfg_boots, scn_dwarf_arena|entry(1),0,fac_commoners,
   [itm_leather_dwarf_armor,itm_dwarf_pad_boots,],
      attr_tier_7,0,0,dwarf_face_2],
["trainer_mordor","Trainer","{!}",tf_hero| tf_orc| tfg_armor| tfg_boots, scn_mordor_arena|entry(1),0,fac_commoners,
   [itm_uruk_ragwrap,itm_orc_tribal_a,],
      attr_tier_7,0,0,orc_face_normal],
["trainer_isengard","Trainer","{!}",tf_hero| tf_orc| tfg_armor| tfg_boots, scn_isengard_arena|entry(1),0,fac_commoners,
   [itm_uruk_ragwrap,itm_orc_tribal_a,],
      attr_tier_7,0,0,orc_face_normal],
["trainer_khand","Trainer","{!}",tf_hero| tf_evil_man| tfg_armor| tfg_boots, scn_khand_arena|entry(1),0,fac_commoners,
   [itm_khand_foot_lam,itm_leather_boots,],
      attr_tier_7,0,0,khand_man2],
["trainer_rhun","Trainer","{!}",tf_hero| tf_evil_man| tfg_armor| tfg_boots, scn_rhun_arena|entry(1),0,fac_commoners,
   [itm_rhun_armor_a,itm_furry_boots,],
      attr_tier_7,0,0,rhun_man2],
["trainer_harad","Trainer","{!}",tf_hero| tf_harad| tfg_armor| tfg_boots, scn_harad_arena|entry(1),0,fac_commoners,
   [itm_harad_scale,itm_harad_scale_greaves,],
      attr_tier_7,0,0,haradrim_face_2],
["trainer_umbar","Trainer","{!}",tf_hero| tfg_armor| tfg_boots, scn_umbar_arena|entry(1),0,fac_commoners,
   [itm_umb_armor_d,itm_corsair_boots,],
      attr_tier_7,0,0,bandit_face2],
      
#
# Ransom brokers.
["ransom_broker_1","Ransom_Broker","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["ransom_broker_2","Ransom_Broker","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["ransom_broker_3","Ransom_Broker","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["ransom_broker_4","Ransom_Broker","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["ransom_broker_5","Ransom_Broker","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["ransom_broker_6","Ransom_Broker","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["ransom_broker_7","Ransom_Broker","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["ransom_broker_8","Ransom_Broker","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["ransom_broker_9","Ransom_Broker","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["ransom_broker_10","Ransom_Broker","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
 
# Tavern traveler.
["tavern_traveler_1","Traveller","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["tavern_traveler_2","Traveller","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["tavern_traveler_3","Traveller","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["tavern_traveler_4","Traveller","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["tavern_traveler_5","Traveller","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["tavern_traveler_6","Traveller","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["tavern_traveler_7","Traveller","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["tavern_traveler_8","Traveller","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["tavern_traveler_9","Traveller","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
["tavern_traveler_10","Traveller","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
# Tavern minstrel.
["tavern_minstrel_1","Minstrel","{!}",tf_hero| tf_randomize_face,0,0,fac_commoners,
   [],
      0,0,0,merchant_face_1,merchant_face_2],
#Companions
["npc1","Mablung","{!}",tf_hero| tf_gondor| tf_unmoveable_in_party_window,0,0,fac_gondor,
...
["npc2","Cirdil","{!}",tf_hero| tf_gondor| tf_unmoveable_in_party_window,0,0,fac_gondor,
   [itm_gon_jerkin,itm_leather_boots_bad,itm_gondor_auxila_helm,itm_shortened_spear,itm_gon_tab_shield_a,itm_gondor_short_sword,],
      str_10|agi_8|int_4|cha_6|level(3),wp_one_handed(10)|wp(60)|wp_throwing(60),knows_common|knows_ironflesh_1|knows_power_strike_2|knows_power_throw_1|knows_power_draw_1|knows_weapon_master_2|knows_shield_2|knows_athletics_1|knows_riding_1|knows_trainer_1|knows_spotting_1|knows_wound_treatment_1|knows_first_aid_1|knows_leadership_1|knows_trade_1,0x000000002d00418519da91378c8aa8d300000000001eb9110000000000000000],
["npc3","Ulfas","{!}",tf_rohan| tf_hero| tf_unmoveable_in_party_window,0,0,fac_rohan,
   [itm_rohan_mail_bad,itm_leather_boots_bad,itm_rohan_shield_a,itm_rohan_light_helmet_b_bad,itm_rohan_spear,itm_rohirrim_long_hafted_axe,itm_rohirrim_courser,],
      str_14|agi_10|int_5|cha_9|level(10),wp_one_handed(110)|wp_two_handed(100)|wp_polearm(120)|wp_archery(80)|wp_throwing(100),knows_common|knows_ironflesh_3|knows_power_strike_2|knows_power_throw_1|knows_weapon_master_3|knows_shield_2|knows_athletics_1|knows_riding_3|knows_horse_archery_2|knows_looting_3|knows_trainer_1|knows_tracking_2|knows_pathfinding_1|knows_wound_treatment_1|knows_surgery_1|knows_leadership_1|knows_trade_2,0x0000000886000085395d6db6db6db8db00000000001db6e30000000000000000],
["npc4","Galmyne","{!}",tf_female| tf_mounted| tfg_ranged| tf_hero| tf_unmoveable_in_party_window,0,0,fac_rohan,
   [itm_rohan_rider,itm_rohan_light_greaves,itm_rohan_shield_d,itm_rohan_archer_helmet_b,itm_rohan_sword_c,itm_strong_bow,itm_khergit_arrows,itm_rohan_warhorse,],
      str_14|agi_18|int_9|cha_12|level(22),wp_one_handed(160)|wp_two_handed(120)|wp_polearm(140)|wp_archery(180)|wp_throwing(160),knows_common|knows_ironflesh_3|knows_power_strike_2|knows_power_throw_4|knows_power_draw_4|knows_weapon_master_6|knows_shield_3|knows_athletics_1|knows_riding_6|knows_horse_archery_5|knows_trainer_1|knows_spotting_1|knows_wound_treatment_4|knows_first_aid_3|knows_leadership_2|knows_trade_1,0x000000000300000114a261248280c73400000000001ca48d0000000000000000],
["npc5","Glorfindel","{!}",tf_lorien| tf_mounted| tfg_ranged| tf_hero| tf_unmoveable_in_party_window,0,0,fac_lorien,
   [itm_riv_armor_reward,itm_lorien_boots,itm_riv_helm_glorfi,itm_lorien_bow_reward,itm_elven_arrows,itm_elven_arrows,itm_lorien_sword_c,itm_riv_warhorse2,],
      str_30|agi_24|int_18|cha_24|level(55),wp(500),knows_common|knows_ironflesh_7|knows_power_strike_7|knows_power_draw_9|knows_weapon_master_8|knows_athletics_5|knows_riding_7|knows_horse_archery_9|knows_trainer_4|knows_pathfinding_5|knows_spotting_6|knows_wound_treatment_3|knows_first_aid_5|knows_persuasion_3|knows_prisoner_management_3|knows_leadership_6,0x000000018000100a38db6db6db6db6db00000000001db6eb0000000000000000],
["npc6","Luevanna","{!}",tf_female| tfg_ranged| tf_hero| tf_unmoveable_in_party_window,0,0,fac_woodelf,
...
["npc7","Kili_Goldfinger","{!}",tf_dwarf| tf_hero| tf_unmoveable_in_party_window,0,0,fac_dwarf,
   [itm_leather_dwarf_armor_b,itm_dwarf_pad_boots,itm_dwarf_sword_a,itm_dwarf_throwing_axe,itm_dwarf_mattock,itm_dwarf_shield_a,],
      str_14|agi_8|int_7|cha_6|level(7),wp_one_handed(100)|wp_two_handed(115)|wp_polearm(115)|wp_archery(50)|wp_throwing(115),knows_common|knows_ironflesh_3|knows_power_strike_3|knows_power_throw_3|knows_weapon_master_2|knows_shield_3|knows_athletics_2|knows_riding_10|knows_horse_archery_10|knows_looting_4|knows_trainer_1|knows_prisoner_management_1|knows_leadership_2|knows_trade_3,0x00000001c000110336db6db6db6db6db00000000001db6db0000000000000000],
["npc8","Faniul","{!}",tf_female| tfg_ranged| tf_hero| tf_unmoveable_in_party_window,0,0,fac_dale,
   [itm_blue_tunic,itm_leather_boots_bad,itm_wimple_with_veil,itm_shortened_spear],
      str_8|agi_6|int_11|cha_5|level(12),wp_one_handed(40)|wp_two_handed(40)|wp_polearm(60)|wp_archery(70)|wp_throwing(40),knows_common|knows_ironflesh_3|knows_power_strike_1|knows_power_draw_3|knows_weapon_master_2|knows_shield_3|knows_athletics_2|knows_riding_2|knows_looting_1|knows_spotting_2|knows_wound_treatment_4|knows_surgery_4|knows_first_aid_2|knows_prisoner_management_1|knows_leadership_1|knows_trade_2,0x0000000d66001004589dae38ad69a64900000000001ec6cc0000000000000000],
["npc9","Gulm","{!}",tf_urukhai| tf_hero| tf_unmoveable_in_party_window,0,0,fac_isengard,
   [itm_isen_uruk_light_a,itm_uruk_chain_greaves,itm_isengard_mallet,itm_evil_gauntlets_a,],
      str_24|agi_17|int_8|cha_4|level(20),wp(185)|wp_throwing(185),knows_common|knows_ironflesh_10|knows_power_strike_5|knows_power_throw_5|knows_weapon_master_5|knows_shield_3|knows_athletics_7|knows_riding_2|knows_looting_5|knows_trainer_2,0x00000001b50000c2003d7dc5a4b2195c00000000000000000000000000000000],
["npc10","Durgash","{!}",tf_orc| tf_mounted| tfg_ranged| tf_hero| tf_unmoveable_in_party_window,0,0,fac_isengard,
   [itm_isen_orc_light_b,itm_wood_club,itm_orc_throwing_arrow,itm_warg_1d,],
      str_12|agi_11|int_11|cha_4|level(10),wp(90)|wp_throwing(90),knows_common|knows_ironflesh_3|knows_power_strike_2|knows_power_throw_2|knows_weapon_master_3|knows_athletics_2|knows_riding_4|knows_horse_archery_3|knows_looting_2|knows_trainer_2|knows_tracking_1|knows_pathfinding_4|knows_spotting_2|knows_prisoner_management_2|knows_leadership_2,0x00000001a2000007399e8ccc9cae34e500000000001d16ad0000000000000000],
["npc11","Ufthak","{!}",tf_orc| tf_hero| tf_unmoveable_in_party_window,0,0,fac_mordor,
   [itm_m_orc_light_a,itm_orc_ragwrap,itm_wood_club,itm_orc_simple_spear,],
      str_8|agi_12|int_6|cha_4|level(1),wp(75)|wp_throwing(75),knows_common|knows_ironflesh_2|knows_power_strike_1|knows_power_throw_1|knows_power_draw_2|knows_weapon_master_2|knows_athletics_3|knows_looting_2|knows_tracking_2|knows_spotting_1|knows_persuasion_1,orc_face6],
["npc12","Gorbag","{!}",tf_uruk| tf_hero| tf_unmoveable_in_party_window,0,0,fac_mordor,
   [itm_m_uruk_med_b,itm_uruk_tracker_boots,itm_orc_two_handed_axe,itm_uruk_pike_b,itm_uruk_helm_b,],
      str_19|agi_16|int_9|cha_4|level(20),wp(175)|wp_throwing(175),knows_common|knows_ironflesh_6|knows_power_strike_5|knows_power_throw_4|knows_weapon_master_5|knows_shield_5|knows_athletics_2|knows_riding_1|knows_looting_5|knows_trainer_3|knows_spotting_3|knows_prisoner_management_2|knows_leadership_3,uruk_hai_face2],
["npc13","Lykyada","{!}",tf_harad| tfg_ranged| tf_mounted| tf_hero| tf_unmoveable_in_party_window,0,0,fac_harad,
   [itm_black_snake_armor,itm_harad_leather_greaves,itm_leather_gloves,itm_black_snake_helm,itm_harad_bow,itm_harad_arrows,itm_black_snake_sword,itm_harad_warhorse,],
      str_24|agi_20|int_18|cha_15|level(40),wp(400)|wp_throwing(400),knows_common|knows_ironflesh_7|knows_power_strike_6|knows_power_draw_6|knows_weapon_master_4|knows_athletics_3|knows_riding_6|knows_horse_archery_5|knows_trainer_6|knows_tracking_3|knows_pathfinding_5|knows_spotting_7|knows_wound_treatment_4|knows_first_aid_6|knows_leadership_4,0x000000051f00000b372571b8ed79a6ac00000000001db6360000000000000000],
["npc14","Fuldimir","{!}",tf_hero| tf_unmoveable_in_party_window,0,0,fac_umbar,
   [itm_umb_armor_a,itm_corsair_boots,itm_umb_shield_a,itm_corsair_throwing_dagger,itm_umbar_cutlass,],
      str_10|agi_9|int_7|cha_7|level(4),wp(80)|wp_throwing(80),knows_common|knows_power_strike_1|knows_power_throw_2|knows_power_draw_2|knows_weapon_master_3|knows_athletics_2|knows_looting_3|knows_spotting_2|knows_surgery_2|knows_prisoner_management_2|knows_leadership_1|knows_trade_3,0x00000001b70032453add7524dc76d74900000000001d35330000000000000000],
["npc15","Bolzog","{!}",tf_orc| tf_hero| tf_unmoveable_in_party_window,0,0,fac_moria,
   [itm_moria_armor_a,itm_orc_slasher],
      str_9|agi_10|int_12|cha_4|level(7),wp(80)|wp_throwing(80),knows_common|knows_ironflesh_3|knows_power_strike_1|knows_power_throw_2|knows_weapon_master_2|knows_shield_2|knows_athletics_3|knows_riding_1|knows_looting_3|knows_trainer_1|knows_tracking_3|knows_wound_treatment_4|knows_surgery_4|knows_first_aid_3,0x00000001ab00200d35627276a42e150c00000000001dca2c0000000000000000],
["npc16","Varfang","{!}",tf_mounted| tf_hero| tf_unmoveable_in_party_window,0,0,fac_rhun,
   [itm_rhun_armor_a,itm_furry_boots,itm_rhun_sword,itm_light_lance,itm_rhun_helm_pot,itm_rhun_horse_a,],
      str_15|agi_15|int_3|cha_5|level(10),wp(120)|wp_throwing(120),knows_common|knows_ironflesh_2|knows_power_strike_4|knows_power_draw_2|knows_weapon_master_3|knows_riding_5|knows_horse_archery_4|knows_looting_4|knows_prisoner_management_1|knows_leadership_2,0x000000018700214944d468dd9bae295b00000000001cb5a40000000000000000],
["npc17","Dimborn","{!}",tf_hero| tf_unmoveable_in_party_window,0,0,fac_beorn,
   [itm_woodman_tunic,itm_leather_boots_bad,itm_beorn_axe,],
      str_12|agi_10|int_5|cha_3|level(4),wp(95)|wp_throwing(95),knows_common|knows_ironflesh_3|knows_power_strike_2|knows_power_draw_2|knows_weapon_master_2|knows_shield_1|knows_athletics_3|knows_riding_1|knows_looting_2|knows_pathfinding_1|knows_wound_treatment_2|knows_persuasion_4,0x00000009f50001c97ac16e65f3ecf7de00000000001cc7080000000000000000],
...
["knight_6_2","Golasgil","{!}",tf_hero| tf_gondor| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_gondor,
...
["harad_lord","Chief_Ul-Ulcari","Chief",tf_hero| tf_harad| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_harad,
   [itm_harad_warhorse,itm_harad_heavy_good,itm_harad_scale_greaves,itm_evil_gauntlets_a,itm_harad_dragon_helm,itm_harad_long_spear,itm_harad_heavy_sword_good,itm_harad_yellow_shield,],
      attr_tier_7,wp_tier_6,knight_skills_4|knows_riding_4|knows_trainer_5|knows_surgery_9,0x00000009ff0020071415a5f9fb60c1b700000000001d663b0000000000000000],
["rhun_lord","Jarl_Helcaroth","Jarl",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_evil_man,0,0,fac_rhun,
   [itm_rhun_horse_h,itm_rhun_armor_k_good,itm_splinted_greaves_good,itm_evil_gauntlets_b_good,itm_rhun_helm_chieftain_good,itm_rhun_greatsword,],
      attr_tier_7,wp_tier_6,knight_skills_5|knows_riding_4|knows_trainer_5|knows_surgery_9,0x00000004a300640c1a938b5499b6556c00000000001edab90000000000000000],
["khand_lord","Shibh_Krukmahur","Shibh",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_evil_man,0,0,fac_khand,
   [itm_variag_kataphrakt,itm_khand_noble_lam_good,itm_splinted_greaves_good,itm_evil_gauntlets_b_good,itm_khand_lance,itm_khand_tulwar,itm_variag_gladiator_shield,],
      attr_tier_7,wp_tier_6,knight_skills_5|knows_riding_4|knows_trainer_4|knows_surgery_9,0x0000000f3f00b38712065fd3287f731c00000000001c53780000000000000000],
["umbar_lord","Admiral_Tulmir","Admiral",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_umbar,
   [itm_umb_armor_f_good,itm_corsair_boots,itm_leather_gloves_reward,itm_umb_helm_reward,itm_corsair_bow,itm_corsair_arrows,itm_kraken,itm_umb_shield_c],
      attr_tier_7,wp_tier_6,knight_skills_5|knows_riding_4|knows_trainer_6|knows_surgery_9,0x0000000e3b004244365b6db99b6db7df00000000001dd6eb0000000000000000],
["lorien_lord","Lady_Galadriel","Lady",tf_hero| tf_randomize_face| tf_female| tfg_armor| tfg_helm| tfg_gloves| tfg_boots,0,0,fac_lorien,
   [itm_galadriel,itm_empty_head,itm_empty_legs,itm_empty_hands,],
      attr_tier_7,wp(20),knows_common|knows_surgery_9,0x0000000e3b004000365b6db99b6db7df00000000001dd6eb0000000000000000],
["imladris_lord","Lord_Elrond","Lord",tf_hero| tf_imladris| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_imladris,
   [itm_mearas_reward,itm_riv_armor_reward,itm_riv_boots,itm_leather_gloves_reward,itm_riv_tiara,itm_riv_riding_sword,itm_riv_shield_b,itm_riv_spear],
      attr_elf_tier_6,wp_elf_tier_6,knight_skills_3|knows_riding_5|knows_persuasion_5|knows_trainer_5|knows_surgery_9,0x0000000bff002001379b74b75346d08d00000000001d969b0000000000000000],
["woodelf_lord","King_Thranduil","King",tf_hero| tf_woodelf| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_woodelf,
   [itm_mirkwood_heavy_scale_cloak,itm_mirkwood_boots,itm_evil_gauntlets_a,itm_riv_tiara,itm_mirkwood_bow,itm_woodelf_arrows,itm_mirkwood_great_spear,],
      attr_elf_tier_6,wp_elf_tier_6,knight_skills_5|knows_persuasion_7|knows_trainer_5|knows_surgery_9,0x0000000c00003002189d6e454c6465a500000000001c68f20000000000000000],
["moria_lord","Master_Bolg_the_Lesser","Master",tf_hero| tf_uruk| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_moria,
   [itm_warg_reward,itm_m_uruk_heavy_c,itm_uruk_helm_e,itm_uruk_chain_greaves,itm_evil_gauntlets_a,itm_orc_javelin,itm_orc_bastard_scimitar,],
      attr_tier_7,wp_tier_6,knight_skills_5|knows_riding_4|knows_trainer_4|knows_persuasion_3|knows_leadership_10|knows_tactics_8|knows_surgery_9,0x00000000260010010038c51051df5f5800000000000000000000000000000000],
["guldur_lord","Master_Fuinur","Master",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_evil_man,0,0,fac_guldur,
   [itm_mordor_warhorse,itm_m_cap_armor,itm_uruk_chain_greaves,itm_evil_gauntlets_b_good,itm_mordor_cap_helm,itm_mordor_man_shield_b,itm_mordor_longsword,],
      attr_tier_7,wp_tier_6,knight_skills_5|knows_riding_4|knows_trainer_6|knows_surgery_9,0x0000000fcd0005c03586a83d4223b2c200000000001c58e00000000000000000],
["gundabad_lord","Master_Burza Krual","Master",tf_hero| tf_uruk| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_gundabad,
   [itm_warg_reward,itm_gundabad_armor_e,itm_orc_greaves,itm_evil_gauntlets_a,itm_gundabad_helm_e,itm_orc_throwing_axes,itm_orc_slasher,],
      attr_tier_7,wp_tier_6,knight_skills_4|knows_riding_4|knows_trainer_4|knows_persuasion_3|knows_leadership_10|knows_tactics_8|knows_surgery_9,0x0000000026002085003f006fe95aae4000000000000000000000000000000000],
["dale_lord","King_Brand","King",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_dale,
   [itm_dale_warhorse,itm_dale_armor_reward,itm_splinted_greaves_good,itm_evil_gauntlets_b_good,itm_dale_helmet_f,itm_dale_sword_reward,itm_dwarf_shield_c_good,itm_lance,],
      attr_tier_6,wp_tier_6,knight_skills_5|knows_riding_4|knows_trainer_5|knows_surgery_9,0x0000000e3f00018436db75b79b6eb6db00000000001db6eb0000000000000000],
["dwarf_lord","King_Dain_II_Ironfoot","King",tf_hero| tf_dwarf| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_dwarf,
   [itm_dwarf_armor_c,itm_dwarf_scale_boots,(itm_gauntlets_reward,imod_lordly),itm_dwarf_helm_king_NPC,itm_dwarf_throwing_axe,(itm_dwarf_great_axe,imod_rotten)],
      attr_dwarf_tier_6,wp_dwarf_tier_6,knight_skills_5|knows_riding_10|knows_persuasion_3|knows_trainer_4|knows_surgery_9,0x0000000e7f00210133c16e7bb1fffdff00000000001f56f30000000000000000],
["dunland_lord","Chief_Daeglaf_the_Black","Chief",tf_hero| tf_dunland| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_dunland,
   [itm_dunland_chieftain_good,itm_hunter_boots,itm_evil_gauntlets_a,itm_dun_helm_c_good,itm_dun_berserker,itm_dun_shield_b,itm_dunland_javelin,],
      attr_tier_7,wp_tier_6,knight_skills_5|knows_persuasion_5|knows_trainer_6|knows_surgery_9,0x000000003f0051c721dc6c71580f36ff00000000001fd2e80000000000000000],
["beorn_lord","Chief_Grimbeorn_the_Old","Chief",tf_hero| tfg_shield| tfg_armor| tfg_helm|tfg_boots,0,0,fac_beorn,
   [itm_beorn_chief,itm_leather_boots,itm_evil_gauntlets_a,itm_beorn_helmet,itm_beorn_battle_axe,itm_dwarf_throwing_axe,itm_beorn_shield_reward,],
      attr_tier_7,wp_tier_6,knight_skills_5|knows_riding_10|knows_persuasion_5|knows_trainer_4|knows_surgery_9,0x0000000d6a00628918d46a72d946e7ae00000000001eeeb90000000000000000],
 

 # marshalls which are not also leaders
["lorien_marshall","Celeborn","{!}",tf_hero| tf_lorien| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_lorien,
   [itm_mearas_reward,itm_lorien_heavy_good_cloak,itm_lorien_boots,itm_leather_gloves_reward,itm_riv_tiara,itm_lorien_bow,itm_elven_arrows,itm_lorien_sword_a,],
      attr_elf_tier_6,wp_elf_tier_6,knight_skills_4|knows_riding_4|knows_riding_5|knows_persuasion_7|knows_trainer_4|knows_surgery_9,0x00000008120000024b146a491440e12400000000001cc4ad0000000000000000],

# ["gondor_marshall","Gondor Marshall","{!}",tf_hero| tf_gondor| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_gondor,
...
["knight_1_2","Húrin_of_the_Keys","{!}",tf_hero| tf_gondor| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_gondor,
   [itm_gon_tower_knight,itm_gondor_heavy_greaves,itm_mail_mittens,itm_gondor_leader_helm,itm_gondor_citadel_sword,itm_gondor_shield_e,itm_gondor_tower_spear],
      attr_tier_7,wp_tier_6,gondor_skills_4|knows_riding_4|knows_surgery_7,0x00000007f700550919da9135148e24e500000000001db9110000000000000000],
...
["knight_1_5","Duinhir","{!}",tf_hero| tf_gondor| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_gondor,
   [itm_blackroot_leader,itm_gondor_heavy_greaves,itm_mail_mittens,itm_gondor_leader_helm,itm_gondor_ranger_sword,itm_gondor_tower_spear,itm_gondor_bow,itm_gondor_arrows,],
      attr_tier_7,wp_tier_6,gondor_skills_3|knows_horse_archery_7|knows_power_draw_7|knows_surgery_6,0x000000003f0021544b246a471b65572400000000001cc6ed0000000000000000],
["knight_1_6","Hirluin_the_Fair","{!}",tf_hero| tf_gondor| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_gondor,
   [itm_gondor_courser,itm_pinnath_leader,itm_gondor_heavy_greaves,itm_mail_mittens,itm_gondor_leader_helm,itm_gondor_citadel_sword,itm_gon_tab_shield_c,itm_gondor_lance],
      attr_tier_7,wp_tier_6,gondor_skills_4|knows_riding_5|knows_surgery_6,0x000000043a0020944aa46a451261533300000000001ec6af0000000000000000],
["knight_1_7","Faramir","{!}",tf_hero| tf_gondor| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_gondor,
   [itm_gondor_warhorse,itm_gon_leader_surcoat_cloak,itm_gondor_heavy_greaves,itm_mail_mittens,itm_gondor_leader_helm,itm_gondor_citadel_sword,itm_gondor_shield_e,itm_gondor_lance],
      attr_tier_7,wp_tier_6,gondor_skills_5|knows_persuasion_7|knows_surgery_9,0x000000043f00200f49248ac99481d72c00000000001d48de0000000000000000],
["knight_1_8","Forlong_the_Fat","{!}",tf_hero| tf_gondor| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_gondor,
   [itm_gondor_warhorse,itm_lossarnach_leader,itm_lossarnach_greaves,itm_mail_mittens,itm_mordor_helm,itm_loss_axe,itm_gondor_lance,itm_gon_tab_shield_a],
      attr_tier_7,wp_tier_6,gondor_skills_4|knows_riding_4|knows_power_throw_7|knows_surgery_6,0x00000008b70052935b1b8f4ae9ee793e00000000001f4cad0000000000000000],
...
["knight_1_11","Elfhelm","{!}",tf_hero| tf_rohan| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_rohan,
...
#Isengard
["knight_1_15","Ugluk","{!}",tf_hero| tf_uruk |tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_isengard,
   [itm_isen_uruk_heavy_reward,itm_uruk_chain_greaves,itm_evil_gauntlets_b_good,itm_isen_uruk_helm_d,itm_isengard_sword,itm_isen_uruk_shield_b,],
      attr_tier_7,wp_tier_6,knight_skills_5|knows_trainer_3|knows_persuasion_3|knows_surgery_6,0x0000000026000004003da293b938671800000000000000000000000000000000],
["knight_1_16","Mauhur","{!}",tf_hero| tf_uruk |tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_isengard,
   [itm_isen_uruk_heavy_reward,itm_uruk_chain_greaves,itm_evil_gauntlets_b_good,itm_isen_uruk_helm_d,itm_isengard_hammer,itm_isen_uruk_shield_b,],
      attr_tier_7,wp_tier_6,knight_skills_3|knows_persuasion_3|knows_surgery_2,0x0000000026000143003f171a07063a1300000000000000000000000000000000],
["knight_1_17","Mog_the_Seven-fingered","{!}",tf_hero| tf_urukhai |tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_isengard,
   [itm_isen_uruk_heavy_reward,itm_uruk_chain_greaves,itm_evil_gauntlets_b_good,itm_isen_uruk_helm_d,itm_isengard_heavy_sword,itm_isen_uruk_shield_b,],
      attr_tier_7,wp_tier_6,knight_skills_2|knows_persuasion_5|knows_surgery_2,0x0000000740000140003f9f9a3fdad74d00000000000000000000000000000000],
["knight_1_18","Hushnak_Longshanks","{!}",tf_hero| tf_urukhai |tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_isengard,
   [itm_isen_uruk_heavy_reward,itm_uruk_chain_greaves,itm_evil_gauntlets_b_good,itm_isen_uruk_helm_d,itm_isengard_hammer,itm_isen_uruk_shield_b,],
      attr_tier_7,wp_tier_6,knight_skills_3|knows_persuasion_3|knows_trainer_4|knows_surgery_2,0x00000004c400120300384eb95df2446200000000000000000000000000000000],
["knight_1_19","Gridash the Tree-biter","{!}",tf_hero| tf_urukhai |tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_isengard,
   [itm_isen_uruk_heavy_reward,itm_uruk_chain_greaves,itm_evil_gauntlets_b_good,itm_isen_uruk_helm_d,itm_isengard_heavy_axe,itm_isen_uruk_shield_b,],
      attr_tier_7,wp_tier_6,knight_skills_4|knows_persuasion_3|knows_trainer_6|knows_surgery_2,0x00000004fa000046003e72470fba445400000000000000000000000000000000],
["knight_1_20","Gronk the Man-eater","{!}",tf_hero| tf_urukhai |tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_isengard,
   [itm_isen_uruk_heavy_reward,itm_uruk_chain_greaves,itm_evil_gauntlets_b_good,itm_isen_uruk_helm_d,itm_isengard_mallet,itm_isen_uruk_shield_b,],
      attr_tier_7,wp_tier_6,knight_skills_5|knows_persuasion_3|knows_trainer_5|knows_surgery_2,0x00000004f2001185003a4e4b5475450200000000000000000000000000000000],
#Mordor
["knight_2_1","Captain_Mortakh","{!}",tf_hero| tf_evil_man| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_mordor,
   [itm_mordor_warhorse2,itm_m_cap_armor,itm_uruk_chain_greaves,itm_evil_gauntlets_a,itm_mordor_cap_helm,itm_mordor_longsword,itm_mordor_man_shield_b,],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_riding_4|knows_trainer_3|knows_surgery_3,0x0000000cff00150f21c38927434e804f00000000001d24be0000000000000000],
["knight_2_2","Berúthiel","{!}",tf_hero| tf_female| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_mordor,
   [itm_mordor_warhorse2,itm_m_cap_armor,itm_uruk_chain_greaves,itm_evil_gauntlets_a,itm_mordor_cap_helm,itm_mordor_longsword,itm_mordor_man_shield_b,],
      attr_tier_7,wp_tier_6,knight_skills_2|knows_riding_4|knows_persuasion_5|knows_surgery_3,0x0000000ebf0010060df26111c003815400000000001c5e380000000000000000],
["knight_2_3","Skang","{!}",tf_hero| tf_uruk |tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_mordor,
   [itm_m_uruk_heavy_c,itm_uruk_chain_greaves,itm_evil_gauntlets_a,itm_uruk_helm_f,itm_mordor_longsword,itm_mordor_uruk_shield_c,],
      attr_tier_7,wp_tier_6,knight_skills_3|knows_surgery_2,0x000000003f002580204175274345004f00000000001d24380000000000000000],
["knight_2_4","Pharakhâd_The_Bastard","{!}",tf_hero| tf_evil_man| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_mordor,
   [itm_mordor_warhorse2,itm_black_num_armor,itm_uruk_chain_greaves,itm_evil_gauntlets_a,itm_mordor_cap_helm,itm_mordor_longsword,itm_mordor_man_shield_b,],
      attr_tier_7,wp_tier_6,knight_skills_4|knows_riding_4|knows_surgery_2,0x0000000f0d0001143586a83dc22382c600000000001cd8e00000000000000000],
["knight_2_5","Grishnakh","{!}",tf_hero| tf_uruk |tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_mordor,
   [itm_m_uruk_heavy_c,itm_uruk_chain_greaves,itm_evil_gauntlets_a,itm_uruk_helm_f,itm_mordor_longsword,itm_mordor_uruk_shield_c,],
      attr_tier_7,wp_tier_6,knight_skills_5|knows_surgery_1,0x00000000260000870038a005c03c5f7000000000000000000000000000000000],
["knight_2_51","Gothmog","Lieutenant",tf_hero| tf_uruk| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_mordor,
   [itm_m_uruk_heavy_c,itm_uruk_chain_greaves,itm_evil_gauntlets_a,itm_uruk_helm_f,itm_mordor_uruk_shield_c,itm_mordor_longsword,],
      attr_tier_7,wp_tier_6,knight_skills_5|knows_persuasion_5|knows_trainer_4|knows_surgery_4,0x000000002c000104003fb3f407b83d0d00000000000000000000000000000000],
#Harad
["knight_2_6","Chieftain_Karna_the_Lion","{!}",tf_hero| tf_harad| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_harad,
   [itm_harad_lion_scale,itm_harad_scale_greaves,itm_evil_gauntlets_a,itm_lion_helm,itm_harad_khopesh,itm_harad_long_shield_c,],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_riding_4|knows_persuasion_3|knows_trainer_3|knows_surgery_6,0x00000009ff00300b1415a5f77872f7b700000000001d663b0000000000000000],
["knight_2_7","Chieftain_Na’man","{!}",tf_hero| tf_harad| tfg_ranged| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_harad,
[itm_harad_heavy_inf_helm,itm_black_snake_armor,itm_leather_gloves,itm_harad_lamellar_greaves,itm_harad_javelin_big,itm_harad_javelin_big,itm_far_harad_2h_mace,itm_harad_long_spear,(itm_camel, imod_champion)],attr_tier_7,wp_tier_6,knight_skills_2|knows_power_throw_7|knows_riding_7|knows_horse_archery_8|knows_surgery_6,0x000000003f00000f20a8b7f9e87ff1b700000000001c3ab80000000000000000],
["knight_2_8","Chieftain_Haarith","{!}",tf_hero| tf_harad| tf_mounted| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_harad,
   [itm_harad_warhorse,itm_harad_pectoral_lordly,itm_harad_leather_greaves,itm_evil_gauntlets_a,itm_harad_dragon_helm,itm_harad_heavy_sword_good,itm_harad_long_shield_c,itm_nomad_bow,itm_harad_arrows,],
      attr_tier_7,wp_tier_6,knight_skills_2|knows_riding_4|knows_persuasion_3|knows_trainer_4|knows_horse_archery_8|knows_surgery_6,0x000000003f00100421526ff7708d22f700000000001fea200000000000000000],
# ["knight_2_9","harad_captain","{!}",tf_hero,0,reserved,fac_harad,[itm_saddle_horse,itm_rich_outfit,itm_mail_hauberk,itm_leather_boots,itm_mail_boots,itm_mail_mittens,itm_two_handed_axe,itm_shield_heater_c],knight_attrib_4,wp(230),knight_skills_4|knows_riding_4,0x0000000c160451d2136469c4d9b159ad00000000001e28f10000000000000000,vaegir_face_older_2],
# ["knight_2_10","Harad_Lieutenant","{!}",tf_hero,0,reserved,fac_harad,[itm_warhorse,itm_fur_coat,itm_mail_hauberk,itm_leather_boots,itm_mail_boots,itm_mail_mittens,itm_shield_heater_c],knight_attrib_5,wp(260),knight_skills_5|knows_riding_4|knows_trainer_6,0x0000000f7c00520e66b76edd5cd5eb6e00000000001f691e0000000000000000,vaegir_face_older_2],
#Rhun
["knight_2_11","Kusulak","{!}",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_evil_man,0,0,fac_rhun,
   [itm_rhun_horse_g,itm_rhun_armor_k_good,itm_splinted_greaves_good,itm_evil_gauntlets_b_good,itm_rhun_helm_chieftain_good,itm_rhun_greatsword,itm_light_lance,itm_rhun_bull3_shield,],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_riding_7|knows_surgery_8,0x0000000fff0093c213f746f5e363f35b00000000001de22a0000000000000000],
["knight_2_12","Ulwarth the Balchoth","{!}",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_evil_man,0,0,fac_rhun,
   [itm_rhun_horse_e,itm_rhun_armor_p_good,itm_leather_boots_dark,itm_evil_gauntlets_a,itm_rhun_helm_barbed_good,itm_arrows,itm_rhun_bow,itm_rhun_sword,itm_rhun_bull1_shield,],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_power_draw_5|knows_riding_7|knows_horse_archery_6|knows_surgery_8,0x0000000e8000410b145546b3695b677b00000000001ee6aa0000000000000000],
["knight_2_13","Brodda","{!}",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_evil_man,0,0,fac_rhun,
   [itm_rhun_horse_f,itm_rhun_armor_k_good,itm_splinted_greaves_good,itm_evil_gauntlets_b,itm_rhun_helm_chieftain,itm_rhun_greataxe,itm_rhun_sword,itm_rhun_bull3_shield,],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_riding_6|knows_surgery_8,0x0000000c1b007303201c6fd3a36f3ff300000000001d66e80000000000000000],
#Khand
["knight_2_16","Torask","{!}",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_evil_man,0,0,fac_khand,
   [itm_khand_inf_helm_d_good,itm_khand_noble_lam_bad,itm_splinted_greaves_good,itm_evil_gauntlets_a_good,itm_khand_2h_tulwar,itm_khand_trident,itm_javelin, itm_javelin,],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_athletics_4|knows_power_throw_6|knows_surgery_5,0x0000000ac800d5400bf7d3f5fb9179ff00000000001f62fc0000000000000000],
["knight_2_17","Lurmsakun","{!}",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_evil_man,0,0,fac_khand,
   [itm_variag_kataphrakt,itm_khand_cav_helm_c,itm_khand_noble_lam,itm_splinted_greaves_good,itm_evil_gauntlets_b_good,itm_khand_lance,itm_khand_rammace,itm_easterling_round_horseman],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_riding_6|knows_horse_archery_3|knows_surgery_5,0x0000000d3f00c40812065fd328ff7bfc00000000001ce6b80000000000000000],
#Umbar
["knight_3_1","Captain_Morbir","{!}",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_umbar,
   [itm_umb_armor_f_good,itm_corsair_boots,itm_leather_gloves_good,itm_umb_helm_b_good,itm_corsair_bow,itm_corsair_arrows,itm_kraken,],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_trainer_3|knows_power_draw_4|knows_surgery_5,0x0000000eb10063c8365369b99b6f77df00000000001d5aeb0000000000000000],
["knight_3_2","Captain_Angamaitë","{!}",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_umbar,
   [itm_umb_armor_f,itm_splinted_greaves,itm_evil_gauntlets_a,itm_umb_helm_a_good,itm_corsair_harpoon,itm_corsair_harpoon,itm_umbar_cutlass,itm_umb_shield_c,],
      attr_tier_7,wp_tier_6,knight_skills_2|knows_power_throw_7|knows_surgery_3,0x000000093f0035c5300251e9b3e041df00000000001cfaeb0000000000000000],
["knight_3_3","Captain_Sangahyando","{!}",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_umbar,
   [itm_umb_armor_e_good,itm_corsair_boots,itm_leather_gloves_reward,itm_umb_helm_a,itm_corsair_bow,itm_corsair_arrows,itm_umbar_pike,],
      attr_tier_7,wp_tier_6,knight_skills_2|knows_power_draw_6|knows_surgery_5,0x000000093f004045300251e9b3e2f7df00000000001dbaab0000000000000000],
#Lothlorien
["knight_3_6","Haldir","{!}",tf_hero| tf_lorien| tf_mounted| tfg_ranged |tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_lorien,
   [itm_lorien_heavy_good_cloak,itm_riv_tiara,itm_lorien_boots,itm_leather_gloves_reward,itm_lorien_bow,itm_elven_arrows,itm_lorien_sword_c,],
      attr_elf_tier_6,wp_elf_tier_6,knight_skills_1|knows_persuasion_7|knows_power_draw_4|knows_surgery_8,0x00000006470010023b1d6e351240e36d00000000001cd8ec0000000000000000],
["knight_3_7","Orophin","{!}",tf_hero| tf_lorien| tf_mounted| tfg_ranged |tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_lorien,
   [itm_lorien_heavy_good_cloak,itm_hood_grey_good,itm_lorien_boots,itm_leather_gloves,itm_lorien_bow,itm_elven_arrows,itm_lorien_sword_a,itm_lorien_round_shield],
      attr_elf_tier_6,wp_elf_tier_6,knight_skills_1|knows_power_draw_4|knows_persuasion_7|knows_surgery_8,0x00000006470010023b1d6e351240e36d00000000001cd8ec0000000000000000],
#Imladris
["knight_3_11","Elladan","{!}",tf_hero| tf_imladris| tf_mounted| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_imladris,
   [itm_mearas_reward,itm_riv_tiara,itm_riv_armor_leader,itm_riv_boots,itm_leather_gloves_reward,itm_lorien_bow_reward,itm_elven_arrows,itm_riv_archer_sword,itm_riv_shield_b],
      attr_elf_tier_6,wp_elf_tier_6,knight_skills_1|knows_riding_5|knows_persuasion_5|knows_power_draw_4|knows_horse_archery_6|knows_surgery_8,0x000000067f0030021ae66e471560632400000000001c58f20000000000000000],
["knight_3_12","Elrohir","{!}",tf_hero| tf_imladris| tf_mounted| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_imladris,
   [itm_mearas_reward,itm_riv_tiara,itm_riv_armor_leader,itm_riv_boots,itm_leather_gloves_good,itm_lorien_bow_reward,itm_elven_arrows,itm_riv_bas_sword,],
      attr_elf_tier_6,wp_elf_tier_6,knight_skills_1|knows_riding_5|knows_persuasion_5|knows_power_draw_4|knows_horse_archery_6|knows_surgery_8,0x00000003fa0030063d256e471644555c00000000001ce8720000000000000000],
["knight_3_13","Halbarad","{!}",tf_hero| tf_dunedain| tf_mounted| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_imladris,
   [itm_arnor_greaves,itm_mail_mittens,itm_lance,itm_arnor_heavy_good_cloak,itm_arnor_sword_c,itm_arnor_shield_c,itm_arnor_helm_c_good,itm_dunedain_warhorse_heavy,],
      attr_elf_tier_6,wp_elf_tier_6,knight_skills_1|knows_riding_5|knows_persuasion_7|knows_power_draw_4|knows_surgery_8,0x00000008a400224736db6db75b6db6db00000000001db6db0000000000000000],
#Woodelves
["knight_3_16","Miriel","{!}",tf_hero| tf_female| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_woodelf,
   [itm_riv_tiara,itm_mirkwood_mail_good,itm_mirkwood_boots,itm_evil_gauntlets_a,itm_mirkwood_helm_d,itm_mirkwood_bow,itm_woodelf_arrows,itm_mirkwood_axe,itm_mirkwood_spear_shield_c,],
      attr_elf_tier_6,wp_elf_tier_6,knight_skills_2|knows_persuasion_7|knows_power_draw_6|knows_surgery_8,0x0000000fc000400c055d7066cb87e08300000000001d44c30000000000000000],
["knight_3_17","Gladvaethor","{!}",tf_hero| tf_woodelf| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_woodelf,
   [itm_riv_tiara,itm_mirkwood_mail_good,itm_mirkwood_boots,itm_leather_gloves_good,itm_mirkwood_helm_d_good,itm_mirkwood_bow,itm_woodelf_arrows,itm_mirkwood_spear_shield_c,itm_mirkwood_war_spear],
      attr_elf_tier_6,wp_elf_tier_6,knight_skills_2|knows_persuasion_7|knows_power_draw_6|knows_surgery_8,0x0000000fc00030023fc36db75b6ab6db00000000001d36db0000000000000000],
#Moria
["knight_4_1","Whip_Snog","{!}",tf_hero| tf_orc| tf_mounted| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_moria,
   [itm_wargarmored_3a,itm_moria_armor_e,itm_orc_beakhelm_lordly,itm_orc_greaves,itm_evil_gauntlets_a,itm_orc_throwing_axes,itm_orc_slasher,],
      attr_tier_7,wp_orc_tier_6,knight_skills_1|knows_riding_4|knows_persuasion_3|knows_leadership_10|knows_tactics_8|knows_surgery_4,0x0000000fff00100936db6db6db6db6db00000000001db6db0000000000000000],
["knight_4_2","Whip_Snotgor","{!}",tf_hero| tf_orc| tf_mounted| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_moria,
   [itm_wargarmored_3a,itm_moria_armor_e,itm_orc_bughelm_lordly,itm_orc_greaves,itm_evil_gauntlets_a,itm_orc_javelin,itm_orc_slasher,],
      attr_tier_7,wp_orc_tier_6,knight_skills_1|knows_riding_4|knows_leadership_10|knows_persuasion_3|knows_tactics_8|knows_surgery_4,0x000000087f00000e36db6db6db6db6db00000000001db6db0000000000000000],
#Dol Guldur
["knight_4_6","General_Tuskim","{!}",tf_hero| tf_uruk |tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_guldur,
   [itm_m_uruk_heavy_c,itm_uruk_chain_greaves,itm_uruk_chain_greaves,itm_evil_gauntlets_a,itm_uruk_helm_f,itm_mordor_uruk_shield_c,itm_mordor_longsword,],
      attr_tier_7,wp_tier_6,knight_skills_2|knows_trainer_4|knows_leadership_10|knows_surgery_7,0x000000018000210700389ff43fdbff4500000000000000000000000000000000],
["knight_4_7","General_Mugslag","{!}",tf_hero| tf_uruk |tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_guldur,
   [itm_m_uruk_heavy_c,itm_uruk_chain_greaves,itm_uruk_chain_greaves,itm_evil_gauntlets_a,itm_uruk_helm_f,itm_mordor_uruk_shield_c,itm_mordor_longsword,],
      attr_tier_7,wp_tier_6,knight_skills_2|knows_trainer_4|knows_persuasion_3|knows_leadership_10|knows_surgery_7,0x00000001800011c4003f1c65b8cdb6db00000000000000000000000000000000],
#Northmen
["knight_4_11","Ruel","{!}",tf_hero| tf_female| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_beorn,
   [itm_woodmen_heavy_cloak,itm_hood_leather,itm_hunter_boots,itm_evil_gauntlets_a,itm_2_handed_axe,itm_elven_bow,itm_arrows,],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_persuasion_6|knows_surgery_7,0x0000000d3f002001134a4a52a34a474b00000000001db6da0000000000000000],
["knight_4_12","Beranor_Blackfur","{!}",tf_hero |tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_beorn,
   [itm_beorn_chief,itm_furry_boots,itm_leather_gloves,itm_beorn_helmet,itm_beorn_shield_reward,itm_rohirrim_throwing_axe,itm_rohirrim_throwing_axe,itm_beorn_axe_reward,],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_persuasion_6|knows_surgery_7,0x0000000bbf0052894dd95757a55accff00000000001d29190000000000000000],
#Mt. Gundabad
["knight_4_16","Whip_Brolgukhsh","{!}",tf_hero| tf_orc| tf_mounted| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_gundabad,
   [itm_warg_reward,itm_gundabad_armor_e,itm_orc_greaves,itm_orc_ragwrap,itm_evil_gauntlets_a,itm_gundabad_helm_e,itm_orc_throwing_axes,itm_orc_slasher,],
      attr_tier_7,wp_orc_tier_6,knight_skills_1|knows_riding_4|knows_leadership_10|knows_persuasion_3|knows_tactics_8|knows_surgery_3,0x0000000fc000000536db6db6db6db6db00000000001db6db0000000000000000],
["knight_4_17","Whip_Grumrunt","{!}",tf_hero| tf_orc| tf_mounted| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_gundabad,
   [itm_wargarmored_3a,itm_gundabad_armor_e,itm_orc_greaves,itm_orc_ragwrap,itm_evil_gauntlets_a,itm_gundabad_helm_e,itm_orc_throwing_axes,itm_orc_slasher,],
      attr_tier_7,wp_orc_tier_6,knight_skills_1|knows_riding_4|knows_leadership_10|knows_persuasion_3|knows_tactics_8|knows_surgery_3,0x00000009bf00000736db6db6db6db6db00000000001db6db0000000000000000],
["knight_4_18","Whip_Grimsob","{!}",tf_hero| tf_orc| tf_mounted| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_gundabad,
   [itm_wargarmored_3a,itm_gundabad_armor_e,itm_orc_greaves,itm_orc_ragwrap,itm_evil_gauntlets_a,itm_gundabad_helm_e,itm_orc_throwing_axes,itm_orc_slasher,],
      attr_tier_7,wp_orc_tier_6,knight_skills_1|knows_riding_4|knows_leadership_10|knows_persuasion_3|knows_tactics_8|knows_surgery_3,0x000000083f00200a36db6db6db6db6db00000000001db6db0000000000000000],
#Dale
["knight_5_1","Lord_Halward","{!}",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_dale,
   [itm_dale_warhorse,itm_dale_heavy_c_good,itm_splinted_greaves_good,itm_leather_gloves,itm_north_nasal_helm_good,itm_dale_sword_long,itm_beorn_shield,itm_javelin, itm_javelin],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_riding_4|knows_trainer_3|knows_horse_archery_5|knows_power_throw_6|knows_surgery_5,0x00000005e30024852ad48e24d660d52d00000000001d46ab0000000000000000],
["knight_5_2","Lord_Bard","{!}",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_dale,
   [itm_dale_armor_reward,itm_splinted_greaves_good,itm_leather_gloves_reward,itm_dale_helmet_e,itm_dale_sword_long,itm_dale_shield_c,itm_dale_bow,itm_black_arrows_reward],
      attr_tier_7,wp_tier_6,knight_skills_2|knows_power_draw_7|knows_trainer_3|knows_surgery_7,0x000000063f00004336db75b7ab6eb6b400000000001db6eb0000000000000000],
["knight_5_3","Lord_Esgarain","{!}",tf_hero| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_dale,
   [itm_dale_heavy_b_pelt,itm_splinted_greaves_good,itm_mail_mittens,itm_dale_helmet_c_good,itm_dale_sword_long,itm_dale_shield_b,],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_trainer_3|knows_shield_7|knows_surgery_5,0x00000008ef00008436db76b7ab6ef6b400000000001d26eb0000000000000000],
#Dwarven
["knight_5_6","Fulgni_Longbeard","{!}",tf_hero| tf_dwarf| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_dwarf,
   [itm_dwarf_armor_b_lordly,itm_dwarf_scale_boots,itm_mail_mittens,itm_dwarf_helm_king_NPC,itm_dwarf_throwing_axe,itm_dwarf_great_axe,],
      attr_dwarf_tier_6,wp_dwarf_tier_6,knows_riding_10|knows_persuasion_3|knight_skills_1|knows_riding_4|knows_surgery_8,0x00000001b000014258e46ec7d780e9fe00000000001ce4710000000000000000],
["knight_5_7","Thorin_Stonehelm","{!}",tf_hero| tf_dwarf| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_dwarf,
...
#Dunland
["knight_5_11","Chief_Fudreim","{!}",tf_hero| tf_dunland| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_dunland,
...
["knight_5_12","Chief_Wulf","{!}",tf_hero| tf_dunland| tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_dunland,
   [itm_dunland_chieftain,itm_hunter_boots,itm_fur_gloves_reward,itm_dun_helm_a,itm_dun_berserker,itm_dun_shield_b,itm_dunland_javelin,],
      attr_tier_7,wp_tier_6,knight_skills_1|knows_persuasion_5|knows_surgery_8,0x0000000e3b00324305f858f1606bbfff00000000001f7ce80000000000000000],

## Kham - New Gondor Lord
["knight_6_1","Dervorin","{!}",tf_hero| tf_gondor| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_gondor,
   [itm_lamedon_leader_surcoat_cloak,itm_loss_war_axe,itm_gondor_heavy_greaves,itm_gon_tab_shield_c,itm_mail_mittens,itm_gondor_infantry_helm_bad,itm_loss_throwing_axes],
      attr_tier_5,wp_tier_5,gondor_skills_2|knows_power_throw_5|knows_persuasion_5|knows_shield_9|knows_surgery_6,0x0000000340003004250c85a90f6868f500000000001ed96a0000000000000000],
...
["smith_dunland","Dorrowuld_Ironpike","smithy",tf_hero| tf_dunland| tf_is_merchant,0,0,fac_dunland,
   [itm_dunland_mail_2,itm_dunland_wolfboots,],
      def_attrib|level(2),wp(20),knows_inventory_management_10|knows_leadership_4|knows_power_strike_4|knows_persuasion_2|knows_horse_archery_2|knows_shield_4|knows_power_draw_2|knows_power_throw_2|knows_trade_4|knows_tactics_6|knows_ironflesh_6|knows_athletics_4|knows_looting_2,0x0000000cbf00624636db6db71b6db6db00000000001ec2db0000000000000000],
["smith_harad","Har_Steelbender","smithy",tf_hero| tf_randomize_face| tf_is_merchant| tf_harad,0,0,fac_harad,
   [itm_harad_padded,itm_harad_scale_greaves,],
      def_attrib|level(5),wp(20),knows_inventory_management_10|knows_leadership_4|knows_power_strike_4|knows_persuasion_2|knows_horse_archery_2|knows_shield_4|knows_power_draw_2|knows_power_throw_2|knows_trade_4|knows_tactics_6|knows_ironflesh_6|knows_athletics_4|knows_looting_2,mercenary_face_1,mercenary_face_2],
["smith_khand","Pushurt_The_Haggler","smithy",tf_hero| tf_is_merchant| tf_evil_man,0,0,fac_khand,
   [itm_khand_light_lam,itm_splinted_greaves_good,],
      def_attrib|level(5),wp(20),knows_inventory_management_10|knows_leadership_4|knows_power_strike_4|knows_persuasion_2|knows_horse_archery_2|knows_shield_4|knows_power_draw_2|knows_power_throw_2|knows_trade_4|knows_tactics_6|knows_ironflesh_6|knows_athletics_4|knows_looting_2,0x0000000fff00d45213f7e6f1636172fb00000000001dc22a0000000000000000],
...
["smith_imladris","Duifirian","elven_weaponmakers",tf_hero| tf_randomize_face| tf_is_merchant| tf_imladris,0,0,fac_imladris,
   [itm_riv_armor_light,itm_leather_boots,],
      def_attrib|level(5),wp(20),knows_inventory_management_10|knows_leadership_4|knows_power_strike_4|knows_persuasion_2|knows_horse_archery_2|knows_shield_4|knows_power_draw_2|knows_power_throw_2|knows_trade_4|knows_tactics_6|knows_ironflesh_6|knows_athletics_4|knows_looting_2,rivendell_elf_face_1,rivendell_elf_face_2],
...
["smith_gundabad_nw","Blurg_Snowseller","smithy",tf_hero| tf_randomize_face| tf_is_merchant| tf_orc,0,0,fac_gundabad,
   [itm_gundabad_armor_c,itm_orc_furboots,],
      def_attrib|level(5),wp(20),knows_inventory_management_10|knows_leadership_2|knows_power_strike_2|knows_persuasion_2|knows_horse_archery_2|knows_shield_4|knows_power_draw_2|knows_power_throw_2|knows_trade_4|knows_tactics_4|knows_ironflesh_4|knows_athletics_2|knows_looting_1,mercenary_face_1,mercenary_face_2],
["smith_moria_s","Burgak_Forger","smithy",tf_hero| tf_randomize_face| tf_is_merchant| tf_orc,0,0,fac_moria,
   [itm_moria_armor_b,itm_orc_greaves,],
      def_attrib|level(5),wp(20),knows_inventory_management_10|knows_leadership_2|knows_power_strike_2|knows_persuasion_2|knows_horse_archery_2|knows_shield_4|knows_power_draw_2|knows_power_throw_2|knows_trade_4|knows_tactics_4|knows_ironflesh_4|knows_athletics_2|knows_looting_1,mercenary_face_1,mercenary_face_2],
...
["merchant_moria_s","Supply_Master","camp_stash",tf_hero| tf_randomize_face| tf_is_merchant| tf_orc,0,0,fac_moria,
...
["merchant_khand","Khand_Stash_Master","camp_stash",tf_hero| tf_is_merchant| tf_evil_man,0,0,fac_khand,
   [itm_khand_foot_lam_bad,itm_splinted_greaves_good,],
...
["merchant_imladris","Supply_Master","camp_supplies",tf_hero| tf_is_merchant,0,0,fac_imladris,
   [itm_arnor_light_b,itm_arnor_greaves,],
...
["elder_harad","Harad_Camp_chief","the_camp",tf_hero| tf_randomize_face| tf_harad,0,0,fac_harad,
   [itm_harad_padded,itm_harad_scale_greaves,],
      def_attrib|level(2),wp(20),knows_common,mercenary_face_1,mercenary_face_2],
["elder_rhun","Rhun_High_Priest","the_camp",tf_hero| tf_randomize_face,0,0,fac_rhun,
   [itm_leather_boots_dark_bad,(itm_rohan_armor_th, imod_old),itm_rhun_helm_chieftain_good],
...
["elder_gunda_nw","Orc_Elder","the_camp",tf_hero| tf_randomize_face| tf_orc,0,0,fac_gundabad,
   [itm_gundabad_armor_d,itm_orc_furboots,],
      def_attrib|level(2),wp(20),knows_common,khand_man1,khand_man2],
["elder_moria_s","Orc_Camp_Chief","the_camp",tf_hero| tf_randomize_face| tf_orc,0,0,fac_moria,
   [itm_moria_armor_c,itm_orc_ragwrap,],
      def_attrib|level(2),wp(20),knows_common,khand_man1,khand_man2],
...
["fugitive_man","Suspicious_Man","{!}Suspicious_Men",tfg_boots| tfg_armor,0,0,fac_commoners,
   [itm_leather_jerkin, itm_evil_light_armor, itm_leather_boots, itm_leather_boots_dark, itm_rhun_shortsword,itm_corsair_throwing_dagger,itm_hood_black, itm_hood_grey_bad],
...
["fugitive_dwarf","Suspicious_Dwarf","{!}Suspicious_Dwarves",tf_dwarf| tfg_boots| tfg_armor,0,0,fac_commoners,
   [itm_leather_dwarf_armor,itm_dwarf_pad_boots,itm_dwarf_sword_a,itm_dwarf_throwing_axe,itm_dwarf_hood],
...
["spy","Shifty-eyed_Corsair","{!}Shifty-eyed_Corsairs",tf_mounted| tfg_boots| tfg_armor| tfg_gloves| tfg_horse,0,0,fac_neutral,
   [itm_umb_armor_d,itm_umb_armor_c,itm_corsair_boots,itm_umb_shield_b,itm_umb_shield_a,itm_umbar_cutlass,itm_umbar_rapier,itm_steppe_horse,],
...
["easter_egg_troll","The Troll","{!}",tf_troll| tfg_helm| tfg_boots| tfg_armor| tfg_gloves| tf_no_capture_alive| tf_hero,scn_troll_cave_center|entry(8),0,fac_moria,
...
["treebeard","Treebeard","{!}",tf_troll| tfg_helm| tfg_boots| tfg_armor| tfg_gloves| tf_no_capture_alive| tf_hero,scn_fangorn|entry(16),0,fac_commoners,
   [itm_tree_trunk_invis,itm_ent_body,itm_ent_hands,itm_ent_feet_boots,itm_ent_head,itm_ent_water,],
      str_255| agi_3| int_30| cha_30|level(30),wp(200),knows_power_strike_10|knows_ironflesh_10|knows_tactics_9,troll_face1,troll_face2],
["ent_1","Bregalad","{!}",tf_troll| tfg_helm| tfg_boots| tfg_armor| tfg_gloves| tf_no_capture_alive| tf_hero,scn_fangorn|entry(17),0,fac_commoners,
...
["ent_2","Finglas","{!}",tf_troll| tfg_helm| tfg_boots| tfg_armor| tfg_gloves| tf_no_capture_alive| tf_hero,scn_fangorn|entry(18),0,fac_commoners,
   [itm_tree_trunk_invis,itm_ent_body,itm_ent_hands,itm_ent_feet_boots,itm_ent_head_3,itm_ent_water,],
      str_255| agi_3| int_30| cha_30|level(30),wp(200),knows_power_strike_10|knows_ironflesh_10,troll_face1,troll_face2],
["ent_3","Fladrif","{!}",tf_troll| tfg_helm| tfg_boots| tfg_armor| tfg_gloves| tf_no_capture_alive| tf_hero,scn_fangorn|entry(19),0,fac_commoners,
   [itm_tree_trunk_invis,itm_ent_body,itm_ent_hands,itm_ent_feet_boots,itm_ent_head_2,itm_ent_water,],
      str_255| agi_3| int_30| cha_30|level(30),wp(200),knows_power_strike_10|knows_ironflesh_10,troll_face1,troll_face2],
...
# GA scene stub NPCs
["barman","Barman","{!}",tf_hero| tf_randomize_face,0,0,fac_neutral,
   [itm_leather_jerkin,itm_leather_boots,],
      def_attrib|level(2),wp(20),knows_common,mercenary_face_1,mercenary_face_2],
["elder","Center_Elder","{!}",tf_hero| tf_randomize_face,0,0,fac_neutral,
   [itm_leather_jerkin,itm_leather_boots,],
      def_attrib|level(2),wp(20),knows_common,mercenary_face_1,mercenary_face_2],
["gear_merchant","Gear_Merchant","{!}",tf_hero| tf_randomize_face,0,0,fac_neutral,
   [itm_leather_jerkin,itm_leather_boots,],
      def_attrib|level(2),wp(20),knows_common,mercenary_face_1,mercenary_face_2],
["goods_merchant","Goods_Merchant","{!}",tf_hero| tf_randomize_face,0,0,fac_neutral,
   [itm_leather_jerkin,itm_leather_boots,],
      def_attrib|level(2),wp(20),knows_common,mercenary_face_1,mercenary_face_2],
...
# ["brigand_arena_master","Tournament_Master","{!}",tf_hero| tf_randomize_face,scn_zendar_arena|entry(52),0,fac_commoners,
   # [itm_leather_jerkin,itm_leather_boots,],
      # def_attrib|level(2),wp(20),knows_common,mercenary_face_1,mercenary_face_2],
# ["gondor_arena_master","Tournament_Master","{!}",tf_hero| tf_randomize_face,scn_gondor_arena|entry(52),0,fac_commoners,
   # [itm_leather_jerkin,itm_leather_boots,],
      # def_attrib|level(2),wp(20),knows_common,mercenary_face_1,mercenary_face_2],
# ["rohan_arena_master","Tournament_Master","{!}",tf_hero| tf_randomize_face,scn_rohan_arena|entry(52),0,fac_commoners,
   # [itm_leather_jerkin,itm_leather_boots,],
      # def_attrib|level(2),wp(20),knows_common,mercenary_face_1,mercenary_face_2],
# ["mordor_arena_master","Pit_Master","{!}",tf_hero| tf_randomize_face,scn_mordor_arena|entry(52),0,fac_commoners,
   # [itm_leather_jerkin,itm_leather_boots,],
      # def_attrib|level(2),wp(20),knows_common,mercenary_face_1,mercenary_face_2],
# ["elf_arena_master","Tournament_Master","{!}",tf_hero| tf_randomize_face,scn_elf_arena|entry(52),0,fac_commoners,
   # [itm_leather_jerkin,itm_leather_boots,],
      # def_attrib|level(2),wp(20),knows_common,mercenary_face_1,mercenary_face_2],
#Kolba additions
#["androg","Androg","{!}",tf_hero,scn_zendar_center|entry(7),0,fac_commoners,
#   [itm_leather_jerkin,itm_leather_boots,],
#      def_attrib|level(2),wp(20),knows_common,mercenary_face_1,mercenary_face_2],
...
["no_troop","{!}","the place",tf_hero,0,0,fac_commoners,[],0,0,0,0,0],
["skill2item_type","{!}","{!}",tf_hero,0,0,fac_commoners,[],0,0,0,0,0], # array for working with merchant skills as indicator of quantity of items in shop
["traits","{!}","{!}",tf_hero,0,0,fac_commoners,[],0,0,0,0,0], # array of traits (0/1)
#Player history array
["log_array_entry_type","{!}","{!}",0,0,0,fac_commoners,   [],      0,0,0,0],
["log_array_entry_time","{!}","{!}",0,0,0,fac_commoners,   [],      0,0,0,0],
["log_array_actor","{!}","{!}",0,0,0,fac_commoners,   [],      0,0,0,0],
["log_array_center_object","{!}","{!}",0,0,0,fac_commoners,   [],      0,0,0,0],
["log_array_center_object_lord","{!}","{!}",0,0,0,fac_commoners,   [],      0,0,0,0],
["log_array_center_object_faction","{!}","{!}",0,0,0,fac_commoners,   [],      0,0,0,0],
["log_array_troop_object","{!}","{!}",0,0,0,fac_commoners,   [],      0,0,0,0],
["log_array_troop_object_faction","{!}","{!}",0,0,0,fac_commoners,   [],      0,0,0,0],
...
["orc_sentry","Orc_Sentry","{!}orc_sentry",tf_orc| tfg_shield| tfg_armor| tfg_boots| tf_no_capture_alive,0,0,fac_mordor,
   [itm_mordor_orc_shield_d,itm_orc_skullcap,itm_orc_ragwrap,itm_orc_slasher,],
...
["black_numenorean_sorcerer","Black_Numenorean_Sorcerer","{!}Black_numenorean_sorcerer", tf_evil_man| tfg_armor| tfg_helm| tfg_boots,0,0,fac_mordor,
   [(itm_rohan_armor_th, imod_old),itm_witchking_helmet,itm_mordor_sword,itm_leather_boots_dark,],
...
["bear_strong_old","Bear","Bears", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
...
["spider_old","Mirkwood Spider","Mirkwood Spiders", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_mordor,
...
["bear_old","Bear","Bears", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
...
["wolf_old","Wolf","Wolves", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
...
["start_quest_beorning","Beorning_Carrock_Berserker","Beorning_Carrock_Berserkers",tfg_gloves| tfg_armor| tfg_helm| tfg_boots,0,0,fac_beorn,
   [itm_beorn_berserk,itm_leather_boots,itm_leather_gloves,itm_beorn_helmet,itm_dale_helmet_b,itm_beorn_battle_axe,itm_dale_sword_long,itm_marker_berserker,],
...
["black_shield_bandit","Amath_Dollen's_Bandit","Amath_Dollen's_Bandits",tf_evil_man| tf_randomize_face| tfg_shield| tfg_armor| tfg_boots,0,0,fac_rhun,
   [itm_furry_boots,itm_leather_gloves,itm_dunland_tunic_1,itm_dunland_tunic_1,itm_dunland_tunic_1,itm_dunland_tunic_1,itm_dunland_tunic_2,itm_dunland_mail_1,itm_dunland_mail_2,itm_orc_throwing_axes,itm_hood_black,itm_lamedon_hood,itm_orc_shield_a,itm_orc_shield_b,itm_wood_club,itm_orc_axe,],
...
["black_shield_scout","Amath_Dollen's_Scout","Amath_Dollen's_Scouts",tf_evil_man| tf_randomize_face|tfg_helm|tfg_armor| tfg_boots|tfg_ranged,0,0,fac_rhun,
   [itm_furry_boots,itm_leather_gloves,itm_dunland_tunic_1,itm_dunland_tunic_1,itm_dunland_tunic_1,itm_dunland_tunic_1,itm_dunland_tunic_2,itm_dunland_mail_1,itm_dunland_mail_2,itm_hood_black,itm_hood_black,itm_gondor_ranger_hood_mask,itm_wood_club,itm_arrows,itm_orc_bow,],
...
["black_shield_guard","Amath_Dollen's_Guard","Amath_Dollen's_Guards",tf_evil_man| tf_randomize_face|tfg_helm| tfg_shield| tfg_armor| tfg_boots,0,0,fac_rhun,
   [itm_furry_boots,itm_leather_gloves,itm_dunland_mail_2,itm_dunland_mail_2,itm_corsair_harpoon,itm_rhun_helm_horde,itm_mordor_uruk_shield_a,itm_rhun_falchion,itm_rhun_sword,itm_rhun_shortsword],
...
["dorwinion_spirit_leader","Spirit","{!}", tf_urukhai|tfg_armor| tfg_boots| tfg_helm|tfg_gloves,0,0,fac_neutral,
  [(itm_dunland_chieftain,imod_old),(itm_leather_gloves,imod_poor),itm_dunland_wolfboots,(itm_empty_head,imod_old), itm_khand_axe_great],
    attr_tier_6,wp(255),knows_common|knows_athletics_6|knows_power_strike_6|knows_ironflesh_6,0,0],

["dorwinion_spirit","Lesser Spirit","{!}", tf_uruk|tfg_armor| tfg_boots| tfg_helm|tfg_gloves,0,0,fac_neutral,
  [(itm_dunland_chieftain,imod_poor),(itm_leather_gloves,imod_poor),itm_dunland_wolfboots,(itm_empty_head,imod_poor), itm_dunnish_war_axe, itm_orc_shield_b, itm_orc_shield_c],
    attr_tier_3,wp_tier_4,knows_common|knows_athletics_6|knows_power_strike_6|knows_ironflesh_6,0,0],

["i6_greenwood_2h_axeman","Greenwood_Axemaster","Greenwood_Axemaster",tf_woodelf| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_woodelf,[itm_mirkwood_helm_d_good,itm_mirkwood_helm_c_good,itm_mirkwood_heavy_scale_cloak,itm_leather_gloves_good,itm_evil_gauntlets_a_good,itm_splinted_greaves,itm_mirkwood_axe,itm_mirkwood_axe_2h,itm_mirkwood_spear_shield_c,itm_marker_hp_shield,itm_marker_scares_horses,itm_marker_scares_wargs,],attr_elf_tier_6,wp_elf_tier_6,knows_common|knows_athletics_8|knows_shield_6|knows_power_strike_7|knows_ironflesh_8,mirkwood_elf_face_1,mirkwood_elf_face_2],
...
## Kham - Dormant Troop
## used for find item cheat, can be moved anywhere
...
["morannon_healer","Okstuk_the_Healer","{!}",tf_hero|tf_orc,scn_morannon_center|entry(13),0,fac_mordor,[itm_moria_armor_b,itm_orc_greaves,itm_orc_skullcap],str_30|agi_5|int_4|cha_4|level(2),wp(20),knows_common,orc_face1],
["minas_tirith_healer","Ioreth","{!}",tf_female|tf_hero,scn_minas_tirith_center|entry(13),0,fac_gondor,[itm_whiterobe,itm_leather_boots],str_30|level(2),wp(20),knows_common,0x0000000fff0030064b3152c34d27231100000000001c986d0000000000000000],
["edoras_healer","Freya_the_Healer","{!}",tf_female|tf_hero,scn_edoras_center|entry(13),0,fac_rohan,[itm_whiterobe,itm_leather_boots],str_30|level(2),wp(20),knows_common,0x00000005070010045a9569a16d724adc00000000001db95a0000000000000000],
["isengard_healer","Nurgal_the_Patcher","{!}",tf_hero|tf_urukhai,scn_isengard_center|entry(13),0,fac_isengard,[itm_leather_gloves,itm_isen_uruk_light_a,itm_leather_boots],str_30|agi_5|int_4|cha_4|level(2),wp(20),knows_common,orc_face1],
["guldur_healer","Mornagar_the_Gramaryer","{!}",tf_hero|tf_evil_man,scn_dol_guldur_center|entry(13),0,fac_guldur,[itm_leather_boots, (itm_rohan_armor_th, imod_old)],str_30|agi_5|int_4|cha_4|level(2),wp(20),knows_common,0x000000047f0024d212014ac90032e05200000000001c84880000000000000000],
["gundabad_healer","Lurgakh_Third_Eye","{!}",tf_orc|tf_hero,scn_gundabad_camp_center|entry(13),0,fac_gundabad,[itm_gundabad_armor_d,itm_orc_furboots],def_attrib|level(2),wp(20),knows_common,0x0000000fc000200b5ff83e35e4f8ed8900000000001f6d470000000000000000],
["mirkwood_healer","Corwiel_the_Soft-Handed","{!}",tf_female|tf_hero,scn_thranduils_halls_center|entry(13),0,fac_woodelf,[itm_mirkwood_leather_good,itm_leather_boots],str_30|level(2),wp(20),knows_common,0x00000004bf00400a5b546a3682a4c2cb00000000001d268a0000000000000000],
...
["hungry_uruk","Hungry_Uruk","{!}BUG",tf_uruk| tfg_shield| tfg_ranged|tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_mordor,
   [itm_uruk_greaves,itm_uruk_chain_greaves,itm_evil_gauntlets_b,itm_orc_throwing_arrow,itm_uruk_bow,itm_orc_hook_arrow,itm_m_uruk_heavy_c,itm_m_uruk_heavy_a,itm_uruk_falchion_a,itm_orc_bastard_scimitar,itm_orc_skull_spear_heavy,itm_mordor_uruk_shield_a,itm_mordor_uruk_shield_b,itm_uruk_helm_b,itm_uruk_helm_c,itm_uruk_helm_d,],
...
["i5_moria_deep_dweller","Deep-Dweller_of_Moria","Deep-Dwellers_of_Moria",tf_orc| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_moria,[itm_orc_bughelm_lordly,itm_orc_bughelm_lordly,itm_uruk_helm_e,itm_uruk_helm_f,itm_moria_armor_e,itm_orc_greaves,itm_orc_mace_heavy,itm_dwarf_war_pick_old,itm_orc_javelin,itm_orc_javelin,itm_moria_orc_shield_b,itm_moria_orc_shield_c],attr_orc_tier_5,wp_orc_tier_5,knows_common|knows_athletics_7|knows_power_strike_6|knows_power_throw_5|knows_ironflesh_7,orc_face5,orc_face4],
["i5_moria_orc_chieftain","Orc_Chieftain_of_Moria","Orc_Chieftains_of_Moria",tf_orc| tfg_armor| tfg_helm| tfg_boots| tfg_shield| tf_no_capture_alive,0,0,fac_moria,[itm_orc_beakhelm_lordly,itm_uruk_helm_c,itm_uruk_helm_d,itm_uruk_helm_f,(itm_moria_armor_e, imod_sturdy),(itm_moria_armor_e, imod_reinforced),(itm_moria_armor_e, imod_lordly),itm_uruk_greaves, itm_orc_greaves,itm_orc_sabre_heavy,itm_orc_scimitar_heavy,itm_orc_skull_spear,itm_orc_simple_spear_heavy, itm_moria_orc_shield_a, (itm_orc_shield_c, imod_reinforced), itm_marker_hp_shield],attr_orc_tier_5,wp_orc_tier_5,knows_common|knows_athletics_5|knows_power_strike_4|knows_ironflesh_10|knows_shield_4,orc_face5,orc_face4],
...
["npc18","Turmbathu","{!}",tf_hero| tf_female | tf_unmoveable_in_party_window,0,0,fac_khand,
   [itm_prisoner_coll_chain, itm_feet_chains, itm_khand_light],
      str_16|agi_15|int_4|cha_3|level(9),wp_one_handed(70)|wp_two_handed(80)|wp_polearm(80)|wp_archery(70)|wp_throwing(90),knows_common|knows_ironflesh_4|knows_power_strike_4|knows_power_throw_4|knows_weapon_master_5|knows_shield_1|knows_athletics_5|knows_looting_3,0x00000008ff00200007e68b1850a756c400000000001f34720000000000000000],

["npc19","Heidrek","{!}",tf_hero| tf_evil_man | tf_unmoveable_in_party_window,0,0,fac_dunland,
   [itm_dunland_fur_1,itm_dunland_wolfboots,itm_dunland_spear,itm_dunland_javelin,],
      str_11|agi_12|int_5|cha_5|level(5),wp_one_handed(60)|wp_two_handed(60)|wp_polearm(60)|wp_archery(60)|wp_throwing(60),knows_common|knows_ironflesh_2|knows_power_strike_1|knows_power_throw_3|knows_weapon_master_2|knows_shield_2|knows_athletics_3|knows_riding_1|knows_looting_2|knows_trainer_1|knows_tracking_2|knows_prisoner_management_1|knows_leadership_2,0x00000006a8001186532b56da62752d6400000000001d5ab20000000000000000],

["npc20","Zigûrphel","{!}",tf_hero| tf_female | tf_unmoveable_in_party_window,0,0,fac_guldur,
   [itm_evil_light_armor,itm_mordor_longsword,(itm_leather_boots, imod_meek),(itm_leather_gloves, imod_meek),],
      str_9|agi_8|int_15|cha_10|level(15),wp_one_handed(90)|wp_two_handed(90)|wp_polearm(90)|wp_archery(70)|wp_throwing(70),knows_common|knows_ironflesh_2|knows_power_strike_3|knows_power_throw_1|knows_weapon_master_2|knows_athletics_2|knows_riding_3|knows_looting_2|knows_trainer_1|knows_spotting_4|knows_wound_treatment_5|knows_surgery_6|knows_first_aid_6|knows_persuasion_2|knows_prisoner_management_2|knows_leadership_1,0x00000005ff001003074372d248664b2700000000001fd6b50000000000000000],

["npc21","Berta","{!}",tf_hero|tf_troll| tf_unmoveable_in_party_window,0,0,fac_gundabad,
    [itm_gunda_troll_head_a, itm_gunda_troll_body_berta,itm_gunda_troll_hands,itm_gunda_troll_feet,itm_giant_bone_cudgel,],
        str_30| agi_30| int_3| cha_3|level(36),wp(120)|wp_one_handed(120),knows_power_strike_9|knows_ironflesh_13|knows_athletics_8|knows_shield_8|knows_leadership_1,troll_face1],

["npc22","{!}Zigûrphel","{!}",tf_hero| tf_female | tf_unmoveable_in_party_window,0,0,fac_no_faction,
   [itm_evil_light_armor,itm_mordor_longsword,(itm_leather_boots, imod_meek),(itm_leather_gloves, imod_meek),],
      str_11|agi_13|int_21|cha_10|level(20),wp_one_handed(100)|wp_two_handed(100)|wp_polearm(100)|wp_archery(100)|wp_throwing(100),knows_athletics_3|knows_power_strike_2|knows_shield_1|knows_ironflesh_3|knows_weapon_master_2|knows_power_throw_2|knows_riding_4|knows_trainer_6|knows_tactics_2|knows_wound_treatment_7|knows_surgery_7|knows_first_aid_7|knows_persuasion_2|knows_prisoner_management_2,0x00000005ff001003074372d248664b2700000000001fd6b50000000000000000],

["npc23","{!}Zigûrphel","{!}",tf_hero| tf_female | tf_unmoveable_in_party_window,0,0,fac_no_faction,
   [itm_evil_light_armor,itm_mordor_longsword,(itm_leather_boots, imod_meek),(itm_leather_gloves, imod_meek),],
      str_11|agi_13|int_21|cha_10|level(20),wp_one_handed(100)|wp_two_handed(100)|wp_polearm(100)|wp_archery(100)|wp_throwing(100),knows_athletics_3|knows_power_strike_2|knows_shield_1|knows_ironflesh_3|knows_weapon_master_2|knows_power_throw_2|knows_riding_4|knows_trainer_6|knows_tactics_2|knows_wound_treatment_7|knows_surgery_7|knows_first_aid_7|knows_persuasion_2|knows_prisoner_management_2,0x00000005ff001003074372d248664b2700000000001fd6b50000000000000000],

["npc24","{!}Zigûrphel","{!}",tf_hero| tf_female | tf_unmoveable_in_party_window,0,0,fac_no_faction,
   [itm_evil_light_armor,itm_mordor_longsword,(itm_leather_boots, imod_meek),(itm_leather_gloves, imod_meek),],
      str_11|agi_13|int_21|cha_10|level(20),wp_one_handed(100)|wp_two_handed(100)|wp_polearm(100)|wp_archery(100)|wp_throwing(100),knows_athletics_3|knows_power_strike_2|knows_shield_1|knows_ironflesh_3|knows_weapon_master_2|knows_power_throw_2|knows_riding_4|knows_trainer_6|knows_tactics_2|knows_wound_treatment_7|knows_surgery_7|knows_first_aid_7|knows_persuasion_2|knows_prisoner_management_2,0x00000005ff001003074372d248664b2700000000001fd6b50000000000000000],

["npc25","{!}Zigûrphel","{!}",tf_hero| tf_female | tf_unmoveable_in_party_window,0,0,fac_no_faction,
   [itm_evil_light_armor,itm_mordor_longsword,(itm_leather_boots, imod_meek),(itm_leather_gloves, imod_meek),],
      str_11|agi_13|int_21|cha_10|level(20),wp_one_handed(100)|wp_two_handed(100)|wp_polearm(100)|wp_archery(100)|wp_throwing(100),knows_athletics_3|knows_power_strike_2|knows_shield_1|knows_ironflesh_3|knows_weapon_master_2|knows_power_throw_2|knows_riding_4|knows_trainer_6|knows_tactics_2|knows_wound_treatment_7|knows_surgery_7|knows_first_aid_7|knows_persuasion_2|knows_prisoner_management_2,0x00000005ff001003074372d248664b2700000000001fd6b50000000000000000],

["npc26","{!}Zigûrphel","{!}",tf_hero| tf_female | tf_unmoveable_in_party_window,0,0,fac_no_faction,
   [itm_evil_light_armor,itm_mordor_longsword,(itm_leather_boots, imod_meek),(itm_leather_gloves, imod_meek),],
      str_11|agi_13|int_21|cha_10|level(20),wp_one_handed(100)|wp_two_handed(100)|wp_polearm(100)|wp_archery(100)|wp_throwing(100),knows_athletics_3|knows_power_strike_2|knows_shield_1|knows_ironflesh_3|knows_weapon_master_2|knows_power_throw_2|knows_riding_4|knows_trainer_6|knows_tactics_2|knows_wound_treatment_7|knows_surgery_7|knows_first_aid_7|knows_persuasion_2|knows_prisoner_management_2,0x00000005ff001003074372d248664b2700000000001fd6b50000000000000000],

["npc27","{!}Zigûrphel","{!}",tf_hero| tf_female | tf_unmoveable_in_party_window,0,0,fac_no_faction,
   [itm_evil_light_armor,itm_mordor_longsword,(itm_leather_boots, imod_meek),(itm_leather_gloves, imod_meek),],
      str_11|agi_13|int_21|cha_10|level(20),wp_one_handed(100)|wp_two_handed(100)|wp_polearm(100)|wp_archery(100)|wp_throwing(100),knows_athletics_3|knows_power_strike_2|knows_shield_1|knows_ironflesh_3|knows_weapon_master_2|knows_power_throw_2|knows_riding_4|knows_trainer_6|knows_tactics_2|knows_wound_treatment_7|knows_surgery_7|knows_first_aid_7|knows_persuasion_2|knows_prisoner_management_2,0x00000005ff001003074372d248664b2700000000001fd6b50000000000000000],
...
# Werewolf
#moved to animal range, but keep this entry around for a while since players may have it their party
["werewolf_old","Werewolf","Werewolves", tf_orc|tf_mounted| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive| tf_unmoveable_in_party_window,0,0,fac_outlaws,
...
["legolas","Legolas","{!}",tf_hero| tf_woodelf| tfg_ranged| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_woodelf,
...
["gimli","Gimli","{!}",tf_hero| tf_dwarf| tfg_shield| tfg_armor| tfg_helm| tfg_boots,0,0,fac_dwarf,
...
["unused_fog_color","{!}BUG","{!}BUG",0,0,0,fac_commoners,[],0,0,0,0], #unused; previously used for storing fog color string in name

## hobbits: two versions: for when you didn't meet them, and for when you did meet them (I wish there was a way to RENAME a Troop. str_set_troop_name FTW)  mtarini

["pippin_notmet","halfling","{!}",tf_hero| tf_mounted| tfg_armor| tfg_helm| tfg_boots,0,0,fac_commoners,
   [itm_empty_head,itm_empty_hands,itm_empty_legs,itm_pippin_outfit],
       attr_tier_7,wp_tier_7,knows_riding_10|knows_athletics_10|knows_power_strike_10|knows_ironflesh_10|knows_pathfinding_10,mercenary_face_2],

["merry_notmet","halfling","{!}",tf_hero| tf_mounted| tfg_armor| tfg_helm| tfg_boots,0,0,fac_commoners,
   [itm_empty_head,itm_empty_hands,itm_empty_legs,itm_merry_outfit],
       attr_tier_7,wp_tier_7,knows_riding_10|knows_athletics_10|knows_power_strike_10|knows_ironflesh_10|knows_pathfinding_10,mercenary_face_2],

["pippin","Pippin","{!}",tf_hero| tf_mounted| tfg_armor| tfg_helm| tfg_boots,0,0,fac_commoners,
   [itm_empty_head,itm_empty_hands,itm_empty_legs,itm_pippin_outfit],
       attr_tier_7,wp_tier_7,knows_riding_10|knows_athletics_10|knows_power_strike_10|knows_ironflesh_10|knows_pathfinding_10,mercenary_face_2],
...
["spider_strong","Great Spider","Great Spiders", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_mordor,
[itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_spider_mount],
str_30| agi_7| int_4| cha_4|level(20),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face7,orc_face2],
...
["bear_strong","Great Bear","Great Bears", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
[itm_bear_strong, itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head,],
str_127|agi_7|int_4|cha_4|level(35),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_10,orc_face7,orc_face2], #0x7D = str_127

["wolf","Wolf","Wolves", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
[itm_wolf, itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head],
str_30| agi_7| int_4| cha_4|level(15),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face7,orc_face2],

["wolf_strong","Huge Wolf","Huge Wolves", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
[itm_wolf_strong, itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_wolf],
str_30| agi_7| int_4| cha_4|level(25),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_5,orc_face7,orc_face2],
...
["werewolf","Werewolf","Werewolves", tf_orc|tf_mounted| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive| tf_unmoveable_in_party_window,0,0,fac_outlaws,
  [itm_warg_ghost_lance,itm_warg_ghost_armour, itm_empty_legs,itm_empty_hands,itm_empty_head,itm_werewolf],
    str_30|agi_7|int_4|cha_4|level(40),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_7,orc_face7,orc_face2], #0x7D = str_127

["boar","Boar","Boars", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
[itm_boar, itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head],
str_30| agi_7| int_4| cha_4|level(15),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_5,orc_face7,orc_face2],

["boar_strong","Great Boar","Great Boars", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
[itm_boar_strong, itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head],
str_30| agi_7| int_4| cha_4|level(20),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_7,orc_face7,orc_face2],

["evil_beast","Evil Beast","Evil Beast", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
[itm_beast, itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head],
str_30| agi_7| int_4| cha_4|level(25),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_5,orc_face7,orc_face2],

["evil_beast_strong","Huge Evil Beast","Huge Evil Beasts", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
[itm_beast_strong, itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head],
str_30| agi_7| int_4| cha_4|level(30),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_6,orc_face7,orc_face2],

["bull","Wild Bull","Wild Kine", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
[itm_kine, itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head],
str_30| agi_7| int_4| cha_4|level(15),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face7,orc_face2],

["bull_strong","Great Bull","Great Kine", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
...
["future_animal_3","Wild Warg","Wild Wargs", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
[itm_warg_wild_1, itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head],
str_30| agi_7| int_4| cha_4|level(15),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face7,orc_face2],

["future_animal_4","Huge Wild Warg","Huge Wild Wargs", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_outlaws,
...
# Named troops that will show up in NPC hosts. These are sort of like companions for lords
# Stub first troop since this will be the value of trp_last in previous saves
["future_unique_0","{!}","{!}",tf_hero| tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_unkillable,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,rohan_face_old_1],

["guthlaf","Guthláf","{!}",tf_hero| tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,0x0000000d0000018236db6db6db6db6db0000000000edb6db0000000000000000],

["damrod","Damrod","{!}",tf_hero| tf_gondor| tfg_ranged| tfg_armor| tfg_helm| tfg_boots,0,subfac_rangers,fac_gondor,[itm_gondor_ranger_hood_mask,(itm_gon_ranger_skirt, imod_lordly),itm_leather_gloves,itm_gondor_light_greaves,itm_ithilien_arrows,itm_ithilien_arrows,itm_gondor_bow,itm_gondor_ranger_sword,],attr_tier_7,wp_tier_7,knows_common|knows_pathfinding_4|knows_athletics_9|knows_shield_9|knows_power_draw_9|knows_power_strike_8|knows_ironflesh_10,0x000000014000018f22dc71b96c8cb6e30000000000fd45330000000000000000],

["duilin","Duilin","{!}",tf_hero| tf_gondor| tfg_ranged| tfg_armor| tfg_helm| tfg_boots,0,subfac_blackroot,fac_gondor,[itm_hood_black,itm_blackroot_leader,itm_leather_gloves_good,itm_gondor_med_greaves,itm_gondor_arrows,itm_gondor_bow,itm_gon_tab_shield_c,itm_gondor_spear,],attr_tier_5,wp_melee(200)|wp_archery(200),knows_common|knows_athletics_7|knows_power_draw_5|knows_power_strike_5|knows_ironflesh_5,0x000000003f0020114b246a471b655b240000000000fcb6ed0000000000000000],

["derufin","Derufin","{!}",tf_hero| tf_gondor| tfg_ranged| tfg_armor| tfg_helm| tfg_boots,0,subfac_blackroot,fac_gondor,[itm_hood_black,itm_blackroot_leader,itm_leather_gloves_good,itm_gondor_med_greaves,itm_gondor_arrows,itm_gondor_bow,itm_gon_tab_shield_c,itm_gondor_spear,],attr_tier_5,wp_melee(200)|wp_archery(200),knows_common|knows_athletics_7|knows_power_draw_5|knows_power_strike_5|knows_ironflesh_5,0x000000003f0020cf4b246a471b655b240000000000fcb69d0000000000000000],

["rumil","Rúmil","{!}",tf_hero| tf_lorien| tf_mounted| tfg_ranged| tfg_shield| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_lorien,[itm_lorien_helm_b_good,itm_lorien_heavy_good_cloak,itm_leather_gloves_good,itm_lorien_boots,(itm_lorien_bow_reward, imod_balanced), itm_elven_arrows,itm_lorien_sword_a,itm_lorien_shield_c,],attr_elf_tier_6,wp_melee(460)|wp_archery(320),knows_common|knows_athletics_9|knows_shield_5|knows_power_draw_6|knows_power_strike_5|knows_ironflesh_5,0x00000006470010043b1d6e351240e36d00000000383cc89c0000000000000000],

["lugdush","Lugdush","{!}",tf_hero| tf_urukhai|tf_mounted| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_isengard,[itm_isen_uruk_helm_a_good,itm_isen_uruk_heavy_b_good, itm_isen_uruk_heavy_c,itm_evil_gauntlets_b, itm_orc_mittens_good,itm_uruk_chain_greaves,itm_isengard_sword,itm_isen_uruk_shield_b,],attr_evil_tier_5,wp_tier_5,knows_common|knows_athletics_3|knows_power_strike_6|knows_ironflesh_6,0x0000000183000045002496bd59551af600000000000000000000000000000000],

["future_unique_2","{!}","{!}",tf_hero| tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_unkillable,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,rohan_face_old_1],

["future_unique_3","{!}","{!}",tf_hero| tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_unkillable,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,rohan_face_old_1],

["future_unique_4","{!}","{!}",tf_hero| tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_unkillable,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,rohan_face_old_1],

["future_unique_5","{!}","{!}",tf_hero| tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_unkillable,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,rohan_face_old_1],

["future_unique_6","{!}","{!}",tf_hero| tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_unkillable,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,rohan_face_old_1],

["future_unique_7","{!}","{!}",tf_hero| tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_unkillable,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,rohan_face_old_1],

["future_unique_8","{!}","{!}",tf_hero| tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_unkillable,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,rohan_face_old_1],

["future_unique_9","{!}","{!}",tf_hero| tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_unkillable,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,rohan_face_old_1],

["future_unique_10","{!}","{!}",tf_hero| tf_rohan| tf_mounted| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tf_unkillable,0,0,fac_rohan,[itm_rohan_inf_helmet_b_lordly,itm_rohan_archer_helmet_c_lordly,itm_rohan_guard_good,itm_mail_mittens,itm_rohirrim_war_greaves,itm_rohan_lance_banner_sun,itm_rohan_lance_banner_horse,itm_rohirrim_long_hafted_axe,itm_rohan_sword_c,itm_rohan_shield_g,itm_thengel_warhorse_heavy,],attr_evil_tier_6,wp_tier_6,knows_common|knows_riding_9|knows_shield_3|knows_power_strike_8|knows_ironflesh_8,rohan_face_old_1],
...
["last_overwrite","{!}BUG","{!}BUG",0,0,0,fac_commoners,[],0,0,0,0],    #the last troop must stay a stub, so that range calls for all troops include the last but one troop.

 ] + (is_a_wb_troop==1 and [
#new bandits
["looter","Looter","Looters",tfg_armor,0,0,fac_outlaws,[itm_hood_black_bad,itm_hood_grey_bad,itm_dun_helm_b_bad, itm_leather_cap, itm_peasant_man_a_wb,  itm_leather_jerkin_wb, itm_dunland_tunic_1_bad, itm_dunland_tunic_2_bad, itm_pelt_coat, itm_leather_boots_dark_bad,itm_rohan_shoes_bad,itm_furry_boots,itm_wood_club, itm_twohand_wood_club, itm_orc_slasher, itm_orc_axe,],attr_evil_tier_1,wp_tier_1,knows_common|knows_athletics_1|knows_power_strike_1|knows_ironflesh_1,dunland_face1,dunland_face2],
["brigand","Brigand","Brigands",tf_evil_man| tfg_armor| tfg_boots,0,0,fac_outlaws,[itm_hood_black, itm_hood_grey, itm_orc_coif_bad, itm_leather_cap, itm_leather_jerkin_wb, itm_dale_light_b, itm_rawhide_coat, itm_ragged_outfit, itm_padded_leather, itm_leather_vest, itm_orc_mittens_bad,itm_leather_boots_dark_bad,itm_furry_boots,itm_orc_bill_bad,itm_orc_slasher,itm_orc_slasher_heavy, itm_orc_falchion_bad, itm_orc_shield_a,itm_orc_shield_b,],attr_evil_tier_2,wp_tier_2,knows_common|knows_athletics_2|knows_power_strike_1|knows_ironflesh_2,mordor_man1,mordor_man2],
["marauder","Marauder","Marauders",tf_evil_man| tfg_armor| tfg_boots,0,0,fac_outlaws,[itm_hood_black_good, itm_hood_grey_good, itm_orc_coif,itm_orc_skullcap_bad,itm_dun_helm_d_bad,itm_evil_light_armor, itm_dunland_mail_1_bad, itm_dunland_mail_2_bad, itm_dale_light_b_good, itm_leather_armor, itm_orc_mittens,itm_leather_boots_dark,itm_orc_club_b, itm_orc_sledgehammer, itm_orc_falchion, itm_orc_axe_heavy, itm_orc_shield_c,itm_orc_shield_b,],attr_evil_tier_3,wp_tier_3,knows_common|knows_athletics_3|knows_power_strike_3|knows_ironflesh_4,mordor_man1,mordor_man2],
["mirkwood_bandit","Mirkwood Bandit","Mirkwood Bandits",tf_evil_man| tfg_armor| tfg_boots,0,0,fac_outlaws,[itm_hood_black_good, itm_hood_grey, itm_hood_green_good, itm_leather_cap, itm_leather_jerkin_wb, itm_dale_light_b, itm_dunland_tunic_1_bad, itm_dunland_tunic_2_bad, itm_leather_vest, itm_ragged_outfit, itm_padded_leather,itm_orc_mittens,itm_leather_boots_dark, itm_leather_boots_bad, itm_furry_boots,itm_long_bearded_axe, itm_beorn_staff, itm_axe_a, itm_axe_b,itm_short_bow,itm_arrows,itm_regular_bow,],attr_evil_tier_3,wp_tier_bow_3,knows_common|knows_athletics_3|knows_power_draw_2|knows_power_strike_1|knows_ironflesh_1,beorn_face1,beorn_face2],
...
["future_bandit_4","{!}Looter","{!}Looters",tf_evil_man| tfg_armor,0,subfac_rangers,fac_outlaws,[itm_leather_jerkin,itm_leather_boots],attr_evil_tier_1,wp_tier_1,knows_common,khand_man1,khand_man2],
["future_bandit_5","{!}Looter","{!}Looters",tf_evil_man| tfg_armor,0,subfac_rangers,fac_outlaws,[itm_leather_jerkin,itm_leather_boots],attr_evil_tier_1,wp_tier_1,knows_common,khand_man1,khand_man2],
["future_bandit_6","{!}Looter","{!}Looters",tf_evil_man| tfg_armor,0,subfac_rangers,fac_outlaws,[itm_leather_jerkin,itm_leather_boots],attr_evil_tier_1,wp_tier_1,knows_common,khand_man1,khand_man2],
["future_bandit_7","{!}Looter","{!}Looters",tf_evil_man| tfg_armor,0,subfac_rangers,fac_outlaws,[itm_leather_jerkin,itm_leather_boots],attr_evil_tier_1,wp_tier_1,knows_common,khand_man1,khand_man2],
["future_bandit_8","{!}Looter","{!}Looters",tf_evil_man| tfg_armor,0,subfac_rangers,fac_outlaws,[itm_leather_jerkin,itm_leather_boots],attr_evil_tier_1,wp_tier_1,knows_common,khand_man1,khand_man2],
["future_bandit_9","{!}Looter","{!}Looters",tf_evil_man| tfg_armor,0,subfac_rangers,fac_outlaws,[itm_leather_jerkin,itm_leather_boots],attr_evil_tier_1,wp_tier_1,knows_common,khand_man1,khand_man2],
["future_bandit_10","{!}Looter","{!}Looters",tf_evil_man| tfg_armor,0,subfac_rangers,fac_outlaws,[itm_leather_jerkin,itm_leather_boots],attr_evil_tier_1,wp_tier_1,knows_common,khand_man1,khand_man2],
...
["warg_ghost_1b","Warg","Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive ,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_warg_1b],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face7,orc_face2],
["warg_ghost_1c","Warg","Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_warg_1c],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face6,orc_face1],
["warg_ghost_1d","Warg","Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_warg_1d],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_a1b","Warg","Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_wargarmored_1b],str_30| agi_7| int_4| cha_4|level(15),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_a1c","Armored Warg","Armored Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_wargarmored_1c],str_30| agi_7| int_4| cha_4|level(15),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_5,orc_face1,orc_face2],
["warg_ghost_a2b","Armored Warg","Armored Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_wargarmored_2b],str_30| agi_7| int_4| cha_4|level(15),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_5,orc_face1,orc_face2],
["warg_ghost_a2c","Armored Warg","Armored Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_wargarmored_2c],str_30| agi_7| int_4| cha_4|level(15),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_5,orc_face1,orc_face2],
["warg_ghost_a3a","Armored Warg","Armored Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_wargarmored_3a],str_30| agi_7| int_4| cha_4|level(15),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_5,orc_face1,orc_face2],
["warg_ghost_h","Huge Warg","Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head,itm_warg_reward],str_30| agi_7| int_4| cha_4|level(20),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_6,orc_face1,orc_face2],
["wild_warg","Wild Warg","Wild Wargs", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tfg_polearm| tf_no_capture_alive,0,0,fac_outlaws,
    [itm_warg_wild_1,itm_warg_ghost_armour, itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face7,orc_face2],
["wild_warg_strong","Huge Wild Warg","Huge Wild Wargs", tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots| tfg_polearm| tf_no_capture_alive,0,0,fac_outlaws,
    [itm_warg_wild_2,itm_warg_ghost_armour, itm_warg_ghost_lance,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(15),0,knows_riding_10|knows_ironflesh_10|knows_power_strike_5,orc_face7,orc_face2],
["warg_ghost_wolf","Great Wolf","Great Wolves",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_wolf_ridable, itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_future0","Huge Warg","Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_future1","Huge Warg","Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_future2","Huge Warg","Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_future3","Huge Warg","Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_future4","Huge Warg","Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_future5","Huge Warg","Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_future6","Huge Warg","Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_future7","Huge Warg","Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_future8","Huge Warg","Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
["warg_ghost_future9","Huge Warg","Huge Wargs",tf_orc| tfg_gloves| tfg_armor| tfg_helm| tfg_horse| tfg_boots |tfg_polearm| tf_no_capture_alive,0,0,fac_isengard,
   [itm_warg_ghost_lance,itm_warg_ghost_armour,itm_empty_legs,itm_empty_hands,itm_empty_head],str_30| agi_7| int_4| cha_4|level(9),wp_orc_tier_2,knows_riding_10|knows_ironflesh_10|knows_power_strike_4,orc_face1,orc_face2],
...
#MIRKWOOD
upgrade2(troops,"a1_greenwood_scout","i2_greenwood_infantry","a2_greenwood_veteran_scout")
...
upgrade2(troops,"a2_riv_vet_scout","i3_riv_swordbearer","a3_riv_archer")
...
upgrade2(troops,"i4_veteran_footman_of_rohan","i5_raider_of_rohan","i5_elite_footman_of_rohan")
upgrade2(troops,"i5_raider_of_rohan","i6_2h_guard_of_rohan","i6_frealaf_raider")
upgrade2(troops,"i5_elite_footman_of_rohan","i6_footman_guard_of_rohan","i6_warden_of_methuseld")
...
upgrade(troops,"a3_dism_skirmisher_of_rohan","a4_dism_veteran_skirmisher_of_rohan")
upgrade(troops,"a4_dism_veteran_skirmisher_of_rohan","a5_dism_elite_skirmisher_of_rohan")
...
upgrade2(troops,"i3_harad_infantry","i4_harad_swordsman","i4_harad_spearman")
...
#upgrade(troops,"i5_dun_wolf_guard","i6_dun_retainer")
#EASTERLINGS
...
upgrade2(troops,"i4_gunda_orc_warrior","i5_gunda_orc_champion","i5_gunda_orc_berserker")
...
#OUTLAWS
upgrade(troops,"looter","brigand")
upgrade(troops,"marauder","i2_mordor_num_renegade")
