...
["imladris_items","{!}BUG","{!}BUG",tf_hero,0,0,fac_imladris,
   [itm_leather_boots,itm_leather_gloves,itm_mail_coif,itm_short_bow,itm_regular_bow,itm_arrows,itm_good_mace,itm_metal_scraps_bad,itm_metal_scraps_medium,itm_metal_scraps_good,itm_sumpter_horse, itm_saddle_horse, itm_arnor_light_a, itm_arnor_light_b, itm_arnor_med_a, itm_arnor_med_b, ],
      0,0,0,0],
#ROHAN
...
["moria_captain","Uruk_Chieftain_of_Moria","Uruk_Chieftains_of_Moria",tf_uruk| tfg_gloves| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_moria,[itm_uruk_helm_e,itm_m_uruk_heavy_c_good,itm_evil_gauntlets_b,itm_uruk_chain_greaves,itm_orc_two_handed_axe_heavy,itm_uruk_falchion_a,itm_uruk_falchion_b,itm_mordor_uruk_shield_a,],attr_evil_tier_6 ,wp_tier_6,knows_common|knows_athletics_5|knows_power_strike_7|knows_ironflesh_9,uruk_hai_face1,uruk_hai_face2],
...
["morannon_healer","Okstuk_the_Healer","{!}",tf_hero|tf_orc,scn_morannon_center|entry(13),0,fac_mordor,[itm_moria_armor_b,itm_orc_greaves,itm_orc_coif],str_30|agi_5|int_4|cha_4|level(2),wp(20),knows_common,orc_face1],
