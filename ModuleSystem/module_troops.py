...
["beorn_walker_fem","Peasant_Woman","Peasant_Women",tf_female| tfg_boots| tfg_armor,0,0,fac_beorn,
    ...
    itm_rohan_shoes_bad,itm_furry_boots,itm_leather_boots_bad],
        attr_tier_1,wp_tier_1,knows_common,rohan_woman_face_1,rohan_woman_face_2],
                ...
                ["walker_man_gondor_black","Townsman","_",tf_gondor| tfg_boots| tfg_armor,0,0,fac_gondor,[itm_corsair_boots,itm_pelargir_hood, itm_gondor_fine_outfit_dress, itm_blue_tunic, itm_white_tunic_a, itm_gon_jerkin, itm_white_tunic_a, itm_white_tunic_b, itm_white_tunic_c, itm_black_tunic, itm_leather_boots,], attr_tier_1,wp_tier_1,knows_common,man_face_young_1,man_face_old_2],
                ["walker_man_gondor_white","Townsman","_",tf_gondor| tfg_boots| tfg_armor,0,0,fac_gondor,[itm_corsair_boots, itm_gondor_fine_outfit_dress, itm_gondor_fine_outfit_dress, itm_white_tunic_a, itm_white_tunic_b, itm_white_tunic_c, itm_blue_tunic, itm_black_tunic, itm_denethor_robe, itm_leather_boots,], attr_tier_5,wp_tier_1,knows_common,man_face_young_1,man_face_old_2],
                ["walker_man_gondor_blue","Townsman","_",tf_gondor| tfg_boots| tfg_armor,0,0,fac_gondor,[itm_hood_black,itm_pelargir_hood,itm_gondor_fine_outfit_dress, itm_blue_tunic, itm_white_tunic_a, itm_gon_jerkin, itm_leather_jerkin, itm_black_tunic,itm_leather_apron,itm_lossarnach_shirt, itm_leather_boots,], attr_tier_1,wp_tier_1,knows_common,man_face_young_1,man_face_old_2],
                ["walker_man_gondor_green","Townsman","_",tf_gondor| tfg_boots| tfg_armor,0,0,fac_gondor,[itm_hood_black,itm_blue_tunic, itm_white_tunic_a, itm_leather_jerkin, itm_black_tunic, itm_leather_apron, itm_leather_boots,itm_rohan_shoes],attr_tier_1,wp_tier_1,knows_common,man_face_young_1,man_face_old_2],
                ["walker_man_rohan_t","Rohan_Townsman","_",tf_rohan| tfg_boots| tfg_armor,0,0,fac_rohan,[itm_rohan_tunic_a,itm_rohan_tunic_b, itm_rohan_fine_outfit_dale_dress, itm_white_tunic_a, itm_leather_jerkin, itm_black_tunic, itm_leather_apron, itm_leather_boots,itm_rohan_shoes],attr_tier_1,wp_tier_1,knows_common,rohan_face_middle_1,rohan_face_older_2],
                ["walker_man_rohan_d","Rohan_Townsman","_",tf_rohan| tfg_boots| tfg_armor,0,0,fac_rohan,[itm_gondor_ranger_hood,itm_rohan_tunic_a,itm_rohan_tunic_b, itm_rohan_fine_outfit_dale_dress, itm_white_tunic_a, itm_leather_jerkin, itm_black_tunic, itm_leather_apron,  itm_rohan_shoes,],attr_tier_1,wp_tier_1,knows_common,rohan_face_middle_1,rohan_face_older_2],
                ["walker_woman_rohan_t","Rohan_Maiden","_",tf_female| tfg_boots| tfg_armor,0,0,fac_rohan,[itm_gondor_ranger_hood,itm_robe_generic_dress,itm_green_dress, itm_black_dress,itm_rohan_fine_outfit_dale_dress,itm_rohan_shoes,itm_leather_boots],attr_tier_1,wp_tier_1,knows_common,rohan_woman_face_1,rohan_woman_face_2],
                ["walker_woman_rohan_d","Rohan_Maiden","_",tf_female| tfg_boots| tfg_armor,0,0,fac_rohan,[itm_robe_generic_dress,itm_rohan_fine_outfit_dale_dress, itm_green_dress, itm_black_dress, itm_green_tunic, itm_white_tunic_a,itm_leather_jerkin, itm_black_tunic, itm_leather_apron,itm_leather_boots,itm_rohan_shoes],attr_tier_1,wp_tier_1,knows_common,rohan_woman_face_1,rohan_woman_face_2],
                ["walker_woman_gondor_b","Gondor_Woman","_",tf_female| tfg_boots| tfg_armor| tfg_helm,0,0,fac_gondor,[itm_robe_generic_dress,itm_rohan_fine_outfit_dale_dress,itm_black_dress, itm_wimple_a, itm_wimple_with_veil ,itm_leather_boots,],attr_tier_1,wp_tier_1,knows_common,woman_face_1,woman_face_2],
                ["walker_woman_gondor_bw","Gondor_Woman","_",tf_female| tfg_boots| tfg_armor| tfg_helm,0,0,fac_gondor,[itm_robe_generic_dress,itm_black_dress,itm_black_dress, itm_blackwhite_dress,itm_wimple_a, itm_wimple_with_veil, itm_fine_hat,itm_leather_boots,],attr_tier_1,wp_tier_1,knows_common,woman_face_1,woman_face_2],
                ["walker_woman_gondor_w","Gondor_Noble","_",tf_male| tfg_boots| tfg_armor,0,0,fac_gondor,[itm_gondor_fine_outfit_dress,itm_gondor_fine_outfit_dress,itm_gondor_fine_outfit_dress,itm_denethor_robe,itm_leather_boots,itm_corsair_boots],attr_tier_1,wp_tier_1,knows_common,woman_face_1,woman_face_2],
...
# ["knight_2_9","harad_captain","_",tf_hero,0,reserved,fac_harad,[itm_saddle_horse,itm_rich_outfit,itm_mail_hauberk,itm_leather_boots,itm_mail_boots,itm_mail_mittens,itm_two_handed_axe,itm_shield_heater_c],knight_attrib_4,wp(230),knight_skills_4|knows_riding_4,0x0000000c160451d2136469c4d9b159ad00000000001e28f10000000000000000,vaegir_face_older_2],
...
#unused
["dummy_troop",  "bug","_", 0, 0, 0, fac_gondor, [], lord_attrib,0,0,0],
["dummy_troop_b","bug","_", 0, 0, 0, fac_gondor, [], lord_attrib,0,0,0],
