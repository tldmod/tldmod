...
["northmen_items","BUG","_",tf_hero,0,0,fac_beorn,
   [itm_leather_gloves,itm_good_mace,itm_metal_scraps_bad,itm_metal_scraps_medium,itm_metal_scraps_good,],
      0,0,0,0],
#Dale
["dale_militia","Dale_Militiaman","Dale_Militia",tfg_boots| tfg_armor,0,0,fac_dale,[itm_north_leather_skullcap, itm_north_leather_skullcap_bad,itm_dale_light_a_bad, itm_dale_light_a_ok, itm_dale_light_a_good,itm_rohan_shoes,itm_dale_pike, itm_dale_sword, itm_arrows,itm_short_bow,itm_axe_a,itm_north_round_shield,],attr_tier_1,wp_tier_1,knows_common,vaegir_face_younger_1,vaegir_face_middle_2],
["dale_man_at_arms","Dale_Man-at-Arms","Dale_Men-at-Arms",tfg_shield| tfg_boots| tfg_armor| tfg_helm,0,0,fac_dale,[itm_north_leather_skullcap, itm_north_leather_skullcap_good, itm_north_skullcap, itm_north_skullcap_good, itm_dale_helmet_a,itm_dale_med_b_bad, itm_leather_boots,itm_rohan_shoes,itm_dale_sword,itm_dale_pike, itm_axe_a, itm_axe_b, itm_axe_c,itm_north_round_shield, itm_dale_shield_c, itm_dale_shield_a, ],attr_tier_2,wp_tier_2,knows_common,vaegir_face_young_1,vaegir_face_middle_2],
