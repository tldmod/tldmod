...
["orc_snaga_of_isengard","Orc_Snaga_of_Isengard","Orc_Snagas_of_Isengard",tf_orc| tf_no_capture_alive,0,0,fac_isengard,
   [itm_isen_orc_armor_a,itm_isen_orc_armor_b,itm_isengard_hammer,itm_isengard_spear,itm_isengard_spear,itm_wood_club,itm_orc_simple_spear,itm_orc_axe,itm_metal_scraps_bad,itm_metal_scraps_medium,itm_metal_scraps_good,],
...
["large_orc_despoiler","Large_Orc_Despoiler","Large_Orc_Despoilers",tf_orc| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_isengard,
   [itm_orc_greaves,itm_evil_gauntlets_b,itm_isen_orc_armor_e,itm_isen_orc_armor_f,itm_isen_orc_helm_b,itm_isengard_mallet,itm_orc_sledgehammer,itm_isengard_hammer,itm_wood_club,],
...
["fell_orc_despoiler","Fell_Orc_Despoiler","Fell_Orc_Despoilers",tf_orc| tfg_armor| tfg_helm| tfg_boots| tfg_gloves| tf_no_capture_alive,0,0,fac_isengard,
   [itm_orc_greaves,itm_evil_gauntlets_b,itm_isen_orc_armor_g,itm_isen_orc_helm_c,itm_isengard_mallet,itm_orc_sledgehammer,itm_isengard_hammer,itm_wood_club,],
...
["wolf_rider_of_isengard","Wolf_Rider_of_Isengard","Wolf_Riders_of_Isengard",tf_orc| tf_mounted| tfg_ranged| tfg_armor| tfg_horse| tf_no_capture_alive,0,0,fac_isengard,
   [itm_orc_throwing_arrow,itm_isen_orc_armor_a,itm_isen_orc_armor_b,itm_warg_1d,itm_warg_1b,itm_warg_1c,itm_wood_club,itm_orc_axe,],
...
["orc_of_guldur","Orc_of_Guldur","Orcs_of_Guldur",tf_orc| tfg_armor| tf_no_capture_alive,0,0,fac_guldur,
   [itm_orc_ragwrap,itm_m_orc_light_b,itm_m_orc_light_c,itm_m_orc_light_d,itm_m_orc_light_e,itm_wood_club,itm_orc_falchion,itm_orc_sabre,itm_orc_slasher,itm_orc_bill,itm_orc_axe,itm_mordor_orc_shield_b,itm_mordor_orc_shield_c,itm_mordor_orc_shield_a,itm_orc_helm_b,itm_orc_helm_c,itm_orc_helm_d,itm_orc_helm_e,],
...
["fell_orc_of_mordor","Fell_Orc_of_Mordor","Fell_Orcs_of_Mordor",tf_orc| tfg_shield| tfg_armor| tfg_helm| tfg_boots| tf_no_capture_alive,0,0,fac_mordor,
   [itm_orc_greaves,itm_evil_gauntlets_a,itm_orc_throwing_axes,itm_orc_throwing_arrow,itm_m_orc_heavy_b,itm_m_orc_heavy_c,itm_m_orc_heavy_d,itm_m_orc_heavy_e,itm_orc_sabre,itm_orc_falchion,itm_orc_two_handed_axe,itm_orc_scimitar,itm_mordor_orc_shield_b,itm_mordor_orc_shield_c,itm_mordor_orc_shield_e,itm_orc_helm_h,itm_orc_helm_i,itm_orc_helm_j,itm_orc_helm_k,],
...
["warg_skirmisher_gundabad","Gundabad_Skirmisher","Gundabad_Skirmishers",tf_orc| tf_mounted| tfg_ranged| tfg_armor| tfg_boots| tf_no_capture_alive,0,0,fac_gundabad,
   [itm_uruk_bow,itm_uruk_bow,itm_orc_hook_arrow,itm_orc_throwing_arrow,itm_orc_throwing_arrow,itm_gundabad_armor_b,itm_gundabad_armor_b,itm_orc_machete,itm_orc_scimitar,itm_orc_falchion,itm_orc_furboots,itm_orc_ragwrap,itm_warg_1c,itm_warg_1d,itm_warg_1b,itm_warg_1d,itm_orc_shield_b,],
...
["goblin_north_clan_skirmisher","Goblin_North_Clan_Skirmisher","Goblin_North_Clan_Skirmishers",tf_orc| tf_mounted| tfg_ranged| tfg_armor| tfg_boots| tf_no_capture_alive,0,0,fac_gundabad,
   [itm_orc_javelin,itm_orc_javelin,itm_uruk_bow,itm_uruk_bow,itm_orc_hook_arrow,itm_gundabad_helm_e,itm_gundabad_armor_b,itm_gundabad_armor_e,itm_orc_sabre,itm_orc_scimitar,itm_orc_simple_spear,itm_orc_skull_spear,itm_leather_gloves,itm_orc_furboots,itm_warg_1d,itm_warg_1b,itm_warg_1d,itm_wargarmored_3a,itm_orc_shield_b],
...
["warg_rider_gundabad","Gundabad_Warg_Rider","Gundabad_Warg_Riders",tf_orc| tf_mounted| tfg_armor| tfg_horse| tfg_boots| tf_no_capture_alive,0,0,fac_gundabad,
   [itm_gundabad_armor_b,itm_gundabad_armor_b,itm_orc_machete,itm_orc_scimitar,itm_orc_falchion,itm_orc_simple_spear,itm_orc_skull_spear, itm_twohand_wood_club,itm_orc_club_b,  itm_orc_furboots,itm_orc_ragwrap,itm_warg_1c,itm_warg_1d,itm_warg_1b,itm_warg_1d,itm_orc_shield_b,itm_orc_shield_b],
...
["goblin_north_clan_rider","Goblin_North_Clan_Rider","Goblin_North_Clan_Riders",tf_orc| tf_mounted| tfg_armor| tfg_shield| tfg_helm| tfg_horse| tfg_boots|tfg_gloves| tf_no_capture_alive,0,0,fac_gundabad,
   [itm_gundabad_helm_e,itm_gundabad_armor_b,itm_gundabad_armor_e,itm_orc_sabre,itm_orc_scimitar,itm_orc_skull_spear,itm_orc_skull_spear,itm_uruk_skull_spear,itm_orc_club_b,itm_leather_gloves,itm_orc_furboots,itm_wargarmored_3a,itm_orc_shield_b,itm_orc_shield_a,itm_orc_shield_b,itm_orc_shield_c],
