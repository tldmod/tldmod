...
[anyone, "start", [(eq, "$g_talk_troop", "trp_generic_hero_infantry"),(eq, "$enemy_reinforcement_stage", 2),],
  "You fight well, kinsman! I don't know how you've been surviving so far. I remember you joining us recently, before all this... before Balin fell... What did you do before?", "ori_choose_1", 
  []],
...
[anyone, "start", [(eq, "$g_talk_troop", "trp_generic_hero_infantry"),(eq, "$enemy_reinforcement_stage", 7),],
  ...
  [ (assign, "$temp", 0),
    ...
    (try_begin),
      ...
      (agent_equip_item, ":player", "itm_glorfi_bow"),
      (agent_set_wielded_item, ":player", "itm_glorfi_bow"),
      (agent_refill_ammo, ":player"),
    (else_try),
      (eq, ":weapon_selection", 2),
      (troop_raise_proficiency_linear, "$g_player_troop", wpt_one_handed_weapon, 20),
  ...
  [anyone, "start", [(eq, "$g_talk_troop", "trp_generic_hero_infantry"),(eq, "$enemy_reinforcement_stage", 10),
