...
[anyone|plyr|repeat_for_1000, "ziggy_choose_prisoners", 
  [   (party_get_num_prisoner_stacks, ":num_prisoners", "p_main_party"),
      ...
      (neg|is_between, ":prisoners", heroes_begin, heroes_end),
...
"{playername}, I see you return from your campaign against Moria and Gundabad! What news do you bring?", "lord_oath_of_vengeance_fulfilled",[]],
   
[anyone|plyr, "lord_oath_of_vengeance_fulfilled",[], "My lord, I have pursued and ravaged the orc scum, destroying and routing their armies wherever I found them. They tremble with fear and hide in their deepest caves. Balin and his followers have been avenged!","lord_oath_of_vengeance_fulfilled1",[]],

[anyone, "lord_oath_of_vengeance_fulfilled1",[],
"You have accomplished more than I could ever have hoped for. Thanks to you, vengeance is ours! The fear and shame of our enemies fills our hearts with satisfaction! I name you Oathkeeper. Go now with the gratitude of Aules' people.","close_window",[
  (call_script,"script_stand_back"),
  (call_script, "script_finish_quest", "qst_oath_of_vengeance", 100),
  ...
  # (try_for_range, ":fac", kingdoms_begin, kingdoms_end),
    ...
    # (faction_get_slot,":enemy_strength",":fac",slot_faction_strength_tmp), 
    # (val_sub, ":enemy_strength", 1000),
    # (faction_set_slot,":fac",slot_faction_strength_tmp,":enemy_strength"),
  # (try_end),
  (neg|party_is_in_any_town, "p_main_party"),
  (assign,"$g_leave_encounter",1),
  ]],
...
"News of your accomplishment against the wild trolls reached me. {s12} has one fear less to worry about, thanks to you, {playername}.", "lord_generic_mission_completed",[
 ...
 # This war is going to make us rich {men/souls}, mark my words!", "lord_pretalk",
   # [
    ...
    # (try_for_range, ":vassal", heroes_begin, heroes_end),
...
[anyone|plyr,"dwarf_lord_book_give_i", 
  [(check_quest_active|neg, "qst_oath_of_vengeance"),
   ...
   (try_begin),
    ...
    (try_end)], 
      "{s3}, I wish to help {s4} people avenge Balin and his company.", "dwarf_lord_book_give_j", []],

[anyone|plyr,"dwarf_lord_book_give_i", 
  [], "I wish you good luck with that.", "lord_pretalk", []],

[anyone,"dwarf_lord_book_give_j", 
  [(check_quest_active, "qst_oath_personal"),], "I have heard that you have already made a vow of vengeance. It would be unwise to divide your strength between two vows. I am afraid I cannot accept your offer.", "lord_pretalk", []],

[anyone,"dwarf_lord_book_give_j", 
  [], "Such a promise is not lightly given, {playername}. If you swear to avenge my kin, I will take you by the word. Are you ready to pledge an oath of vengeance against the goblin filth of the mountains?", "dwarf_lord_book_give_k", []],

[anyone|plyr,"dwarf_lord_book_give_k", 
  [], "I swear!", "dwarf_lord_book_give_l", []],

[anyone|plyr,"dwarf_lord_book_give_k", 
  [], "I understand. I am afraid I have other pressing obligations. Yet I wish you the best of luck in your fight against the orcs.", "lord_pretalk", []],
  
[anyone|plyr,"dwarf_lord_book_give_l", 
  [], "I swear not to rest and to bring death and destruction to all the orcs of the mountains before this moon wanes and rises again!", "dwarf_lord_book_give_m", []],

[anyone,"dwarf_lord_book_give_m", 
  [], "Very good, {playername}. Go with the blessings of Durin's folk and bring death to our enemies. Make them know pain and fear as our people have known them.", "close_window", 
    [(str_clear, s4),(str_clear, s3),(str_clear, s2),
     (str_store_troop_name, s4, "$g_talk_troop"),
     (store_character_level, ":player_level", "trp_player"),
     (val_mul, ":player_level", 30),
     (quest_set_slot, "qst_oath_of_vengeance", slot_quest_object_faction, "fac_dwarf"),
     (quest_set_slot, "qst_oath_of_vengeance", slot_quest_target_amount, 500),
     (quest_set_slot, "qst_oath_of_vengeance", slot_quest_importance, 20),
     (quest_set_slot, "qst_oath_of_vengeance", slot_quest_xp_reward, 1000),
     (quest_set_slot, "qst_oath_of_vengeance", slot_quest_gold_reward, 2000),
     (quest_set_slot, "qst_oath_of_vengeance", slot_quest_rank_reward, 30),
     (quest_set_slot, "qst_oath_of_vengeance", slot_quest_giver_fac_str_effect, 1000),
     (quest_set_slot, "qst_oath_of_vengeance", slot_quest_target_fac_str_effect, -1000),
     (quest_set_slot, "qst_oath_of_vengeance", slot_quest_expiration_days, 30),
     (quest_set_slot, "qst_oath_of_vengeance", slot_quest_current_state, 0),
     (quest_set_slot, "qst_oath_of_vengeance", slot_quest_giver_troop, "trp_dwarf_lord"),
     (assign, "$oath_kills", 0),
     (try_begin),
        (faction_slot_eq, "fac_moria", slot_faction_state, sfs_active),
        (faction_slot_eq, "fac_gundabad", slot_faction_state, sfs_active),
        (str_store_string, s3, "@Moria and Gundabad"),
        (quest_set_slot, "qst_oath_of_vengeance", slot_quest_target_faction, "fac_gundabad"),
      (else_try),
        (faction_slot_eq, "fac_moria", slot_faction_state, sfs_active),
        (str_store_string, s3, "@Moria"),
        (quest_set_slot, "qst_oath_of_vengeance", slot_quest_target_faction, "fac_moria"),
        (neg|faction_slot_ge, "fac_moria", slot_faction_strength, 4000),
		(faction_get_slot,":enemy_strength","fac_moria",slot_faction_strength_tmp), 
		(val_add, ":enemy_strength", 1000),
	    (faction_set_slot,"fac_moria",slot_faction_strength_tmp,":enemy_strength"),
        (display_message, "@Your enemies in {s3} hear of your oath and rally their strength to counter the threat."),
      (else_try),
        (faction_slot_eq, "fac_gundabad", slot_faction_state, sfs_active),
        (str_store_string, s3, "@Gundabad"),
        (quest_set_slot, "qst_oath_of_vengeance", slot_quest_target_faction, "fac_gundabad"),
        (neg|faction_slot_ge, "fac_gundabad", slot_faction_strength, 4000),
		(faction_get_slot,":enemy_strength","fac_gundabad",slot_faction_strength_tmp), 
		(val_add, ":enemy_strength", 1000),
	    (faction_set_slot,"fac_gundabad",slot_faction_strength_tmp,":enemy_strength"),    
        (display_message, "@Your enemies in {s3} hear of your oath and rally their strength to counter the threat."),
      (try_end),
     (setup_quest_text, "qst_oath_of_vengeance"),
     (str_store_string, s2, "@You swear an oath of vengeance against {s3}. You must now defeat as many parties and personally kill as many orcs of Moria and Gundabad as possible in the coming days. You are keenly aware that your followers have witnessed this oath and you do not wish to become known as an oathbreaker. An orgy of bloodletting must now begin!^."),
     (call_script, "script_start_quest", "qst_oath_of_vengeance", "trp_dwarf_lord"),
     (neg|party_is_in_any_town, "p_main_party"),
     (assign,"$g_leave_encounter",1),
     ]],
...
"Again you save our necks, {playername}! Truly, you are the best of friends. {s43}", "close_window", [
    (call_script,"script_stand_back"),
       ...
       (try_begin),
         ...
         (is_between, ":enemy_party_leader", heroes_begin, heroes_end),
         (troop_slot_eq, ":enemy_party_leader", slot_troop_occupation, slto_kingdom_hero),
...
"Aye, I can take them to {s13}.","move_cattle_herd_quest_taken",[
     ...
     (else_try),
       ...
       (str_store_string, s12, "@slaves"),
       #(party_set_faction, ":herd_party", "fac_commoners"), #makes them not run from good side enemies, but from bandits
       (party_clear, ":herd_party"),
       (faction_get_slot, ":leader_troop", "$g_encountered_party_faction", slot_faction_tier_3_troop),
       (party_add_leader, ":herd_party", ":leader_troop"),
       (store_random_in_range, ":num_slaves", 6, 11),
       (party_add_members, ":herd_party", "trp_human_prisoner", ":num_slaves"),
       (try_begin), #faction specific slaver icons
        (eq, "$g_encountered_party_faction", fac_mordor),
        (party_set_icon, ":herd_party", icon_slaver_mordor),
      (else_try),
        (eq, "$g_encountered_party_faction", fac_isengard),
        (party_set_icon, ":herd_party", icon_slaver_isengard),
      (try_end),
     (try_end),
...
[anyone,"prisoner_slaughter", [(eq, "$talk_context", tc_troop_review_talk), (neg|troop_is_hero,"$g_talk_troop") ], "One day you will pay!", "prisoner_slaughter_02",[
  (try_begin),
...
[anyone|plyr|repeat_for_100, "town_dweller_ask_directions2", [
    ...
    (try_begin),
        ...
        (str_store_string, s4, "@Lead me to the {s3}"),
    (else_try),
        (eq, ":entry", 11),
        (str_store_string, s4, "@Lead me to the local authority"),
    (else_try),
        (eq, ":entry", 12),
...
[anyone ,"start", [
    ...
    (try_begin),
        (eq, "$player_looks_like_an_orc", 1),
        (str_store_string, s1, "@What snaga dares approach me?"),
    (else_try),
        (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
        (str_store_string, s1, "@Who are you?"),
    (else_try),
        (str_store_string, s1, "@I don't believe we have met."),
    (try_end)
],
"{!}{s1}", "kingdom_companion_meet", []],
...
[anyone, "event_triggered", [
    ...
    (try_begin),
        ...
        (try_begin),
            (eq, "$player_looks_like_an_orc", 1),
            (str_store_string, s5, "@Wait! You must be {playername}. {s4} Hear me before you depart..."),
        (else_try),
            (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
            (str_store_string, s5, "@Wait! I am told you are {playername}. {s4} Before you leave..."),
        (else_try),
    ...
    (else_try),
        (try_begin),
            (eq, "$player_looks_like_an_orc", 1),
            (str_store_string, s5, "@Wait, {playername}, hear me before you depart..."),
        (else_try),
...
[anyone ,"kingdom_companion_start", [
    ...
    (try_begin),
        (eq, "$player_looks_like_an_orc", 1),
        (str_store_string, s1, "@I hope your rabble fight well."),
    (else_try),
        (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
        (str_store_string, s1, "@Let us bring ruin to our enemies."),
    (else_try),
...
[anyone ,"kingdom_companion_start", [
    ...
    (troop_get_slot, ":quest", "$g_talk_troop", slot_troop_quest_help_target),
    ...
    (try_begin),
        ...
        (try_begin),
            (eq, "$player_looks_like_an_orc", 1),
            (str_store_string,s4,"@Realized it was a mistake to turn me down, have you?"),
        (else_try),
            (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
            (str_store_string,s4,"@Have you changed your mind about letting me join you?"),
        (else_try),
    ...
    (else_try),
        ...
        (try_begin),
            (eq, "$player_looks_like_an_orc", 1),
            (str_store_string,s4,"@Have you made room for me yet? I am more capable than the snagas following you."),
        (else_try),
            (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
            (str_store_string,s4,"@Do you have room for me now? I am still prepared to assist you."),
        (else_try),
    ...
    (else_try),
        ...
        (try_begin),
            (eq, "$player_looks_like_an_orc", 1),
            (str_store_string,s4,"@Do you require my assistance once more?"),
        (else_try),
            (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
            (str_store_string,s4,"@Are you ready for me to join you again?"),
        (else_try),
    ...
    (else_try),
        ...
        (try_begin),
            (eq, "$player_looks_like_an_orc", 1),
            (str_store_string,s4,"@I will join you if you are not up to the task alone."),
        (else_try),
            (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
            (str_store_string,s4,"@Let me join you, and ensure success."),
        (else_try),
    ...
    (try_begin),
        (eq, "$player_looks_like_an_orc", 1),
        (str_store_string, s6, "@Are you certain you can handle the orders given to you by my {s5}, {s3}? {s4}"),
    (else_try),
        (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
        (str_store_string, s6, "@The task given to you by my {s5}, {s3}, is too important to risk failure. {s4}"),
    (else_try),
        (str_store_string, s6, "@My {s5}, {s3}, has given you a task of great importance. {s4}"),
    (try_end),    
],
"{!}{s6}", "kingdom_companion_help_offer", []],
...
[anyone|plyr ,"kingdom_companion_help_offer", [
    ...
    (try_begin),
        (eq, "$player_looks_like_an_orc", 1),
        (str_store_string, s6, "@Join my horde, but remember I answer to {s3}, not to you."),
    (else_try),
        (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
        (str_store_string, s6, "@Very well, let's see how useful you are."),
    (else_try),
        (str_store_string, s6, "@Your assistance would be most welcome."),
    (try_end),   
], "{!}{s6}", "close_window", [
...
[anyone|plyr ,"kingdom_companion_help_offer", [
    ...
    (try_begin),
        (eq, "$player_looks_like_an_orc", 1),
        (str_store_string, s6, "@My horde has no room for another."),
    (else_try),
        (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
        (str_store_string, s6, "@My party has no place for anyone else."),
    (else_try),
...
[anyone|plyr ,"kingdom_companion_help_offer", [
    (try_begin),
        (eq, "$player_looks_like_an_orc", 1),
        (str_store_string, s6, "@Hrmph, I can do this on my own."),
    (else_try),
        (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
        (str_store_string, s6, "@I don't need any help."),
    (else_try),
...
[anyone, "event_triggered", [
    ...
    (else_try),
        ...
        (try_begin),
            (eq, "$player_looks_like_an_orc", 1),
            (str_store_string,s4,"@I knew you were not up to this task. My {s5} will hear that this was your fault, not mine."),
        (else_try),
            (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
            (str_store_string,s4,"@Our mission has failed. Let us hope my {s5} will be merciful."),
        (else_try),
            (str_store_string,s4,"@Alas, we have failed in our mission! Let us hope we can each atone for this failure. I must now return to my {s5}."),
        (try_end),
    (else_try),
        (try_begin),
            (eq, "$player_looks_like_an_orc", 1),
            (str_store_string,s4,"@You have completed your task for my {s5}. Good. I have no further business here."),
        (else_try),
            (neg|faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
            (str_store_string,s4,"@Now that my {s5}'s orders have been carried out I am leaving."),
        (else_try),
