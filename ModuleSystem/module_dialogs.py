...
"Indeed. I have trained {reg2} troops, and {reg1} of them have learned well. You can take them, they should be more prepared for battle.", "lord_raise_troops_thank",[
  (assign, ":finish_percentage", 1000),
  (quest_get_slot, ":target_troop", "qst_raise_troops", slot_quest_target_troop), #InVain: we need to reduce the quest reward wrt the target troop level, so it's not exploitable
  (store_character_level, ":target_troop_level", ":target_troop"),
  (val_div, ":finish_percentage", ":target_troop_level"),
  ...
  (quest_get_slot, ":quest_target_amount", "qst_raise_troops", slot_quest_target_amount),  
  (val_div, ":finish_percentage", ":quest_target_amount"),
  (val_mul, ":finish_percentage", ":trained_recruits"),
