...
###CWE trees  
 ...
 ('misc_camp_evil_placeholder', #placeholder
  0,
  [['chair_castle_a', '0'],
   ['tavern_chair_a', '0'],
   ['tavern_chair_b', '0'],
 ...
 ('misc_town_placeholder', #placeholder
  0,
  [['chair_castle_a', '0'],
   ['tavern_chair_a', '0'],
   ['tavern_chair_b', '0'],
 ...
 ('misc_food_good', #and other stuff you put on a table
  0,
  [['bowl_wood', '0'],
   ['chandelier_table', '0'],
   ['cup', '0'],
   ...
   ['marrow_b', '0'],
   ['potlamp', '0'],  
   ['khazad_dwarf_ale_pint_1', '0'],
   ['khazad_dwarf_ale_pint_2', '0'],
   ['candle_b', '0'],
   ['ewer_a', '0'],]),

 ('misc_food_evil', #to be expanded
  0,
  [['bowl_wood', '0'],
   ['cup', '0'],
   ['cup', '0'],
