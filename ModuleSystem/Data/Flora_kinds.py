...
###CWE trees  
 ...
 ('misc_pottery',
  0,
  [['jug_new_repositioned', '0'],
   ['honey_pot_new_repositioned', '0'],
   ['oil_new_repositioned', '0'],
   ['amphora_slim_new_repositioned', '0'],
   ['butter_pot_new', '0'],]),
 ...
 ('misc_food_good',
  0,
  [['dish_metal_new_horizontal', '0'],
   ['fried_pig', '0'],
   ['chicken_roasted', '0'],
   ['grape_a', '0'],
   ['grape_b', '0'],
   ['sausages', '0'],
   ['ewer_a_new', 'bo_ewer_a'],
   ]),
 ...
 ('misc_containers_food',
  ...
  [['apple_basket_new', 'bo_apple_basket'],
   ['basket_grain', 'bo_apple_basket'],
   ['CWE_kitchen_herbs_a', '0'],
   ['CWE_kitchen_herbs_b', '0'],
   ['CWE_kitchen_herbs_c', '0'],
   ['CWE_kitchen_herbs_d', '0'],
   ]),
 ...
 ('misc_barrels',
  0,
  [
   ['barrel_a_repositioned', 'bo_barrel_a_repositioned'],
   ['barrel_b_repositioned', 'bo_barrel_a_repositioned'],
