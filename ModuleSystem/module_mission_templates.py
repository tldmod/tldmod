...
( "town_center",0,-1,
    ...
    (ti_on_agent_spawn, 0, 0, [],[(store_trigger_param_1, ":agent_no"),(agent_get_troop_id, ":troop_no", ":agent_no"),(is_between, ":troop_no", heroes_begin, heroes_end), (troop_slot_eq, ":troop_no", slot_troop_occupation, slto_kingdom_hero),(call_script, "script_init_town_agent", ":agent_no")]),
	...
	(1, 0, ti_once, [],[ # set walkers, music and ambient sounds
          ...
          # (display_message, "@Player speed {reg0}%"),   
            ...
            (try_begin),
				...
				(try_begin),(gt,":a",0),(play_sound, ":a", sf_looping|sf_2d),(try_end),
			(else_try),
				(play_sound, "$bs_day_sound", sf_looping|sf_2d),
			(try_end),
...
# ( "tld_caravan_help",mtf_battle_mode,-1,#TLD - starting quest to help/kill caravan (GA) - Modified and hooked up by Kham
  ...
  # (ti_before_mission_start, 0, 0, [],[(team_set_relation, 0, 1, -1),(team_set_relation, 0, 2, 1),(team_set_relation, 1, 2, -1)]),
...
( "tld_start_quest_ambush",mtf_battle_mode,-1,#TLD - starting quest to ambush orcs in forest
  "You ambush the orcs.",
    [ (0,mtef_visitor_source|mtef_team_2,0,aif_start_alarmed,1,[]),(1,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
      (2,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),(3,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
      (4,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),(5,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
      (6,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),(7,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
      (8,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),(9,mtef_visitor_source|mtef_team_0,0,aif_start_alarmed,1,[]),
      ...
      (16,mtef_visitor_source|mtef_team_3,0,aif_start_alarmed,1,[]),(17,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),
      (18,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),(19,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),
      (20,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),(21,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),
      (22,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),(23,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),
      (24,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),(25,mtef_visitor_source|mtef_team_1,0,aif_start_alarmed,1,[]),
  ...
  (ti_before_mission_start, 0, 0, [],[
    (team_set_relation, 0, 1, -1),(team_set_relation, 0, 2, 1),(team_set_relation, 1, 2, -1),
    (team_set_relation, 0, 3, -1),(team_set_relation, 1, 3, 1),(team_set_relation, 3, 2, -1), #if player is evil
    ]),
...
# Siege Tutorial
  (6, 0 , ti_once, [
      (eq, "$formations_tutorial", 3), (neq, "$cheat_mode", 1),(eq, "$tld_show_tutorials", 1),(eq, "$advanced_siege_ai",1),],
      [
      ] + (is_a_wb_mt==1 and [
      (tutorial_message_set_background, 1), 
      ] or []) + [
   ...
   [(try_for_agents, ":agent_no"),
    ...
    (agent_get_team, ":team", ":agent_no"),
        ...
        (try_begin), #teleport rogue player spawn agents to correct entry point
              ...
              (assign, ":team", 3), #they will be reassigned later
        (else_try),
        ...
        (try_begin),
            ...
            (assign, ":team", ":team"), #might not be needed anymore since attacker teams now charge, keep for archers
                ] + (is_a_wb_mt==1 and [
            (try_begin),
    ...
    (agent_set_slot, ":agent_no", slot_agent_original_team, ":team"),
...
# charge defenders if attackers almost depleated
  ...
  (4, 0, 10,[
    ...
    (try_begin),
        ...
        (assign, ":continue", 1),
    (else_try),
        (assign, "$player_team_updated", 0), #this is so we only recruit agents from other parties every 20s
    (try_end),
    (eq, ":continue", 1),
    ],[
    (set_fixed_point_multiplier, 100),
    ...
    (try_for_agents, ":agent_no"),
        ...
        (try_begin),
            ...
            (else_try),
                ...
                (ge, ":player_cha", 14),
                (store_random_in_range, ":random", 0, 600),
                (store_mul, ":join_chance", "$attacker_reinforcement_stage", ":player_cha"), #so that progressively more attackers join player team
                ...
                (try_begin),
                    ...
                    (le, ":chance", 50), #only half of them shout
                ...
                #(str_store_troop_name, s1, ":troop_id"),
            (try_end),
        (else_try), #some go back to their original team, but not player party members
            (eq, ":agent_team", 6),
            (val_add, ":followers", 1),
            (neq, ":party_id", "p_main_party"),
            (gt, ":dist", 2500),
            (agent_get_slot, ":original_team", ":agent_no", slot_agent_original_team),
            (agent_set_team, ":agent_no", ":original_team"),
            (val_add, ":counter_2", 1),
            (val_sub, ":followers", 1),
        (try_end),
    (try_end),
    ...
    (try_begin),
        (ge, ":counter_1", 1),
        (assign, reg5, ":counter_1"),
        (store_sub, reg4, ":counter_1", 1),
        (display_message, "@{reg5} {reg4?troops:troop} rallied to your side due to your Charisma."),
        (assign, "$player_team_updated", 1),
    (try_end),
    (try_begin),
        (ge, ":counter_2", 1),
        (assign, reg5, ":counter_2"),
        (store_sub, reg4, ":counter_2", 1),
        (display_message, "@{reg5} {reg4?troops:troop} stopped following you (too far away)."),
    (try_end),
    (try_begin),
        (ge, ":followers", 1),
        (assign, reg5, ":followers"),
        (store_sub, reg4, ":followers", 1),
        (display_message, "@{reg5} {reg4?troops:troop} are currently following you."),
    (try_end),
  ]),



    #After-reinforcement check: attackers almost depleted? Ask player to retreat or clean up remainders.
   (3, 0, 0, [
    (this_or_next|eq, "$att_reinforcements_arrived", 1), #if attacker reinforcement
    (ge,"$attacker_reinforcement_stage",19),
   ],[
     (store_normalized_team_count,":num_attackers",1),
     (get_player_agent_no, ":player_agent"),
    ...
    (else_try),  
        ...
        (else_try),
            (eq, "$att_reinforcements_needed", 0),
            (agent_is_defender, ":player_agent"), 
            (entry_point_get_position, pos5, 48), #middle attacker entry
            (try_for_agents, ":agent_no"),
                (agent_is_alive, ":agent_no"),
                (neg|agent_is_defender, ":agent_no"),
                (neq, ":agent_no", ":player_agent"),
                (agent_start_running_away, ":agent_no", pos5),
            ...
            (assign, "$att_reinforcements_needed", 2), #fleeing
            (assign, "$battle_won", 1),
            (assign, "$g_battle_result", 1),
        (try_end),
    (try_end),
  ...
  (5, 10, 0,[
    ...
    (this_or_next|le, ":num_attackers", 5),
    (eq, "$att_reinforcements_needed", 2), #attackers fleeing
  ],[
    (store_normalized_team_count,":num_defenders",0),
    (store_normalized_team_count,":num_attackers",1),
    (get_player_agent_no, ":player_agent"),
    (try_begin),
        ...
        (agent_is_defender, ":player_agent"), 
        (display_message, "@The remaining attackers disperse!"),
        (assign, "$att_reinforcements_needed", 2), #attackers fleeing
        (entry_point_get_position, pos5, 48), #middle attacker entry
        (try_for_agents, ":agent_no"),
            (agent_is_alive, ":agent_no"),
            (neg|agent_is_defender, ":agent_no"),
    ...
    (else_try), 
        ...
        (try_for_agents, ":agent_no"),
            (agent_is_alive, ":agent_no"),
            (agent_is_defender, ":agent_no"),
            (agent_fade_out, ":agent_no"), #fade out is enough, as the center will be cleansed anyway
        (try_end),
        (set_show_messages, 1),
    (try_end),
  ]),
...
## Step 2: Now, check slot counts
 ...
 (10, 0, 0,[(eq, "$cheat_mode", 1), (eq, 0, 1)], # report attackers and defenders distribution ##disabled
...
#initial commands
  ...
  (0, 0, 10, [(lt,"$defender_reinforcement_stage", 100),(store_mission_timer_a,":mission_time"),(ge,":mission_time",30)],[ 
   ...
   (3, 0, 0, [(ge, "$att_reinforcements_arrived",1),],
     [(store_normalized_team_count,":num_defenders",0),
     (store_normalized_team_count,":num_attackers",1),
     (get_player_agent_no, ":player_agent"),
     (try_begin),
        (eq, "$att_reinforcements_arrived", 1), #if attacker reinforcement
        (neg|agent_is_defender, ":player_agent"),
        (ge,"$attacker_reinforcement_stage",19),
        #(display_message, "@attackers almost defeated!"),
        (question_box,"@Last attacker wave. Do you want to retreat?"),
    ...
    (1,0,ti_once,[], [
     ...
     (10, 0, ti_once, [], [ # Kham - Give legendary place description
        ...
        (else_try),
            ...
            (agent_get_item_slot, ":item", "$current_player_agent", ek_item_1),
            (try_begin),
                (ge, ":item", 1),
                (agent_unequip_item, "$current_player_agent", ":item"),
            (try_end),
            (agent_equip_item, "$current_player_agent", itm_torch, ek_item_1),
...
# Beast hunt, based on animal ambush
("hunt_beast",mtf_battle_mode,charge,
 "You are ambushed by an animal.",
 [
 
     (0,mtef_visitor_source|mtef_team_0,af_override_horse,aif_start_alarmed,0,[]), #player
     
     (1,mtef_defenders|mtef_team_1,0,aif_start_alarmed,15,[]), #animals, up to 15
 ...
 [
    ...
    # Make friends follow
    (team_give_order, 0, grc_everyone, mordr_follow),
    (team_give_order, 0, grc_everyone, mordr_spread_out),
    (team_give_order, 0, grc_everyone, mordr_spread_out),
    (str_store_string, s1, "@The beast must be here somewhere. Find and kill it, before it escapes!"),
    (tutorial_message, "@{!}{s1}!", 0, 10),
    (display_message, "@{!}{s1}!"),
    ...
    (val_div, ":max_y", 2),
	(init_position, pos10),
	(position_set_x, pos10, ":max_x"),
	(position_set_y, pos10, ":max_y"),
	(position_set_z_to_ground_level, pos10),
    (agent_set_position, ":agent", pos10),
    # (set_spawn_position, pos10),
    ...
    (try_for_agents, ":agent"),
        ...
        (else_try),
            ...
            (quest_slot_eq, "$random_quest_no", slot_quest_target_troop, ":troop_id"),
            (quest_set_slot, "$random_quest_no", slot_quest_target_dna, ":agent"), #store agent
            #(display_message, "@{s5} assigned as target."),
            (agent_get_horse, ":mount", ":agent"),
            (store_agent_hit_points, ":hp", ":mount", 1),
            (store_character_level, ":level", "trp_player"),
            (val_add, ":level", 5),
            (val_mul, ":hp", ":level"),
            (val_div, ":hp", 10),
            (agent_set_max_hit_points , ":mount", ":hp", 1), #scalable
        (try_end),
    (try_end),
    ]),
    ...
    (try_for_agents, ":agent"),
        ...
        (position_move_x, pos11, ":x"),
        (position_move_y, pos11, ":y"),
        (agent_set_scripted_destination_no_attack, ":agent", pos11),
    (try_end),
    ]),
    ...
    (ti_on_agent_hit, 0.4, 0, [
        ...
        (set_fixed_point_multiplier, 100),
        (agent_get_position, pos11, ":victim"),
        (agent_get_position, pos12, ":attacker"),
        (get_distance_between_positions, ":dist", pos11, pos12),
        (try_begin),
            (lt, ":dist", 3000),
            (quest_set_slot, "$random_quest_no", slot_quest_current_state, 1),
            (team_set_relation, 0, 1, -1),(team_set_relation, 1, 0, -1),
            (team_give_order, 1, grc_everyone, mordr_charge),
            (try_for_agents, ":agent"),
                (agent_clear_scripted_mode, ":agent"),
        ...
        (else_try),
            (ge, ":dist", 3000),
            #(display_message, "@{!}debug: animals spread out"),
            (try_for_agents, ":agent"), #animals spread out
                (call_script, "script_store_random_scene_position_in_pos10"),
	...
	[
    (set_fixed_point_multiplier, 100),
    (quest_get_slot, ":beast", "$random_quest_no", slot_quest_target_dna),
    (assign, ":encounters", 0),
    (try_for_agents, ":agent"), 
        (agent_is_alive, ":agent"),
        (agent_is_human, ":agent"),
        ...
        (eq, ":team", 1),
        (try_begin),
            (quest_slot_ge, "$random_quest_no", slot_quest_current_state, 1),
            (agent_set_speed_limit, ":agent", 100),
        (else_try),
            (agent_set_speed_limit, ":agent", 15),
        (try_end),
        (agent_get_position, pos11, ":agent"),
        (try_for_agents, ":agent_2", pos11, 2500), #nested agent loop, be aware!
     ...
     (try_begin),
        (gt, ":encounters", 0),
        (neg|quest_slot_ge, "$random_quest_no", slot_quest_current_state, 1),
        (quest_set_slot, "$random_quest_no", slot_quest_current_state, 1),
        (team_set_relation, 0, 1, -1),(team_set_relation, 1, 0, -1),
        (team_give_order, 1, grc_everyone, mordr_charge),
        (try_for_agents, ":agent"),
    ...
    (else_try),
        (eq, ":encounters", 0),
        (this_or_next|quest_slot_eq, "$random_quest_no", slot_quest_current_state, 1),
        (quest_slot_eq, "$random_quest_no", slot_quest_current_state, 2),
        (agent_is_alive, ":beast"),
        (team_set_relation, 0, 1, 0),
        (call_script, "script_store_random_scene_position_in_pos10"),
        (team_set_order_position, 1, pos10),
        (team_give_order, 1, mordr_hold),
        (quest_set_slot, "$random_quest_no", slot_quest_current_state, 0),
        (team_give_order, 0, grc_everyone, mordr_follow),
        (display_message, "@You lost the beast, but it is still nearby."),
    (try_end),
    # (assign, reg13, ":encounters"),
    # (display_message, "@encounters: {reg13}"),
    
    #if beast is slain, minor animals flee
    (try_begin),
        (neg|agent_is_alive, ":beast"),
        (try_for_agents, ":agent"),
            (agent_is_alive, ":agent"),
            (agent_is_human, ":agent"),
            (agent_get_team, ":team", ":agent"),
    ...
    (quest_get_slot, ":beast", "$random_quest_no", slot_quest_target_dna),
    (agent_is_alive, ":beast"),
    (agent_get_horse, ":beast_mount", ":beast"),
    (this_or_next|eq, ":beast", ":victim"),
    (eq, ":beast_mount", ":victim"),
    (store_agent_hit_points, ":hp", ":beast_mount", 0),
    # (store_agent_hit_points, reg78, ":beast_mount", 1),
    # (display_message, "@beast mount hp {reg78}"),
    (lt, ":hp", 50),
    (store_random_in_range, ":rand", 0, 50),
    (gt, ":rand", ":hp"),
    (call_script, "script_store_random_scene_position_in_pos10", ":beast"),
    (try_for_range, ":unused", 0, 5),
        (call_script, "script_store_random_scene_position_in_pos10"),
        ...
        (assign, ":unused", 5),
    (try_end),
    (agent_set_scripted_destination_no_attack, ":beast", pos10, 1),
    (quest_set_slot, "$random_quest_no", slot_quest_current_state, 2), #retreating
    (display_message, "@The beast is fleeing. Don't let it escape!"),
    (try_begin),
        (lt, ":hp", 20),
        (quest_set_slot, "$random_quest_no", slot_quest_current_state, 3), #fleeing for good!
    (try_end),
    ], 
    [(set_fixed_point_multiplier, 100),
    (get_player_agent_no, ":player_agent"),
	...
	[
    #debug
    # (quest_get_slot, reg67, "$random_quest_no", slot_quest_current_state),
    # (display_message, "@quest state {reg67}"),
    
    (this_or_next|quest_slot_eq, "$random_quest_no", slot_quest_current_state, 2),
    (quest_slot_eq, "$random_quest_no", slot_quest_current_state, 3),
    (quest_get_slot, ":beast", "$random_quest_no", slot_quest_target_dna),
    (agent_is_alive, ":beast"),
    ], 
    [(set_fixed_point_multiplier, 100),
    (team_set_relation, 0, 1, 0),
    (quest_get_slot, ":beast", "$random_quest_no", slot_quest_target_dna),
    (agent_get_scripted_destination, pos5, ":beast"),
    (agent_get_position, pos6, ":beast"),
    (get_distance_between_positions, ":dist", pos5, pos6),
    (le, ":dist", 500),
    (try_begin),
        (quest_slot_eq, "$random_quest_no", slot_quest_current_state, 2),
        (quest_set_slot, "$random_quest_no", slot_quest_current_state, 0), #return to normal 
        (call_script, "script_store_random_scene_position_in_pos10"),
        (team_set_order_position, 1, pos10),
        (team_give_order, 1, mordr_hold),
    (else_try),
        (quest_slot_eq, "$random_quest_no", slot_quest_current_state, 3), #..or flee for good?
        (get_player_agent_no, ":player_agent"),
        (agent_get_position, pos7, ":player_agent"),
        (get_distance_between_positions, ":player_dist", pos6, pos7),
        (store_mission_timer_a,":time"),
        (try_begin),
            (le, ":player_dist", 2000),
            (le,":time",300),
            (quest_set_slot, "$random_quest_no", slot_quest_current_state, 1),
            (agent_clear_scripted_mode, ":beast"), 
            (agent_force_rethink, ":beast"),
            (team_set_relation, 0, 1, -1),
            (team_give_order, 1, grc_everyone, mordr_charge),
        (else_try),
            #(agent_fade_out, ":beast"),
            (agent_start_running_away, ":beast"), #no target pos, so they fade out at map border
            (team_set_relation, 0, 1, -1),
            (team_give_order, 1, grc_everyone, mordr_charge),
        (try_end),
    (try_end),
	...
	[(store_mission_timer_a,":time"),
    (ge,":time",30),
    (neg|quest_slot_eq, "$random_quest_no", slot_quest_current_state, 1),
    (quest_get_slot, ":beast", "$random_quest_no", slot_quest_target_dna),
    (agent_is_routed, ":beast"),
	],
	[
    (display_message, "@The beast has escaped."),
    (quest_set_slot, "$random_quest_no", slot_quest_current_state, 11), #escaped
    (quest_get_slot, ":beast", "$random_quest_no", slot_quest_target_dna),
    (agent_get_horse, ":beast_mount", ":beast"),
    (store_agent_hit_points, ":hp", ":beast_mount", 0),
    (lt, ":hp", 15),
    ...
    (store_random_in_range, ":chance", 0, 100),
    (lt, ":chance", ":num_troops"),
    (quest_set_slot, "$random_quest_no", slot_quest_current_state, 13), #killed on escape
    ...
    (quest_get_slot, ":beast", "$random_quest_no", slot_quest_target_dna),
    (neg|agent_is_alive, ":beast"),
    (neg|agent_is_routed, ":beast"),
	],
	[
    (display_message,"@The beast has been slain!"),
    (assign,"$battle_won",1),
    (assign, "$g_battle_result", 1),
    (set_mission_result,1),
    (call_script, "script_music_set_situation_with_culture", mtf_sit_victorious),
...
tld_place_inventory_backup,
  ...
  tld_animal_attacks+
  fade+ 
  ((is_a_wb_mt==1) and tld_bow_shield + khams_custom_player_camera + bright_nights or [] )
  ),
