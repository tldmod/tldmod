...
### Raid Village MT Start (kham)###
 ...
 (
    ...
    [
      ...
      # Player:
      (16,mtef_team_1|mtef_attackers|mtef_use_exact_number,0,aif_start_alarmed,10,[]),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (else_try),
            ...
            (assign, ":interloper_1", "trp_c4_warg_rider_gundabad"),
            (assign, ":interloper_2", "trp_ca4_warg_skirmisher_gundabad"),
