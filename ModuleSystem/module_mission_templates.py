      ...
      (0, 0, 0,
       [
         ...
         (else_try),
           ...
           (init_position, pos1),
           (position_set_x, pos1, 10000), #10000
           (position_set_y, pos1, 4500), #4500
...
(5,1,0,[],[ 
  (try_for_agents, ":enemy"),
    ...
    (try_for_range, "$positions", 1, 21),
        (get_distance_between_positions, "$position_distance", "$positions", 32),
...
(3,0,0,[],[ 
  ...
  (try_for_range, reg15, 21, 32),
    (get_distance_between_positions, ":dist", reg15, 33),
    (neg|gt, ":dist", 150),
    (eq, "$player_hiding", 0),
    (assign, "$player_hiding", reg15),
    (display_message, "@You_are_now_hidden.", 0),
    (try_begin),
        (eq, "$hiding_tut", 0),
  ...
  (assign, reg25, 0),
  (try_for_range, reg15, 21, 32),
    (get_distance_between_positions, ":dist", reg15, pos33),
    (ge, "$player_hiding", 1),
    (ge, ":dist", 150),
    (val_add, reg25, 1),
  (try_end),
  (try_begin),
    (eq, reg25, 11),
    (display_message, "@You_move_out_of_hiding.", 0),
...
(5,0,0,[],[ 
  (try_for_agents, ":agent"),
    ...
    (try_begin),
        ...
        (try_begin),
            (eq, "$alarm_level", 0),
            (display_message, "@The_guards_have_spotted_you!", 0),
            (display_message, "@Alarm_Level_is_now_at_1!", 4294945450),
