...
( "town_center",0,-1,
  ...
  (3, 0, 0, [], [ # positional sounds
    ...
    (get_player_agent_no, ":player_agent"),
    (agent_get_position, pos4, ":player_agent"),
    (scene_prop_get_num_instances, ":num_props", "spr_sound_emitter_var1x100_plus_var2_scalable"),
    (try_for_range, ":count", 0, ":num_props"),
        (scene_prop_get_instance, ":instance_no", "spr_sound_emitter_var1x100_plus_var2_scalable", ":count"),
  ...
  (3, 0, 0, [], [ # ambient sounds
    ...
    (get_player_agent_no, ":player_agent"),
    (agent_get_position, pos4, ":player_agent"),
    (scene_prop_get_num_instances, ":num_props", "spr_sound_emitter_ambient_var1x100_plus_var2_scalable"),
    (try_for_range, ":count", 0, ":num_props"),
        (scene_prop_get_instance, ":instance_no", "spr_sound_emitter_ambient_var1x100_plus_var2_scalable", ":count"),
        (prop_instance_get_variation_id, ":sound", ":instance_no"),
        (val_mul, ":sound", 100),
        (prop_instance_get_variation_id_2, ":sound_2", ":instance_no"),
        (val_add, ":sound", ":sound_2"),
