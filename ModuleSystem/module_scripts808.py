...
(call_script, "script_set_infiltration_companions", 0, 0),
    ...
    (set_visitor, 10, "trp_black_numenorian_sorcerer", 0),
...
(assign, "$meta_stealth", 0),
    (try_begin),
    (neg|eq, "$rescue_companion_1", 0),
    (store_skill_level, reg1, 8, "$rescue_companion_1"),
    (val_add, "$meta_stealth", reg1),
    (val_add, "$current_companions_total", 1),
(try_end),
    (try_begin),
    (neg|eq, "$rescue_companion_2", 0),
    (store_skill_level, reg1, 8, "$rescue_companion_2"),
    (val_add, "$meta_stealth", reg1),
    (val_add, "$current_companions_total", 1),
(try_end),
    (try_begin),
    (neg|eq, "$rescue_companion_3", 0),
    (store_skill_level, reg1, 8, "$rescue_companion_3"),
    (val_add, "$meta_stealth", reg1),
    (val_add, "$current_companions_total", 1),
(try_end),
    (try_begin),
    (neg|eq, "$rescue_companion_4", 0),
    (store_skill_level, reg1, 8, "$rescue_companion_4"),
    (val_add, "$meta_stealth", reg1),
    (val_add, "$current_companions_total", 1),
(try_end),
    (try_begin),
    (neg|eq, "$rescue_companion_5", 0),
    (store_skill_level, reg1, 8, "$rescue_companion_5"),
    (val_add, "$meta_stealth", reg1),
    (val_add, "$current_companions_total", 1),
(try_end),
    (try_begin),
    (neg|eq, "$rescue_companion_6", 0),
    (store_skill_level, reg1, 8, "$rescue_companion_6"),
    (val_add, "$meta_stealth", reg1),
    (val_add, "$current_companions_total", 1),
(try_end),
    (try_begin),
    (neg|eq, "$rescue_companion_7", 0),
    (store_skill_level, reg1, 8, "$rescue_companion_7"),
    (val_add, "$meta_stealth", reg1),
    (val_add, "$current_companions_total", 1),
(try_end),
    (try_begin),
    (neg|eq, "$rescue_companion_8", 0),
    (store_skill_level, reg1, 8, "$rescue_companion_8"),
    (val_add, "$meta_stealth", reg1),
    (val_add, "$current_companions_total", 1),
(try_end),
    (try_begin),
    (neg|eq, "$rescue_companion_9", 0),
    (store_skill_level, reg1, 8, "$rescue_companion_9"),
    (val_add, "$meta_stealth", reg1),
    (val_add, "$current_companions_total", 1),
(try_end),
    (try_begin),
...
(try_end),
    ...
    (check_quest_active, "qst_trait_stealthy", 1),
        (try_begin),
        (eq, "$current_companions_total", 0),
        (val_add, "$meta_stealth", 3),
        (else_try),
        (neg|eq, "$current_companions_total", 0),
        (val_add, "$meta_stealth", 1),
    (try_end),
(try_end),
]), 
...
(val_mul, reg10, 5),
(assign|shuffle_range, reg5, 100, 0),
(val_add, reg5, reg10),
...
(assign, reg13, reg5),
    (try_begin),
    (neg|ge, reg5, 15),
    (assign, "$stealth_results", 1),
    (else_try),
    (is_between, reg5, 15, 50),
    (assign, "$stealth_results", 2),
    (else_try),
    (is_between, reg5, 50, 85),
    (assign, "$stealth_results", 3),
    (else_try),
    (ge, reg5, 85),
    (assign, "$stealth_results", 4),
(try_end),
]), 
