...
(try_end),
    ...
    (eq, "$orc_daylight_penalty_active", 0),
        (try_for_range, reg1, "trp_orc_snaga_of_isengard", "trp_i1_mordor_uruk_snaga"),
        (assign, reg2, -1),
    ...
    (try_end),
        (try_for_range, ":local2", "trp_orc_snaga_of_isengard", "trp_i1_mordor_uruk_snaga"),
...
(try_end),
    ...
    (try_end),
        (try_for_range, ":local0", "trp_orc_snaga_of_isengard", "trp_i1_mordor_uruk_snaga"),
