...
(party_get_num_companion_stacks, ":local2", ":local1"),
    ...
    (this_or_next|neg|troop_is_hero, ":local4"),
    (eq, "$g_move_heroes", 1),
    (neg|is_between, ":local4", "trp_a1_lorien_scout", "trp_dunedain_youth"),
    (neg|is_between, ":local4", "trp_i1_isen_orc_snaga", "trp_end_orc_uruk_troll"),
        (try_begin),
...
("normalize_troop_morale",[
    ...
    (assign, "$troop_range_end", "trp_i1_rohan_youth"),
    (else_try),
    (eq, reg1, "fac_rohan"),
    (assign, "$troop_range_begin", "trp_i1_rohan_youth"),
    (assign, "$troop_range_end", "trp_harad_youth"),
    (else_try),
    (eq, reg1, "fac_lothlorien"),
    (assign, "$troop_range_begin", "trp_a1_lorien_scout"),
    (assign, "$troop_range_end", "trp_a1_greenwood_scout"),
    (else_try),
    (eq, reg1, "fac_imladris"),
    (assign, "$troop_range_begin", "trp_a1_riv_scout"),
    (assign, "$troop_range_end", "trp_gondor_youth"),
    (else_try),
    (eq, reg1, "fac_woodelves"),
    (assign, "$troop_range_begin", "trp_a1_greenwood_scout"),
    (assign, "$troop_range_end", "trp_a1_riv_scout"),
    (else_try),
    (eq, reg1, "fac_mordor"),
    (assign, "$troop_range_begin", "trp_i1_mordor_orc_snaga"),
    (assign, "$troop_range_end", "trp_wolf_rider_of_moria"),
    (assign, "$second_troop_range_begin", "trp_i1_mordor_uruk_snaga"),
    (assign, "$second_troop_range_end", "trp_uruk_hai_scout"),
    (else_try),
    (eq, reg1, "fac_isengard"),
    (assign, "$troop_range_begin", "trp_i1_isen_orc_snaga"),
    (assign, "$troop_range_end", "trp_i1_mordor_orc_snaga"),
    ...
    (assign, "$troop_range_end", "trp_i1_khand_bondsman"),
    (else_try),
    (eq, reg1, "fac_easterlings"),
    (assign, "$troop_range_begin", "trp_i1_khand_bondsman"),
    (assign, "$troop_range_end", "trp_i1_corsair_youth"),
    (else_try),
    (eq, reg1, "fac_corsairs"),
    (assign, "$troop_range_begin", "trp_i1_corsair_youth"),
    (assign, "$troop_range_end", "trp_i1_isen_orc_snaga"),
    (else_try),
    (eq, reg1, "fac_moria"),
...
("reduce_missile_skill",[
    (try_for_range, reg1, "trp_c3_pinnath_knight", "trp_a1_lorien_scout"),
    (assign, reg2, -1),
...
(try_end),
    (try_for_range, reg1, "trp_a1_lorien_scout", "trp_gondor_youth"),
    (assign, reg2, -1),
    ...
    (troop_raise_proficiency_linear, reg1, 5, reg2),
(try_end),
    (try_for_range, reg1, "trp_a4_gon_archer", "trp_i2_guardsman_of_rohan"),
    (assign, reg2, -1),
    (val_mul, reg2, "$missile_skill_difficulty_level"),
    (troop_raise_proficiency_linear, reg1, 3, reg2),
    (troop_raise_proficiency_linear, reg1, 4, reg2),
    (troop_raise_proficiency_linear, reg1, 5, reg2),
(try_end),
    (try_for_range, reg1, "trp_a4_harad_archer", "trp_dunnish_youth"),
    (assign, reg2, -1),
    (val_mul, reg2, "$missile_skill_difficulty_level"),
    (troop_raise_proficiency_linear, reg1, 3, reg2),
    (troop_raise_proficiency_linear, reg1, 4, reg2),
    (troop_raise_proficiency_linear, reg1, 5, reg2),
(try_end),
    (try_for_range, reg1, "trp_easterling_hurler", "trp_i4_corsair_veteran_spearman"),
    (assign, reg2, -1),
    (val_mul, reg2, "$missile_skill_difficulty_level"),
    (troop_raise_proficiency_linear, reg1, 3, reg2),
    (troop_raise_proficiency_linear, reg1, 4, reg2),
    (troop_raise_proficiency_linear, reg1, 5, reg2),
(try_end),
    (try_for_range, reg1, "trp_i1_mordor_orc_snaga", "trp_i3_mordor_uruk_slayer"),
    (assign, reg2, -1),
    (val_mul, reg2, "$missile_skill_difficulty_level"),
    (troop_raise_proficiency_linear, reg1, 3, reg2),
    (troop_raise_proficiency_linear, reg1, 4, reg2),
...
(try_for_range, ":troop", "trp_a3_lorien_vet_warden", "trp_a2_lorien_archer"),
    (troop_remove_item, ":troop", "itm_sword"),
    (troop_add_item, ":troop", "itm_dagger", 0),
(try_end),
(try_for_range, ":troop", "trp_a4_gon_archer", "trp_a4_ithilien_ranger"),
    (troop_remove_item, ":troop", "itm_sword"),
    (troop_add_item, ":troop", "itm_dagger", 0),
(try_end),
(try_for_range, ":troop", "trp_a2_mordor_orc_archer", "trp_wolf_rider_of_moria"),
    (troop_remove_item, ":troop", "itm_umbarian_short_sword"),
    (troop_remove_item, ":troop", "itm_orc_falchion"),
    (troop_add_item, ":troop", "itm_knife", 0),
(try_end),
(try_for_range, ":troop", "trp_uruk_hai_scout", "trp_i6_isen_uruk_berserker"),
    (troop_remove_item, ":troop", "itm_orc_falchion"),
    (troop_add_item, ":troop", "itm_knife", 0),
(try_end),
(try_for_range, ":troop", "trp_a2_corsair_marine", "trp_i3_corsair_swordsman"),
    (troop_remove_item, ":troop", "itm_umbarian_short_sword"),
    (troop_add_item, ":troop", "itm_dagger", 0),
(try_end),
(try_for_range, ":troop", "trp_a1_blackroot_hunter", "trp_a1_lorien_scout"),
    (troop_raise_proficiency_linear, ":troop", 3, -30),
(try_end),
(try_for_range, ":troop", "trp_a4_harad_archer", "trp_dunnish_youth"),
    (troop_raise_proficiency_linear, ":troop", 3, -30),
(try_end),
(try_for_range, ":troop", "trp_a3_greenwood_archer", "trp_i2_greenwood_infantry"),
    (troop_raise_proficiency_linear, ":troop", 3, -30),
(try_end),
]), 
...
(try_for_range, ":troop", "trp_i1_isen_orc_snaga", "trp_end_orc_uruk_troll"),
    (store_skill_level, reg2, 19, ":troop"),
    (val_min, reg2, reg5),
    (val_mul, reg2, -1),
    (troop_raise_skill, ":troop", 19, reg2),
...
(assign, "$guard_troop1", "trp_i2_mordor_orc"),
(assign, "$guard_troop2", "trp_a2_guldur_orc_tracker"),
(assign, "$guard_troop3", "trp_i3_mordor_large_orc"),
(assign, "$guard_troop4", "trp_i4_mordor_fell_orc"),
(assign, "$guard_troop5", "trp_a3_guldur_large_orc_tracker"),
(assign, "$guard_troop6", "trp_i2_mordor_num_renegade"),
(assign, "$guard_troop7", "trp_i4_mordor_fell_uruk"),
(assign, "$guard_troop8", "trp_i3_mordor_num_warrior"),
(assign, "$guard_troop9", "trp_i4_mordor_num_vet_warrior"),
(assign, "$guard_troop10", "trp_i5_mordor_num_champion"),
(assign, "$wall_missile_troop1", "trp_a2_mordor_orc_archer"),
(assign, "$wall_missile_troop2", "trp_a2_mordor_orc_archer"),
(assign, "$wall_missile_troop3", "trp_a3_mordor_large_orc_archer"),
(assign, "$wall_missile_troop4", "trp_a3_mordor_large_orc_archer"),
(assign, "$wall_missile_troop5", "trp_a4_mordor_fell_orc_archer"),
...
(try_end),
    (try_begin),
    (eq, "$troop_to_pick", "trp_a4_ithilien_ranger"),
    (val_add, "$no_a4_ithilien_ranger_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a5_ithilien_vet_ranger"),
    (val_add, "$no_a5_ithilien_vet_ranger_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a6_ithilien_master_ranger"),
    (val_add, "$no_a6_ithilien_master_ranger_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a4_arnor_vet_ranger"),
    (val_add, "$no_a4_arnor_vet_ranger_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a3_arnor_ranger"),
    (val_add, "$no_a3_arnor_ranger_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a5_arnor_master_ranger"),
    (val_add, "$no_a5_arnor_master_ranger_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_i6_frealaf_raider"),
    (val_add, "$no_i6_frealaf_raider_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_corsair_raider"),
    (val_add, "$no_corsair_raider_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_i4_corsair_raider"),
    (val_add, "$no_i4_corsair_raider_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_i5_corsair_night_raider"),
    (val_add, "$no_i5_corsair_night_raider_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a3_guldur_large_orc_tracker"),
    (val_add, "$no_a3_guldur_large_orc_tracker_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a4_guldur_fell_orc_tracker"),
    (val_add, "$no_a4_guldur_fell_orc_tracker_picked", "$number_of_troop_type"),
    (else_try),
    ...
    (else_try),
    (eq, "$troop_to_pick", "trp_a4_corsair_assassin"),
    (val_add, "$no_a4_corsair_assassin_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a5_corsair_master_assassin"),
    (val_add, "$no_a5_corsair_master_assassin_picked", "$number_of_troop_type"),
    (else_try),
    ...
    (else_try),
    (eq, "$troop_to_pick", "trp_i3_lorien_inf"),
    (val_add, "$no_i3_lorien_inf_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_i4_lorien_gal_inf"),
    (val_add, "$no_i4_lorien_gal_inf_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_i5_lorien_gal_royal_inf"),
    (val_add, "$no_i5_lorien_gal_royal_inf_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a1_riv_scout"),
    (val_add, "$no_a1_riv_scout_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a2_riv_vet_scout"),
    (val_add, "$no_a2_riv_vet_scout_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a3_riv_archer"),
    (val_add, "$no_a3_riv_archer_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a4_riv_vet_archer"),
    (val_add, "$no_a4_riv_vet_archer_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a5_riv_master_archer"),
    (val_add, "$no_rivendell_veteran_elite_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_ac6_riv_knight"),
    (val_add, "$no_ac6_riv_knight_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a1_greenwood_scout"),
    (val_add, "$no_a1_greenwood_scout_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a2_greenwood_veteran_scout"),
    (val_add, "$no_a2_greenwood_veteran_scout_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a3_greenwood_archer"),
    (val_add, "$no_a3_greenwood_archer_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a4_greenwood_veteran_archer"),
    (val_add, "$no_a4_greenwood_veteran_archer_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a5_greenwood_master_archer"),
    (val_add, "$no_a5_greenwood_master_archer_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_thranduil_s_royal_marksman"),
    (val_add, "$no_thranduil's_royal_marksman_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_i2_greenwood_infantry"),
    (val_add, "$no_i2_greenwood_infantry_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_i3_greenwood_vet_infantry"),
    (val_add, "$no_i3_greenwood_vet_infantry_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_i4_greenwood_elite_infantry"),
    (val_add, "$no_i4_greenwood_elite_infantry_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a1_lorien_scout"),
    (val_add, "$no_a1_lorien_scout_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a2_lorien_warden"),
    (val_add, "$no_a2_lorien_warden_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_i4_greenwood_elite_infantry"),
    (val_add, "$no_i4_greenwood_elite_infantry_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a3_lorien_vet_warden"),
    (val_add, "$no_a3_lorien_vet_warden_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a4_lorien_gal_warden"),
    (val_add, "$no_a4_lorien_gal_warden_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a5_lorien_gal_royal_warden"),
    (val_add, "$no_a5_lorien_gal_royal_warden_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a6_lorien_grey_warden"),
    (val_add, "$no_a6_lorien_grey_warden_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_galadhrim_royal_marksman"),
    (val_add, "$no_galadhrim_royal_marksman_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a2_lorien_archer"),
    (val_add, "$no_a2_lorien_archer_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a3_lorien_vet_archer"),
    (val_add, "$no_a3_lorien_vet_archer_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a4_lorien_gal_archer"),
    (val_add, "$no_a4_lorien_gal_archer_picked", "$number_of_troop_type"),
    (else_try),
    (eq, "$troop_to_pick", "trp_a5_lorien_gal_royal_archer"),
    (val_add, "$no_a5_lorien_gal_royal_archer_picked", "$number_of_troop_type"),
    (else_try),
...
(assign, "$rescue_companion_8", 0),
(assign, "$rescue_companion_9", 0),
(assign, "$no_a4_ithilien_ranger_picked", 0),
(assign, "$no_a5_ithilien_vet_ranger_picked", 0),
(assign, "$no_a6_ithilien_master_ranger_picked", 0),
(assign, "$no_a3_arnor_ranger_picked", 0),
(assign, "$no_a4_arnor_vet_ranger_picked", 0),
(assign, "$no_a5_arnor_master_ranger_picked", 0),
(assign, "$no_i6_frealaf_raider_picked", 0),
(assign, "$no_corsair_raider_picked", 0),
(assign, "$no_i4_corsair_raider_picked", 0),
(assign, "$no_i5_corsair_night_raider_picked", 0),
(assign, "$no_uruk_hai_scout_picked", 0),
(assign, "$no_large_uruk_hai_scout_picked", 0),
(assign, "$no_fighting_uruk_hai_scout_picked", 0),
(assign, "$no_a3_guldur_large_orc_tracker_picked", 0),
(assign, "$no_a4_guldur_fell_orc_tracker_picked", 0),
(assign, "$no_a4_corsair_assassin_picked", 0),
(assign, "$no_a5_corsair_master_assassin_picked", 0),
...
(assign, "$no_a1_riv_scout_picked", 0),
(assign, "$no_a2_riv_vet_scout_picked", 0),
(assign, "$no_a3_riv_archer_picked", 0),
(assign, "$no_a4_riv_vet_archer_picked", 0),
(assign, "$no_a5_riv_master_archer_picked", 0),
(assign, "$no_ac6_riv_knight_picked", 0),
(assign, "$no_a1_greenwood_scout_picked", 0),
(assign, "$no_a2_greenwood_veteran_scout_picked", 0),
(assign, "$no_a3_greenwood_archer_picked", 0),
(assign, "$no_a4_greenwood_veteran_archer_picked", 0),
(assign, "$no_a5_greenwood_master_archer_picked", 0),
(assign, "$no_thranduil's_royal_marksman_picked", 0),
(assign, "$no_i2_greenwood_infantry_picked", 0),
(assign, "$no_i3_greenwood_vet_infantry_picked", 0),
(assign, "$no_i4_greenwood_elite_infantry_picked", 0),
(assign, "$no_a1_lorien_scout_picked", 0),
(assign, "$no_a2_lorien_warden_picked", 0),
(assign, "$no_a3_lorien_vet_warden_picked", 0),
(assign, "$no_a4_lorien_gal_warden_picked", 0),
(assign, "$no_a5_lorien_gal_royal_warden_picked", 0),
(assign, "$no_a6_lorien_grey_warden_picked", 0),
(assign, "$no_galadhrim_royal_marksman_picked", 0),
(assign, "$no_i3_lorien_inf_picked", 0),
(assign, "$no_i4_lorien_gal_inf_picked", 0),
(assign, "$no_i5_lorien_gal_royal_inf_picked", 0),
(assign, "$no_a2_lorien_archer_picked", 0),
(assign, "$no_a3_lorien_vet_archer_picked", 0),
(assign, "$no_a4_lorien_gal_archer_picked", 0),
(assign, "$no_a5_lorien_gal_royal_archer_picked", 0),
...
(assign, "$guard_troop5", "trp_a4_gon_archer"),
...
(assign, "$wall_missile_troop1", "trp_a4_gon_archer"),
(assign, "$wall_missile_troop2", "trp_a4_gon_archer"),
(assign, "$wall_missile_troop3", "trp_a5_gon_vet_archer"),
(assign, "$wall_missile_troop4", "trp_a5_gon_vet_archer"),
(assign, "$wall_missile_troop5", "trp_master_yeoman_of_gondor"),
(assign, "$wall_mounted_troop1", "trp_c2_gon_squire"),
#(assign, "$wall_mounted_troop2", "trp_c4_gon_knight"),
(assign, "$wall_mounted_troop3", "trp_c4_gon_knight"),
#(assign, "$wall_mounted_troop4", "trp_c5_gon_vet_knight"),
(assign, "$wall_mounted_troop5", "trp_c5_gon_vet_knight"),
]), 
...
(assign, "$guard_troop2", "trp_i3_footman_of_rohan"),
(assign, "$guard_troop3", "trp_i3_footman_of_rohan"),
(assign, "$guard_troop4", "trp_i3_footman_of_rohan"),
(assign, "$guard_troop5", "trp_i3_footman_of_rohan"),
(assign, "$guard_troop6", "trp_i4_veteran_footman_of_rohan"),
(assign, "$guard_troop7", "trp_i5_elite_footman_of_rohan"),
(assign, "$guard_troop8", "trp_i5_elite_footman_of_rohan"),
(assign, "$guard_troop9", "trp_i5_raider_of_rohan"),
(assign, "$guard_troop10", "trp_i6_footman_guard_of_rohan"),
(assign, "$wall_missile_troop1", "trp_c3_rider_of_rohan"),
(assign, "$wall_missile_troop2", "trp_c3_rider_of_rohan"),
(assign, "$wall_missile_troop3", "trp_c4_veteran_rider_of_rohan"),
(assign, "$wall_missile_troop4", "trp_c5_elite_rider_of_rohan"),
(assign, "$wall_missile_troop5", "trp_c6_rider_guard_of_rohan"),
(assign, "$wall_mounted_troop1", "trp_c3_rider_of_rohan"),
#(assign, "$wall_mounted_troop2", "trp_c3_rider_of_rohan"),
(assign, "$wall_mounted_troop3", "trp_c4_veteran_rider_of_rohan"),
#(assign, "$wall_mounted_troop4", "trp_c4_veteran_rider_of_rohan"),
(assign, "$wall_mounted_troop5", "trp_c6_rider_guard_of_rohan"),
]), 
...
(assign, "$guard_troop6", "trp_i3_mordor_large_orc"),
(assign, "$guard_troop7", "trp_i3_mordor_large_orc"),
(assign, "$guard_troop8", "trp_i4_mordor_fell_orc"),
(assign, "$guard_troop9", "trp_i4_mordor_fell_orc"),
(assign, "$guard_troop10", "trp_mordor_olog_hai"),
(assign, "$wall_missile_troop1", "trp_a2_mordor_orc_archer"),
(assign, "$wall_missile_troop2", "trp_a2_mordor_orc_archer"),
(assign, "$wall_missile_troop3", "trp_a3_mordor_large_orc_archer"),
(assign, "$wall_missile_troop4", "trp_a3_mordor_large_orc_archer"),
(assign, "$wall_missile_troop5", "trp_a4_mordor_fell_orc_archer"),
(assign, "$wall_mounted_troop1", "trp_i3_mordor_large_orc"),
#(assign, "$wall_mounted_troop2", "trp_i3_mordor_large_orc"),
(assign, "$wall_mounted_troop3", "trp_i4_mordor_fell_orc"),
#(assign, "$wall_mounted_troop4", "trp_c3_mordor_warg_rider"),
(assign, "$wall_mounted_troop5", "trp_c4_mordor_great_warg_rider"),
]), 
...
(assign, "$guard_troop2", "trp_i2_isen_uruk"),
(assign, "$guard_troop3", "trp_i2_isen_uruk"),
(assign, "$guard_troop4", "trp_i2_isen_uruk"),
(assign, "$guard_troop5", "trp_uruk_hai_scout"),
(assign, "$guard_troop6", "trp_i3_isen_large_uruk"),
(assign, "$guard_troop7", "trp_i3_isen_large_uruk"),
(assign, "$guard_troop8", "trp_fighting_uruk_hai_scout"),
(assign, "$guard_troop9", "trp_i4_isen_fighting_uruk_warrior"),
(assign, "$guard_troop10", "trp_i5_isen_fighting_uruk_champion"),
...
(assign, "$wall_mounted_troop1", "trp_ac2_isen_wolf_rider"),
#(assign, "$wall_mounted_troop2", "trp_ac3_isen_warg_rider"),
(assign, "$wall_mounted_troop3", "trp_ac3_isen_warg_rider"),
#(assign, "$wall_mounted_troop4", "trp_ac4_isen_white_hand_rider"),
(assign, "$wall_mounted_troop5", "trp_i6_isen_uruk_berserker"),
]), 
...
(assign, "$formation_troop_7", "trp_i2_guardsman_of_rohan"),
(assign, "$formation_troop_8", "trp_i3_footman_of_rohan"),
(assign, "$formation_troop_9", "trp_i4_veteran_footman_of_rohan"),
(assign, "$formation_troop_10", "trp_i5_elite_footman_of_rohan"),
(assign, "$formation_troop_11", "trp_i6_footman_guard_of_rohan"),
(assign, "$formation_troop_12", "trp_i6_warden_of_methuseld"),
(assign, "$formation_troop_13", "trp_a2_lorien_archer"),
(assign, "$formation_troop_14", "trp_a3_lorien_vet_archer"),
(assign, "$formation_troop_15", "trp_a4_lorien_gal_archer"),
(assign, "$formation_troop_16", "trp_a5_lorien_gal_royal_archer"),
(assign, "$formation_troop_17", "trp_i2_greenwood_infantry"),
(assign, "$formation_troop_18", "trp_i3_greenwood_vet_infantry"),
(assign, "$formation_troop_19", "trp_i4_greenwood_elite_infantry"),
(assign, "$formation_troop_20", "trp_i3_isen_uruk_pikeman"),
(assign, "$formation_troop_21", "trp_i4_isen_fighting_uruk_pikeman"),
(assign, "$formation_troop_22", "trp_i4_corsair_veteran_spearman"),
(assign, "$formation_troop_23", "trp_i5_corsair_master_spearman"),
(assign, "$formation_troop_24", "trp_i5_corsair_master_pikeman"),
...
(assign, "$formation_troop_28", "trp_i5_mordor_black_uruk"),
...
(assign, "$formation_troop_32", "trp_i5_arnor_champion"),
...
(assign, "$formation_troop_1", "trp_a4_gon_archer"),
(assign, "$formation_troop_2", "trp_a5_gon_vet_archer"),
(assign, "$formation_troop_3", "trp_master_yeoman_of_gondor"),
(assign, "$formation_troop_4", "trp_a6_gon_tower_archer"),
(assign, "$formation_troop_5", "trp_a4_harad_archer"),
(assign, "$formation_troop_6", "trp_harad_veteran_archer"),
(assign, "$formation_troop_7", "trp_harad_master_archer"),
(assign, "$formation_troop_8", "trp_a1_blackroot_hunter"),
(assign, "$formation_troop_9", "trp_a2_blackroot_bowman"),
(assign, "$formation_troop_10", "trp_a3_blackroot_archer"),
...
(assign, "$formation_troop_14", "trp_a2_corsair_marine"),
(assign, "$formation_troop_15", "trp_a3_corsair_marksman"),
(assign, "$formation_troop_16", "trp_a4_corsair_veteran_marksman"),
(assign, "$formation_troop_17", "trp_a5_corsair_master_marksman"),
(assign, "$formation_troop_18", "trp_a2_mordor_orc_archer"),
(assign, "$formation_troop_19", "trp_a3_mordor_large_orc_archer"),
(assign, "$formation_troop_20", "trp_a4_mordor_fell_orc_archer"),
...
(assign, "$formation_troop_24", "trp_a4_ithilien_ranger"),
(assign, "$formation_troop_25", "trp_a5_ithilien_vet_ranger"),
(assign, "$formation_troop_26", "trp_a6_ithilien_master_ranger"),
...
(else_try),
    ...
    (try_begin),
        ...
        (party_add_members, "$eohere_party_id", "trp_c3_rider_of_rohan", ":local6"),
        (else_try),
        (ge, ":local5", 200),
    (try_end),
    ...
    (try_end),
    (party_add_leader, "$eohere_party_id", "trp_c6_king_s_man_of_rohan", 10),
...
("troop_daylight_modifications",[
   (try_begin),
    (eq, "$night_missile_penalty_active", 1),
        (try_for_range, reg1, "trp_c3_pinnath_knight", "trp_i1_amroth_recruit"),
    ...
    (try_end),
        (try_for_range, reg1, "trp_a4_gon_archer", "trp_i1_rohan_youth"),
        (troop_raise_proficiency_linear, reg1, 3, "$night_missile_penalty"),
        (troop_raise_proficiency_linear, reg1, 4, "$night_missile_penalty"),
        (troop_raise_proficiency_linear, reg1, 5, "$night_missile_penalty"),
    (try_end),
...
(try_end),
    ...
    (eq, "$orc_daylight_penalty_active", 0),
        (try_for_range, reg1, "trp_i1_isen_orc_snaga", "trp_i1_mordor_uruk_snaga"),
        (assign, reg2, -1),
    ...
    (try_end),
        (try_for_range, ":local0", "trp_i1_mordor_uruk_snaga", "trp_cave_troll"),
        (store_skill_level, ":local1", 13, ":local0"),
        (neg|eq, ":local1", 0),
        (val_mul, ":local1", -1),
        (troop_raise_skill, ":local0", 13, ":local1"),
    (try_end),
        (try_for_range, ":local2", "trp_i1_isen_orc_snaga", "trp_i1_mordor_uruk_snaga"),
        (neg|eq, reg1, "trp_ac2_isen_wolf_rider"),
        (neg|eq, reg1, "trp_ac3_isen_warg_rider"),
        (neg|eq, reg1, "trp_ac4_isen_white_hand_rider"),
        (neg|eq, reg1, "trp_c3_mordor_warg_rider"),
        (neg|eq, reg1, "trp_c4_mordor_great_warg_rider"),
...
(try_end),
    ...
    (try_end),
        (try_for_range, ":local0", "trp_i1_isen_orc_snaga", "trp_i1_mordor_uruk_snaga"),
        (neg|eq, ":local0", "trp_ac2_isen_wolf_rider"),
        (neg|eq, ":local0", "trp_ac3_isen_warg_rider"),
        (neg|eq, ":local0", "trp_ac4_isen_white_hand_rider"),
        (neg|eq, ":local0", "trp_c3_mordor_warg_rider"),
        (neg|eq, ":local0", "trp_c4_mordor_great_warg_rider"),
...
(store_random_in_range, ":local17", 2, 5),
    ...
    (party_add_members, ":local0", "trp_c3_rider_of_rohan", ":local17"),
(try_end),
(assign, reg0, 0),
(val_add, reg0, ":local3"),
(val_add, reg0, ":local4"),
