...
hp_shield_trigger = (ti_on_agent_hit, 0, 0, [
  ...
  [  
    ...
    (try_begin),
      ...
      #(display_message, "@chance {reg78}, current hp shield {reg77}"),
        ...
        (try_begin),
            ...
            (call_script, "script_agent_become_uncontrollable", ":agent", 1),
        (else_try), #running amok
            ...
            (call_script, "script_agent_become_uncontrollable", ":agent", 2),
    ...
    ### Berserkers begin ###
    (try_begin), #with every hit, there's a chances for activating berserk mode
        (troop_slot_eq, ":troop_id", slot_troop_is_berserker, 1),
        (agent_slot_eq, ":agent", slot_agent_troll_uncontrollable, 0),
        (gt, ":damage", 5),
        ...
        (call_script, "script_agent_become_uncontrollable", ":agent", 1),
        (agent_get_slot, ":morale_penalty", ":agent", slot_agent_morale_modifier),
        (val_add, ":morale_penalty", 150),
        (agent_set_slot, ":agent", slot_agent_morale_modifier, ":morale_penalty"),
        (agent_get_damage_modifier, ":damage_mod", ":agent"),
        (val_add, ":damage_mod", 30),
        (agent_set_damage_modifier, ":agent", ":damage_mod"),
...
tld_kill_or_wounded_triggers = (ti_on_agent_killed_or_wounded, 0, 0, [
  ...
  [
    ...
    (try_begin),
        ...
        (ge, "$tld_war_began",1), 
        (eq, ":killer", ":player"),
        (neg|key_clicked, 0x3e),
        (neg|key_is_down, 0x3e),
        (neg|key_clicked, 0x1d),
        (neg|key_is_down, 0x1d),
        (1726, ":i", ":killer", 0),
        (1570, ":type", ":i"),
        (this_or_next|eq, ":type", 0x00000002),
        (this_or_next|eq, ":type", 0x00000003),
        (this_or_next|eq, ":type", 0x00000004),
        (eq, ":type", 0x0000000a), 
        (store_agent_hit_points, ":hp", ":killer", 0),
        (troop_get_slot, ":y", 872, 15),
        (agent_get_slot, ":x", ":killer", 15),
        (try_begin),
            (lt, ":hp", 50),
            (eq, ":y", 1),
            (val_add, ":x", 1),
...
tld_animated_town_agents = [
  ...
  (1, 0, 0, [], [ #oh no and cheer
    ...
    (try_for_agents, ":agent"),
        ...
        (this_or_next|eq, ":entry", 24), #since not all captain slots are set yet, they may share troop type with regular troops
...
tld_positional_sound_props = [
  ...
  (3, 0, 0, [], [ # occasional sounds
    (set_fixed_point_multiplier, 100),
    (scene_prop_get_num_instances, ":num_props", "spr_sound_emitter_occasional_var1x10_plus_var2_scalable"),
    (try_for_range, ":count", 0, ":num_props"),
        (scene_prop_get_instance, ":instance_no", "spr_sound_emitter_occasional_var1x10_plus_var2_scalable", ":count"),
        (prop_instance_get_variation_id, ":sound", ":instance_no"),
        (val_mul, ":sound", 10),
        (prop_instance_get_variation_id_2, ":sound_2", ":instance_no"),
        (val_add, ":sound", ":sound_2"),
        (assign, reg76, ":sound"), 
        (prop_instance_get_scale, pos2, ":instance_no"),
        (position_get_scale_x, ":chance", pos2),     
  ...
  (3, 0, 0, [], [ # ambient sounds, replacing center ambiance while in range
    (set_fixed_point_multiplier, 100),
    (get_player_agent_no, ":player_agent"),
    (agent_get_position, pos4, ":player_agent"),
...
tld_points_of_interest = [
  ...
  (1.5, 0, 0, [], [ 
    ...
    (try_for_prop_instances, ":instance_no", "spr_secret_point_of_interest"), #points of interest
        ...
        (try_begin), #Minas Morgul citadel
            ...
            (try_begin),
                (lt, ":player_level", 14), 
                (store_random_in_range, ":chance", 3000, 10000),     
                (gt, ":chance", ":dist"),
                ...
                (try_begin), 
                    ...
                    (agent_set_animation, ":player_agent", "anim_strike_fly_back_rise"),
                    (agent_start_running_away, ":player_mount"),
                    (agent_stop_running_away, ":player_mount"),
                (else_try), 
                    (ge,":long_skretch",1),
                ...
                (try_end),
                (store_random_in_range, ":chance_2", 0, 10),     
                (gt, ":chance_2", 5),
                (agent_deliver_damage_to_agent, ":player_agent", ":player_agent", 10),                
                (try_begin),
                    (ge,":long_skretch",1),
        ...
        (else_try), #Rhun temple 
            ...
            (try_begin),          
                (lt, ":player_level", 12),
                (store_random_in_range, ":chance", 500, 4500),
                (assign, reg77, ":chance"),          
                (lt, ":chance", ":dist"),
        ...
        (else_try), #Gundabad
            ...
            (try_begin),          
                ...
                (else_try), 
                    (agent_set_animation, ":player_agent", "anim_nazgul_noooo_long"),
                (try_end),    
                (display_message, "@You are unable to oppose the power of this holy place."),
...
(ti_before_mission_start, 0, 0, [(eq, "$prev_day", 3),], #display terrain notification.
  ...
  (try_begin), #underground
   ...
   (try_begin),
      ...
      (troop_slot_eq, "trp_traits", slot_trait_ranger, 1),
      (display_message, "@As an experienced ranger, you are well adapted to fighting in rough terrain."),
    (try_end), 
...
(ti_on_agent_spawn, 0, 0, [(eq, "$prev_day", 3),],
  [
    ...
    (try_begin),
        ...
        (eq, "$terrain_condition", tc_swamp),
        (try_begin), #ranger trait
            (eq, ":troop_no", trp_player), 
            (troop_get_slot, ":trait_score", "trp_traits", slot_trait_ranger),
            (neq, ":trait_score", 1),
            (lt, ":movement_malus", 5),
            (val_add, ":trait_score", 2),
            (troop_set_slot, "trp_traits", slot_trait_ranger, ":trait_score"),
        (else_try),
            (eq, ":troop_no", trp_player),
            (troop_slot_eq, "trp_traits", slot_trait_ranger, 1),
            (val_sub, ":movement_malus", 10),
            (val_add, ":accuracy_mod", 5),
        (try_end),    
        (val_sub, ":horse_speed_mod", 10),
    ...
    (else_try), #night bonus/malus, also magic darkness
        ...
        (else_try),
            ...
            (val_sub, ":reload_speed_mod", 5),
            (val_sub, ":speed_mod", 10),
        (else_try), #night troop trait counter
            (troop_slot_eq, ":troop_no", slot_troop_is_night_troop, 1),
            (eq, ":agent_party", "p_main_party"),
            (troop_get_slot, ":trait_score", "trp_traits", slot_trait_night_fighter),
            (neq, ":trait_score", 1),
            (val_add, ":trait_score", 2),
            (troop_set_slot, "trp_traits", slot_trait_night_fighter, ":trait_score"),            
        (else_try),
            #(call_script, "script_cf_is_a_night_troop", ":troop_no"), #Night Troops Exceptions
            (neg|troop_slot_eq, ":troop_no", slot_troop_is_night_troop, 1),
            (val_sub, ":horse_speed_mod", 15),
            (val_sub, ":melee_damage_mod", 10),
            (val_sub, ":accuracy_mod", 20),
            (val_sub, ":reload_speed_mod", 10),
