  ...
  (1.5, 0, 0, [], [ 
    ...
    (try_for_prop_instances, ":instance_no", "spr_secret_point_of_interest"), #points of interest
        ...
        (else_try),
            ...
            (lt, ":dist", 1000),
            (ge, ":player_level", 8),
            (display_message, "@You endure the horrors of the unspeakable rituals in this sacred place. The cruel people of Rhun recognize the strength you have shown."),
    ...
    (try_for_prop_instances, ":instance_no", "spr_secret_guardian"), #guardians, can also be used for persons of interest, very nice!
        ...
        (try_begin),
            ...
            (agent_set_slot, ":agent", slot_agent_secret_guardian, ":rank_req"),
            (agent_get_troop_id, ":troop_no", ":agent"),
            #(assign, "$talk_context", tc_castle_gate), #previously unused talk context
            (try_begin),
                (lt, ":rank", ":rank_req"),
