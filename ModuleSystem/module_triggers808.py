...
(try_for_range, ":troop", "trp_brigand_lord", "trp_end_orc_uruk_troll"),
    ...
    (try_begin),
        ...
        (this_or_next|is_between, ":troop", "trp_easterling_hurler", "trp_i4_khand_pit_champion"),
        (this_or_next|is_between, ":troop", "trp_ac3_khand_skirmisher", "trp_i1_corsair_youth"),
        (this_or_next|is_between, ":troop", "trp_a2_corsair_marine", "trp_i3_corsair_swordsman"),
        (this_or_next|is_between, ":troop", "trp_a4_corsair_assassin", "trp_i4_corsair_veteran_spearman"),
        (this_or_next|is_between, ":troop", "trp_a2_mordor_orc_archer", "trp_wolf_rider_of_moria"),
        (this_or_next|is_between, ":troop", "trp_uruk_hai_scout", "trp_i6_isen_uruk_berserker"),
        ...
        (this_or_next|is_between, ":troop", "trp_c2_amroth_squire", "trp_lothlorien_scout"),
        ...
        (this_or_next|is_between, ":troop", "trp_i3_corsair_swordsman", "trp_a4_corsair_assassin"),
        (this_or_next|is_between, ":troop", "trp_c2_khand_pony_rider", "trp_easterling_hurler"),
        (this_or_next|is_between, ":troop", "trp_ac2_isen_wolf_rider", "trp_i1_mordor_orc_snaga"),
        (this_or_next|is_between, ":troop", "trp_wolf_rider_of_moria", "trp_snaga_of_moria"),
        (this_or_next|is_between, ":troop", "trp_c3_mordor_warg_rider", "trp_i2_mordor_morgul_orc"),
...
(try_end),
    ...
    (else_try),
        ...
        (store_random, reg8, 3),
        (party_add_members, reg2, "trp_a1_blackroot_hunter", reg8),
        (store_random, reg7, 3),
        (val_add, reg7, 1),
        (party_add_members, reg2, "trp_gondor_youth", reg7),
    (else_try),
        ...
        (store_random, reg8, 3),
        (party_add_members, reg2, "trp_c3_pinnath_knight", reg8),
        (store_random, reg7, 3),
        (val_add, reg7, 1),
        (party_add_members, reg2, "trp_gondor_youth", reg7),
    (else_try),
    ...
    (else_try),
        ...
        (store_random, reg8, 3),
        (party_add_members, reg2, "trp_i1_lam_clansman", reg8),
        (store_random, reg7, 3),
        (val_add, reg7, 1),
        (party_add_members, reg2, "trp_gondor_youth", reg7),
    (else_try),
        ...
        (store_random, reg8, 3),
        (party_add_members, reg2, "trp_i1_amroth_recruit", reg8),
        (store_random, reg7, 3),
        (party_add_members, reg2, "trp_c2_amroth_squire", reg7),
    (try_end),
(try_end),
    ...
    (store_random, reg7, 4),
    (val_add, reg7, 1),
    (party_add_members, reg2, "trp_i1_rohan_youth", reg7),
    (store_random, reg8, 2),
    (party_add_members, reg2, "trp_ec2_squire_of_rohan", reg8),
(try_end),
    ...
    (store_random, reg7, 5),
    (val_add, reg7, 1),
    (party_add_members, reg2, "trp_i1_mordor_orc_snaga", reg7),
    (store_random, reg7, 2),
    (val_add, reg7, 1),
    (party_add_members, reg2, "trp_i1_mordor_uruk_snaga", reg7),
    (store_random, reg8, 2),
    (try_begin),
        (eq, reg2, "p_osgiliath_mercs"),
        (party_add_members, reg2, "trp_i1_corsair_youth", reg8),
        (else_try),
        (eq, reg2, "p_morannon_mercs"),
        (party_add_members, reg2, "trp_i1_khand_bondsman", reg8),
        (else_try),
...
(try_end),
    ...
    (store_random, reg7, 4),
    (val_add, reg7, 1),
    (party_add_members, reg2, "trp_i1_isen_orc_snaga", reg7),
    (store_random, reg9, 3),
    (val_add, reg9, 1),
    (party_add_members, reg2, "trp_i1_isen_uruk_snaga", reg9),
    (store_random, reg8, 2),
...
(try_begin),
    ...
    (neg|gt, reg7, 4),
    (party_add_members, reg2, "trp_a4_ithilien_ranger", 1),
(try_end),
(try_begin),
    ...
    (store_random, reg8, 3),
    (party_add_members, reg2, "trp_i1_harad_levy", reg8),
    (party_add_members, reg2, "trp_i1_mordor_orc_snaga", reg8),
(try_end),
(try_begin),
    ...
    (store_random, reg8, 3),
    (party_add_members, reg2, "trp_i2_dun_warrior", reg8),
    (party_add_members, reg2, "trp_i1_isen_uruk_snaga", reg8),
(try_end),
(try_begin),
    ...
    (store_random, reg7, 6),
    (val_add, reg7, 1),
    (party_add_members, reg2, "trp_i1_corsair_youth", reg7),
    (store_random, reg8, 3),
    (party_add_members, reg2, "trp_i2_corsair_warrior", reg8),
    (party_add_members, reg2, "trp_i1_mordor_orc_snaga", reg8),
(try_end),
    ...
    (store_random, reg7, 6),
    (val_add, reg7, 1),
    (party_add_members, reg2, "trp_i1_khand_bondsman", reg7),
    (store_random, reg8, 3),
    (party_add_members, reg2, "trp_i2_khand_pit_dog", reg8),
    (party_add_members, reg2, "trp_i1_mordor_orc_snaga", reg8),
(try_end),
]),
...
(store_troop_count_companions, reg10, "trp_a3_guldur_large_orc_tracker", 0),
(store_troop_count_companions, reg11, "trp_a4_guldur_fell_orc_tracker", 0),
...
(try_end),
    ...
    (try_end),
        (try_for_range, reg8, "trp_i1_khand_bondsman", "trp_i1_corsair_youth"),
    ...
    (neg|eq, "$dunlanders_celebrate", 1),
        ...
        (party_remove_prisoners, reg6, reg5, reg4),
    (try_end),
        (try_for_range, reg8, "trp_dunnish_youth", "trp_i1_khand_bondsman"),
        (troop_raise_proficiency_linear, reg8, 0, "$evil_men_frenzy_bonus"),
        (troop_raise_proficiency_linear, reg8, 1, "$evil_men_frenzy_bonus"),
        (troop_raise_proficiency_linear, reg8, 2, "$evil_men_frenzy_bonus"),
        (troop_raise_proficiency_linear, reg8, 3, "$evil_men_frenzy_bonus"),
