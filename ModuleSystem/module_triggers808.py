...
(0, 0, , ti_once, [], [
(assign, "$peak_a1_lorien_scouts", 3),
...
(store_num_parties_of_template, reg2, "pt_a1_lorien_scouts"),
(neg|ge, reg2, "$peak_a1_lorien_scouts"),
], [
(store_random, reg5, 3, 0),
(val_add, reg5, "p_caras_galadhon"),
(set_spawn_radius, 1),
(spawn_around_party, reg5, "pt_a1_lorien_scouts"),
]),
...
(eq, "$war_has_begun", 1),], [
    ...
    (assign, "$peak_a1_lorien_scouts", 1),
    ...
    (assign, "$peak_a1_lorien_scouts", 2),
    (assign, "$elven_setback", 1),
    (assign, "$lothlorien_status_counter", 0),
(try_end),
]),
