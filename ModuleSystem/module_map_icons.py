...
#TLD army icons begin
  ...
  ("orc_x4",0,"orc_x4", avatar_scale, snd_footstep_grass, 0.15, 0.173, 0),
...
#  ("training_ground",mcn_no_shadow,"training", 0.35,0),
  ...
  ("castle_gondor_small",mcn_no_shadow,"Castle", 1.5,0,
   [(ti_on_init_map_icon,
      [ (store_trigger_param_1, ":center"),(party_slot_eq, ":center", slot_center_destroyed,1),
        (cur_map_icon_set_tableau_material, "tableau_icon_burnable","mesh_icon_castle1")])]),
  ("castle__gondor_full",mcn_no_shadow,"Castle_Full", 1.0,0,
   [(ti_on_init_map_icon,
      [ (store_trigger_param_1, ":center"),(party_slot_eq, ":center", slot_center_destroyed,1),
        (cur_map_icon_set_tableau_material, "tableau_icon_burnable","mesh_icon_castle1")])]),
  ("castle__gondor_wall",mcn_no_shadow,"Castle_Wall", 1.0,0,
   [(ti_on_init_map_icon,
      [ (store_trigger_param_1, ":center"),(party_slot_eq, ":center", slot_center_destroyed,1),
        (cur_map_icon_set_tableau_material, "tableau_icon_burnable","mesh_icon_castle1")])]),
  ("corsaircamp",mcn_no_shadow,"corsaircamp", 1.0,0),
  ("dolamroth",mcn_no_shadow,"dolamroth", 1.0,0,
   [(ti_on_init_map_icon,
      [ (store_trigger_param_1, ":center"),(party_slot_eq, ":center", slot_center_destroyed,1),
        (cur_map_icon_set_tableau_material, "tableau_icon_burnable","mesh_icon_dolamroth")])]),
  ...
  ("edoras",mcn_no_shadow,"Edoras", 1.0,0,
     [(ti_on_init_map_icon,
      [ (store_trigger_param_1, ":center"),(party_slot_eq, ":center", slot_center_destroyed,1),
        (cur_map_icon_set_tableau_material, "tableau_icon_burnable","mesh_icon_edoras")])]),
  ("field_a",mcn_no_shadow,"Fielda", 1.0,0),
  ("field_b",mcn_no_shadow,"Fieldb", 1.0,0),
  ("field_c",mcn_no_shadow,"Fieldc", 1.0,0),
  ("gondortown",mcn_no_shadow,"gondortown", 1.0,0,
    [(ti_on_init_map_icon,
      [ (store_trigger_param_1, ":center"),(party_slot_eq, ":center", slot_center_destroyed,1),
        (cur_map_icon_set_tableau_material, "tableau_icon_burnable","mesh_icon_gondor_town")])]),
  ("grove",mcn_no_shadow,"Grove", 0.45,0),
  ("hand_isen",mcn_no_shadow,"handsign", 0.26,0),
  ("haradcamp",mcn_no_shadow,"haradcamp", 1.0,0),
  ("helms_deep",mcn_no_shadow,"Helms_Deep", 0.7,0,
   [(ti_on_init_map_icon,
      [ (store_trigger_param_1, ":center"),(party_slot_eq, ":center", slot_center_destroyed,1),
  ...
  ("minas_tirith",mcn_no_shadow,"Minas_Tirith", 0.8,0, 0.0,-0.75,3.6,
   [(ti_on_init_map_icon,
      [ (store_trigger_param_1, ":center"),(party_slot_eq, ":center", slot_center_destroyed,1),
