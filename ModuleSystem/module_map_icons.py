    ...
    (ti_on_init_map_icon,
      [
         # (dialog_box, "@LOLOL","@INITIALIZED morannon"),
		   ...
		   (gt, "$savegame_version", 0), #InVain: We need this condition so the script doesn't fire before the savegame version is assigned in script_game_start
