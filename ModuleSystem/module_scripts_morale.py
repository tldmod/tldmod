  ...
  #script_coherence, overhauled by InVain
	...
	(try_for_agents,":agent"), #allies
        ...
        (try_begin),
            ...
            (try_end),
            (try_begin),
                (this_or_next|eq, ":troop_type", "trp_ithilien_captain"),
                (this_or_next|eq, ":troop_type", "trp_loss_captain"),
                (this_or_next|eq, ":troop_type", "trp_pel_captain"),
                (this_or_next|eq, ":troop_type", "trp_a6_pel_marine_leader"),
                (this_or_next|eq, ":troop_type", "trp_lam_captain"),
                (this_or_next|eq, ":troop_type", "trp_pinnath_captain"),
                (this_or_next|eq, ":troop_type", "trp_amroth_captain"),
                (eq, ":troop_type", "trp_gondor_captain"),
