...
skills = [
  ...
  ("leadership","Leadership",sf_base_att_cha,10,"Every point increases maximum number of troops you can command by 5 (3 for companions), increases your party morale and coherence in battle. Makes more and stronger volunteers willing to follow you (player only). (Cumulative skill)"),
  ...
  ("inventory_management","Party Management",sf_base_att_int,10,"Increases inventory capacity by +6 per skill level. Reduces food consumption by 5%% and upkeep for troops in your party by 3%% per level. (Leader skill)"), 
  ...
  ("tactics","Tactics",sf_base_att_int,10,"Improves battle advantage. Decreases battle join range for enemy parties and increases battle join range for friendly parties by 3%% per level. (Leader skill)"),
  ("tracking","Tracking",sf_base_att_int|sf_effects_party,10,"Tracks become more informative. (Party skill)"),
  ("trainer","Trainer",sf_base_att_cha,10,"Every day, each hero with this skill adds some experience to every other member of the party whose level is lower than his/hers. Experience gained goes as: {0,4,10,16,23,30,38,46,55,65,80}. (Cumulative skill)"),
  ...
  ("looting","Looting",sf_base_att_agi,10,"Increases amount and quality of loot gained after battles. (Cumulative skill)"), 
