...
skills = [
  ...
  ("tactics","Tactics",sf_base_att_int,10,"Improves battle advantage. Decreases battle join distance for enemy parties and increases battle join distance for friendly parties by 3% per level. (Leader skill)"),
