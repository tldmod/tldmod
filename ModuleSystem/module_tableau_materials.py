...
##       (cur_tableau_add_mesh, ":banner_mesh", pos1, ":banner_scale", 0),
  ...
  ("faction_note_mesh", 0, "pic_mb_warrior_1", 1024, 512, 0, 0, 500, 250,
   [ (store_script_param, ":faction_no", 1),
     (cur_tableau_set_background_color, 0xFFFFFFFF),
     (set_fixed_point_multiplier, 100),
     (try_begin),
       #background image
       (is_between, ":faction_no",  kingdoms_begin, kingdoms_end), #Excluding player kingdom
       (store_add, ":victory_mesh", "mesh_tp_victory_gondor", ":faction_no"),
       (val_sub, ":victory_mesh",  kingdoms_begin),
       (init_position, pos1),
       (position_set_x, pos1, -60),
       (position_set_y, pos1, -40),
       (cur_tableau_add_mesh, ":victory_mesh", pos1, 40, 0),
       ...
       (cur_tableau_add_mesh, ":banner_mesh", pos1, 21, 0),
       (cur_tableau_set_camera_parameters, 0, 100, 45, 0, 100000),
     (try_end),
     ]),
