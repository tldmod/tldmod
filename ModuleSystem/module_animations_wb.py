...
#Hoboistice begin
#Replaced 0, in anim code for ready/release fist anims with acf_rot_vertical_sword, so they're now aimable on the Y axis. Hooray.
...
##   [ready_durn, "anim_human", combat+8500, combat+8510, blend_in_ready], 
 ...
 #Hoboistice begin
 #Changed release time from 0.47 to 0.46 on onehanded and onehanded_horseback
...
#Hoboistice begin
#Replaced 0, with acf_rot_vertical_sword so you can aim Y axis while blocking with unarmed, left arm isn't moving correctly I'll have to look into it
  ["defend_fist", acf_rot_vertical_sword, amf_play|amf_restart|amf_priority_defend|amf_use_defend_speed|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
   [defend_duration, "anim_human", combat+4950, combat+4960, blend_in_defense], 
 ],
 ["defend_fist_keep", acf_rot_vertical_sword, amf_rider_rot_defend|amf_priority_defend|amf_keep|amf_rider_rot_defend|amf_client_owner_prediction,
...
##   [3.0, "anim_human", 70100, 70150, arf_blend_in_5],
   ...
   [2.5, "victory_cheer01", 0, 41, arf_blend_in_5],
   [2.5, "victory_cheer02", 0, 40, arf_blend_in_5],
 ],
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 #Hoboistice begin
 #Added the 30 missing 1.143 animations (crouching, musket reload in parts, upstab, what is used for 1h upstab, pistol partial reload, thrust_musket, and the pistol to melee swap animation.
 #Also added the Orc bow animation for pistol crouching so that if an Orc does crouch with a bow, he'll still use the right animation when shooting.
...
#swy-- added stand animations for cutscenes in wb, but with higher priority to override jumps.
 ...
 ["troll_pushback", acf_enforce_all, amf_client_prediction|amf_priority_die|amf_play|amf_start_instantly,
   [3.0, "troll_pushback", 0, 63, arf_blend_in_1],
 ],
 ...
 #["unused_human_anim_97", 0, 0, [1.0, "anim_human", 0, 1, 0]], - troll pushback
...
# Animal attack anims... (cppcoder, merlkir) - Fixed by Kham
 ["bear_slap_right", acf_enforce_all|acf_align_with_ground|acf_displace_position, amf_priority_rear|amf_play|amf_client_prediction, [1.4, "bear_slap_right", 1, 45, blend_in_walk|arf_use_walk_progress,pack4f(0.15,0.16,0.65,0.66), (0, 0.8, 0), 0.9]],
 ["bear_uppercut",   acf_enforce_all|acf_align_with_ground|acf_displace_position, amf_priority_rear|amf_play|amf_client_prediction, [1.4, "bear_uppercut", 44, 93, blend_in_walk|arf_use_walk_progress,pack4f(0.15,0.16,0.65,0.66), (0, 0.7, 0), 0.9]],
 ...
 ["bear_slam", acf_enforce_all|acf_align_with_ground|acf_displace_position, amf_priority_rear|amf_play|amf_client_prediction, [1.6, "bear_slam", 1, 45, arf_blend_in_4|arf_use_walk_progress,pack4f(0.15,0.16,0.65,0.66), (0, -0.5, 0), 0.9]],
