...
("evil_gondor_gate_house",0,"mt_gate_house_evil", "bo_mt_gate_house_evil",
[
	(ti_on_scene_prop_init,
    [
        ...
        (try_begin),
        	...
        	(eq, "$bright_nights", 1),
        	# --
        	(set_fog_distance,450,0x07291D),
        	(assign, "$base_fog", 450),
        (else_try),
        	(is_currently_night),
        	# --
        	(set_fog_distance,200,0x07291D),
        	(assign, "$base_fog", 200),
] + (is_a_wb_sceneprop==1 and [
        	(set_startup_ambient_light, 40, 40, 50),
        	(set_startup_sun_light, 5, 5, 10),
        	(set_startup_ground_ambient_light, 25, 25, 25),
] or []) + [ 
        (else_try),
...
("gate_destructible",sokf_destructible,"gate_tld","bo_gate_tld",   [ 
   ...
   (prop_instance_get_variation_id_2, ":health", ":instance_no"),
	...
	# make aggravator a statue (WB Only)
...
#Unused
("tree0_yellow_flower_DONT_USE", 0, "yellow_flower", "0", []),
("tree1_yellow_flower_DONT_USE", 0, "tree_e_2","bo_tree_e_2", []),
...
("tree1_aspen_a_DONT_USE", 0, "aspen_a", "bo_aspen_a", []),
("tree1_aspen_b_DONT_USE", 0, "aspen_b", "bo_aspen_b", []),
("tree1_aspen_c_DONT_USE", 0, "aspen_c", "bo_aspen_c", []),
("tree1_pine_1_a_DONT_USE", 0, "pine_1_a", "bo_pine_1_a", []),
("tree1_pine_1_b_DONT_USE", 0, "pine_1_b", "bo_pine_1_b", []),
("tree1_pine_2_a_DONT_USE", 0, "pine_2_a", "bo_pine_2_a", []),
("tree1_pine_3_a_DONT_USE", 0, "pine_3_a", "bo_pine_3_a", []),
("tree1_pine_4_a_DONT_USE", 0, "pine_4_a", "bo_pine_4_a", []),
("tree1_rock_c_DONT_USE", 0, "rock_c", "bo_rock_c", []),
("tree1_beech_d_DONT_USE", 0, "beech_d", "bo_beech_d", []),
("tree1_beech_e_DONT_USE", 0, "beech_e", "bo_beech_e", []),
("trees_end_DONT_USE", 0, "spike_a", "0", []), 
...
("morannon_gate",0,"morannon_gate","bo_morannon_gate", [
     (ti_on_scene_prop_init,[ (set_fixed_point_multiplier, 100), 
         ...
         (else_try),(is_currently_night),(set_fog_distance,450,0x150101),  (assign, "$base_fog", 450),
			...
			(set_startup_ambient_light, 25, 25, 25),(set_startup_sun_light, 5, 5, 5),(set_startup_ground_ambient_light, 12, 12, 12),
] or []) + [ 
         (else_try),(set_fog_distance,800,0x150101), (assign, "$base_fog", 800),
] + (is_a_wb_sceneprop==1 and [
	(set_startup_ambient_light, 40, 40, 40),(set_startup_sun_light, 10, 10, 10),(set_startup_ground_ambient_light, 12, 12, 12),
] or []) + [ 
         (try_end),
     ])]),
...
("fog_darkish_glow",sokf_invisible|sokf_place_at_origin,"collision_cube", "0", [ #Mordor and Minas Tirith siege, Erebor
     ...
     (prop_instance_get_scale, pos1, ":instance_no"), (position_get_scale_x, ":scale", pos1),
         ...
         (else_try),
           (is_currently_night),
           # --
           (set_fog_distance,130,0x010101),
           (val_div, ":scale", 2),
] + (is_a_wb_sceneprop==1 and [
           (set_startup_ambient_light, 25, 25, 25),(set_startup_sun_light, 5, 5, 5),(set_startup_sun_light, 2, 2, 2),(set_startup_ground_ambient_light, 12, 12, 12),
] or []) + [ 
         (else_try),
     ...
     (ti_on_scene_prop_init,[ (set_fixed_point_multiplier, 1000),
        (assign, "$base_fog_color", 0x07291D),
         (try_begin),
            (is_currently_night),
            (eq, "$bright_nights", 1),
            (set_fog_distance,450,0x07291D), (assign, "$base_fog", 450),
         (else_try),
            (is_currently_night),
            (set_fog_distance,450,0x07291D), (assign, "$base_fog", 450),
          ] + (is_a_wb_sceneprop==1 and [
            (set_startup_ambient_light, 25, 40, 25), (set_startup_sun_light, 5, 5, 5), (set_startup_ground_ambient_light, 12, 30, 12),
          ] or []) + [ 
         (else_try),
...
("troop_troll_fight_duel",sokf_invisible,"arrow_helper_blue","0", [(ti_on_init_scene_prop,[
    ...
    (scene_prop_set_slot, ":instance_no", slot_prop_agent_1, ":fighter_1"),(agent_set_team, ":fighter_1", 0),(agent_ai_set_interact_with_player, ":fighter_1", 0),(agent_set_is_alarmed, ":fighter_1", 1),(agent_set_no_death_knock_down_only, ":fighter_1", 1),  (agent_set_damage_modifier, ":fighter_1", 0),
    (position_move_y, pos1, 300,0),
    (position_rotate_z, pos1, 180),
    (set_spawn_position, pos1),
    (spawn_agent, ":troop"),(assign, ":fighter_2", reg0),
    (scene_prop_set_slot, ":instance_no", slot_prop_agent_2, ":fighter_2"),
    (agent_set_team, ":fighter_2", 0),(agent_ai_set_interact_with_player, ":fighter_2", 0),(agent_set_is_alarmed, ":fighter_2", 1),(agent_set_no_death_knock_down_only, ":fighter_2", 1), (agent_set_damage_modifier, ":fighter_2", 0),
    (agent_add_relation_with_agent, ":fighter_2", ":fighter_1", -1),(agent_add_relation_with_agent, ":fighter_1", ":fighter_2", -1),
] or []) + [  
  ])]),
...
("troop_human_prisoner_oh_no",sokf_invisible,"arrow_helper_blue","0",
[(ti_on_init_scene_prop,
    [
    (store_trigger_param_1, ":instance_no"),
    (prop_instance_get_position, pos1, ":instance_no"), (set_spawn_position, pos1),
...
("secret_loot_prop",sokf_invisible|sokf_moveable|spr_use_time(2),"sphere_30cm","bo_sphere_30cm", [ 
  ...
  ("secret_viewpoint", sokf_invisible|sokf_moveable, "arrow_helper_blue", "bo_sphere_30cm", []), 
]) + [  
