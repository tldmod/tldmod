...
##  ("triumph", "triumph.mp3", mtf_sit_attack),
  ...
  ("infiltration_khergit", "TLD_Infiltration_Evil.mp3", mtf_module_track|mtf_culture_3|mtf_sit_town_infiltrate, mtf_culture_all),

  ("killed_by_khergit", "TLD_Killed_By_Evil.mp3", mtf_module_track|mtf_persist_until_finished|mtf_culture_3|mtf_sit_killed, 0),
  ...
  ("lords_hall_vaegir", "TLD_Rohan_LordHall.mp3", mtf_module_track|mtf_sit_travel, mtf_sit_town|mtf_sit_night|mtf_sit_tavern),
#culture 7
...
#culture8
  ...
  ("victorious_evil", "TLD_Victory_Evil_1.mp3", mtf_module_track|mtf_persist_until_finished, 0),
  ...
  ("victorious_swadian", "TLD_Victory_Good_1.mp3", mtf_module_track|mtf_persist_until_finished|mtf_culture_2|mtf_sit_victorious, 0),
  ("victorious_vaegir", "TLD_Victory_Good_2.mp3", mtf_module_track|mtf_persist_until_finished|mtf_culture_2|mtf_sit_victorious, 0),
  ("victorious_vaegir_2", "TLD_Victory_Good_3.mp3", mtf_module_track|mtf_persist_until_finished|mtf_culture_2|mtf_sit_victorious, 0),
]
