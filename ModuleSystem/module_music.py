...
("TLD_Map_Day_A", "Day-Night-Map\TLD_Map_Day_A.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night),
("TLD_Map_Day_B", "Day-Night-Map\TLD_Map_Day_B.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night),
("TLD_Map_Day_C", "Day-Night-Map\TLD_Map_Day_C.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night),
("TLD_Map_Day_D", "Day-Night-Map\TLD_Map_Day_D.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night),
("TLD_Map_Day_E", "Day-Night-Map\TLD_Map_Day_E.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night),
("TLD_Map_Day_F", "Day-Night-Map\TLD_Map_Day_F.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night),
("TLD_Map_Day_G", "Day-Night-Map\TLD_Map_Day_G.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night),
("TLD_Map_Day_H", "Day-Night-Map\TLD_Map_Day_H.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night),
...
("TLD_Map_Dunland_A", "Day-Night-Map\TLD_Map_Dunland_A.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_evilmen),
("TLD_Map_Dunland_B", "Day-Night-Map\TLD_Map_Dunland_B.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_evilmen),
("TLD_Map_Dwarves_A", "Day-Night-Map\TLD_Map_Dwarves_A.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_rohan_goodmen),
("TLD_Map_Dwarves_B", "Day-Night-Map\TLD_Map_Dwarves_B.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_rohan_goodmen),
("TLD_Map_Dwarves_C", "Day-Night-Map\TLD_Map_Dwarves_C.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_rohan_goodmen),
("TLD_Map_Elven_A", "Day-Night-Map\TLD_Map_Elven_A.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_elves),
("TLD_Map_Elven_B", "Day-Night-Map\TLD_Map_Elven_B.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_elves),
("TLD_Map_Elven_C", "Day-Night-Map\TLD_Map_Elven_C.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_elves),
("TLD_Map_Elven_D", "Day-Night-Map\TLD_Map_Elven_D.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_elves),
("TLD_Map_Elven_E", "Day-Night-Map\TLD_Map_Elven_E.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_elves),
("TLD_Map_Gondor_A", "Day-Night-Map\TLD_Map_Gondor_A.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_gondor),
("TLD_Map_Gondor_B", "Day-Night-Map\TLD_Map_Gondor_B.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_gondor),
("TLD_Map_Gondor_C", "Day-Night-Map\TLD_Map_Gondor_C.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_gondor),
("TLD_Map_Gondor_D", "Day-Night-Map\TLD_Map_Gondor_D.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_gondor),
("TLD_Map_Gondor_E", "Day-Night-Map\TLD_Map_Gondor_E.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_gondor),
("TLD_Map_Harad_A", "Day-Night-Map\TLD_Map_Harad_A.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_harad),
("TLD_Map_Harad_B", "Day-Night-Map\TLD_Map_Harad_B.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_harad),
("TLD_Map_Harad_C", "Day-Night-Map\TLD_Map_Harad_C.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_harad),
("TLD_Map_Harad_D", "Day-Night-Map\TLD_Map_Harad_D.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_harad),
("TLD_Map_Khand_A", "Day-Night-Map\TLD_Map_Khand_A.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_evilmen),
("TLD_Map_Khand_B", "Day-Night-Map\TLD_Map_Khand_B.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_evilmen),
("TLD_Map_Khand_C", "Day-Night-Map\TLD_Map_Khand_C.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_evilmen),
("TLD_Map_Orcs_A", "Day-Night-Map\TLD_Map_Orcs_A.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_orcs),
("TLD_Map_Orcs_B", "Day-Night-Map\TLD_Map_Orcs_B.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_orcs),
("TLD_Map_Orcs_C", "Day-Night-Map\TLD_Map_Orcs_C.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_orcs),
("TLD_Map_Orcs_D", "Day-Night-Map\TLD_Map_Orcs_D.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_orcs),
("TLD_Map_Rohan_A", "Day-Night-Map\TLD_Map_Rohan_A.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_rohan_goodmen),
("TLD_Map_Rohan_B", "Day-Night-Map\TLD_Map_Rohan_B.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_rohan_goodmen),
("TLD_Map_Rohan_C", "Day-Night-Map\TLD_Map_Rohan_C.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_rohan_goodmen),
("TLD_Map_Rohan_D", "Day-Night-Map\TLD_Map_Rohan_D.mp3", mtf_module_track, mtf_sit_travel|mtf_sit_night|mtf_culture_rohan_goodmen),
