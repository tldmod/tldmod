  ...
  (3,[
    ...
    (try_begin),
      ...
      (try_for_range, ":enemy_faction", kingdoms_begin, kingdoms_end),
        ...
        (faction_get_slot, ":enemy_faction_side", ":enemy_faction", slot_faction_side),
        (try_for_range, ":besieger_heroes", kingdom_heroes_begin, kingdom_heroes_end),
          ...
          (faction_get_slot, ":attacker_faction_theater", ":lord_faction", slot_faction_active_theater),
          (eq, ":attacker_faction_theater", ":enemy_faction_current_theater"),
          (neg|faction_slot_eq, ":lord_faction", slot_faction_side, ":enemy_faction_side"),
          (troop_get_slot, ":lord_party", ":besieger_heroes", slot_troop_leaded_party),
          (party_is_active, ":lord_party"),
          (neg|party_slot_eq, ":lord_party", slot_party_type, spt_kingdom_hero_alone), #Should not be alone
          (call_script, "script_party_count_fit_regulars", ":lord_party"), 
          (ge, reg0, tld_siege_min_party_size),
          (faction_set_slot, ":lord_faction", slot_faction_state, sfai_attacking_center),
          ...
          (party_set_slot, ":lord_party", slot_party_scripted_ai, 1),
          (party_set_ai_initiative, ":lord_party", 0),
          (str_store_troop_name, s31, ":besieger_heroes"),
