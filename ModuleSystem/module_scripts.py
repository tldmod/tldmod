  ...
  ("tld_training_equip_entry_point",
   [
     ...
     (try_begin),
       ...
       (try_begin),
         (eq, "$g_talk_troop", "trp_trainer_gondor"),
       ...
       (else_try),
         (eq, "$g_talk_troop", "trp_trainer_elf"),
         (mission_tpl_entry_add_override_item, "mt_training_ground_training", ":entry_point", "itm_green_tunic"),
       (else_try),
       ...
       (else_try),
         (eq, "$g_talk_troop", "trp_trainer_dale"),
       ...
       (else_try),
         ...
         (mission_tpl_entry_add_override_item, "mt_training_ground_training", ":entry_point", "itm_red_tunic"),
       (else_try),
         (eq, "$g_talk_troop", "trp_trainer_rhun"),
         (mission_tpl_entry_add_override_item, "mt_training_ground_training", ":entry_point", "itm_black_tunic"),
       (else_try),
         (eq, "$g_talk_troop", "trp_trainer_khand"),
         (mission_tpl_entry_add_override_item, "mt_training_ground_training", ":entry_point", "itm_white_tunic_b"),
       (else_try),
         (eq, "$g_talk_troop", "trp_trainer_beorn"),
         (mission_tpl_entry_add_override_item, "mt_training_ground_training", ":entry_point", "itm_beorn_tunic"),
       (else_try),
         #(eq, "$g_talk_troop", "trp_trainer_mordor"), #or isengard - for all orcs
         (mission_tpl_entry_add_override_item, "mt_training_ground_training", ":entry_point", "itm_evil_light_armor"),
       (try_end),
     (else_try),  #opponents
       (try_begin),
         (eq, "$g_talk_troop", "trp_trainer_gondor"),
     ...
     (else_try),
       ...
       (assign, ":item_1", "itm_arena_sword_two_handed"),
     (else_try),
       #(eq, ":weapon_type", itp_type_polearm),
       (try_begin),
         (eq, ":is_mounted", 1),
         (assign, ":item_1", "itm_arena_lance"),
         (assign, ":item_2", "itm_tab_shield_small_round_b"),
       (else_try),
...
#GA: cultures used only for music in TLD
...
(store_agent_hit_points, ":hp", ":compagent", 0),
(try_begin),
    (neg|ge, ":hp", ":local1"),
    (faction_set_slot, "fac_mission_companion_10", slot_fcomp_hp, ":hp"),
(try_end),
...
(try_end),
(get_player_agent_no, ":player"),
(faction_set_slot, "fac_mission_companion_10", slot_fcomp_agentid, ":player"),
(try_for_agents, ":agent"),
    (neg|eq, ":agent", ":player"),
    (agent_is_ally, ":agent"),
    (agent_is_human, ":agent"),
