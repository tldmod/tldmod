  ...
  ("game_get_item_extra_text",
    [ (store_script_param, ":item_no", 1),
      ...
      (else_try),
		...
		(try_begin),(eq, ":extra_text_id", 0),(set_result_string, "@+1 to Athletics"),(set_trigger_result, 0xFFEEDD),(try_end),
      ...
      (else_try),
		...
		(try_begin),(eq, ":extra_text_id", 0),(set_result_string, "@+1 to Weapon Mastery"),(set_trigger_result, 0xFFEEDD),(try_end),
      (else_try),
		(eq,":item_no","itm_garlic_reward"),
		(try_begin),(eq, ":extra_text_id", 0),(set_result_string, "@+1 to Wound Treatment"),(set_trigger_result, 0xFFEEDD),(try_end),
      (else_try),
		(eq,":item_no","itm_scroll_reward"),
		(try_begin),(eq, ":extra_text_id", 0),(set_result_string, "@+1 to Tactics"),(set_trigger_result, 0xFFEEDD),(try_end),
      (else_try),
		(this_or_next|eq,":item_no","itm_westernesse1h_reward"),
		(this_or_next|eq,":item_no","itm_westernesse2h_reward"),
		(eq,":item_no","itm_torque_reward"),
		(try_begin),(eq, ":extra_text_id", 0),(set_result_string, "@+1 to Power Strike"),(set_trigger_result, 0xFFEEDD),(try_end),
      (else_try),
		(eq,":item_no","itm_ring_a_reward"),
		(try_begin),(eq, ":extra_text_id", 0),(set_result_string, "@+1 to Strength"),(set_trigger_result, 0xFFEEDD),(try_end),
      (else_try),
		(eq,":item_no","itm_ring_b_reward"),
		(try_begin),(eq, ":extra_text_id", 0),(set_result_string, "@+1 to Agility"),(set_trigger_result, 0xFFEEDD),(try_end),
      (else_try),
		(eq,":item_no","itm_herbarium_reward"),
		(try_begin),(eq, ":extra_text_id", 0),(set_result_string, "@+1 to Wound Treatment"),(set_trigger_result, 0xFFEEDD),(try_end),
      (else_try),
		(eq,":item_no","itm_silmarillion_reward"),
		(try_begin),(eq, ":extra_text_id", 0),(set_result_string, "@+1 to Leadership"),(set_trigger_result, 0xFFEEDD),(try_end),
      (else_try),
		(eq,":item_no","itm_elven_amulet_reward"),
		(try_begin),(eq, ":extra_text_id", 0),(set_result_string, "@+1 to Power Draw"),(set_trigger_result, 0xFFEEDD),(try_end),
      (else_try),
		(eq,":item_no","itm_angmar_whip_reward"),
		(try_begin),(eq, ":extra_text_id", 0),(set_result_string, "@+1 to Trainer"),(set_trigger_result, 0xFFEEDD),(try_end),
      (else_try),
  ...
  ("game_get_skill_modifier_for_troop",
   [(store_script_param, ":troop_no", 1),
    ...
    (else_try),
      ...
      (call_script, "script_get_troop_item_amount", ":troop_no", "itm_westernesse1h_reward"),
      (try_begin),
        (gt, reg0, 0),
        (val_add, ":modifier_value", 1),
      (try_end),
      (call_script, "script_get_troop_item_amount", ":troop_no", "itm_westernesse2h_reward"),
      (try_begin),
        (gt, reg0, 0),
        (val_add, ":modifier_value", 1),
      (try_end),
...
##
  ...
  #script_update_villages_infested_by_bandits - TLD: or don't
...
##         (display_message, "@{reg1} Deserters spawned from {s1}, near {s2}."),
  ...
  ("apply_attribute_bonuses",
    ...
    # Tulcarisil, STR+1
    (try_begin),
      (call_script, "script_get_troop_item_amount", "trp_player", "itm_ring_a_reward"),
      (gt, reg0, 0),
      (try_begin), # just got it
        (item_slot_eq, "itm_ring_a_reward", slot_item_strength_bonus, 0),
        (troop_raise_attribute, "trp_player", ca_strength, 1),
        (item_set_slot, "itm_ring_a_reward", slot_item_strength_bonus, 1),
      (try_end),
    (else_try), #lost it
      (item_slot_eq, "itm_ring_a_reward", slot_item_strength_bonus, 1),
      (troop_raise_attribute, "trp_player", ca_strength, -1),
      (item_set_slot, "itm_ring_a_reward", slot_item_strength_bonus, 0),
    (try_end),
    
    # Finwarisil, AGI+1
    (try_begin),
      (call_script, "script_get_troop_item_amount", "trp_player", "itm_ring_b_reward"),
      (gt, reg0, 0),
      (try_begin), # just got it
        (item_slot_eq, "itm_ring_b_reward", slot_item_agility_bonus, 0),
        (troop_raise_attribute, "trp_player", ca_agility, 1),
        (item_set_slot, "itm_ring_b_reward", slot_item_agility_bonus, 1),
      (try_end),
    (else_try), #lost it
      (item_slot_eq, "itm_ring_b_reward", slot_item_agility_bonus, 1),
      (troop_raise_attribute, "trp_player", ca_agility, -1),
      (item_set_slot, "itm_ring_b_reward", slot_item_agility_bonus, 0),
    (try_end),

    # Light of Galadriel, INT+1
    (try_begin),
      (call_script, "script_get_troop_item_amount", "trp_player", "itm_phial_reward"),
      (gt, reg0, 0),
      (try_begin), # just got it
        (item_slot_eq, "itm_phial_reward", slot_item_intelligence_bonus, 0),
        (troop_raise_attribute, "trp_player", ca_intelligence, 1),
        (item_set_slot, "itm_phial_reward", slot_item_intelligence_bonus, 1),
      (try_end),
    (else_try), #lost it
      (item_slot_eq, "itm_phial_reward", slot_item_intelligence_bonus, 1),
      (troop_raise_attribute, "trp_player", ca_intelligence, -1),
      (item_set_slot, "itm_phial_reward", slot_item_intelligence_bonus, 0),
    (try_end),

    # Horn of Gondor, CHA+1
    (try_begin),
      (call_script, "script_get_troop_item_amount", "trp_player", "itm_horn_gondor_reward"),
      (gt, reg0, 0),
      (try_begin), # just got it
        (item_slot_eq, "itm_horn_gondor_reward", slot_item_charisma_bonus, 0),
        (troop_raise_attribute, "trp_player", ca_charisma, 1),
        (item_set_slot, "itm_horn_gondor_reward", slot_item_charisma_bonus, 1),
      (try_end),
    (else_try), #lost it
      (item_slot_eq, "itm_horn_gondor_reward", slot_item_charisma_bonus, 1),
      (troop_raise_attribute, "trp_player", ca_charisma, -1),
      (item_set_slot, "itm_horn_gondor_reward", slot_item_charisma_bonus, 0),
    (try_end),
