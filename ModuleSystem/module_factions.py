...
##TLD FACTIONS BEGIN##########
  ...
  ("woodelf",    "Woodelves",  0,0.5,[("gondor", 0.5),("rohan", 0.2),("lorien", 0.5 ),("imladris", 0.5 ),                  ("mordor",-0.2),("harad",-0.05),("rhun",-0.05),("khand",-0.05),("dunland",-0.05),("umbar",-0.05),("isengard",-0.05),("moria",-0.5),("guldur",-0.5),("gundabad",-0.5),("dale", 0.0),("dwarf", 0.0),("beorn", 0.2),("tribal_orcs",-0.5),("outlaws",-0.05)], [], 0x5EFFA9),
  ...
  ("dunland",    "Dunlanders", 0,0.5,[("gondor",-0.5),("rohan",-0.5),("lorien",-0.05),("imladris",-0.05),("woodelf",-0.05),("mordor", 0.5),("harad", 0.5 ),("rhun", 0.5 ),("khand", 0.5 ),                  ("umbar", 0.5 ),("isengard", 0.5 ),("moria", 0.5),("guldur", 0.5),("gundabad", 0.5),("dale",-0.2),("dwarf",-0.2),("beorn",-0.2),("tribal_orcs",-0.5)], [], 0xFF4800),
