...
##TLD FACTIONS BEGIN##########
  ...
  ("rohan",     "Rohan",      0,0.5,[("gondor", 0.2),               ("lorien", 0.1),("imladris", 0.1),("woodelf", 0.1),("mordor",-0.5),("harad",-0.5),("rhun",-0.5),("khand",-0.5),("dunland",-0.5),("umbar",-0.5),("isengard",-0.5),("moria",-0.5),("guldur",-0.5),("gundabad",-0.5),("dale", 0.5),("dwarf", 0.2),("beorn", 0.2),("tribal_orcs",-0.5),("outlaws",-0.15),("player_faction", 0.20)], [], 0x0DFF00),
  ...
  ("woodelf","The Woodland Realm",0,0.5,[("gondor", 0.5),("rohan", 0.2),("lorien", 0.5),("imladris", 0.5),                 ("mordor",-0.2),("harad",-0.1),("rhun",-0.1),("khand",-0.1),("dunland",-0.1),("umbar",-0.1),("isengard",-0.1),("moria",-0.5),("guldur",-0.9),("gundabad",-0.5),("dale", 0.1),("dwarf", 0.1),("beorn", 0.2),("tribal_orcs",-0.5),("outlaws",-0.05)                         ], [], 0x5EFFA9),
  ...
  ("umbar",     "Umbar",      0,0.5,[("gondor",-0.5),("rohan",-0.5),("lorien",-0.5),("imladris",-0.5),("woodelf",-0.5),("mordor", 0.5),("harad", 0.5),("rhun", 0.5),("khand", 0.5),("dunland", 0.5),               ("isengard", 0.5),("moria", 0.5),("guldur", 0.5),("gundabad", 0.5),("dale",-0.2),("dwarf",-0.2),("beorn",-0.2),("tribal_orcs",-0.5)                                           ], [], 0xff21cd),
  ("moria",     "Moria",      0,0.5,[("gondor",-0.5),("rohan",-0.5),("lorien",-0.5),("imladris",-0.5),("woodelf",-0.5),("mordor", 0.5),("harad", 0.5),("rhun", 0.5),("khand", 0.5),("dunland", 0.5),("umbar", 0.5),("isengard", 0.5),               ("guldur", 0.5),("gundabad", 0.5),("dale",-0.2),("dwarf",-0.2),("beorn",-0.2),("tribal_orcs",-0.5)                                           ], [], 0xff6f21),
