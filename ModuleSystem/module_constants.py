...
("p_town_dol_amroth", ["scn_dol_amroth_center", "scn_dol_amroth_castle", "scn_gondor_prison","scn_gondor_tavern","scn_gondor_arena","scn_dol_amroth_siege","mesh_town_dol_amroth"],
	["trp_barman_dolamroth", "trp_smith_dolamroth", "trp_merchant_dolamroth", "trp_elder_dolamroth", "pt_dol_amroth_recruits", "trp_gondor_lord", "trp_walker_woman_gondor_bw","trp_walker_man_gondor_white","trp_walker_man_gondor_blue","trp_walker_woman_gondor_b"], 
...
("p_town_lossarnach", ["scn_lossarnach_center", "scn_gondor_castle", "scn_gondor_prison","scn_gondor_tavern","scn_gondor_arena","scn_lossarnach_siege", "mesh_town_lossarnach"],
	["trp_barman_lossarnach", "trp_smith_lossarnach", "trp_merchant_lossarnach", "trp_elder_lossarnach", "pt_lossarnach_recruits", "trp_gondor_lord", "trp_walker_woman_gondor_bw","trp_walker_man_gondor_blue","trp_walker_man_gondor_green","trp_walker_woman_gondor_b"], 
...
("p_town_erech", ["scn_erech_center", "scn_gondor_castle", "scn_gondor_prison","scn_gondor_tavern","scn_gondor_arena","scn_erech_siege", "mesh_town_erech"],
	["trp_barman_erech", "trp_smith_erech", "trp_merchant_erech", "trp_elder_erech", "pt_blackroot_recruits", "trp_gondor_lord", "trp_walker_woman_gondor_bw","trp_walker_man_gondor_black","trp_walker_man_gondor_green","trp_walker_woman_gondor_b"], 
...
("p_town_pinnath_gelin", ["scn_pinnath_gelin_center", "scn_gondor_castle", "scn_gondor_prison","scn_gondor_tavern","scn_gondor_arena","scn_pinnath_gelin_siege", "mesh_ui_default_menu_window"],
	["trp_barman_pinnath", "trp_smith_pinnath", "trp_merchant_pinnath", "trp_elder_pinnath", "pt_pinnath_recruits", "trp_gondor_lord", "trp_walker_woman_gondor_bw","trp_walker_man_gondor_black","trp_walker_man_gondor_green","trp_walker_woman_gondor_b"], 
...
("p_town_calembel", ["scn_ethring_center", "scn_gondor_castle", "scn_gondor_prison","scn_gondor_tavern","scn_gondor_arena", "scn_ethring_siege", "mesh_town_calembel"],
	["trp_barman_calembel", "trp_smith_calembel", "trp_merchant_calembel", "trp_elder_ethring", "pt_lamedon_recruits", "trp_gondor_lord", "trp_gondor_commoner","trp_walker_man_gondor_black","trp_walker_man_gondor_green","trp_walker_woman_gondor_b"], 
...
("p_town_hornburg", ["scn_hornburg_center", "scn_hornburg_castle", "scn_rohan_prison","scn_rohan_tavern", -1, "scn_hornburg_siege","mesh_town_hornburg"],
	["trp_barman_hornburg", "trp_smith_hornburg", "trp_merchant_hornburg", "trp_elder_hornburg", "pt_rohan_recruits", "trp_knight_1_10", "trp_rohan_youth", "trp_walker_man_rohan_t", "trp_guardsman_of_rohan", "trp_footman_of_rohan"], 
...
("p_town_east_emnet", ["scn_east_emnet_center", "scn_rohan_castle_a", "scn_rohan_prison","scn_rohan_tavern","scn_rohan_arena", "scn_east_emnet_siege", "mesh_ui_default_menu_window"],
	["trp_barman_eastemnet", "trp_smith_eastemnet", "trp_merchant_eastemnet", "trp_elder_eastemnet", "pt_rohan_recruits", "trp_knight_1_11", "trp_walker_woman_rohan_d", "trp_walker_man_rohan_t", "trp_walker_man_rohan_d", "trp_walker_woman_rohan_t"], 
...
("p_town_westfold", ["scn_westfold_center", "scn_rohan_castle_b", "scn_rohan_prison","scn_rohan_tavern","scn_rohan_arena", "scn_westfold_siege", "mesh_ui_default_menu_window"],
	["trp_barman_westfold", "trp_smith_westfold", "trp_merchant_westfold", "trp_elder_westfold", "pt_rohan_recruits", "trp_knight_1_12", "trp_walker_woman_rohan_d", "trp_walker_man_rohan_t", "trp_walker_man_rohan_d", "trp_walker_woman_rohan_t"], 
...
("p_town_west_emnet", ["scn_west_emnet_center", "scn_rohan_castle_a", "scn_rohan_prison","scn_rohan_tavern","scn_rohan_arena", "scn_west_emnet_siege", "mesh_town_west_emnet"],
	["trp_barman_westemnet", "trp_smith_westemnet", "trp_merchant_westemnet", "trp_elder_westemnet", "pt_rohan_recruits", "trp_knight_1_13", "trp_walker_woman_rohan_d", "trp_walker_man_rohan_t", "trp_walker_man_rohan_d", "trp_walker_woman_rohan_t"], 
...
("p_town_eastfold", ["scn_eastfold_center", "scn_rohan_castle_b", "scn_rohan_prison","scn_rohan_tavern","scn_rohan_arena", "scn_eastfold_siege", "mesh_ui_default_menu_window"],
	["trp_barman_eastfold", "trp_smith_eastfold", "trp_merchant_eastfold", "trp_elder_eastfold", "pt_rohan_recruits", "trp_knight_1_14", "trp_walker_woman_rohan_d", "trp_walker_man_rohan_t", "trp_walker_man_rohan_d", "trp_walker_woman_rohan_t"], 
...
("p_advcamp_gondor", ["scn_advcamp_good", -1, -1, -1, -1, -1, "mesh_town_goodcamp"],
	[-1, "trp_smith_wosgiliath", "trp_merchant_wosgiliath", -1, "pt_gondor_recruits", "trp_gondor_lord", "trp_ranger_of_ithilien","trp_gondor_militiamen","trp_gondor_spearmen","trp_gondor_swordsmen"], 
...
("p_advcamp_rohan", ["scn_advcamp_good", -1, -1, -1, -1, -1, "mesh_town_goodcamp"],
	[-1, "trp_smith_eastfold", "trp_merchant_eastfold", -1, "pt_rohan_recruits", "trp_rohan_lord", "trp_skirmisher_of_rohan", "trp_lancer_of_rohan", "trp_guardsman_of_rohan", "trp_footman_of_rohan"], 
...
("p_advcamp_mordor", ["scn_advcamp_bad", -1, -1, -1, -1, -1, "mesh_town_evilcamp"],
	[-1, "trp_smith_oscamp", "trp_merchant_isengard", -1, "pt_mordor_recruits", "trp_mordor_lord", "trp_uruk_of_mordor", "trp_orc_of_mordor", "trp_large_orc_of_mordor", "trp_orc_tracker_of_mordor"], 
...
("p_advcamp_harad", ["scn_advcamp_bad", -1, -1,-1,-1, -1, "mesh_town_harad"],
	[-1, "trp_smith_harad", "trp_merchant_harad", -1, "pt_harad_recruits", "trp_harad_lord","trp_harad_desert_warrior","trp_harad_desert_warrior","trp_harad_infantry","trp_harondor_rider"], 
...
("p_advcamp_rhun", ["scn_advcamp_bad", -1, -1,-1,-1, -1, "mesh_town_rhun_north"],
	[-1, "trp_smith_north_rhun", "trp_merchant_north_rhun", -1, "pt_rhun_recruits",  "trp_rhun_lord", "trp_rhun_noble_cavalry", "trp_rhun_vet_infantry", "trp_rhun_tribesman", "trp_rhun_tribal_warrior", ], 
...
("p_advcamp_khand", ["scn_advcamp_bad", -1, -1,-1,-1, -1, "mesh_town_evilcamp"],
	[-1, "trp_smith_khand", "trp_merchant_khand", -1, "pt_khand_recruits", "trp_khand_lord", "trp_easterling_youth", "trp_easterling_axeman","trp_khand_glaive_whirler","trp_variag_pitfighter"], 
...
("p_advcamp_umbar", ["scn_advcamp_bad", -1, -1,-1,-1, -1, "mesh_town_evilcamp"],
	[-1, "trp_smith_umbar", "trp_merchant_umbar", -1, "pt_umbar_recruits", "trp_umbar_lord", "trp_corsair_youth", "trp_corsair_warrior", "trp_assassin_of_umbar","trp_militia_of_umbar"], 
...
("p_advcamp_lorien", ["scn_advcamp_good", -1, -1, -1, -1, -1, "mesh_town_goodcamp"],
	[-1, "trp_smith_camroth", "trp_merchant_camroth", -1, "pt_lorien_recruits",  "trp_lorien_lord", "trp_lothlorien_scout", "trp_lothlorien_archer", "trp_lothlorien_infantry", "trp_lothlorien_warden"], 
...
("p_advcamp_imladris", ["scn_advcamp_good", -1, -1,-1,-1, -1, "mesh_town_goodcamp"],
	[-1, "trp_smith_imladris", "trp_merchant_imladris", -1, "pt_imladris_recruits", "trp_imladris_lord", "trp_rivendell_scout","trp_rivendell_infantry", "trp_rivendell_sentinel","trp_dunedain_scout"], 
...
("p_advcamp_woodelf", ["scn_advcamp_good", -1, -1,-1,-1, -1, "mesh_town_goodcamp"],
	[-1, "trp_smith_woodelf_camp", "trp_merchant_woodelf_camp", -1, "pt_woodelf_recruits", "trp_woodelf_lord", "trp_greenwood_archer", "trp_greenwood_scout", "trp_greenwood_archer", "trp_greenwood_spearman"], 
...
("p_advcamp_moria", ["scn_advcamp_bad", -1, -1,-1,-1, -1, "mesh_town_evilcamp"],
	[-1, "trp_smith_moria", "trp_merchant_moria", -1, "pt_moria_recruits", "trp_moria_lord","trp_snaga_of_moria","trp_goblin_of_moria","trp_wolf_rider_of_moria","trp_large_goblin_of_moria"], 
...
("p_advcamp_guldur", ["scn_advcamp_bad", -1, -1,-1,-1, -1, "mesh_town_evilcamp"],
	[-1, "trp_smith_dolguldur", "trp_merchant_dolguldur", -1, "pt_guldur_recruits", "trp_guldur_lord", "trp_uruk_of_mordor", "trp_orc_of_mordor", "trp_large_orc_of_mordor", "trp_orc_tracker_of_mordor"], 
...
("p_advcamp_gundabad", ["scn_advcamp_bad", -1, -1,-1,-1, -1, "mesh_town_evilcamp"],
	[-1, "trp_smith_gundabad", "trp_merchant_gundabad", -1, "pt_gundabad_recruits", "trp_gundabad_lord","trp_goblin_gundabad","trp_orc_gundabad","trp_orc_fighter_gundabad","trp_goblin_rider_gundabad"], 
...
("p_advcamp_dale", ["scn_advcamp_good", -1, -1, -1, -1, -1, "mesh_town_goodcamp"],
	[-1, "trp_smith_esgaroth", "trp_merchant_esgaroth", -1, "pt_dale_recruits", "trp_dale_lord","trp_dale_warrior","trp_dale_billman","trp_dale_marchwarden","trp_laketown_archer"], 
...
("p_advcamp_dwarf", ["scn_advcamp_good", -1, -1,-1,-1, -1, "mesh_town_goodcamp"],
	[-1, "trp_smith_ironhill", "trp_merchant_ironhill", -1, "pt_dwarf_recruits", "trp_dwarf_lord","trp_dwarven_lookout", "trp_dwarven_bowman", "trp_iron_hills_infantry", "trp_iron_hills_miner"], 
...
("p_advcamp_dunland", ["scn_advcamp_bad", -1, -1,-1,-1, -1, "mesh_town_evilcamp"],
	[-1, "trp_smith_dunland", "trp_merchant_dunland", -1, "pt_dunland_recruits", "trp_dunland_lord", "trp_dunnish_wildman","trp_dunnish_warrior", "trp_dunnish_pikeman", "trp_dunnish_wolf_guard"], 
...
("p_advcamp_beorn", ["scn_advcamp_good", -1, -1,-1,-1, -1, "mesh_town_goodcamp"],
	[-1, "trp_smith_beorn", "trp_merchant_woodmen", -1, "pt_beorn_recruits", "trp_beorn_lord", "trp_beorning_carrock_berserker", "trp_beorning_sentinel", "trp_beorning_warrior", "trp_beorning_tolltacker"], 
