...
center_list = [
	...
	("p_town_henneth_annun", ["scn_henneth_annun_center", "scn_henneth_annun_castle", -1, -1, -1],
	    [-1, "trp_smith_hannun", -1, -1, "pt_gondor_reinf_a", "trp_gondor_lord", "trp_gondor_commoner","trp_gondor_militiamen","trp_gondor_spearmen","trp_gondor_swordsmen"], 
		["icon_mfc_gondor"],[6,2,2,2,2,0,4,2,0,2,4,4,4,2,1,900],[2,1,4,1,4,1]),
	("p_town_cair_andros", ["scn_cair_andros_center", "scn_cair_andros_castle", -1, -1, -1],
	    [-1, "trp_smith_candros", -1, -1, "pt_gondor_reinf_a", "trp_gondor_lord", "trp_gondor_commoner","trp_gondor_militiamen","trp_gondor_spearmen","trp_gondor_swordsmen"], 
	...
	("p_town_ethring", ["scn_ethring_center", "scn_gondor_castle", "scn_gondor_prison","scn_gondor_tavern","scn_gondor_arena"],
	    ["trp_barman_ethring", "trp_smith_ethring", -1, "trp_elder", "pt_gondor_reinf_a", "trp_gondor_lord", "trp_gondor_commoner","trp_walker_man_gondor_black","trp_walker_man_gondor_green","trp_walker_woman_gondor_b"], 
		["icon_mfc_gondor"],[6,2,2,2,2,0,4,2,0,2,4,4,4,2,1,900],[2,2,2,5,2,8]),
# Rohan centers
...
#		["icon_mfc_woodelf"],[6,2,2,2,2,0,4,2,0,2,4,4,4,2,1,900],[2,1,4,1,4,1]),
	...
	("p_town_troll_cave", ["scn_troll_cave_center", -1, -1,-1,-1],
	    [-1, -1, -1, "trp_elder", "pt_moria_reinf_a", "trp_moria_lord","trp_snaga_of_moria","trp_goblin_of_moria","trp_wolf_rider_of_moria","trp_large_goblin_of_moria"], 
	...
	("p_town_rhun_south_camp", ["scn_rhun_south_camp_center", -1, -1,-1,-1],
	    [-1, "trp_town_47_weaponsmith", -1, "trp_elder", "pt_gundabad_reinf_a",  "trp_rhun_lord", "trp_rhun_noble_cavalry", "trp_rhun_vet_infantry", "trp_rhun_tribesman", "trp_rhun_tribal_warrior", ], 
		["icon_mfc_rhun"],[6,2,2,2,2,0,4,2,0,2,4,4,4,2,1,900],[2,1,4,1,4,1]),
	("p_town_rhun_north_camp", ["scn_rhun_north_camp_center", -1, -1,-1,-1],
	    [-1, -1, "trp_town_47_horse_merchant", "trp_elder", "pt_gundabad_reinf_a",  "trp_rhun_lord", "trp_rhun_noble_cavalry", "trp_rhun_vet_infantry", "trp_rhun_tribesman", "trp_rhun_tribal_warrior", ], 
		["icon_mfc_rhun"],[6,2,2,2,2,0,4,2,0,2,4,4,4,2,1,900],[2,1,4,1,4,1]),
	...
	("p_town_gundabad_ne_outpost", ["scn_gundabad_ne_outpost_center", -1, -1,-1,-1],
	    [-1, -1, "trp_town_48_horse_merchant", "trp_elder", "pt_gundabad_reinf_a", "trp_gundabad_lord","trp_goblin_gundabad","trp_orc_gundabad","trp_orc_fighter_gundabad","trp_goblin_rider_gundabad"], 
		["icon_mfc_gundabad"],[6,2,2,2,2,0,4,2,0,2,4,4,4,2,1,900],[2,1,4,1,4,1]),
	("p_town_gundabad_nw_outpost", ["scn_gundabad_nw_outpost_center", -1, -1,-1,-1],
	    [-1, "trp_town_48_weaponsmith", -1, "trp_elder", "pt_gundabad_reinf_a", "trp_gundabad_lord","trp_goblin_gundabad","trp_orc_gundabad","trp_orc_fighter_gundabad","trp_goblin_rider_gundabad"], 
		["icon_mfc_gundabad"],[6,2,2,2,2,0,4,2,0,2,4,4,4,2,1,900],[2,1,4,1,4,1]),
