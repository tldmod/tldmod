...
# faction ,	initial strength,culture,			faction lord,  	faction marshall,  [5 tiers of troops],			T2							t3								t4									t5									archer								[reinforcement templates, prisoner trains],                                       main banner,  map party banner, [slot_faction: deserter_troop, guard_troop,				messenger_troop, 					prison_guard_troop, 				castle_guard_troop]					faction capital         side              home theater, advance camp
faction_init = [
...
(fac_rhun    ,3500,mtf_culture_evilmen      ,[trp_rhun_lord    ,trp_rhun_lord     ],[trp_i1_rhun_tribesman,     trp_ac2_rhun_horse_scout,	trp_c3_rhun_swift_horseman, 	trp_ac4_rhun_veteran_horse_archer, 	trp_c6_rhun_warlord, 				trp_ac3_rhun_horse_archer],			[pt_rhun_reinf_a,    pt_rhun_reinf_b,    pt_rhun_reinf_c,    -1],                 spr_banner_f, icon_mfp_rhun,    [trp_i1_rhun_tribesman,	trp_ac4_rhun_veteran_horse_archer, trp_c2_rhun_horseman,			trp_i4_rhun_vet_infantry,			trp_c6_rhun_warlord],				p_town_rhun_main_camp, 	faction_side_eye ,theater_N ,p_advcamp_rhun),
(fac_khand   ,2100,mtf_culture_evilmen      ,[trp_khand_lord   ,trp_khand_lord    ],[trp_i1_khand_bondsman,    	trp_i2_khand_pit_dog,    	trp_i3_khand_warrior,       	trp_i4_khand_pit_champion,         	trp_c5_khand_kataphrakt,			trp_ac3_khand_skirmisher],			[pt_khand_reinf_a,   pt_khand_reinf_b,   pt_khand_reinf_c,   -1],                 spr_banner_e, icon_mfp_khand,   [trp_i2_khand_pit_dog,  	trp_i5_khand_war_master,     	trp_c2_khand_pony_rider,			trp_c2_khand_pony_rider,			trp_c3_khand_horseman],       	  	p_town_khand_camp,      faction_side_eye ,theater_SE,p_advcamp_khand),
(fac_umbar   ,2300,mtf_culture_evilmen      ,[trp_umbar_lord   ,trp_umbar_lord    ],[trp_i1_corsair_youth,    	trp_i2_corsair_warrior,  	trp_i3_corsair_swordsman,   	trp_i4_corsair_veteran_swordsman,  	trp_i5_corsair_master_swordsman,	trp_a3_corsair_marksman],			[pt_umbar_reinf_a,   pt_umbar_reinf_b,   pt_umbar_reinf_c,   -1],                 spr_banner_g, icon_mfp_umbar,   [trp_i2_corsair_warrior,	trp_i5_corsair_night_raider,	trp_a3_corsair_marksman,			trp_a4_corsair_veteran_marksman,	trp_i5_corsair_master_swordsman],	p_town_umbar_camp,      faction_side_eye ,theater_SE,p_advcamp_umbar),
(fac_lorien  ,4500,mtf_culture_elves        ,[trp_lorien_lord ,trp_lorien_marshall],[trp_a1_lorien_scout,    	trp_a2_lorien_warden,  		trp_a3_lorien_vet_warden,		trp_a4_lorien_gal_warden, 			trp_a5_lorien_gal_royal_warden,		trp_a1_lorien_scout],				[pt_lorien_reinf_a,  pt_lorien_reinf_b,  pt_lorien_reinf_c,  pt_lorien_p_train],  spr_banner_h, icon_mfp_lorien,  [-1,                      trp_a2_lorien_archer,			trp_a2_lorien_warden,				trp_a3_lorien_vet_archer,			trp_a5_lorien_gal_royal_archer],	p_town_caras_galadhon,  faction_side_good,theater_C ,p_advcamp_lorien),
(fac_imladris,3300,mtf_culture_elves        ,[trp_imladris_lord,trp_imladris_lord ],[trp_a1_riv_scout,    		trp_a2_riv_vet_scout, 		trp_a3_riv_archer,				trp_a4_riv_vet_archer,				trp_ac6_riv_knight,					trp_a1_riv_scout],					[pt_imladris_reinf_a,pt_imladris_reinf_b,pt_imladris_reinf_c,pt_imladris_p_train],spr_banner_i, icon_mfp_imladris,[-1,                      trp_i3_riv_swordbearer,			trp_a1_riv_scout,					trp_a3_riv_archer,					trp_ac6_riv_knight],         		p_town_imladris_camp,   faction_side_good,theater_C ,p_advcamp_imladris),
(fac_woodelf ,3300,mtf_culture_elves        ,[trp_woodelf_lord ,trp_woodelf_lord  ],[trp_a1_greenwood_scout,    trp_a2_greenwood_veteran_scout, trp_a3_greenwood_archer,	trp_a4_greenwood_veteran_archer,  	trp_i5_greenwood_chosen_shieldmaster,trp_a2_greenwood_veteran_scout],	[pt_woodelf_reinf_a, pt_woodelf_reinf_b, pt_woodelf_reinf_c, pt_woodelf_p_train], spr_banner_j, icon_mfp_woodelf, [-1,                      trp_a3_greenwood_sentinel,		trp_a1_greenwood_scout,				trp_i3_greenwood_vet_infantry,		trp_i4_greenwood_elite_infantry],	p_town_thranduils_halls,faction_side_good,theater_N ,p_advcamp_woodelf),
(fac_moria   ,4500,mtf_culture_orcs         ,[trp_moria_lord   ,trp_moria_lord    ],[trp_i1_moria_snaga,   		trp_i2_moria_goblin,      	trp_i3_moria_large_goblin,  	trp_i4_moria_fell_goblin,   		trp_c5_moria_clan_rider,			trp_a3_moria_large_goblin_archer],	[pt_moria_reinf_a,   pt_moria_reinf_b,   pt_moria_reinf_c,   -1],                 spr_banner_k, icon_mfp_moria,   [trp_i1_moria_snaga,   	trp_i2_moria_goblin,			trp_i3_moria_large_goblin,			trp_i4_moria_fell_goblin,			trp_i4_moria_fell_goblin],			p_town_moria,           faction_side_hand,theater_C ,p_advcamp_moria),
...
(fac_dwarf   ,3500,mtf_culture_rohan_goodmen,[trp_dwarf_lord   ,trp_dwarf_lord    ],[trp_i1_dwarf_apprentice,	trp_i2_dwarf_warrior,      	trp_i3_dwarf_hardened_warrior,	trp_i4_dwarf_axeman,        		trp_i6_iron_hills_grors_guard,		trp_a4_dwarf_bowman],				[pt_dwarf_reinf_a,   pt_dwarf_reinf_b,   pt_dwarf_reinf_c,   pt_dwarf_p_train],   spr_banner_p, icon_mfp_dwarf,   [-1,                      trp_i2_dwarf_warrior,			trp_i4_dwarf_spearman,				trp_i6_dwarf_longaxeman,			trp_i6_dwarf_longbeard_axeman],		p_town_erebor,          faction_side_good,theater_N ,p_advcamp_dwarf),
(fac_dunland ,3500,mtf_culture_evilmen      ,[trp_dunland_lord ,trp_dunland_lord  ],[trp_i1_dun_wildman,     	trp_i2_dun_warrior,         trp_i3_dun_vet_warrior,     	trp_i4_dun_wolf_warrior,      		trp_i5_dun_wolf_guard,				trp_i3_dun_pikeman],				[pt_dunland_reinf_a, pt_dunland_reinf_b, pt_dunland_reinf_c, -1],                 spr_banner_r, icon_mfp_dunland, [trp_i2_dun_warrior,    	trp_i3_dun_pikeman,				trp_i3_dun_pikeman,					trp_i3_dun_pikeman,					trp_i3_dun_pikeman],				p_town_dunland_camp,    faction_side_hand,theater_SW,p_advcamp_dunland),
