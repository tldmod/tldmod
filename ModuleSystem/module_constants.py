...
slot_agent_walker_type            = 12 # 1= civilian walkers; 2=patrols; 3=messengers; 4=prop walkers; 5=don't talk to me
...
subfaction_data= [      
 (subfac_pelargir     ,p_town_pelargir     ,"Pelargir"  ,[trp_i1_pel_watchman,		trp_a2_pel_marine,		    trp_i3_pel_vet_infantry],		[pt_pelargir_reinf_a  ,pt_pelargir_reinf_b  ,pt_pelargir_reinf_c  ],[trp_pel_captain, trp_a6_pel_marine_leader,]),
 (subfac_dol_amroth   ,p_town_dol_amroth   ,"Amroth"    ,[trp_i1_amroth_recruit,	trp_a3_gon_bowman,    	    trp_c6_amroth_swan_knight],		[pt_dol_amroth_reinf_a,pt_dol_amroth_reinf_b,pt_dol_amroth_reinf_c],[trp_amroth_captain]),
 (subfac_ethring      ,p_town_calembel     ,"Lamedon"   ,[trp_i1_lam_clansman,		trp_a3_gon_bowman,		    trp_c5_lam_knight],			    [pt_lamedon_reinf_a   ,pt_lamedon_reinf_b   ,pt_lamedon_reinf_c   ],[trp_lam_captain]),
 (subfac_lossarnach   ,p_town_lossarnach   ,"Lossarnach",[trp_i1_loss_woodsman,		trp_a3_gon_bowman,		    trp_i5_loss_axemaster],			[pt_lossarnach_reinf_a,pt_lossarnach_reinf_b,pt_lossarnach_reinf_c],[trp_loss_captain]),
 (subfac_pinnath_gelin,p_town_pinnath_gelin,"Pinnath"   ,[trp_i1_pinnath_plainsman,	trp_a2_pinnath_bowman,		trp_c3_pinnath_knight],			[pt_pinnath_reinf_a   ,pt_pinnath_reinf_b   ,pt_pinnath_reinf_c   ],[trp_pinnath_captain]),
 (subfac_blackroot    ,p_town_erech        ,"Blackroot" ,[trp_a1_blackroot_hunter,	trp_a2_blackroot_bowman,	trp_a5_blackroot_shadow_hunter],[pt_blackroot_reinf_a ,pt_blackroot_reinf_b ,pt_blackroot_reinf_c ],[trp_blackroot_captain]),
 (subfac_rangers      ,p_town_henneth_annun,"Ithilien"  ,[trp_a4_ithilien_ranger,	trp_a4_ithilien_ranger,	    trp_a6_ithilien_master_ranger],	[pt_ithilien_reinf_a  ,pt_ithilien_reinf_b  ,pt_ithilien_reinf_c  ],[trp_ithilien_captain]),
]
...
(p_town_goblin_south_outpost     ,pt_moria_scouts,pt_gundabad_raiders,-1,                    -1),
(p_town_gundabad_m_outpost       ,pt_gundabad_scouts,pt_guldur_raiders,pt_moria_war_party,                    -1),
#Advance camps   
...
(p_town_linhir, [scn_linhir_center, scn_gondor_castle_b, scn_gondor_prison,scn_gondor_tavern,scn_gondor_arena,scn_linhir_siege, mesh_ui_default_menu_window],
	...
	[icon_mfc_gondor],[500],[2,8,2,8,2,8], str_income_low, garrison_limit_med, 1, tld_siegable_always, tld_siege_battle_size_default),
(p_town_dol_amroth, [scn_dol_amroth_center, scn_dol_amroth_castle, scn_gondor_prison,scn_gondor_tavern,scn_gondor_arena,scn_dol_amroth_siege,mesh_town_dol_amroth],
	[trp_amroth_captain, trp_smith_dolamroth, trp_merchant_dolamroth, trp_elder_dolamroth, pt_dol_amroth_recruits, trp_knight_1_3, trp_walker_man_gondor_blue,trp_walker_man_gondor_black,trp_walker_man_gondor_white,trp_walker_woman_gondor_b], 
	[icon_mfc_dol_amroth],[500],[2,8,3,8,2,5], str_income_med, garrison_limit_high, 1, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_edhellond, [scn_edhellond_center, scn_gondor_castle, scn_gondor_prison,scn_gondor_tavern,scn_gondor_arena,scn_edhellond_siege, mesh_town_edhellond],
	[trp_gondor_captain, trp_smith_edhellond, trp_merchant_edhellond, trp_elder_edhellond, pt_gondor_recruits, trp_gondor_lord, trp_walker_man_gondor_black,trp_walker_man_gondor_green,trp_walker_woman_gondor_bw,trp_walker_woman_gondor_b], 
	[icon_mfc_gondor],[500],[2,3,2,5,2,8], str_income_low, garrison_limit_low, 1, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_lossarnach, [scn_lossarnach_center, scn_gondor_castle, scn_gondor_prison,scn_gondor_tavern,scn_gondor_arena,scn_lossarnach_siege, mesh_town_lossarnach],
	[trp_loss_captain, trp_smith_lossarnach, trp_merchant_lossarnach, trp_elder_lossarnach, pt_lossarnach_recruits, trp_knight_1_8, trp_walker_man_gondor_blue,trp_walker_man_gondor_green,trp_walker_woman_gondor_bw,trp_walker_woman_gondor_b], 
	[icon_mfc_lossarnach],[500],[2,4,3,4,3,6], str_income_low, garrison_limit_med, 1, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_tarnost, [scn_tarnost_center, scn_gondor_castle_c, scn_gondor_prison,scn_gondor_tavern,scn_gondor_arena,scn_tarnost_siege, mesh_ui_default_menu_window],
	[trp_gondor_captain, trp_smith_tarnost, trp_merchant_tarnost, trp_elder_tarnost, pt_gondor_recruits, trp_gondor_lord, trp_walker_man_gondor_black,trp_walker_man_gondor_green,trp_walker_woman_gondor_bw,trp_walker_woman_gondor_b], 
	[icon_mfc_gondor],[500],[4,4,4,6,4,8], str_income_low, garrison_limit_med, 1, tld_siegable_always, tld_siege_battle_size_default),
(p_town_erech, [scn_erech_center, scn_gondor_castle, scn_gondor_prison,scn_gondor_tavern,scn_gondor_arena,scn_erech_siege, mesh_town_erech],
	[trp_blackroot_captain, trp_smith_erech, trp_merchant_erech, trp_elder_erech, pt_blackroot_recruits, trp_knight_1_5, trp_walker_man_gondor_black,trp_walker_man_gondor_green,trp_walker_woman_gondor_bw,trp_walker_woman_gondor_b], 
	[icon_mfc_erech],[500],[3,1,3,3,3,7], str_income_low, garrison_limit_low, 1, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_pinnath_gelin, [scn_pinnath_gelin_center, scn_gondor_castle, scn_gondor_prison,scn_gondor_tavern,scn_gondor_arena,scn_pinnath_gelin_siege, mesh_ui_default_menu_window],
	[trp_pinnath_captain, trp_smith_pinnath, trp_merchant_pinnath, trp_elder_pinnath, pt_pinnath_recruits, trp_knight_1_6, trp_walker_man_gondor_black,trp_walker_man_gondor_green,trp_walker_woman_gondor_bw,trp_walker_woman_gondor_b], 
	[icon_mfc_pinnath],[500],[2,2,2,5,2,8], str_income_low, garrison_limit_low, 1, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_west_osgiliath, [scn_west_osgiliath_center, scn_west_osgiliath_castle, -1, -1, -1, scn_west_osgiliath_siege,mesh_town_osgilliath],
	[trp_gondor_captain, trp_smith_wosgiliath, trp_merchant_wosgiliath,trp_elder_wosgiliath , pt_gondor_recruits, trp_gondor_lord, trp_i1_gon_levy,trp_i2_gon_watchman,trp_a4_ithilien_ranger,trp_i4_gon_swordsman], 
...
(p_town_edoras, [scn_edoras_center, scn_edoras_castle, scn_rohan_prison,scn_rohan_tavern,scn_rohan_arena, scn_edoras_siege,mesh_town_edoras],
	...
	[icon_mfc_rohan],[900],[2,8,3,4,3,6], str_income_high, garrison_limit_high, 1, tld_siegable_capital, tld_siege_battle_size_big),
(p_town_aldburg, [scn_aldburg_center, scn_rohan_castle, scn_rohan_prison,scn_rohan_tavern,scn_rohan_arena, scn_aldburg_siege, mesh_ui_default_menu_window],
	...
	[icon_mfc_rohan],[500],[2,3,2,5,2,8], str_income_med, garrison_limit_med, 1, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_hornburg, [scn_hornburg_center, -1, scn_rohan_prison,scn_rohan_tavern, -1, scn_hornburg_siege,mesh_town_hornburg],
	...
	[icon_mfc_rohan],[500],[3,8,4,6,4,5], str_income_high, garrison_limit_high, 1, tld_siegable_capital, tld_siege_battle_size_big),
(p_town_east_emnet, [scn_east_emnet_center, scn_rohan_castle_a, scn_rohan_prison,scn_rohan_tavern,scn_rohan_arena, scn_east_emnet_siege, mesh_ui_default_menu_window],
	...
	[icon_mfc_rohan],[500],[2,8,4,5,4,7], str_income_med, garrison_limit_med, 1, tld_siegable_always, tld_siege_battle_size_default),
(p_town_westfold, [scn_westfold_center, scn_rohan_castle_b, scn_rohan_prison,scn_rohan_tavern,scn_rohan_arena, scn_westfold_siege, mesh_ui_default_menu_window],
	...
	[icon_mfc_rohan],[500],[2,4,2,5,2,6], str_income_med, garrison_limit_med, 1, tld_siegable_always, tld_siege_battle_size_default),
(p_town_west_emnet, [scn_west_emnet_center, scn_rohan_castle_a, scn_rohan_prison,scn_rohan_tavern,scn_rohan_arena, scn_west_emnet_siege, mesh_town_west_emnet],
	...
	[icon_mfc_rohan],[500],[2,8,3,4,3,6], str_income_med, garrison_limit_med, 1, tld_siegable_always, tld_siege_battle_size_default),
(p_town_eastfold, [scn_eastfold_center, scn_rohan_castle_b, scn_rohan_prison,scn_rohan_tavern,scn_rohan_arena, scn_eastfold_siege, mesh_ui_default_menu_window],
	...
	[icon_mfc_rohan],[500],[3,8,4,6,4,5], str_income_med, garrison_limit_med, 1, tld_siegable_normal, tld_siege_battle_size_default),
# Mordor centers
(p_town_morannon, [scn_morannon_center, scn_morannon_castle, scn_mordor_prison,scn_mordor_tavern,scn_mordor_arena, scn_morannon_siege,mesh_town_morannon],
	[trp_mordor_captain, trp_smith_morannon, trp_merchant_morannon, trp_elder_morannon, pt_morannon_recruits, trp_mordor_lord, trp_i2_mordor_uruk, trp_i2_mordor_orc, trp_i3_mordor_large_orc, trp_a3_guldur_large_orc_tracker], 
	[icon_mfc_mordor],[900],[2,8,4,5,4,7], str_income_high, garrison_limit_evil_high*2, 1, tld_siegable_capital, tld_siege_battle_size_huge),
(p_town_minas_morgul, [scn_minas_morgul_center, scn_mordor_castle_b, scn_mordor_prison,scn_mordor_tavern,scn_mordor_arena, scn_minas_morgul_siege, mesh_ui_default_menu_window],
	[trp_mordor_captain, trp_smith_mmorgul, trp_merchant_mmorgul, trp_elder_mmorgul, pt_morgul_recruits, trp_mordor_lord, trp_i2_mordor_uruk, trp_i2_mordor_orc, trp_i3_mordor_large_orc, trp_a3_guldur_large_orc_tracker], 
	[icon_mfc_mordor],[500],[2,4,2,5,2,6], str_income_med, garrison_limit_evil_med*2, 1, tld_siegable_capital, tld_siege_battle_size_big),
(p_town_cirith_ungol, [scn_cirith_ungol_center, -1, scn_mordor_prison,scn_mordor_tavern, -1, scn_cirith_ungol_siege, mesh_town_evilcamp],
	[trp_mordor_uruk_captain, trp_smith_orc_patrol, trp_merchant_orc_patrol, trp_elder_cungol, pt_mordor_recruits, trp_mordor_lord, trp_i2_mordor_uruk, trp_i2_mordor_orc, trp_i3_mordor_large_orc, trp_a3_guldur_large_orc_tracker], 
	[icon_mfc_mordor],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_evil_high, 2, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_orc_sentry_camp, [scn_orc_sentry_camp_center, -1, -1, -1, -1, scn_orc_sentry_camp_center_siege, mesh_town_evilcamp],
	[trp_mordor_uruk_captain, trp_smith_oscamp, trp_merchant_orc_sentry, trp_elder_oscamp, pt_mordor_recruits, trp_mordor_lord, trp_i2_mordor_uruk, trp_i2_mordor_orc, trp_i3_mordor_large_orc, trp_a3_guldur_large_orc_tracker], 
	[icon_mfc_mordor],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_evil_high, 2, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_east_osgiliath, [scn_east_osgiliath_center, scn_east_osgiliath_castle, -1, -1, -1, scn_east_osgiliath_siege, mesh_town_osgilliath],
	[trp_mordor_uruk_captain, trp_smith_eosgiliath, trp_merchant_eosgiliath, trp_elder_eosgiliath, pt_mordor_recruits, trp_mordor_lord, trp_i2_mordor_uruk, trp_i2_mordor_orc, trp_i3_mordor_large_orc, trp_a3_guldur_large_orc_tracker], 
	[icon_mfc_mordor],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_med, 0, tld_siegable_always, tld_siege_battle_size_default),
# Isengard centers
(p_town_isengard, [scn_isengard_center, scn_isengard_castle, scn_mordor_prison,scn_mordor_tavern, scn_isengard_arena, scn_isengard_siege,mesh_town_isengard],
	[trp_isen_captain, trp_smith_isengard, trp_merchant_isengard, trp_elder_isengard, pt_isengard_recruits,  trp_isengard_lord,trp_i2_isen_orc,trp_i3_isen_large_orc,trp_a2_isen_uruk_tracker,trp_i2_isen_uruk], 
	[icon_mfc_isengard],[900],[2,1,4,1,4,1], str_income_high, garrison_limit_evil_high, 1, tld_siegable_capital, tld_siege_battle_size_default),
(p_town_urukhai_outpost, [scn_uruk_hai_outpost_center, -1, -1, -1, scn_isengard_arena, scn_uruk_hai_outpost_center_siege, mesh_town_evilcamp],
	[trp_isen_captain, trp_smith_uoutpost, trp_merchant_uoutpost, trp_elder_uoutpost, pt_isengard_recruits,  trp_isengard_lord,trp_i2_isen_orc,trp_i3_isen_large_orc,trp_a2_isen_uruk_tracker,trp_i2_isen_uruk], 
	[icon_mfc_isengard],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_evil_med, 2, tld_siegable_always, tld_siege_battle_size_default),
(p_town_urukhai_h_camp, [scn_uruk_hai_h_camp_center, -1, -1, -1, scn_isengard_arena, scn_uruk_hai_h_camp_center_siege, mesh_town_evilcamp],
	[trp_isen_tracker_captain, trp_smith_uhcamp, trp_merchant_uhcamp,trp_elder_uhcamp, pt_isengard_recruits,  trp_isengard_lord,trp_i2_isen_orc,trp_i3_isen_large_orc,trp_a2_isen_uruk_tracker,trp_i2_isen_uruk], 
	[icon_mfc_isengard],[500],[2,1,4,1,4,1], str_income_med, garrison_limit_evil_high, 2, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_urukhai_r_camp, [scn_uruk_hai_r_camp_center, -1, -1, -1, scn_isengard_arena, scn_uruk_hai_r_camp_center_siege, mesh_town_evilcamp],
	[trp_isen_tracker_captain, trp_smith_urcamp, trp_merchant_urcamp, trp_elder_urcamp, pt_isengard_recruits,  trp_isengard_lord,trp_i2_isen_orc,trp_i3_isen_large_orc,trp_a2_isen_uruk_tracker,trp_i2_isen_uruk], 
	[icon_mfc_isengard],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_evil_med, 2, tld_siegable_always, tld_siege_battle_size_default),
# Elf centers
(p_town_caras_galadhon, [scn_caras_galadhon_center, -1, scn_elf_prison,scn_elf_tavern,scn_elf_arena,scn_caras_galadhon_siege,mesh_town_caras_galadhon],
	[trp_lorien_captain, trp_smith_cgaladhon, trp_merchant_cgaladhon, trp_elder_cgaladhon, pt_lorien_recruits, trp_lorien_lord, trp_a1_lorien_scout, trp_lorien_walker_1, trp_lorien_walker_2, trp_a2_lorien_warden], 
	[icon_mfc_lorien],[900],[2,1,4,1,4,1], str_income_high, garrison_limit_med, 1, tld_siegable_capital, tld_siege_battle_size_default),
(p_town_cerin_dolen, [scn_cerin_dolen_center, -1, -1, -1, -1, scn_cerin_dolen_siege, mesh_ui_default_menu_window],
	[trp_lorien_captain, trp_smith_cdolen, trp_merchant_cdolen, trp_elder_cdolen, pt_lorien_recruits,  trp_lorien_lord, trp_a1_lorien_scout, trp_lorien_walker_1, trp_lorien_walker_2, trp_a2_lorien_warden], 
	[icon_mfc_lorien],[500],[2,1,4,1,4,1], str_income_med, garrison_limit_low, 2, tld_siegable_always, tld_siege_battle_size_default),
(p_town_cerin_amroth, [scn_cerin_amroth_center, -1, -1, -1, -1, scn_cerin_amroth_siege, mesh_ui_default_menu_window],
	[trp_lorien_captain, trp_smith_camroth, trp_merchant_camroth, trp_elder_camroth, pt_lorien_recruits,  trp_lorien_lord, trp_a1_lorien_scout, trp_lorien_walker_1, trp_lorien_walker_2, trp_a2_lorien_warden], 
	[icon_mfc_lorien],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_low, 2, tld_siegable_normal, tld_siege_battle_size_default),
...
(p_town_thranduils_halls, [scn_thranduils_halls_center, scn_thranduil_hall_room, scn_elf_prison,scn_elf_tavern,scn_elf_arena,scn_thranduils_halls_siege,mesh_town_thranduils],
	[trp_greenwood_captain, trp_smith_thranduils_halls, trp_merchant_thranduils_halls, trp_elder_thalls, pt_woodelf_recruits, trp_woodelf_lord, trp_mirkwood_walker_1, trp_a1_greenwood_scout, trp_mirkwood_walker_1, trp_mirkwood_walker_2], 
	[icon_mfc_woodelf],[900],[2,1,4,1,4,1], str_income_med, garrison_limit_high, 1, tld_siegable_capital, tld_siege_battle_size_default),
(p_town_woodelf_camp, [scn_woodelf_camp_center, -1, -1,-1,-1,scn_woodelf_camp_siege, mesh_town_goodcamp],
	[trp_greenwood_captain, trp_smith_woodelf_camp, trp_merchant_woodelf_camp, trp_elder_woodelf_camp, pt_woodelf_recruits, trp_woodelf_lord, trp_mirkwood_walker_1, trp_a1_greenwood_scout, trp_mirkwood_walker_1, trp_mirkwood_walker_2], 
	[icon_mfc_woodelf],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_med, 2, tld_siegable_always, tld_siege_battle_size_default),
(p_town_woodelf_west_camp, [scn_woodelf_west_camp_center, -1, -1,-1,-1,scn_woodelf_west_camp_siege, mesh_town_goodcamp],
	[trp_greenwood_captain, trp_smith_woodelf_west_camp, trp_merchant_woodelf_west_camp, trp_elder_woodelf_west_camp, pt_woodelf_recruits, trp_woodelf_lord, trp_mirkwood_walker_1, trp_a1_greenwood_scout, trp_mirkwood_walker_1, trp_mirkwood_walker_2], 
	[icon_mfc_woodelf],[500],[2,1,4,1,4,1], str_income_med, garrison_limit_med, 2, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_imladris_camp, [scn_rivendell_camp_center, -1, -1,-1,-1,scn_rivendell_camp_siege,mesh_town_rivendell_camp],
	[trp_riv_captain, trp_smith_imladris, trp_merchant_imladris, trp_elder_imladris, pt_imladris_recruits, trp_imladris_lord, trp_a1_riv_scout, trp_a1_arnor_scout, trp_i3_riv_swordbearer, trp_a3_riv_archer], 
	[icon_mfc_imladris],[900],[2,1,4,1,4,1], str_income_high, garrison_limit_med, 2, tld_siegable_capital, tld_siege_battle_size_default),
...
(p_town_woodsmen_village, [scn_woodsmen_village2_center, -1, -1,-1,-1,scn_woodsmen_village2_siege, mesh_ui_default_menu_window],
	...
	[icon_mfc_northmen],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_med, 1, tld_siegable_always, tld_siege_battle_size_default),
...
(p_town_beorn_house, [scn_woodsmen_village_center, scn_beorn_castle, -1,-1, scn_beorn_arena,scn_woodsmen_village_siege,mesh_town_beorns_house],
	...
	[icon_mfc_northmen],[900],[2,1,4,1,4,1], str_income_low, garrison_limit_high, 1, tld_siegable_capital, tld_siege_battle_size_default),

(p_town_moria, [scn_moria_center, -1, scn_mordor_prison,scn_mordor_tavern,scn_mordor_arena,scn_moria_siege,mesh_town_moria],
	[trp_moria_captain, trp_smith_moria, trp_merchant_moria, trp_elder_moria, pt_moria_recruits, trp_moria_lord,trp_i1_moria_snaga,trp_i2_moria_goblin,trp_a2_moria_goblin_archer,trp_i3_moria_large_goblin], 
	[icon_mfc_moria],[900],[2,1,4,1,4,1], str_income_high, garrison_limit_high, 1, tld_siegable_capital, tld_siege_battle_size_default),
(p_town_troll_cave, [scn_troll_cave_center, -1, -1,-1,-1,scn_troll_cave_siege, mesh_ui_default_menu_window],
	[trp_moria_captain, trp_smith_troll_cave, trp_merchant_troll_cave, trp_elder_troll_cave, pt_moria_recruits, trp_moria_lord,trp_i1_moria_snaga,trp_i2_moria_goblin,trp_a2_moria_goblin_archer,trp_i3_moria_large_goblin], 
	[icon_mfc_moria],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_med, 1, tld_siegable_normal, tld_siege_battle_size_default),
...
(p_town_dale, [scn_dale_center, scn_dale_castle, scn_rohan_prison,scn_rohan_tavern,scn_dale_arena, scn_dale_siege, mesh_ui_default_menu_window],
	...
	[icon_mfc_dale],[900],[2,1,4,1,4,1], str_income_med, garrison_limit_high, 1, tld_siegable_capital, tld_siege_battle_size_big),
(p_town_esgaroth, [scn_esgaroth_center, scn_esgaroth_castle, scn_rohan_prison,scn_rohan_tavern,scn_dale_arena,scn_esgaroth_siege,mesh_town_esgaroth],
	...
	[icon_mfc_dale],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_med, 1, tld_siegable_normal, tld_siege_battle_size_default),

(p_town_dunland_camp, [scn_dunland_camp_center, -1, -1,-1,-1,scn_dunland_camp_siege, mesh_town_evilcamp],
	[trp_dun_captain, trp_smith_dunland, trp_merchant_dunland, trp_elder_dunland, pt_dunland_recruits, trp_dunland_lord, trp_i1_dun_wildman,trp_i2_dun_warrior, trp_i3_dun_pikeman, trp_i5_dun_wolf_guard], 
	[icon_mfc_dunland],[900],[2,1,4,1,4,1], str_income_med, garrison_limit_evil_high, 2, tld_siegable_capital, tld_siege_battle_size_big),
(p_town_harad_camp, [scn_harad_camp_center, -1, -1,-1, scn_harad_arena,scn_harad_camp_siege, mesh_town_harad],
	[trp_harad_captain, trp_smith_harad, trp_merchant_harad, trp_elder_harad, pt_harad_recruits, trp_harad_lord,trp_i1_harad_levy,trp_a3_harad_hunter,trp_i3_harad_infantry,trp_i2_far_harad_tribesman], 
	[icon_mfc_harad],[900],[2,1,4,1,4,1], str_income_high, garrison_limit_evil_high, 2, tld_siegable_capital, tld_siege_battle_size_big),
(p_town_khand_camp, [scn_khand_camp_center, -1, -1,-1, scn_khand_arena, scn_khand_camp_siege, mesh_town_khand],
	[trp_khand_captain, trp_smith_khand, trp_merchant_khand, trp_elder_khand, pt_khand_recruits, trp_khand_lord, trp_i1_khand_bondsman, trp_i3_khand_warrior,trp_i3_khand_pitfighter,trp_i4_khand_pit_champion], 
	[icon_mfc_khand],[900],[2,1,4,1,4,1], str_income_high, garrison_limit_evil_high, 2, tld_siegable_capital, tld_siege_battle_size_big),
(p_town_umbar_camp, [scn_umbar_camp_center, -1, -1,-1, scn_umbar_arena,scn_umbar_camp_siege, mesh_town_evilcamp],
	[trp_umbar_captain, trp_smith_umbar, trp_merchant_umbar, trp_elder_umbar, pt_umbar_recruits, trp_umbar_lord, trp_i1_corsair_youth, trp_i2_corsair_warrior, trp_a4_corsair_veteran_marksman,trp_a2_corsair_marine], 
	[icon_mfc_umbar],[900],[2,1,4,1,4,1], str_income_high, garrison_limit_evil_high, 1, tld_siegable_capital, tld_siege_battle_size_default),
...
(p_town_dol_guldur, [scn_dol_guldur_center, scn_mordor_castle, scn_mordor_prison,scn_mordor_tavern,scn_mordor_arena,scn_dol_guldur_siege,mesh_town_dol_guldur],
	[trp_mordor_captain, trp_smith_dolguldur, trp_merchant_dolguldur, trp_elder_dolguldur, pt_guldur_recruits, trp_guldur_lord, trp_i2_mordor_uruk, trp_i2_mordor_orc, trp_i3_mordor_large_orc, trp_a3_guldur_large_orc_tracker], 
	[icon_mfc_guldur],[900],[2,1,4,1,4,1], str_income_med, 550, 1, tld_siegable_capital, tld_siege_battle_size_default),
(p_town_dol_guldur_north_outpost, [scn_dol_guldur_north_outpost_center, -1, -1,-1,-1,scn_dol_guldur_north_outpost_center_siege, mesh_town_evilcamp],
	[trp_mordor_uruk_captain, trp_smith_dg_outpost, trp_merchant_dg_outpost, trp_elder_dg_outpost, pt_guldur_recruits, trp_guldur_lord, trp_i2_mordor_uruk, trp_i2_mordor_orc, trp_i3_mordor_large_orc, trp_a3_guldur_large_orc_tracker], 
	[icon_mfc_guldur],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_evil_high, 2, tld_siegable_normal, tld_siege_battle_size_default),

(p_town_rhun_main_camp, [scn_north_rhun_camp_center, -1, -1,-1, scn_rhun_arena,scn_north_rhun_camp_siege, mesh_town_rhun_north],
	[trp_rhun_captain, trp_smith_main_rhun, trp_merchant_main_rhun, trp_elder_rhun, pt_rhun_recruits,  trp_rhun_lord, trp_i1_rhun_tribesman, trp_i2_rhun_tribal_warrior, trp_i3_rhun_tribal_infantry, trp_i4_rhun_vet_infantry, ], 
	[icon_mfc_rhun],[900],[2,1,4,1,4,1], str_income_high, garrison_limit_evil_high, 2, tld_siegable_capital, tld_siege_battle_size_big),
(p_town_rhun_south_camp, [scn_rhun_south_camp_center, -1, -1,-1,-1,scn_rhun_south_camp_siege, mesh_town_rhun],
	[trp_rhun_captain, trp_smith_north_rhun, trp_merchant_south_rhun, trp_elder_rhun_sc, pt_rhun_recruits,  trp_rhun_lord,trp_i1_rhun_tribesman, trp_i2_rhun_tribal_warrior, trp_i3_rhun_tribal_infantry, trp_i4_rhun_vet_infantry, ], 
	[icon_mfc_rhun],[500],[2,1,4,1,4,1], str_income_med, garrison_limit_evil_med, 2, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_rhun_north_camp, [scn_rhun_north_camp_center, -1, -1,-1,-1,scn_rhun_north_camp_siege, mesh_town_rhun],
	[trp_rhun_captain, trp_smith_south_rhun, trp_merchant_north_rhun, trp_elder_rhun_nc, pt_rhun_recruits,  trp_rhun_lord,trp_i1_rhun_tribesman, trp_i2_rhun_tribal_warrior, trp_i3_rhun_tribal_infantry, trp_i4_rhun_vet_infantry, ], 
	[icon_mfc_rhun],[500],[2,1,4,1,4,1], str_income_med, garrison_limit_evil_med, 2, tld_siegable_normal, tld_siege_battle_size_default),
# Gundabad camp
(p_town_gundabad,     [scn_gundabad_camp_center, -1, -1,-1, scn_mordor_arena,scn_gundabad_siege, mesh_town_gundabad],
	[trp_gunda_captain, trp_smith_gundabad, trp_merchant_gundabad, trp_elder_gunda, pt_gundabad_cap_recruits, trp_gundabad_lord,trp_i1_gunda_goblin,trp_i2_gunda_orc,trp_i3_gunda_orc_fighter,trp_i4_gunda_orc_warrior], 
	[icon_mfc_gundabad],[900],[2,1,4,1,4,1], str_income_low, 600, 2, tld_siegable_capital, tld_siege_battle_size_default),
(p_town_gundabad_ne_outpost, [scn_gundabad_ne_outpost_center, -1, -1,-1,-1,scn_gundabad_ne_outpost_center_siege, mesh_town_evilcamp],
	[trp_gunda_captain, trp_smith_gundabad_ne, trp_merchant_gundabad_ne, trp_elder_gunda_ne, pt_gundabad_recruits, trp_gundabad_lord,trp_i1_gunda_goblin,trp_i2_gunda_orc,trp_i3_gunda_orc_fighter,trp_i4_gunda_orc_warrior], 
	[icon_mfc_gundabad],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_evil_high, 0, tld_siegable_always, tld_siege_battle_size_default),
(p_town_gundabad_nw_outpost, [scn_gundabad_nw_outpost_center, -1, -1,-1,-1,scn_gundabad_nw_outpost_center_siege, mesh_town_evilcamp],
	[trp_gunda_captain, trp_smith_gundabad_nw, trp_merchant_gundabad_nw, trp_elder_gunda_nw, pt_gundabad_recruits, trp_gundabad_lord,trp_i1_gunda_goblin,trp_i2_gunda_orc,trp_i3_gunda_orc_fighter,trp_i4_gunda_orc_warrior], 
	[icon_mfc_gundabad],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_evil_med, 2, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_goblin_north_outpost, [scn_goblin_north_outpost_center, -1, -1,-1,-1,scn_goblin_north_outpost_center_siege, mesh_town_evilcamp],
	[trp_gunda_captain, trp_town_50_weaponsmith, trp_town_50_horse_merchant, trp_village_1_elder, pt_gundabad_recruits, trp_gundabad_lord,trp_i1_gunda_goblin,trp_i2_gunda_orc,trp_i3_gunda_orc_fighter,trp_i4_gunda_orc_warrior], 
	[icon_mfc_gundabad],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_evil_high, 2, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_goblin_south_outpost, [scn_goblin_south_outpost_center, -1, -1,-1,-1,scn_goblin_south_outpost_center_siege, mesh_town_evilcamp],
	[trp_moria_captain, trp_smith_moria_s, trp_merchant_moria_s, trp_elder_moria_s, pt_moria_recruits, trp_moria_lord,trp_i1_moria_snaga,trp_i2_moria_goblin,trp_a2_moria_goblin_archer,trp_i3_moria_large_goblin], 
	[icon_mfc_moria],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_evil_high, 1, tld_siegable_always, tld_siege_battle_size_default),
(p_town_gundabad_m_outpost, [scn_gundabad_mirkwood_outpost, -1, -1,-1,-1,scn_gundabad_mirkwood_outpost_siege, mesh_town_evilcamp],
	[trp_gunda_captain, trp_smith_gundabad_m, trp_merchant_gundabad_m, trp_elder_gunda_m, pt_gundabad_recruits, trp_gundabad_lord,trp_i1_gunda_goblin,trp_i2_gunda_orc,trp_i3_gunda_orc_fighter,trp_i4_gunda_orc_warrior], 
	[icon_mfc_gundabad],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_evil_med, 2, tld_siegable_normal, tld_siege_battle_size_default),
(p_town_erebor, [scn_erebor_center, scn_erebor_castle, scn_rohan_prison,-1,scn_dwarf_arena,scn_erebor_siege, mesh_town_erebor],
	[trp_dwarf_captain, trp_smith_erebor, trp_merchant_erebor, trp_elder_erebor, pt_dwarf_recruits, trp_dwarf_lord, trp_i1_dwarf_apprentice, trp_dwarf_walker, trp_dwarf_walker, trp_i2_iron_hills_miner], 
	[icon_mfc_dwarf],[900],[2,1,4,1,4,1], str_income_high, garrison_limit_high, 1, tld_siegable_capital, tld_siege_battle_size_default),
(p_town_ironhill_camp, [scn_ironhill_camp_center, -1, -1,-1,-1,scn_ironhill_camp_siege, mesh_town_goodcamp],
	[trp_dwarf_captain, trp_smith_ironhill, trp_merchant_ironhill, trp_elder_ironhill, pt_dwarf_iron_recruits, trp_dwarf_lord,trp_dwarf_walker, trp_i1_dwarf_apprentice, trp_dwarf_walker, trp_i2_iron_hills_miner], 
	[icon_mfc_dwarf],[500],[2,1,4,1,4,1], str_income_low, garrison_limit_low, 0, tld_siegable_always, tld_siege_battle_size_default),
...
(p_advcamp_gondor, [scn_advcamp_gondor, -1, -1, -1, -1, scn_advcamp_gondor_siege, mesh_town_goodcamp],
	...
	[icon_mfc_gondor],[900],[2,1,4,1,4,1], 0, garrison_limit_low, 3, tld_siegable_always, tld_siege_battle_size_default),
(p_advcamp_rohan, [scn_advcamp_rohan, -1, -1, -1, -1, scn_advcamp_rohan_siege, mesh_town_goodcamp],
	...
	[icon_mfc_rohan],[900],[3,8,4,6,4,5], 0, garrison_limit_low, 3, tld_siegable_always, tld_siege_battle_size_default),
(p_advcamp_isengard, [scn_advcamp_isengard, -1, -1, -1, -1, scn_advcamp_isengard_siege, mesh_town_evilcamp],
	...
	[icon_mfc_isengard],[900],[2,1,4,1,4,1], 0, garrison_limit_evil_low, 3, tld_siegable_always, tld_siege_battle_size_default),
(p_advcamp_mordor, [scn_advcamp_mordor, -1, -1, -1, -1, scn_advcamp_mordor_siege, mesh_town_evilcamp],
	[trp_mordor_captain, trp_smith_oscamp, trp_merchant_isengard, trp_no_troop, pt_mordor_recruits, trp_mordor_lord, trp_i2_mordor_uruk, trp_i2_mordor_orc, trp_i3_mordor_large_orc, trp_a3_guldur_large_orc_tracker], 
	[icon_mfc_mordor],[900],[2,1,4,1,4,1], 0, garrison_limit_evil_low, 3, tld_siegable_always, tld_siege_battle_size_default),
...
(p_advcamp_lorien, [scn_advcamp_lorien, -1, -1, -1, -1, scn_advcamp_lorien_siege, mesh_town_goodcamp],
	...
	[icon_mfc_lorien],[900],[2,1,4,1,4,1], 0, garrison_limit_low, 3, tld_siegable_always, tld_siege_battle_size_default),
(p_advcamp_imladris, [scn_advcamp_imladris, -1, -1,-1,-1, scn_advcamp_imladris_siege, mesh_town_goodcamp],
	...
	[icon_mfc_imladris],[900],[2,1,4,1,4,1], 0, garrison_limit_low, 3, tld_siegable_always, tld_siege_battle_size_default),
...
(p_advcamp_guldur, [scn_advcamp_guldur, -1, -1,-1,-1, scn_advcamp_guldur_siege, mesh_town_evilcamp],
	...
	[icon_mfc_guldur],[900],[2,1,4,1,4,1], 0, garrison_limit_evil_low, 3, tld_siegable_always, tld_siege_battle_size_default),
...
center_sounds=[#center      slot_center_ambient_sound_day , slot_center_ambient_sound_always      , slot_center_occasional_sound1_day (later to be divided into occasional nature and occasional faction)
    ...
    (p_town_goblin_south_outpost,snd_orcs_ambiance,snd_wind_ambiance	    ,snd_orc_occasional),
...
#fac_isengard
[(2,itm_cooking_cauldron,0),(3,itm_orc_brew      ,0),(4,itm_gauntlets_reward, imod_hardened), (5, itm_warg_reward, imod_heavy), (6, itm_torque_reward, 0), (7, itm_silmarillion_reward, 0), (8, itm_isen_uruk_heavy_reward, imod_lordly), (9, itm_tome_of_knowledge, 0)],
#fac_lorien
...
#fac_dale
[(2,itm_cooking_cauldron,0),(3,itm_map ,0),			(4,itm_leather_gloves_reward, 0), (5, itm_thrush_reward, 0), (6, itm_dale_armor_reward, 0), (7, itm_dale_sword_reward, 0), (8, itm_black_arrows_reward, imod_masterwork), (9, itm_dale_bow_reward, 0)],
#fac_harad
...
[(2,itm_cooking_cauldron,0),(3,itm_orc_brew      ,0),(4,itm_moria_orc_shield_c, imod_reinforced), (5, itm_wargarmored_3a, imod_reinforced), (6, itm_ring_b_reward, 0), (7, itm_dwarf_great_pick, imod_strong), (8, itm_moria_armor_e, imod_lordly), (9, itm_drums_of_the_deep, 0)],
#fac_guldur
[(2,itm_cooking_cauldron,0),(3,itm_orc_brew      ,0),(4,itm_orc_mace, imod_balanced), (5, itm_leather_gloves_reward, imod_crude), (6, itm_herbarium_reward, 0), (7, itm_spider, 0), (8, itm_black_arrows_reward, 0), (9, itm_witchking_helmet, 0)],
#fac_gundabad
