...
# Mordor towns
    ...
    ("town_cirith_ungol","Emyn_Muil_Watchtower",   icon_orctower   |pf_tld_down,  no_menu, pt_none, fac_mordor,0,ai_bhvr_hold,0,(-50.1,-45.3),[],170),
...
# Dwarves towns
    ...
    ("town_ironhill_camp","Grey Mountains Gateway",icon_camp  |pf_tld_down, no_menu, pt_none, fac_dwarf,0,ai_bhvr_hold,0,(-49.6,-239.9),[],170),
...
##  ("black_khergit_spawn_point"  ,"black_khergit_sp",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(47.1, -73.3),[(trp_mercenaries_end,15,0)]),
  ...
  ("mountain_bandit_spawn_point","{!}mountain_bandit_sp",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(23.41,-219.62),[(trp_mercenaries_end,15,0)]),
  ("mountain_bandit_spawn_point_2","{!}mountain_bandit_sp_2",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(33.80,-111.50),[(trp_mercenaries_end,15,0)]),
