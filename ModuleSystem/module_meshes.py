...
# Kham - Troop Presentation dupes
  ("tp_victory_gondor",      0, "draw_victory_gondor",    0, 0, 0, 0, 0, 0, 3.3, 3.3, 3.3),
  ("tp_victory_dwarf",       0, "draw_victory_dwarf",     0, 0, 0, 0, 0, 0, 3, 3, 3),
  ("tp_victory_rohan",       0, "draw_victory_rohan",     0, 0.05, 0, 0, 0, 0, 3.3, 3.3, 3.3),
  ("tp_victory_evilman",     0, "draw_victory_evilman",   0, 0.2, 0, 0, 0, 0, 2.7, 2.7, 2.7),#Mordor
  #("tp_victory_uruk",        0, "draw_victory_uruk",   0, -0.35, 0, 0, 0, 0, 3.6, 3.6, 3.6), #Isengard
  ("tp_victory_uruk",        0, "draw_lumberjack_orcs",   0, -0.1, 0, 0, 0, 0, 3.3, 3.3, 3.3), #Isengard
  ("tp_lorien_arrows",       0, "draw_victory_lorien",    0, 0, 0, 0, 0, 0, 3.3, 3.3, 3.3),
  ("tp_victory_rivendell",   0, "draw_victory_rivendell", 0, 0, 0, 0, 0, 0, 3.5, 3.5, 3.5),#
  ("tp_victory_mirkwood",    0, "draw_victory_mirkwood",  0, 0, 0, 0, 0, 0, 3.6, 3.6, 3.6),
  ("tp_war_starts",          0, "draw_victory_dale",      0, 0, 0, 0, 0, 0, 3.3, 3.3, 3.3),
  ("tp_victory_harad",       0, "draw_victory_harad",     0, 0, 0, 0, 0, 0, 3.3, 3.3, 3.3),
  ("tp_victory_rhun",        0, "draw_victory_rhun",      0, 0, 0, 0, 0, 0, 3.3, 3.3, 3.3),
  ("tp_victory_khand",       0, "draw_victory_khand",     0, 0, 0, 0, 0, 0, 3, 3, 3),
  ("tp_victory_corsairs",    0, "draw_victory_corsairs",  0, 0, 0, 0, 0, 0, 3, 3, 3),
  ("tp_victory_orc_orc",     0, "draw_victory_orc_orc",   0, 0, 0, 0, 0, 0, 3.3, 3.3, 3.3),
  ("tp_tribal_orcs",         0, "draw_victory_orc",       0, 0.15, 0, 0, 0, 0, 3, 3, 3),
  ("tp_orc_raiders",         0, "draw_orc_raiders",       0, -0.2, 0, 0, 0, 0, 3.3, 3.3, 3.3),
  ("tp_victory_dunland",     0, "draw_victory_dunland",   0, 0.2, 0, 0, 0, 0, 2.7, 2.7, 2.7),#
  ("tp_victory_beornings",   0, "draw_victory_beornings", 0, 0.15, 0, 0, 0, 0, 3.3, 3.3, 3.3),#
...
("choose_icon_dwarf",   0, "icon_dwarf",   0, 0, 0, 0, 0, 0, 1, 1, 1),
