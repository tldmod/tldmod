...
#  ("outer_terrain_plain_1", 0, "ter_border_a", -90, 0, 0, 0, 0, 0, 1, 1, 1),
  ("banner_gondor"  , 0, "banner_a01", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_rohan"   , 0, "banner_a02", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_mordor"  , 0, "banner_a03", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_harad"   , 0, "banner_a04", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_khand"   , 0, "banner_a05", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_rhun"    , 0, "banner_a06", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_umbar"   , 0, "banner_a07", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_lorien"  , 0, "banner_a08", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_imladris", 0, "banner_a09", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_woodelf" , 0, "banner_a10", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_moria"   , 0, "banner_a11", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_guldur"  , 0, "banner_a12", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_beorn"   , 0, "banner_a13", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_gundabad", 0, "banner_f15", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_dale"    , 0, "banner_f21", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_erebor"  , 0, "banner_a16", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_dunland" , 0, "banner_a17", 0, 0, 0, -90, 0, 0, 1, 1, 1),
#  ("banner_a18", 0, "banner_a18", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ("banner_isengard", 0, "banner_a19", 0, 0, 0, -90, 0, 0, 1, 1, 1),
...
#  ("banner_f03", 0, "banner_f03", 0, 0, 0, -90, 0, 0, 1, 1, 1),
  ...
  ("arms_a14", 0, "banner_a15", 0, 0, 0, -90, 0, 0, 1, 1, 1),
