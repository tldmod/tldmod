...
("tld_mod_options", 0, mesh_load_window, [
    ...
    (create_text_overlay, reg1, "@Battle Formations and AI:  ", tf_right_align, tf_double_space),
        ...
        #Siege Type
        (create_text_overlay, reg1, "@Advanced Siege AI:  ", tf_right_align, tf_double_space),
        (position_set_y, pos0, ":y_pos"),
        (overlay_set_position, reg1, pos0),
        
        (create_combo_button_overlay, "$tld_options_overlay_3"),
        (overlay_add_item, "$tld_options_overlay_3", "@Native"),
        (overlay_add_item, "$tld_options_overlay_3", "@On"),
    ...
    (create_text_overlay, reg1, "@Permanent death for lords and companions:  ", tf_right_align, tf_double_space),
        ...
        (overlay_add_item, "$tld_options_overlay_14", "@Enable without Faction Names"),
        (overlay_add_item, "$tld_options_overlay_14", "@Enable with Faction Names"),
        (overlay_add_item, "$tld_options_overlay_14", "@Simple: Red - Enemy / Green - Allies"),
        ...
        (try_for_agents, ":agent_id"),
          ...
          (try_begin),
            (try_begin),
              ...
              (else_try),
                # (eq, "$g_display_agent_labels", 3),
                # (store_troop_faction, ":player_faction", "trp_player"),
                # (store_relation, ":team_side", ":player_faction", ":troop_faction"),
                (try_begin),
                  #(lt, ":team_side", 0),
                  (neg|agent_is_ally, ":agent_id"),
                  (assign, ":color", color_bad_news),
                # (else_try),
                  # (this_or_next|eq, ":troop_faction", "fac_tribal_orcs"),
                  # (this_or_next|eq, ":troop_faction", "fac_manhunters"),
                  # (this_or_next|eq, ":troop_faction", "fac_deserters"),
                  # (this_or_next|eq, ":troop_faction", "fac_mountain_bandits"),
                  # (eq, ":troop_faction", "fac_forest_bandits"),
                  # (assign, ":color", color_bad_news),
                (else_try),
                  (assign, ":color", 0x429AFF), #blue instead of green - colourblind friendly
                (try_end),
                (str_store_string, s2, "@*"),
              (else_try),
                (faction_get_color, ":color", ":troop_faction"),
