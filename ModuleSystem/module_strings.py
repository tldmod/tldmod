...
#npc16 = Rhun NPC
  ...
  ("npc9_intro_response_2", "Never mind."),
  ("npc10_intro_response_2", "Never mind."),
  ("npc11_intro_response_2", "Never mind."),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc4_backstory_later", "More warriors return with their bodies broken, and I try to give aid where I can. But I still feel trapped in a cage."),
...
#11
  ...
  ("npc2_payment", "The guard Sergeant would let me go for {reg3} Resource Points."),
...
#local color strings
  ...
  ("npc5_home_recap", "I'll make this short."),
  ("npc6_home_recap", "I'll make this short."),
  ("npc7_home_recap", "I'll make this short."),
  ("npc8_home_recap", "I'll make this short."),
