...
#11
  ...
  ("npc11_payment", "I just need someone to do in the Boss. We could wait till he closes his eyes to lop off, but I reckon someone really high up can force his eyes shut. Ai!"),
  ("npc12_payment", "Hai! Yoi! I'll need to remind the boys to keep their mangy gobs shut or the High Ups will get my number and 'ave it out for me, they will."),
  ("npc13_payment", "Alas the Chieftains here will not to allow my leave. Are you able to convince them otherwise?"),
  ("npc14_payment", "The captain of the Haven will require much persuasion for my leave. Convince him and we shall set sail through this storm."),
  ("npc15_payment", "Ah, yes. Noble Warrior-Lord! One small impediment is there! A great injustice befell me, that the master of this cave did not like my offer of healing, and has stolen all my gear! The cheek! To steal from the Great Bolzog! Master, I can't recover my priceless equipment from his filthy claws!"),
  ("npc16_payment", "I will not follow you, I will go my own path; but your path may go along with mine for a while. Though, before I travel these lands I must first pay tribute to those who died trying before us. Show them your tribute and we may make our leave. We must never forget our ancestors. They have not forgotten us."),
