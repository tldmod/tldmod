...
#11
  ...
  ("npc3_payment", "Ahem, it seems that I have ran up quite a tab in the fine tavern here, so I'll need to settle my account before I can leave."),
  ("npc4_payment", "I would join you, but who will care for the wounded if the city is attacked?"),
  ...
  ("npc7_payment", "I would join you, but I'm afraid my honorable father Dwalin will not understand why I left the town in a time of need."),
  ("npc8_payment", "I cannot abandon my duties here, my King still needs me. I'm too concerned for his health."),
  ("npc9_payment", "I want to leave with you, but the guards at the gate won't let me.^Trust me,  I've tried."),
  ...
  ("npc17_payment", "I like trees, but my old uncle needs me here."),
