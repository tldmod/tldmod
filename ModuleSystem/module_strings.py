...
# TLD party encounter greetings - depends on faction IDs staying in the same order
 ...
 ("party_greet_enemy_dwarf", "Prepare to taste dwarven anger!"), 
 ...
 ("party_greet_friend_mordor", "Greetings from the servants of the Eye!"), 
 ("party_greet_enemy_mordor", "Your heads will look nice on the gates of Morannon!"), 
 ("party_greet_friend_isengard", "Greetings from the servants of the White Hand!"), 
 ...
 ("party_greet_enemy_lorien", "You are no match for our ancient skill and valor!"), 
 ("party_greet_friend_imladris", "Hail, friend of Imladris and Elrond!"), 
 ("party_greet_enemy_imladris", "Draw your puny weapons, enemies of Imladris and all that is fair!"), 
 ...
 ("party_greet_friend_khand", "Greetings, Variag friend!"), 
 ("party_greet_enemy_khand", "The enemies of Sauron are no match for Variag ferocity!"), 
 ("party_greet_friend_umbar", "Hail, friend of the Umbar Pirates!"), 
 ("party_greet_enemy_umbar", "If we were at sea, you would dance on a plank soon enough!"), 
 ("party_greet_friend_moria", "Greetings from the servants of Moria!"), 
 ("party_greet_enemy_moria", "You shall have your throats cut by the orcs of Moria!"), 
 ("party_greet_friend_guldur", "Greetings from the servants of Dol Guldur!"), 
 ("party_greet_enemy_guldur", "The Elves and their friends shall fall under our blades!"), 
 ("party_greet_friend_gundabad", "Greetings, friend of the orcs of Angmar!"), 
