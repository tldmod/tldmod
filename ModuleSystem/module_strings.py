...
#11
  ...
  ("npc9_payment", "Before we leave, I'll need {reg3} Resources to bribe the guards at the gate."),
  ...
  ("npc9_payment_response", "That's a lot, and you better be worth it - here's {reg3} Resources."),
