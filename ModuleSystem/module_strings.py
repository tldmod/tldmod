...
("npc21_backstory_later", "Look wha' the cat dragged in! Done well fo' yerself, then, 'ave yer? Had a lovely time strollin' around, not bein' chained to a damned rock?! Well ain't that nice! How 'bout yer go speak to the bossman for me? Now, better than never."),
...
("npc21_payment", "Speakin' of 'worth', that lil' debt of mine might not be all that little, if yer catch me drift. And the bossman might try and pull a sneaky on yer, so watch out!" + costs_reg14_inf_with_s14),
...
("npc21_morality_speech", "Listen 'ere, chief. A well respected raidin' company can't just {s21} and leave the lads' stomachs agrowlin'!  And mine, look what a biggun' it is too! I might just go and have a lil' nibble off one of the smaller ones - a finger, a leg mayhaps... "),
