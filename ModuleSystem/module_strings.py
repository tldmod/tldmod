...
#backstory intro
  ...
  ("npc9_backstory_a", "Good for you! They call me Gulm. I have gutted my sergeant and his snagas now hunt for me.^The worthless maggot had it coming. Once we got ambushed by a manling patrol and he lost it - 'fall back' he screams and runs. Gulm and a few others stood there and broke their horses as they came charging. Then bludgeoned the yellow-haired manlings into paste, har-har! If it wasn't for us, we would be worm food."),
  ...
  ("npc13_backstory_a", "I am Lykyada!"),
...
#backstory main body
  ...
  ("npc9_backstory_b", "I am a fighting Uruk-hai, and a berserker! What there is to know of killing men, I know it. I was in the service of the White Hand, but now the Hand would as likely throw me into the fire-pits."),
...
#backstory recruit pitch
  ...
  ("npc9_backstory_c", "I don't have a Master. I would come with you and hunt men in the south while the snagas of Isengard gnash their teeth."),
...
#11
  ...
  ("npc1_payment", "I would join you, but my Captain Faramir would miss my presence here."),
  ("npc2_payment", "The guard Sergeant would not let me go, I'm afraid."),
  ("npc3_payment", "Ahem, it seems that I've been made a few damages around these nights when I was drunk and now I'm supposed to stay here until I fix all the mess I made."),
  ("npc4_payment", "I would joint you, but who will care for the wounded if the city is attacked?"),
  ("npc5_payment", "We should be off soon. The value of my coming will be diminished if the Enemy senses my presence before we have struck. But Lothlórien also needs me here."),
  ("npc6_payment", "I would join you, but my duty is here."),
  ("npc7_payment", "I would join you, but I'm afraid my honorable father Dwalin will not understand why I left the town in these times of need."),
  ("npc8_payment", "But I cannot leave this place. Our King still needs me here. I'm too afraid for his health."),
  ("npc9_payment", "I want to leave with you, but the guards here won't let me.^Trust me, I know.^I tried. Orders are that I'm to fight in this group."),
  ("npc10_payment", "I would join you, but my duty is here."),
  ("npc11_payment", "I would join you, but my duty is here."),
  ("npc12_payment", "I would join you, but my duty is here."),
  ("npc13_payment", "I would join you, but my duty is here."),
  ("npc14_payment", "I would join you, but my duty is here."),
  ("npc15_payment", "I would join you, but my duty is here."),
  ("npc16_payment", "I would join you, but my duty is here."),
  ("npc17_payment", "I like trees, but my duty is here. Orders, you know."),

  ("npc1_payment_response", "Don't worry, I'll arrange your leave with him.." + spend_reg14_inf_on_reg15),
  ("npc2_payment_response", "Don't worry, I'll talk with the Sargent." + spend_reg14_inf_on_reg15 ),
  ("npc3_payment_response", "Just leave with me. I'll settle this with the autorities."+spend_reg14_inf_on_reg15),
  ("npc4_payment_response", "Don't worry, I'll make sure that someone replaces you."+spend_reg14_inf_on_reg15),
  ...
  ("npc7_payment_response", "Master Dwalin will understand that it is for the best of the cause, you have my word."+spend_reg14_inf_on_reg15),
  ("npc8_payment_response", "The King's health will benefit more by learning of the deeds which we will accomplish together."+spend_reg14_inf_on_reg15),
  ...
  ("npc11_payment_response", "From now on, your duty is with me."+spend_reg14_inf_on_reg15),
  ("npc12_payment_response", "From now on, your duty is with me."+spend_reg14_inf_on_reg15),
  ("npc13_payment_response", "From now on, your duty is with me."+spend_reg14_inf_on_reg15),
  ("npc14_payment_response", "From now on, your duty is with me."+spend_reg14_inf_on_reg15),
  ("npc15_payment_response", "From now on, your duty is with me."+spend_reg14_inf_on_reg15),
  ("npc16_payment_response", "From now on, your duty is with me."+spend_reg14_inf_on_reg15),
  ("npc17_payment_response", "Orders changed. You are with me now."+spend_reg14_inf_on_reg15),
