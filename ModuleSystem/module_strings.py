...
#npc17 = Dímborn (Beornings)
  ...
  ("npc9_intro_response_1", "Who are you?"),
  ...
  ("npc15_intro_response_1", "Who are you?"),
  ...
  ("npc9_intro_response_2", "[Ignore and leave]"),
  ("npc10_intro_response_2", "[Ignore and leave]"),
  ("npc11_intro_response_2", "[Ignore and leave]"),
  ("npc12_intro_response_2", "[Ignore and leave]"),
  ("npc13_intro_response_2", "[Ignore and leave]"),
  ("npc14_intro_response_2", "[Ignore and leave]"),
  ("npc15_intro_response_2", "[Ignore and leave]"),
  ("npc16_intro_response_2", "[Ignore and leave]"),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc12_backstory_later", "Have you reconsidered? I will serve well."),
  ("npc13_backstory_later", "Have you reconsidered? I will serve well."),
  ("npc14_backstory_later", "Have you reconsidered? I will serve well."),
  ("npc15_backstory_later", "Have you reconsidered? I will serve well."),
  ("npc16_backstory_later", "Have you reconsidered? I will serve well."),
  ...
  ("npc12_backstory_response_1", "You will do."),
  ...
  ("npc9_signup", "Really? You would do well to enlist me."),
  ("npc10_signup", "Really? You would do well to enlist me."),
  ("npc11_signup", "Really? You would do well to enlist me."),
  ("npc12_signup", "Really? You would do well to enlist me."),
  ("npc13_signup", "Really? You would do well to enlist me."),
  ("npc14_signup", "Really? You would do well to enlist me."),
  ("npc15_signup", "Really? You would do well to enlist me."),
  ("npc16_signup", "Really? You would do well to enlist me."),
  ...
  ("npc9_signup_response_1", "Very well. Let's go."),
  ("npc10_signup_response_1", "Very well. Let's go."),
  ("npc11_signup_response_1", "Very well. Let's go."),
  ("npc12_signup_response_1", "Very well. Let's go."),
  ("npc13_signup_response_1", "Very well. Let's go."),
  ("npc14_signup_response_1", "Very well. Let's go."),
  ("npc15_signup_response_1", "Very well. Let's go."),
  ("npc16_signup_response_1", "Very well. Let's go."),
...
#11
  ...
  ("npc9_signup_response_2", "I don't need you, slave."),
  ...
  ("npc15_signup_response_2", "I've changed my mind."),
  ("npc16_signup_response_2", "I've changed my mind."),
  ("npc17_signup_response_2", "On the other hand, I think I've changed my mind. You're a bit of a nut, aren't you?"),

  ("npc1_payment", "My Captain Faramir would miss my presence here, but he would agree to grant me leave for {reg3} Resource Points."),
  ("npc2_payment", "The guard Sergeant would let me go for {reg3} Resources."),
  ("npc3_payment", "Ahem, it seems that I have ran up quite a tab in the fine tavern here, so I'll also need {reg3} Resources before I can leave."),
  ("npc4_payment", "Before I leave, our healers are in desperate need of supplies and require {reg3} Resources."),
  ("npc5_payment", "We should be off soon. The value of my coming will be diminished if the Enemy senses my presence before we have struck. But Lothlórien will first need {reg3} Resources to compensate for my absence."),
  ("npc6_payment", "I'll join you for {reg3} Resources."),
  ("npc7_payment", "My honorable father Dwalin will need {reg3} Resources to make up for my absence."),
  ("npc8_payment", "Before I leave, I'll need {reg3} Resources to provide our King with a steady supply of mind-easing herbs."),
  ("npc9_payment", "I'll join you for {reg3} Resources."),
  ("npc10_payment", "I'll join you for {reg3} Resources."),
  ("npc11_payment", "I'll join you for {reg3} Resources."),
  ("npc12_payment", "I'll join you for {reg3} Resources."),
  ("npc13_payment", "I'll join you for {reg3} Resources."),
  ("npc14_payment", "I'll join you for {reg3} Resources."),
  ("npc15_payment", "I'll join you for {reg3} Resources."),
  ("npc16_payment", "I'll join you for {reg3} Resources."),
  ("npc17_payment", "I like trees. But I need {reg3} Resources things before we go. Need to leave some for my old uncle when I'm away."),

  ("npc1_payment_response", "And they will be well spent. Here's {reg3} worth of resources."),
  ("npc2_payment_response", "Certainly. Here's {reg3} Resources."),
  ("npc3_payment_response", "This better be worth it. Here's {reg3} Resources."),
  ("npc4_payment_response", "Everything for a noble cause. Here's {reg3} Resources."),
  ("npc5_payment_response", "I'll gladly help with {reg3} Resources."),
  ("npc6_payment_response", "Certainly. Here's {reg3} Resources."),
  ("npc7_payment_response", "Certainly. Master Dwalin shall have {reg3} Resources."),
  ("npc8_payment_response", "The King's well-being is important. Here's {reg3} Resources."),
  ("npc9_payment_response", "Here's {reg3} Resources."),
  ("npc10_payment_response", "Here's {reg3} Resources."),
  ("npc11_payment_response", "Here's {reg3} Resources."),
  ("npc12_payment_response", "Here's {reg3} Resources."),
  ("npc13_payment_response", "Here's {reg3} Resources."),
  ("npc14_payment_response", "Here's {reg3} Resources."),
  ("npc15_payment_response", "Here's {reg3} Resources."),
  ("npc16_payment_response", "Here's {reg3} Resources."),
  ("npc17_payment_response", "Right. Here's {reg3} Resources, woodman."),
...
#these are not used  
  ...
  ("npc9_rehire_speech", "Can I serve you once again?"),
  ...
  ("npc15_rehire_speech", "Can I serve you once again?"),
...
#local color strings
  ...
  ("npc6_home_description", "I have never ventured this far, but I overheard our Mirkwood scouts say there may be Nazguls here. I feel an evil presence, but I cannot put a name to it. It is powerful, though, so let us be prepared."),
  ...
  ("npc6_home_description_2", "I sense the evil armies behind its walls prepare to march... To fair Lothlórien? To Dale? To my Mirkwood homeland? I cannot tell, but please do everything you can to thwart them."),
  ...
  ("npc9_home_recap", "I'll make this short."),
...
("trait_desc_elf_friend", "You_have_become_highly_esteemed_by_the_Elves_and_they_now_regard_you_as_a_trusted_ally._The_influence_cost_to_recruit_elves_has_been_reduced_and_you_may_now_attempt_to_give_orders_to_elven_armies."),

("trait_title_gondor_friend", "Steward's_Blessing"),
("trait_desc_gondor_friend", "You_have_become_highly_esteemed_by_the_Steward_Denethor_and_your_status_has_risen_among_the_men_of_Gondor_as_a_result._The_influence_cost_to_recruit_experienced_Gondorians_has_been_reduced_and_you_may_now_attempt_to_give_orders_to_Gondorian_armies."),

("trait_title_rohan_friend", "King's_Man"),
("trait_desc_rohan_friend", "You_have_become_highly_esteemed_by_King_Theoden_of_Rohan_and_your_status_has_risen_among_the_men_of_Rohan_as_a_result._The_influence_cost_to_recruit_experienced_Rohirrim_men_has_been_reduced_and_you_may_now_attempt_to_give_orders_to_the_armies_of_the_Riddermark."),

("trait_title_brigand_friend", "Brigand_Champion"),
("trait_desc_brigand_friend", "You_have_become_highly_esteemed_by_the_brigands_of_the_Entwash_as_a_result_of_your_impressive_displays_in_their_arena._You_may_now_recruit_experienced_brigand_men_from_Balan_at_the_brigand_fort."),
...
("trait_desc_berserker", "After_many_battles_where_you_eschewed_the_use_of_armor_your_ferocious_will_has_become_like_iron._In_battles_where_you_are_gravely_wounded_you_will_receive_an_occasional_health_bonus._This_will_not_restore_you_to_full_strength_but_may_keep_you_going_long_after_others_would_have_succumbed_to_their_wounds."),

("trait_title_infantry_captain", "Infantry_Captain"),
("trait_desc_infantry_captain", "You_have_developed_uncanny_skill_in_the_command_of_infantry_troops._Due_to_rigorous_and_specialized_training_such_troops_will_receive_a_small_health_boost,_once_per_battle,_upon_being_wounded._You_will_also_receive_a_small_bonus_during_the_melee_phase_of_abstracted_battles."),

("trait_title_archer_captain", "Archery_Captain"),
("trait_desc_archer_captain", "You_have_developed_uncanny_skill_in_the_command_of_missile_troops._Due_to_rigorous_and_specialized_training_such_troops_will_receive_a_small_health_boost,_once_per_battle,_upon_being_wounded._You_will_also_receive_a_small_bonus_during_the_missile_phase_of_abstracted_battles."),

("trait_title_cavalry_captain", "Cavalry_Captain"),
("trait_desc_cavalry_captain", "You_have_developed_uncanny_skill_in_the_command_of_mounted_troops._Due_to_rigorous_and_specialized_training_such_troops_will_receive_a_small_health_boost,_once_per_battle,_upon_being_wounded._You_will_also_receive_a_small_bonus_during_the_shock_phase_of_abstracted_battles."),

("trait_title_command_voice", "Command_Voice"),
("trait_desc_command_voice", "Your_experience_with_commanding_men_in_the_field_has_lent_you_an_air_of_authority._The_cost_to_give_orders_to_armies_in_the_field_has_been_reduced."),
