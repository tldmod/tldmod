...
("trait_desc_oathkeeper", "You_have_sworn_grim_oaths_and_lived_to_see_them_fulfilled._Subsequently_you_have_aquired_a_reputation_as_a_man_of_his_word._Whenever_you_receive_influence,_there_is_a_small_chance_for_an_influence_bonus."),

("trait_title_oathbreaker", "Oathbreaker"),
("trait_desc_oathbreaker", "You_have_sworn_grim_oaths_and_failed_to_see_them_through_to_their_conclusion._Subsequently_you_have_aquired_a_reputation_as_a_man_whose_passion_outstrips_his_prowess._Whenever_you_receive_influence,_there_is_a_small_chance_for_an_influence_malus."),
...
("npc21_intro", "Buzz off, little fly, 'fore I SQUASH YER! RRAAARGHH!  (*The troll bares her fangs in a somewhat half-hearted snarl.*)"),
...
("npc21_intro_response_1", "Ah yes, you have me quaking in my boots. What a scary troll, bound by this tiny chain! Why don't you squash me then?"),
...
("npc21_intro_response_2", "Just this once I will let you live, you dirty beast. (leave)"),
...
("npc21_backstory_a", "Hah, step an itsy bit closer an' I'll snap your neck like a twig.  Come on! I'll stomp on your liver, smash your bones into dust an' juice your head like a grape."),
...
("npc21_backstory_b", "Yer' a hard one, are ye? (*she sighs*) Name's Berta. Used to 'ave me a raidin' gang in the Misty Mountains, mind, the nastiest goblin thieves around. Those were the good days. Then we ran into a band of these wild ones from Gundabad.  Did some drinkin', some gamblin'... Next mornin' I woke all tied up, my lads in the wind. Now I break rocks and I haul their baggage around. Sometimes they 'ave me scrappin' for money."),
...
("npc21_backstory_c", "Listen 'ere, tiny! If yer' some bigshot chief indeed, p'raps yer can talk to the bossman there and pay off what I owe? I reckon I could join your lil' band. See the world, eat some sheep... (*She licks her impressive fangs.*)"),
...
("npc21_backstory_later" , "Look wha' the cat dragged in! Done well fo' yerself, then, 'ave yer? Had a lovely time strollin' around, not bein' chained to a damned rock?! Well ain't that nice! How 'bout yer go speak to the bossman for me? Now, better than never."),("npc22_backstory_later", "Have you reconsidered? The time for the Eldar grows short."),
...
("npc21_backstory_response_1", "It's true you're rather large and look like you can handle yourself in a scrap. I might have use for you."),
...
("npc21_backstory_response_2", "Bad luck, troll. I can't afford to haggle for the likes of you."),
...
("npc21_signup", "Now yer' talkin'! Go see the boss and let me outta this hole."),
...
("npc21_signup_2", "I'll be right behind yer, don't yer worry."),
...
("npc21_signup_response_1", "Very well, we shall see if you prove worthy."),
...
("npc21_signup_response_2", "I have no need for you at the moment."),
...
("npc21_payment", "Speakin' of 'worth', that little debt of mine might not be all that little, if yer catch me drift. And the bossman might try and pull a sneaky on yer, so watch out!" + costs_reg14_inf_with_s14),
...
("npc21_payment_response", "Whatever he might try, you are leaving with me."+spend_reg14_inf_on_reg15),
...
("npc21_morality_speech" , "Listen 'ere, chief. A well respected raidin' company can't just {s21} and leave the lads' stomachs agrowlin'!  And mine, look what a biggun' it is too! I might just go and have a little nibble off one of the smaller ones - a finger, a leg maybe... "),
...
("npc21_2ary_morality_speech", "Now where did all the grub go, ey? Need some help bean-countin'?! A proper chief would fetch me a nice juicy leg o'lamb, or a tasty dwarf. Poor ol' me, I'm stuck with yer instead."),
...
("npc21_personalityclash_speech", "Blimey, chief, but that Sickburpfoul's a bit of a mad bat, ain't she? Yer can tell she's cooked one crow too many in that there cauldron of hers, the one what I drag on me poor ol' back at Her Ladyship's command. And lumme if she don't look at me down the end of the nose like I was a piece of dung scrapings, and her head not even up to me navel! Enough to make me want to 'ave her noggin meet my fist, I reckon. But I've seen her sort afore, yes I 'ave. With the likes o' her around, yer wants a pair o' extra eyes round the back of your 'ead, and no mistake."),
...
("npc21_personalityclash2_speech", "I've been thinkin', chief - how does one kill a witch? Without gettin' turnt into a pile o'slugs, I means. That ol' bat's been givin' me the evil eye again and it made me skin crawl the whole day. On the inside! I'm 'appy to smash heads and break shields in a scrap, but what SHE does to the heads I did done smashed, when nobody's lookin'?! I don't play with me food, not like that. Gives me the creeps, tha' one."),
...
("npc21_personalitymatch_speech", "Ha! Chief! Last night, right, I was a-watching that poor little blighter Ufthak for a bit. 'E's a funny little fella, and no mistake! I made 'im cook me some meat he'd stashed away, right, and then I et it, right 'fore his face! Blimey if he didn't bawl his eyes out! Yer should've saw how his nose runs when he bawls, it don't 'arf run like a stream! Ha! Good thing yer keep him around!"),
...
("npc21_personalitymatch_speech_b" , "That silly Ufthak keeps tryin' to sneak away, but I'll always catch 'im, yes I will. It's almost like the old days, chief. When I had me band o'lads at me service. Or way back o'er the mountains, when I had me boys with me -- Bert, and Bill, and Tom... Ah well. Them days be long gone. Where's that little ratty rascal gone now, eh? Ufthak! Come 'ere, yer no-good skulker!"),
...
("npc21_rehire_speech", "How've yer been, chief? Should I pack me things and be off with yer again?"),
...
("npc21_home_intro", "Oi, chief! That there is a bad place! Dol Guldur, the darkest den of the worst kinds of things. All them trees around and not one juicy squirrel, not one tasty bird on them branches. Don't need to be no witch or nuffin' to know the smell of them Dark Ones, and that's the shape of it."),
...
("npc21_home_description", "All me life I've not gone near sorcery, and it'd be a mighty shame to start now."),
...
("npc21_home_description_2", "All me life I've not gone near sorcery, and it'd be a mighty shame to start now."),
...
("npc21_home_recap", "I had me a nice time leadin' a proper raidin' band in the mountains, until I did drunk too much and gambled me life away with those cheats from Gundabad."),
...
("gondor_guildmaster_companion_none", "Nay, Commander. What valour we have is needed to defend our own walls. You may go to the barracks and find soldiers of courage and experience -- maybe more the former than the latter, I fear. Ever have we been traders, crafters and farmers. The finest of our soldiers go to the capital to enlist - perhaps you should try the White City."),
...
("gondor_ha_guildmaster_companion", " Indeed there are. High in the esteem of our Captain Faramir are two of our commanders, Mablung and Damrod. Damrod is away at our Captain’s behest; but Mablung may be found in the cave yonder, a little way along this path here. We Rangers know much of woodlore and archery; Mablung stands above many of us. He is a man of prowess, and accounted one of our finest. Maybe he will be given leave to accompany you for a time."),
...
("gundabad_guildmaster_player_found_ok", "Do I hear you aright? Is this “Berta” of yours a troll that thinks? Now this, I have to see for myself."),

("gundabad_guildmaster_companion", "Watch your tongue, you, or someone here will cut it off! Oh yes, put a foot wrong, and with a snap of my fingers, just like that -- off to the fighting pit you go! A special treat we have there, for loudmouth braggarts like you. Ha, see how you like it, when you’re in that pit with big ol’ Berta! I’d wager a month’s vittles you don’t stay standing after a blow from her. The most cunning troll we’ve ever found, but we’re more cunning, see, seeing as how we’re the ones who’ve got her chained up proper! Bit of a laugh we’re having, putting her below that big statue of that old dwarf king in the caves. So’s she doesn’t get lonely, heh heh heh. Well? Care to take a few swings at our Berta?"),
...
("trait_desc_animal_fighter ", "Wild beasts have learned to avoid you. Your skill at avoiding hostile animals through your wildcraft is greatly enhanced."),
("trait_title_horse_fiend", "Horse Fiend"),
("trait_desc_horse_fiend", "You are a slayer of horses. Horses are frightened by your sheer presence in battle."),
("trait_title_warg_fiend", "Warg Fiend"),
("trait_desc_warg_fiend", "Your terrible reputation as a Wolf Slayer has spread. Your presence may frighten wargs and wolves in battle."),
("trait_title_troll_slayer", "Troll Slayer"),
("trait_desc_troll_slayer", "Your skill in fighting trolls in melee is renowned. You deal additional melee damage against trolls."),
("trait_title_troll_hunter", "Troll Hunter"),
("trait_desc_troll_hunter", "Your skill in fighting trolls from afar is renowned. You deal additional ranged damage against trolls."),
("trait_title_light_armor", "Light Armored"),
("trait_desc_light_armor", "You are well adapted to wearing light armor in battle. You receive a fighting and movement bonus when wearing light armor, sclaing with your agility."),
...
("trait_title_stub_6", "{!}unused"),
("trait_desc_stub_6", "{!}unused"),
("trait_title_stub_7", "{!}unused"),
("trait_desc_stub_7", "{!}unused"),
("trait_title_stub_8", "{!}unused"),
("trait_desc_stub_8", "{!}unused"),
("trait_title_stub_9", "{!}unused"),
("trait_desc_stub_9", "{!}unused"),
("trait_title_stub_10", "{!}unused"),
("trait_desc_stub_10", "{!}unused"),
