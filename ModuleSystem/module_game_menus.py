...
("cheat_impose_quest",0,"{!}Current imposed quest:^{s20}^^Which quest do you want to impose?^(no other quests will be given)","none",[
	...
	("impose_quest_1",[],"{!}hunt_beast",[(assign,"$cheat_imposed_quest","qst_hunt_beast_mayor")]),
...
( "hunt_beast",0,
  ...
  [ ("hunt_begin",  [], "Let the hunt begin!.",
    ...
    ("pick_troops_hunt", [(ge, reg16, 2),], "Pick companions for the hunt, {reg15} selected",
        [(party_get_num_companion_stacks, ":num_stacks","p_main_party"),
        (assign, "$tld_mission_companions", 0),
        (party_clear, "p_temp_party_2"),
        (try_for_range, ":slot", 0, 40),
...
( "hunt_beast_debrief",0,
  "{s9}^^Your Casualties:{s8}", "none", 
    ...
    (try_begin),
        ...
        (str_store_string, s9, "@The {s7} lies dead before you. You and your troops celebrate the triumph and share the experience of the successful hunt."),
    ...
    (else_try),
        ...
        (str_store_string, s9, "@Heavily wounded, the beast tried to escape. It was hunted down and slain by your men."),
        (val_mul, ":beast_level", ":beast_level"),
        ...
        (call_script, "script_safe_remove_party", ":party"),
    (else_try),
        (str_store_string, s9, "@The beast has escaped. You need to pick up its track again."),
    (try_end),
    ],
