...
( "mvtest_cutscenes",0,
   ...
   [],
    [("intro",[], "Play intro.", [(jump_to_menu, "mnu_auto_intro_rohan"),]),
     ...
     ("gandalf_5",[], "Play Gandalf Helms Deep.", [(call_script, "script_start_conversation_cutscene", tld_cc_gandalf_helms_deep),]),
     ("gandalf_6",[], "Play Gandalf Isengard.", [(call_script, "script_start_conversation_cutscene", tld_cc_gandalf_isengard),]),
