...
#	(troop_get_slot, reg2, "trp_player", slot_troop_renown),
    ...
    [ 
 	 ...
 	 +
	   ...
	   ((is_a_wb_menu==1) and
	   [
	      ("action_view_troop_trees",[],"View troop trees.", [(start_presentation, "prsnt_troop_tree"),]),
	   ]
	   or
	   [
	      # 1011: do nothing
...
## ENEMY
		...
		(set_visitors, 18, "trp_corsair_pikeman",				6),
		(set_visitors, 19, "trp_corsair_veteran_raider",		4),
