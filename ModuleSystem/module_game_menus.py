...
( "start_game_3",mnf_disable_all_keys,
   ...
   [("custom_battle_scenario_1" ,[], "Skirmish, Gondor factions vs Harad",
	...
	("custom_battle_scenario_5" ,[],"Skirmish, North factions vs Rhûn",
...
## US     
		...
		(set_visitors, 2, "trp_a4_dism_veteran_skirmisher_of_rohan",		6),
		(set_visitors, 3, "trp_a4_dism_veteran_skirmisher_of_rohan",			6),
		...
		(set_visitors, 8, "trp_a4_dism_veteran_skirmisher_of_rohan",		6),
		...
		(set_visitors, 14, "trp_a4_dism_veteran_skirmisher_of_rohan",	6),
		(set_visitors, 15, "trp_a4_dism_veteran_skirmisher_of_rohan",	6),
		(set_visitors, 40, "trp_a4_dism_veteran_skirmisher_of_rohan",	2),
		(set_visitors, 41, "trp_a4_dism_veteran_skirmisher_of_rohan",	2),
		(set_visitors, 42, "trp_a4_dism_veteran_skirmisher_of_rohan",	2),
		(set_visitors, 43, "trp_a4_dism_veteran_skirmisher_of_rohan",	2),
		(set_visitors, 44, "trp_a4_dism_veteran_skirmisher_of_rohan",	2),
## ENEMY
...
########################################## FOOTBALL  
      ...
      # (else_try),
       ...
       (set_player_troop, "$g_player_troop"),
       (modify_visitors_at_site, "$g_custom_battle_scene"),
			(try_for_range, ":trolls", trp_moria_troll, trp_ent),
    ...
    (else_try),
      ...
      (else_try),
       ...
       (modify_visitors_at_site, "$g_custom_battle_scene"),
       (set_visitor, 1, "$g_player_troop"),
	   (set_visitors, 1, "trp_i2_isen_orc",	15),
	   (set_visitors, 1, "trp_isen_armored_troll",	1),
	   (set_visitors, 1, "trp_isen_vet_troll",	1),
	   (set_visitors, 16, "trp_mordor_olog_hai",	2),
	   (set_visitors,16, "trp_i2_mordor_orc",	15),
    ...
    (else_try),
	   ...
	   (set_visitors, 1, "trp_i5_gon_vet_spearman",		8),
	   (set_visitors, 1, "trp_i5_gon_vet_swordsman",				1),
    ...
    (else_try),
       ...
       (modify_visitors_at_site, "$g_custom_battle_scene"),
       (set_visitor, 1, "$g_player_troop"),
	   (set_visitors, 1, "trp_a5_gon_vet_archer",		1),
	   (set_visitors, 16, "trp_ac2_isen_wolf_rider",		    3),
	   (set_visitors, 16, "trp_i1_isen_orc_snaga",				1),
    ...
    (else_try),
	   ...
	   (set_visitors, 16, "trp_i1_isen_orc_snaga",				4),
...
( "quick_battle_general_test",mnf_disable_all_keys,
   ...
   [
    ...
    ("dot_go_back_ct",[],"{!}.                 Go back",[(jump_to_menu, "mnu_start_game_3"),]),    ]
 ),
...
( "upkeep_report", 0,
 "{!}^{s13}^^{s12}", "none",[ (set_background_mesh, "mesh_ui_default_menu_window"),
    ...
    (try_for_range, ":faction_no", kingdoms_begin, kingdoms_end),
      (neq, ":faction_no", "fac_player_supporters_faction"),
  	  (call_script, "script_compute_wage_per_faction", ":faction_no", p_main_party),
	  (val_add, reg5, reg4),
      (call_script, "script_compute_wage_per_faction", ":faction_no", ":reserve_party_cap"),
	  (val_add, reg5, reg4),
      (call_script, "script_compute_wage_per_faction", ":faction_no", ":reserve_party_ac"),
	  (val_add, reg5, reg4),
    (try_end),
    
    (try_begin),
      (gt,reg5,0),
      (str_store_string, s12, "@Troop upkeep (paid every four days):^"),
      (try_for_range, ":faction_no", kingdoms_begin, kingdoms_end),
        (neq, ":faction_no", "fac_player_supporters_faction"),
        (assign, reg7, 0),
        (assign, reg8, 0),
        ...
        (call_script, "script_compute_wage_per_faction", ":faction_no", p_main_party),
        (val_div, reg7, 2), #half upkeep for reserves
        (store_add, reg8, reg4, reg7),
        (gt, reg8, 0),
        (str_store_faction_name, s4, ":faction_no"),
        (faction_get_slot, reg5, ":faction_no", slot_faction_respoint),
        (str_store_string, s12, "@{s12}^^  {s4}: {reg8}/{reg5} Resource Points ^Party: {reg4}^Reserves: {reg7}"),
      (try_end),
	(else_try),
      ...
      [		(store_random_in_range,":r",0,10),#random number
			(try_begin),
				...
				(try_begin),
					...
					(assign,":troop","trp_i2_goblin_raider"),
				(try_end),
...
("dev_menu", 0,
	"These are development options that give you a lot of cheats/tools to play with.^^ However, this will result in some WIP events, triggers, campaign changes that could be game breaking.^^ Use at your own risk! ^^ Also, when reporting bugs, please tell us that you are using the Dev Menu.",
...
( "mvtest_cutscenes",0,
   ...
   [],
    [("intro",[], "{!}Play intro.", [(jump_to_menu, "mnu_auto_intro_rohan"),]),
     ...
     ("gandalf_5",[], "{!}Play Gandalf Helms Deep.", [(call_script, "script_start_conversation_cutscene", tld_cc_gandalf_rohan_quest_start),]),
...
( "camp_chest_fill",0,
 ...
 [
  ...
  ("f_rhun"    ,[],"{!}Rhûn items"      ,[(call_script,"script_fill_camp_chests","fac_rhun"    ),(jump_to_menu, "mnu_camp"),]),	   
  ...
  ("go_back_ct",[],"{!}Go back"         ,[(jump_to_menu, "mnu_camp"),]),
 ]
 ),
( "cheat_change_race",0,
 ...
 [
  ...
  ("go_back_ct"     ,[],"{!}Go back"   ,[(jump_to_menu, "mnu_camp_cheat"),]),
 ]),  
...
#	),
    ...
    ("camp_use_athelas",
        ...
        (try_begin),
            ...
            (assign, ":orc_faction", fac_mordor),
        (else_try),
            (eq, ":theater", theater_SW),
            (assign, ":orc_faction", fac_isengard),
        (else_try),
            (eq, ":theater", theater_N),
            (assign, ":orc_faction", fac_gundabad),
        (else_try),
            (eq, ":theater", theater_C),
            (party_get_position, pos1, "p_main_party"),
            (position_get_x, reg0, pos1),
            (try_begin),
                (gt, reg0, 10), # roughly west of Anduin
                (assign, ":orc_faction", fac_moria),
            (else_try), #east of Anduin
                (assign, ":orc_faction", fac_guldur),
            (try_end),
        (try_end),
        
        (faction_get_slot, ":faction_template_a", ":orc_faction", slot_faction_reinforcements_a),
        (faction_get_slot, ":faction_template_b", ":orc_faction", slot_faction_reinforcements_b),
        (faction_get_slot, ":faction_template_c", ":orc_faction", slot_faction_reinforcements_c),
        
        (try_begin),
            (store_relation, ":faction_relation", ":orc_faction", "$players_kingdom"),
            (lt, ":faction_relation", 0),
            (assign, ":orc_faction", 0), 
        (try_end), 
                
        (assign, ":drum_strength", 1),
        (store_attribute_level, ":player_charisma", trp_player, ca_charisma),
        (store_attribute_level, ":player_strength", trp_player, ca_strength),
        (val_add, ":drum_strength", ":player_charisma"),
        (val_add, ":drum_strength", ":player_strength"),
        
        (store_random_in_range, ":random", 0, 100),
        (val_add, ":random", ":drum_strength"),
        # (assign, reg77, ":drum_strength"),
        # (display_message, "@drum strength: {reg77}"),
        # (assign, reg77, ":random"),
        # (display_message, "@score: {reg77}"),
        
        (assign, ":reinf_template", 0),
        (assign, ":reinf_adjust", 0), 
        (try_begin),
            (ge, ":orc_faction", 1),
            (ge, ":drum_strength", 40), 
            (ge, ":random", 120), 
            (assign, ":reinf_template", ":faction_template_c"),
            (str_store_faction_name, s1, ":orc_faction"),
            (str_store_string, s2, "@elites"),
            (faction_get_slot, ":faction_troll", ":orc_faction", slot_faction_troll_troop),
            (party_add_members, "p_main_party", ":faction_troll", 1),
        (else_try), 
            (ge, ":orc_faction", 1),
            (ge, ":drum_strength", 28),
            (ge, ":random", 100),
            (assign, ":reinf_template", ":faction_template_b"),
            (str_store_faction_name, s1, ":orc_faction"),
            (str_store_string, s2, "@regulars"),
        (else_try), 
            (ge, ":orc_faction", 1),
            (ge, ":random", 80),
            (assign, ":reinf_template", ":faction_template_a"),
            (str_store_faction_name, s1, ":orc_faction"),
            (str_store_string, s2, "@recruits"),
        (else_try), 
            (ge, ":random", 60),
            (this_or_next|eq, ":theater", theater_N),
            (this_or_next|eq, ":theater", theater_C),
            (eq, ":theater", theater_SW),
            (assign, ":reinf_template", pt_tribal_orcs),  
            (str_store_string, s1, "@wild"),
            (str_store_string, s2, "@goblins"),
        (else_try),
            (ge, ":random", 45), 
            (eq, ":theater", theater_SE),
            (assign, ":reinf_template", pt_forest_bandits),
            (str_store_string, s1, "@lordless"),
            (str_store_string, s2, "@orc stragglers"),
            (assign, ":reinf_adjust", -4), #party template is much bigger than others
        (try_end),
 
        (store_random_in_range, ":reinf_rounds", 1, 5),
        (val_div, ":drum_strength", 10), #1-6)
        (val_add, ":reinf_rounds", ":drum_strength"),
        (val_add, ":reinf_rounds", ":reinf_adjust"),
        (val_max, ":reinf_rounds", 2),
        
        (try_for_range, ":unused", 0, ":reinf_rounds"),
            (gt, ":reinf_template", 0),
            (party_add_template, p_main_party, ":reinf_template"),
        (try_end),
        
        (try_begin),
            (gt, ":drum_strength", 4),
            (gt, ":reinf_template", 0),            
            (display_message, "@You camp and beat the Drums of the Deep. The mighty sound attracts a group of {s1} {s2}."),
        (else_try),
            (gt, ":drum_strength", 2),
            (gt, ":reinf_template", 0),            
            (display_message, "@You camp and beat the Drums of the Deep. The powerful sound attracts a group of {s1} {s2}."),
        (else_try),
            (gt, ":reinf_template", 0),            
            (display_message, "@You camp and beat the Drums of the Deep. The weak sound attracts a group of {s1} {s2}."),
        (else_try),
            (display_message, "@You camp and try to beat the Drums of the Deep, yet noone answers your pitiful call."),
        (try_end),
...
("cheat_impose_quest",0,"{!}Current imposed quest:^{s20}^^Which quest do you want to impose?^(no other quests will be given)","none",[
    ...
    ("impose_quest_11", [], "{!}qst_eliminate_patrols", [(assign, "$cheat_imposed_quest", "qst_eliminate_patrols")]),
    ("impose_quest_12", [], "{!}Dispatch Troll", [
    	(try_begin),
...
#Post 0907 changes end
		...
		(try_begin),
			...
			(quest_get_slot, ":target_lord", "qst_defeat_target_lord", slot_quest_target_troop),
			(troop_get_slot, ":party", ":target_lord", slot_troop_leaded_party),
			(eq, ":party", "$g_enemy_party"),
			(call_script, "script_succeed_quest", "qst_defeat_target_lord"),
		(else_try),
			(check_quest_active, "qst_defeat_target_lord"),
			(quest_get_slot, ":target_lord", "qst_defeat_target_lord", slot_quest_target_troop),
			(troop_get_slot, ":party", ":target_lord", slot_troop_leaded_party),
		...
		(try_begin),
			(check_quest_active, "qst_defend_refugees"),
...
#          (str_store_string, s3, "str_place_is_occupied_by_friendly"),
        ...
        (else_try),
          ...
          (troop_get_type, ":player_race", "trp_player"),
          (assign, ":quest_object_troop", "trp_aragorn"),
          (try_begin),
            (eq, ":player_race",  tf_dwarf), (assign, ":quest_object_troop", trp_gimli),
          (else_try),
            (is_between, ":player_race", tf_elf_begin, tf_elf_end),(assign, ":quest_object_troop", trp_legolas),
          (try_end),          
          (modify_visitors_at_site,"scn_conversation_scene"),
          (reset_visitors),
          (set_visitor,0, "trp_player"),
...
#             (set_jump_mission,"mt_castle_attack_walls_belfry"),
		   (else_try),
			(assign, ":siege_mission", "mt_castle_attack_walls_ladder"), 
			# (try_begin), #reduced siege AI is now integrated in the regular mission template
				# (eq, "$advanced_siege_ai",1),
				# (assign, ":siege_mission", "mt_castle_attack_walls_ladder"),
			# (else_try),
				# (eq, "$advanced_siege_ai", 0),
...
( "siege_started_defender",mnf_scale_picture|mnf_enable_hot_keys,
  ...
  ##            (lt, ":min_enemy_str", "$g_friend_fit_for_battle"),
            ...
            (else_try),
              ...
              (lt, "$g_enemy_fit_for_battle", "$g_friend_fit_for_battle"),
              (assign, ":attackers_retreat", 1),
            (else_try),
              (store_random_in_range, ":random_no", 0, 100),
              (lt, ":random_no", 10),
    ...
    [
	   ...
	   ("town_castle",[
		  ...
		  # (try_begin),   # barman troop stores center common name in plural register #InVain, disabled, use barmen for missing merchants and smiths
			# (party_get_slot, ":barman_troop", "$current_town", slot_town_captain),
     ...
     [ (call_script, "script_initialize_center_scene", 0),
      ...
      (try_begin),
		...
		(eq, ":town_faction", "fac_gondor"), #InVain Fix to Cair Andros smith always belonging to Gondor, even after CA has been captured
	  	...
	  	(str_store_troop_name_plural, s41, "trp_merchant_candros"),
	  (else_try),
	    (this_or_next|eq, "$current_town", "p_town_west_osgiliath"),
		(eq, "$current_town", "p_town_east_osgiliath"),
		(store_faction_of_party, ":town_faction", "$current_town"),
		(eq, ":town_faction", "fac_gondor"),
	  	...
	  	(str_store_troop_name_plural, s41, "trp_merchant_wosgiliath"),
	  (else_try),
...
#	]),
       ...
       [(try_begin),
            ...
            (party_get_slot, ":training_scene", "$current_town", slot_town_arena),
        (else_try),
            (store_faction_of_party, ":faction_no", "$current_town"),
            (faction_get_slot, ":capital", ":faction_no", slot_faction_capital),
            (party_get_slot, ":training_scene", ":capital", slot_town_arena),
        (try_end),
        (jump_to_menu, "mnu_town"),
	...
	("talk_to_castle_commander",[(party_slot_eq,"$current_town",slot_party_type, spt_town),
          ...
          (this_or_next|eq,"$tld_option_town_menu_hidden",0),(party_slot_ge, "$current_town", slot_barracks_visited, 1),
             ...
             (try_end),
             (str_store_troop_name, s1, ":barracks_troop"),
             ...
             (call_script, "script_setup_troop_meeting", ":barracks_troop", 0),
             ]),
	  ...
	  ("town_ask",
       [   (party_slot_eq,"$current_town",slot_party_type, spt_town),
           ...
           (party_slot_eq, "$current_town", slot_town_all_found, 0),
        ],
         "Ask around for persons of import...",
         [ (jump_to_menu, "mnu_town_find_NPCs"),
          ]),
...
( "town_find_NPCs",0,
    ...
    (try_begin),
        (try_begin),
            ...
            (party_slot_ge, "$current_town", slot_weaponsmith_visited, 1),
            (val_add, ":count", 1),
        (try_end),
        ...
        (try_begin),
            ...
            (val_add, ":check_count", 1),
            (party_slot_ge, "$current_town", slot_merchant_visited, 1),
            (val_add, ":count", 1),
        (try_end),    

        (try_begin),
            (party_slot_ge, "$current_town", slot_town_elder, 1),
             (val_add, ":check_count", 1),
            (party_slot_ge, "$current_town", slot_elder_visited, 1),
            (val_add, ":count", 1),
        (try_end),   

        (try_begin),
            (val_add, ":check_count", 1), #barracks are always there
        ...
        # (assign, reg77, ":check_count"),
        # (assign, reg78, ":count"),
        # (display_message, "@count: {reg78}/{reg77}"),
        (str_store_string, s4, "@You have already found all persons of interest."),
        (party_set_slot, "$current_town", slot_town_all_found, 1),
        (assign, "$temp_2", 1),
    (try_end),
    ],
...
( "town_find_NPCs_end",0,
    ...
    (call_script, "script_get_max_skill_of_player_party", "skl_trade"),
     ...
     (try_begin),
        ...
        (str_store_string, s4, "@the captain of the garrison, and the civil authority."),
      (else_try),
        (str_store_string, s4, "@and the captain of the garrison. As this place was recently captured, it has not civil authority."),
      (try_end),   
    ...
    (str_clear, s6),
     (try_begin),
        (party_slot_ge, "$current_town", slot_town_healer, 1),
        (str_store_string, s6, "@You also heard of a healer, but you will have to find them on your own."),
      (try_end),   
...
#      (set_visitors,17,"trp_i1_tribal_goblin", 8),
#      (set_visitors,18,"trp_i2_goblin_raider", 8),
	...
	[("start_defend_caravan",
		...
		"Defend the Caravan!", [
		    ...
		    (modify_visitors_at_site,"scn_starting_quest"),
		      ...
		      (set_visitors,18,"trp_i1_tribal_goblin", 8),
		      (set_visitors,20,"trp_i2_goblin_raider", 6),
		      (set_visitors,22,"trp_i4_mordor_fell_uruk", 1),
		      (jump_to_scene,"scn_starting_quest"),
		      (set_battle_advantage, 0),
		      (assign, "$g_battle_result", 0),
		...
		"Raid the Caravan!", [
		    ...
		    (modify_visitors_at_site,"scn_starting_quest"),
		      ...
		      (try_begin),
			      (this_or_next|eq, "$players_kingdom", "fac_isengard"),
			      ( 			eq, "$players_kingdom",  "fac_dunland"),
			      (set_visitors,4,"trp_i2_guardsman_of_rohan", 5),
			      (set_visitors,2,"trp_i3_footman_of_rohan", 4),
		      (else_try),
		      	  (this_or_next|eq,"$players_kingdom", "fac_mordor"),
		      	  (				eq,"$players_kingdom", "fac_umbar"),
			      (set_visitors,4,"trp_i2_gon_watchman", 5),
			      (set_visitors,2,"trp_i3_gon_footman", 3),
			  (else_try),
			  	  (				eq,"$players_kingdom", "fac_guldur"),
  	  			  (set_visitors,4,"trp_a2_woodmen_tracker", 4),
			      (set_visitors,2,"trp_i2_beorning_warrior", 5),
			 (else_try),
			  	  (				eq,"$players_kingdom", "fac_rhun"),
  	  			  (set_visitors,4,"trp_a2_dale_scout", 5),
			      (set_visitors,2,"trp_i2_dale_man_at_arms", 4),
			 (else_try),
			  	  (this_or_next|eq,"$players_kingdom", "fac_moria"),
  			  	  (				eq,"$players_kingdom", "fac_gundabad"),
  	  			  (set_visitors,4,"trp_i2_dwarf_warrior", 4),
			      (set_visitors,2,"trp_i2_iron_hills_miner", 3),
		      (try_end),
		      (set_visitors,6,"trp_start_quest_caravaneer", 1),
		      (set_visitors,18,":tier_1_troop", 6),
		      (set_visitors,20,":tier_2_troop", 6),
		      (set_visitors,22,"trp_start_quest_uruk", 1),
	...
	("start_ambush_orcs",
		...
		"Ambush the Orcs!", [
		    ...
		    (try_end),
		      ...
		      (try_end),
		      (faction_get_slot, ":tier_1_troop", "$assist", slot_faction_tier_2_troop),
		      (faction_get_slot, ":tier_2_troop", "$assist", slot_faction_tier_3_troop),
		      (set_visitor,0,"trp_player"),
		      (try_begin),
		      	(eq,"$assist", "fac_beorn"),
		      	(set_visitors,2,":tier_1_troop", 6),
			  ...
			  (else_try),    
			     (set_visitors,2,":tier_1_troop", 3),
			     (set_visitors,4,":tier_2_troop", 3),
		      	 (set_visitors,6,"trp_start_quest_woodelf", 1),
		      (try_end),
		      (set_visitors,22,"trp_i1_tribal_goblin", 15),
		      (set_visitors,23,"trp_i2_goblin_raider", 8),
	...
	("start_kill_scouts",
		...
		"Stop the scouts from reporting your arrival!", [
		    ...
		    (modify_visitors_at_site,"scn_quick_battle_ambush"),
		      ...
		      (try_end),
		      (faction_get_slot, ":tier_2_troop", "$assist", slot_faction_tier_2_troop),
		      (faction_get_slot, ":tier_3_troop", "$assist", slot_faction_tier_3_troop),
		      (set_visitor,0,"trp_player"),
		      (set_visitors,2,":tier_3_troop", 4),
		      (set_visitors,4,":tier_2_troop", 10),
		      (set_visitor,6,"trp_start_quest_mordor_scout"),
		      (set_visitors,22,"trp_a4_ithilien_ranger", 3),
...
###################### Sea Battle Quest Start (Kham) ##########################################
	...
	("sea_battle_quest",0,
	 ...
	 ("sb_defend_the_town",[
	     ...
	     [  
	     	#(quest_get_slot, ":target_center", "qst_sea_battle", slot_quest_target_center),
	     	(quest_get_slot, ":object_troop", "qst_sea_battle", slot_quest_object_center),
...
("sea_battle_quest_results",mnf_scale_picture|mnf_disable_all_keys,
	    ...
	    [ (set_background_mesh, "mesh_ui_default_menu_window"),
	      (try_begin),
	        ...
	        (try_end),
			(call_script, "script_succeed_quest", "qst_sea_battle"),
		  (else_try),
	      	(neq, "$g_battle_result", 1),
	        (call_script, "script_fail_quest", "qst_sea_battle"),
	        (try_begin),
	        	(faction_slot_eq, "$g_encountered_party_faction", slot_faction_side, faction_side_good),
...
("refugees_quest",0,
	"{!}{s1}","none", 
   [(this_or_next|check_quest_active, "qst_defend_refugees"),
    (			  check_quest_active, "qst_hunt_down_refugees"),
   	(try_begin),
   		(check_quest_active, "qst_defend_refugees"),
   		(assign, ":quest", "qst_defend_refugees"),
   	(else_try),
   		(assign, ":quest", "qst_hunt_down_refugees"),
   	(try_end),
   ...
   [("defend_refugees" ,[(check_quest_active, "qst_defend_refugees")],"Keep your eye out for raiders...",[(change_screen_map)]),
    ("attack_refugees" ,[(check_quest_active, "qst_hunt_down_refugees")],"Attack the refugee train...",[(jump_to_menu, "mnu_simple_encounter")]),
    ("leave_refugees",  [(check_quest_active, "qst_hunt_down_refugees")],"Leave them for now...", [(change_screen_map)]),
   ],
 ),
...
( "custom_battle_choose_faction3",0,
	...
	("cb_mordor"    ,[],"Mordor"     ,[(assign,"$faction_evil",fac_mordor  ),(jump_to_menu,"mnu_custom_battle_2"),]),
     ...
     ("cb_mordor7"   ,[],"Rhûn"       ,[(assign,"$faction_evil",fac_rhun    ),(jump_to_menu,"mnu_custom_battle_2"),]),
...
( "ancient_ruins",0,
  "{!}{s1}^^{s2}", "none", 
		[
			...
			(else_try),
				(str_store_string, s1, "@You approach a heavily guarded region of the forest... ^^ You have to decide whether you venture forward on your own, or take some troops with you. ^Choose your actions carefully, because the more attention you attract, the better the sorcerer will be guarded.^Speed will be more important than heavy armor."),				
			(try_end),
            (try_begin), #Reset reg0 from previous uses if no companion chosen
                (neg|faction_slot_ge, fac_mission_companion_1, slot_fcomp_troopid, 1),
                (assign, reg0, 0),
            (try_end),
            ...
            (try_begin),
                ...
                (neg|check_quest_failed, "qst_mirkwood_sorcerer"),
                (try_begin),
                    (ge, "$meta_stealth", 7),
                    (str_store_string, s2, "@You have a good chance of avoiding the guards and slipping through unnoticed."),			
                (else_try),
                    (ge, "$meta_stealth", 4),
                    (str_store_string, s2, "@You may have a chance of avoiding the guards."),
                (else_try),
                    (str_store_string, s2, "@You will probably have to fight the guards."),				
                (try_end),
            (try_end),
            
            (troop_set_slot, "trp_black_numenorean_sorcerer", slot_troop_hp_shield, 500),
		],
  ...
  "Sneak into the sorcerer's lair under the night's cover.",
	...
	(else_try),
		...
		(try_begin),
            (ge, "$stealth_results", 3),(assign, "$rescue_stage", 0),(call_script, "script_infiltration_combat_1"),
            (display_message, "@You_are_quickly_discovered_by_the_enemy."),
            (display_message, "@Eliminate_them_before_the_alarm_spreads!"),
	 	(else_try),
            (eq, "$stealth_results", 2),(assign, "$rescue_stage", 1),(call_script, "script_infiltration_stealth_2"),
	 	...
	 	(else_try),
            (eq, "$stealth_results", 1),(assign, "$rescue_stage", 2),(call_script, "script_final_sorcerer_fight"),
            # (display_message, "@You_have_evaded_the_patrols_and_crept_close_to_the_ruins!"),
            # (display_message, "@Find and kill the sorcerer! Do not let the guards stop you."),
		(try_end),
		(assign, "$active_rescue", 5),
		(change_screen_mission),
	(try_end),
    ...
    ("next_rescue_scene", [(eq, 1, 0)], "{!}_",  #invisible,only accessible from scene passages
						[
						 (try_begin),
							(neq, "$alarm_level", 0),
		...
		("pick_troops1", [(neg|quest_slot_ge, "qst_mirkwood_sorcerer",slot_quest_current_state,2)], "Pick companions for the mission, {reg0} selected",
							[(party_get_num_companion_stacks, ":num_stacks","p_main_party"),
                            (assign, "$tld_mission_companions", 0),
                            (party_clear, "p_temp_party_2"),
                            ...
                            (try_for_range, ":stack_no", 0, ":num_stacks"), # store troops eligible for stealth mission
                              ...
                              (store_skill_level, reg1, skl_athletics, ":stack_troop"), # only troops with high athletics can go on stealth missions
                              (ge, reg1, 4),
                              ...
                              (val_add,":slot",1),
                              (party_add_members, "p_temp_party_2", ":stack_troop", ":stack_size"),
                            (try_end),
                            (assign, "$quest_auto_menu", "mnu_ancient_ruins"),
...
( "pick_troops", 0, 
  "Whom would you take with you into the mission? \
   ^Only your most nimble troops and companions will be able to join you. \
   ^As the party member with the highest wildcraft skill, {reg13?{s1} advises:you decide} that you can take up to {reg11} troops with you. \
   ^^Currently you have picked {reg12} companions.", "none",
   [(set_background_mesh, "mesh_ui_default_menu_window"),
    (call_script, "script_get_max_skill_of_player_party", "skl_persuasion"),
    (assign, ":max_skill", reg0),
    (assign, ":max_skill_owner", reg1),
    (assign, reg13, ":max_skill_owner"),
    (str_store_troop_name, s1, ":max_skill_owner"),
    (val_add, ":max_skill", 1),
    (val_min, ":max_skill", 10),
    (assign, reg11, ":max_skill"),
    (assign, reg12, "$tld_mission_companions"),
    (party_stack_get_size, reg20, "p_temp_party_2", 0),
    (party_stack_get_size, reg22, "p_temp_party_2", 1),
    (party_stack_get_size, reg23, "p_temp_party_2", 2),
    (party_stack_get_size, reg24, "p_temp_party_2", 3),
    (party_stack_get_size, reg25, "p_temp_party_2", 4),
    (party_stack_get_size, reg26, "p_temp_party_2", 5),
    (party_stack_get_size, reg27, "p_temp_party_2", 6),
    (party_stack_get_size, reg28, "p_temp_party_2", 7),
    (party_stack_get_size, reg29, "p_temp_party_2", 8),
     ], [ 
   #"$tld_mission_companions" counts total # of companions picked
  ("troop1", [(party_stack_get_troop_id,":troop","p_temp_party_2",0),(gt,":troop",0),(str_store_troop_name, s1, ":troop")],
   "{!}{s1}: {reg10}/{reg20}", [(party_stack_get_troop_id,":troop","p_temp_party_2",0),
                    (party_count_members_of_type, ":n", "p_temp_party_2",":troop"),
					(try_begin),(lt,reg10,":n"),(lt,"$tld_mission_companions",reg11),(val_add, reg10,1),(call_script, "script_set_hero_companion", ":troop"),
					(else_try),(val_sub,"$tld_mission_companions",reg10),(assign,reg10,0),
					(try_end),(jump_to_menu, "mnu_pick_troops")]),  
  ("troop2", [(party_stack_get_troop_id,":troop","p_temp_party_2",1),(gt,":troop",0),(str_store_troop_name, s2, ":troop")],
   "{!}{s2}: {reg2}/{reg22}", [(party_stack_get_troop_id,":troop","p_temp_party_2",1),
                    (party_count_members_of_type, ":n", "p_temp_party_2",":troop"),
					(try_begin),(lt,reg2,":n"),(lt,"$tld_mission_companions",reg11),(val_add, reg2,1),(call_script, "script_set_hero_companion", ":troop"),
					(else_try),(val_sub,"$tld_mission_companions",reg2),(assign,reg2,0),
					(try_end),(jump_to_menu, "mnu_pick_troops")]),  
  ("troop3", [(party_stack_get_troop_id,":troop","p_temp_party_2",2),(gt,":troop",0),(str_store_troop_name, s3, ":troop")],
   "{!}{s3}: {reg3}/{reg23}", [(party_stack_get_troop_id,":troop","p_temp_party_2",2),
                    (party_count_members_of_type, ":n", "p_temp_party_2",":troop"),
					(try_begin),(lt,reg3,":n"),(lt,"$tld_mission_companions",reg11),(val_add, reg3,1),(call_script, "script_set_hero_companion", ":troop"),
					(else_try),(val_sub,"$tld_mission_companions",reg3),(assign,reg3,0),
					(try_end),(jump_to_menu, "mnu_pick_troops")]),  
  ("troop4", [(party_stack_get_troop_id,":troop","p_temp_party_2",3),(gt,":troop",0),(str_store_troop_name, s4, ":troop")],
   "{!}{s4}: {reg4}/{reg24}", [(party_stack_get_troop_id,":troop","p_temp_party_2",3),
                    (party_count_members_of_type, ":n", "p_temp_party_2",":troop"),
					(try_begin),(lt,reg4,":n"),(lt,"$tld_mission_companions",reg11),(val_add, reg4,1),(call_script, "script_set_hero_companion", ":troop"),
					(else_try),(val_sub,"$tld_mission_companions",reg4),(assign,reg4,0),
					(try_end),(jump_to_menu, "mnu_pick_troops")]),  
  ("troop5", [(party_stack_get_troop_id,":troop","p_temp_party_2",4),(gt,":troop",0),(str_store_troop_name, s5, ":troop")],
   "{!}{s5}: {reg5}/{reg25}", [(party_stack_get_troop_id,":troop","p_temp_party_2",4),
                    (party_count_members_of_type, ":n", "p_temp_party_2",":troop"),
					(try_begin),(lt,reg5,":n"),(lt,"$tld_mission_companions",reg11),(val_add, reg5,1),(call_script, "script_set_hero_companion", ":troop"),
					(else_try),(val_sub,"$tld_mission_companions",reg5),(assign,reg5,0),
					(try_end),(jump_to_menu, "mnu_pick_troops")]),  
  ("troop6", [(party_stack_get_troop_id,":troop","p_temp_party_2",5),(gt,":troop",0),(str_store_troop_name, s6, ":troop")],
   "{!}{s6}: {reg6}/{reg26}", [(party_stack_get_troop_id,":troop","p_temp_party_2",5),
                    (party_count_members_of_type, ":n", "p_temp_party_2",":troop"),
					(try_begin),(lt,reg6,":n"),(lt,"$tld_mission_companions",reg11),(val_add, reg6,1),(call_script, "script_set_hero_companion", ":troop"),
					(else_try),(val_sub,"$tld_mission_companions",reg6),(assign,reg6,0),
					(try_end),(jump_to_menu, "mnu_pick_troops")]),  
  ("troop7", [(party_stack_get_troop_id,":troop","p_temp_party_2",6),(gt,":troop",0),(str_store_troop_name, s7, ":troop")],
   "{!}{s7}: {reg7}/{reg27}", [(party_stack_get_troop_id,":troop","p_temp_party_2",6),
                    (party_count_members_of_type, ":n", "p_temp_party_2",":troop"),
					(try_begin),(lt,reg7,":n"),(lt,"$tld_mission_companions",reg11),(val_add, reg7,1),(call_script, "script_set_hero_companion", ":troop"),
					(else_try),(val_sub,"$tld_mission_companions",reg7),(assign,reg7,0),
					(try_end),(jump_to_menu, "mnu_pick_troops")]),  
  ("troop8", [(party_stack_get_troop_id,":troop","p_temp_party_2",7),(gt,":troop",0),(str_store_troop_name, s8, ":troop")],
   "{!}{s8}: {reg8}/{reg28}", [(party_stack_get_troop_id,":troop","p_temp_party_2",7),
                    (party_count_members_of_type, ":n", "p_temp_party_2",":troop"),
					(try_begin),(lt,reg8,":n"),(lt,"$tld_mission_companions",reg11),(val_add, reg8,1),(call_script, "script_set_hero_companion", ":troop"),
					(else_try),(val_sub,"$tld_mission_companions",reg8),(assign,reg8,0),
					(try_end),(jump_to_menu, "mnu_pick_troops")]),  
  ("troop9", [(party_stack_get_troop_id,":troop","p_temp_party_2",8),(gt,":troop",0),(str_store_troop_name, s9, ":troop")],
   "{!}{s9}: {reg9}/{reg29}", [(party_stack_get_troop_id,":troop","p_temp_party_2",8),
                    (party_count_members_of_type, ":n", "p_temp_party_2",":troop"),
					(try_begin),(lt,reg9,":n"),(lt,"$tld_mission_companions",reg11),(val_add, reg9,1),(call_script, "script_set_hero_companion", ":troop"),
					(else_try),(val_sub,"$tld_mission_companions",reg9),(assign,reg9,0),
					(try_end),(jump_to_menu, "mnu_pick_troops")]),  
  ("go_forward",   [], "End selecting companions and proceed.",  [#clear overflowing companions slots
					(store_add, ":empty", "$tld_mission_companions", "fac_mission_companion_1"),
...
("cheat_force_scene",0,
 ...
 "none",
   ...
   ("back_3dotct" ,[],"{!}Back...",[(jump_to_menu, "mnu_camp_cheat")])],
 ),
...
( "hunt_beast",0,
  "{!}{s5}.", "none", 
    [(set_background_mesh, "mesh_ui_default_menu_window"),
    (try_begin),
        (quest_slot_eq, "qst_hunt_beast_mayor", slot_quest_target_party, "$g_encountered_party"),
        (assign, "$random_quest_no", "qst_hunt_beast_mayor"), #reuse this global for tracking the current hunt quest variant
    (else_try),
        (quest_slot_eq, "qst_hunt_beast_coop", slot_quest_target_party, "$g_encountered_party"),
        (assign, "$random_quest_no", "qst_hunt_beast_coop"), #reuse this global for tracking the current hunt quest variant
    (try_end),
    (str_clear, s5),
    (party_get_num_companions, reg16, "p_main_party"),
    (try_begin),
        (eq, "$random_quest_no", "qst_hunt_beast_mayor"),
        (ge, reg16, 2),
        (str_store_string, s5, "@You have tracked down the beast and ordered your party to encircle it, so it may not escape from the area. ^Now, decide how many companions should accompany you on your hunt. The more you take with you, the easier it is to find and kill the beast, but your part in the hunt will be smaller."),
        (assign, reg15, "$tld_mission_companions"),
    (else_try),
        (eq, "$random_quest_no", "qst_hunt_beast_mayor"),
        (str_store_string, s5, "@You have tracked down the beast."),
    (else_try),
        (str_store_troop_name, s6, "$g_talk_troop"),
        (str_store_string, s5, "@{s6}'s soldiers have tracked down the beast and encircled it, so it may not escape from the area. {s6} and you now need to meet it in fight."),
    (try_end),
    ],
    
  [ ("hunt_begin",  [], "Let the hunt begin!",
        [(quest_set_slot, "qst_hunt_beast_mayor", slot_quest_target_item, reg0), #store number of companions
        (set_jump_mission, "mt_hunt_beast"),
        (set_battle_advantage, 0),
        (set_party_battle_mode),
        (assign,"$number_of_combatants",5), #use a big scene
        (call_script, "script_jump_to_random_scene", "$current_player_region", "$current_player_terrain",  "$current_player_landmark"),
        (modify_visitors_at_site, reg0),
        (reset_visitors),
        (call_script, "script_set_infiltration_companions"), #also puts player as visitor
        (try_begin),
            (eq, "$random_quest_no", "qst_hunt_beast_coop"),
            (quest_get_slot, ":lord", "qst_hunt_beast_coop", slot_quest_giver_troop),
            (set_visitor, 0, ":lord"),
        (try_end),
        (jump_to_scene, reg0),
        (change_screen_mission),
        ...
        (try_begin),
            (faction_slot_eq, "$players_kingdom", slot_faction_side, faction_side_good),
            (music_set_culture, mtf_culture_good),
        (else_try),
            (music_set_culture, mtf_culture_evil),
        (try_end),
	]),
    ...
    ("pick_troops_hunt", 
        [(ge, reg16, 2),
        (eq, "$random_quest_no", "qst_hunt_beast_mayor"),], 
    "Pick companions for the hunt, {reg15} selected",
        [(party_get_num_companion_stacks, ":num_stacks","p_main_party"),
        (assign, "$tld_mission_companions", 0),
        (party_clear, "p_temp_party_2"),
        (try_for_range, ":slot", 0, 40),
        ...
        (try_for_range, ":stack_no", 0, ":num_stacks"), # store troops eligible for stealth mission
          ...
          (party_add_members, "p_temp_party_2", ":stack_troop", ":stack_size"),
        (try_end),
        (assign, "$quest_auto_menu", "mnu_hunt_beast"),
        (assign,reg1,0),(assign,reg2,0),(assign,reg3,0),(assign,reg4,0),(assign,reg5,0),(assign,reg6,0),(assign,reg7,0),(assign,reg8,0),(assign,reg9,0),(assign,reg10,0),(assign,reg0,0),
        (jump_to_menu, "mnu_pick_troops")
     ]),
        
    ("leave", [(eq, "$random_quest_no", "qst_hunt_beast_mayor"),], "Leave.",
        [(leave_encounter),
        (change_screen_return),
        (try_for_range, ":comp","fac_mission_companion_1","fac_mission_companion_11"), #clear companions
            (faction_set_slot, ":comp", slot_fcomp_troopid, 0),
            (faction_set_slot, ":comp", slot_fcomp_hp, 0),
        (try_end),
        (rest_for_hours, 4, 8, 0),
        (call_script,"script_maybe_relocate_player_from_z0"),
     ]),
	]
 ),

( "hunt_beast_debrief",0,
  "{!}{s9}^^{s10}", "none", 
    [(set_background_mesh, "mesh_ui_default_menu_window"),
 
    (str_clear, s10),
    (try_begin),
        (party_get_num_companions, reg1, "p_player_casualties"),
        (gt, reg1, 0),
        (call_script, "script_print_casualties_to_s0", "p_player_casualties", 0),
        (str_store_string_reg, s11, s0),
        (str_store_string, s10,  "@Your Casualties: {s11}"),
    (try_end),
    ...
    (try_begin),
        (eq, "$random_quest_no", "qst_hunt_beast_coop"),
        (assign, reg11, 1),
        (quest_get_slot, ":quest_giver", "qst_hunt_beast_coop", slot_quest_giver_troop),
        (str_store_troop_name, s12, ":quest_giver"),
        (assign, "$tld_mission_companions", 1),
    (try_end),
    (try_begin),
        (quest_slot_eq, "$random_quest_no", slot_quest_current_state, 12),
        (quest_get_slot, ":beast", "$random_quest_no", slot_quest_target_troop),
        (str_store_troop_name, s7, ":beast"),
        (str_store_string, s9, "@The {s7} lies dead before you. You and {reg11?{s12}:your troops} celebrate the triumph and share the experience of the successful hunt."),
        ...
        (quest_get_slot, ":num_animals", "$random_quest_no", slot_quest_target_amount),
        (store_character_level, ":beast_level", ":beast"),
        (val_mul, ":beast_level", ":beast_level"),
        (val_mul, ":num_animals", 20),
        (store_add, ":xp_reward", ":beast_level", ":num_animals"),
        (assign, reg15, "$tld_mission_companions"),
        (assign, reg16, ":xp_reward"),
        (display_message, "@Shared {reg16} experience with {reg15} companions"),
        (val_add, ":num_companions", 1), #count player
        (val_max, ":num_companions", 1), #just in case
        (val_div, ":xp_reward", ":num_companions"),
        ...
        (try_for_range, ":faction", "fac_mission_companion_1", "fac_mission_companion_10"),
            ...
            (try_begin),
                (troop_is_hero, ":troop"),
                (add_xp_to_troop, ":xp_reward", ":troop"),
            (else_try),
                (try_for_range, ":i_stack", 0, ":num_stacks"),
                    (party_stack_get_troop_id, ":stack_troop", ":i_stack"),
                    (eq, ":stack_troop", ":troop"),
                    (party_add_xp_to_stack, "p_main_party", ":stack_troop", ":xp_reward"),
                (try_end),
            (try_end),
        (try_end),
    (else_try),
        (quest_slot_eq, "$random_quest_no", slot_quest_current_state, -1),
        (str_store_string, s9, "@The beast has overcome you, and only by fortune did you escape being torn apart. When at last you regain your senses, you find that the trail has gone cold. The creature is far beyond your reach now, and there is no hope of catching it again."),
        (call_script, "script_fail_quest", "$random_quest_no"),
        (quest_get_slot, ":party", "$random_quest_no", slot_quest_target_party),
        (party_is_active, ":party"),
        (call_script, "script_safe_remove_party", ":party"),
    (else_try),
        (quest_slot_eq, "$random_quest_no", slot_quest_current_state, 13),
        (str_store_string, s9, "@Heavily wounded, the beast tried to escape. It was hunted down and slain by {reg11?{s12}'s:your} men."),
        (val_mul, ":beast_level", ":beast_level"),
        (party_add_xp, "p_main_party", ":beast_level"),
        (call_script, "script_succeed_quest", "$random_quest_no"),
        (quest_get_slot, ":party", "$random_quest_no", slot_quest_target_party),
        (party_is_active, ":party"),
        (call_script, "script_safe_remove_party", ":party"),
    (else_try),
        (str_store_string, s9, "@The beast has escaped. {reg11?The hunt has ended.:You need to pick up its track again.}"),
        (eq, "$random_quest_no", "qst_hunt_beast_coop"),
        (call_script, "script_fail_quest", "$random_quest_no"),
        (quest_get_slot, ":party", "$random_quest_no", slot_quest_target_party),
        (party_is_active, ":party"),
  ...
  [      
    ("leave", [], "Leave.",
        ...
        (try_begin), #coop version? Prepare performance strings and automatically continue to dialog scene
            (eq, "$random_quest_no", "qst_hunt_beast_mayor"),
            (neg|quest_slot_ge, "$random_quest_no", slot_quest_current_state, 12),
            (rest_for_hours, 4, 8, 0),
        (else_try),
            (eq, "$random_quest_no", "qst_hunt_beast_coop"),
            (quest_get_slot, ":quest_giver", "qst_hunt_beast_coop", slot_quest_giver_troop),
            ...
            (assign, ":partner_fallen", 0),
            (party_get_num_companion_stacks, ":num_stacks", "p_player_casualties"),
            (try_for_range, ":cur_stack", 0, ":num_stacks"),
                (party_stack_get_troop_id, ":troop_no", "p_player_casualties", ":cur_stack"),
                (eq, ":troop_no", "trp_player"),
                (assign, ":player_fallen", 1),
            (else_try),
                (eq, ":troop_no", ":quest_giver"),
                (assign, ":partner_fallen", 1),
            (try_end),

            #who fought better?
            (quest_get_slot, ":player_damage", "qst_hunt_beast_coop", slot_quest_giver_fac_str_effect), 
            (quest_get_slot, ":partner_damage", "qst_hunt_beast_coop", slot_quest_target_fac_str_effect),
            (store_mul, ":player_performance", ":player_damage", 100),
            (val_max, ":partner_damage", 1), #avoid division by zero
            (val_div, ":player_performance", ":partner_damage"),
            
            (assign, reg78, ":player_performance"),
            (display_message, "@player_performance: {reg78}"),

            (str_clear, s9),
            (str_clear, s11),
            (try_begin),
                (this_or_next|le, ":player_damage", 20),
                (lt, ":player_performance", 100),
                (str_store_string, s9, "@You did almost nothing to help! Shame on you!^^"),
                (str_store_string, s11, "@Moreover"),
                (val_sub, ":score", 10),
            (else_try),
                (gt, ":player_performance", 150),
                (str_store_string, s9, "@You have fought well! I am impressed!^^"),
                (str_store_string, s11, "@However"),
                (val_add, ":score", 5),
            (else_try),
                (str_store_string, s9, "@Well fought, {playername}.^^"),
                (str_store_string, s11, "@However"),
                (val_add, ":score", 5),
            (try_end),

            #player or partner ko'd in battle?
            (str_clear, s10),
            (try_begin),
                (eq, ":player_fallen", 1), (eq, ":partner_fallen", 0),
                (str_store_string, s10, "@{s11}, I had to save your life there. Next time, better look after yourself."),
                (val_sub, ":score", 5),
            (else_try),
                (eq, ":partner_fallen", 1),
                (str_store_string, s10, "@{s11}, I nearly died there! Where were you when that beast attacked me?"),
                (val_sub, ":score", 10),
            (try_end),
            (call_script, "script_change_player_relation_with_troop", ":quest_giver", ":score"),
            
            #(call_script, "script_setup_troop_meeting",":quest_giver", 0), #no idea why this doesn't work
            (start_map_conversation, ":quest_giver"),
        (try_end),
        ]),
	]
 ),
