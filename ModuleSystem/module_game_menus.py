...
###################### Defend / Raid Village Quest Start (Kham) ##########################################
	...
	#Set Entry and Number of Defenders   
	        ...
	        (store_random_in_range, ":random_no", ":min_guards", ":max_guards"),
	        (store_random_in_range, ":entry_points", 0, 2),
	        (try_begin), #Kham - Lets mix it up!
	        	(eq, ":entry_points",0),
	        	(assign, ":player_entry", 0),
	        	(assign, ":guard_troop_1_entry",18),
	        	(assign, ":guard_troop_2_entry",16),
	        (else_try),
	        	(assign, ":player_entry", 16),
	        	(assign, ":guard_troop_1_entry",10),
	        	(assign, ":guard_troop_2_entry",11),
	        (try_end),
	        (set_jump_entry, ":player_entry"), 
	        (set_visitor, ":player_entry", "trp_player"),
	        (set_visitors, ":guard_troop_1_entry", ":guard_troop_1", ":random_no"),
	        (val_div,":random_no",6),
	        (set_visitors,":guard_troop_2_entry", ":guard_troop_2", ":random_no"),
	        (set_visitors, ":guard_troop_2_entry", ":guard_troop_3", 6),
	        (set_party_battle_mode),
	        (set_battle_advantage, 0),
	        (assign, "$g_battle_result", 0),
	        (set_jump_mission,"mt_village_attack_bandits"),
