	...
	[("start_defend_caravan",
		...
		"Defend the Caravan!", [
		    ...
		    (modify_visitors_at_site,"scn_starting_quest"),
		      ...
		      (set_visitors,16,"trp_i1_tribal_goblin", 8),
		      (set_visitors,18,"trp_i2_goblin_raider", 5),
	...
	("start_ambush_orcs",
		...
		"Ambush the Orcs!", [
		    ...
		    (try_end),
		      ...
		      (try_end),
		      (set_visitors,20,"trp_i1_tribal_goblin", 13),
		      (set_visitors,22,"trp_i3_goblin_warrior", 10),
