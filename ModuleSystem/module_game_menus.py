...
########################################## FOOTBALL  
     ...
     (else_try),
	   ...
	   (set_visitors, 1, "trp_i3_greenwood_vet_infantry",		20),
	   (set_visitors, 1, "trp_a2_greenwood_veteran_scout",		10),
	   (set_visitors, 16, "trp_olog_hai",				2),
    ...
    (else_try),
      ...
      (else_try),
       ...
       (modify_visitors_at_site, "$g_custom_battle_scene"),
       (set_visitor, 0, "$g_player_troop"),
	   (set_visitors, 1, "trp_i2_isen_orc",	8),
   ...
   (else_try),########################################## TEST SCENE FOR DYNAMIC SCENERY  
		...
		(try_begin),
			...
			(eq,":gfac",6),(assign,":trp_good_min","trp_a1_greenwood_scout"  ),(assign,":trp_good_max","trp_knight_of_rivendell"         ),(else_try),
