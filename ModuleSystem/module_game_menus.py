...
########################################## ORCS VS MIRKWOOD  
       ...
       (set_visitor, 0, "$g_player_troop"),
		...
		(set_visitors, 1, "trp_orc_fighter_gundabad",				8),
		(set_visitors, 2, "trp_fell_orc_warrior_gundabad",		6),
		(set_visitors, 3, "trp_orc_beserker_gundabad",			10),
		(set_visitors, 4, "trp_fell_goblin_of_moria",					6),
		(set_visitors, 5, "trp_bolg_clan_rider",						2),
		(set_visitors, 6, "trp_warg_rider_of_moria",					4),
		(set_visitors, 7, "trp_wolf_rider_of_moria",					4),
		(set_visitors, 8, "trp_goblin_gundabad",					10),
		(set_visitors, 9, "trp_orc_gundabad",						12),
		(set_visitors, 10, "trp_warg_skirmisher_gundabad",8),
		(set_visitors, 11, "trp_goblin_north_clan_skirmisher",		4),
		(set_visitors, 12, "trp_goblin_rider_gundabad",			4),
		(set_visitors, 13, "trp_warg_rider_gundabad",				4),
		(set_visitors, 14, "trp_goblin_north_clan_rider",				2),
## ENEMY
  ...
  (assign, reg63, ":num_followers"), (display_message, "@{reg63} followers", color_bad_news), (call_script, "script_move_scout_camp_to_hardcoded_locations"),]),
    ("what_region",[], "What Region am I in?", 
    	[(store_add, reg1, str_shortname_region_begin , "$current_player_region"),
		 ...
		 (position_get_x, reg60, pos1),
		 (position_get_y, reg61, pos1),
		 (display_message, "@{s1} - X: {reg60} - Y:{reg61}",color_bad_news),
		 (spawn_around_party, "p_main_party","pt_scout_camp_small"),
		 (assign, "$qst_destroy_scout_camp_party", reg0),
		 (set_fixed_point_multiplier, 100.0),
		 (position_set_x, pos2, -8146),
		 (position_set_y, pos2, -4477),
		 (party_set_position, "$qst_destroy_scout_camp_party", pos2),
		 (display_message, "@Scout camp party spawned and positioned in Dagorlad"),
    	]),
...
("cheat_impose_quest",0,"Current imposed quest:^{s20}^^Which quest do you want to impose?^(no other quests will be given)","none",[
	...
	("cheat_kill_quest",[],"Kill Faction Troop Quest",[(assign,"$cheat_imposed_quest","qst_blank_quest_05")]),
		...
		"Raid the Caravan!", [
		    ...
		    (modify_visitors_at_site,"scn_starting_quest"),
			 ...
			 (else_try),
			  	  (this_or_next|eq,"$players_kingdom", "fac_moria"),
  			  	  (				eq,"$players_kingdom", "fac_gundabad"),
  	  			  (set_visitors,2,"trp_dwarven_warrior", 2),
			      (set_visitors,4,"trp_dwarven_apprentice", 3),
		      (try_end),
		      (set_visitors,6,"trp_start_quest_caravaneer", 1),
