...
#	),
    ...
    ("camp_use_athelas",
        ...
        (assign, ":reinf_rounds", 7),
        (store_attribute_level, ":player_charisma", trp_player, ca_charisma),
        (store_attribute_level, ":player_strength", trp_player, ca_strength),
        (val_add, ":reinf_rounds", ":player_charisma"),
        (val_add, ":reinf_rounds", ":player_strength"),
        (val_div, ":reinf_rounds", 14),
        (val_max, ":reinf_rounds", 1),
        
        (store_random_in_range, ":random", 0, 10),
        (val_add, ":random", ":reinf_rounds"),
        ...
        (else_try), 
            ...
            (str_store_string, s1, "@lordless"),
            (str_store_string, s2, "@wild goblins"),
        (else_try), 
            (lt, ":random", 6),
