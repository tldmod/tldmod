...
triggers = [
  ...
  (0.2, 0.0, 0.0,
    [
      ...
      (try_begin),
        ...
        (else_try),
          (party_slot_eq, "$qst_bring_back_runaway_serfs_party_1", slot_town_castle, 0),
      ...
      (try_begin),
        ...
        (else_try),
          ...
          (val_add, "$qst_bring_back_runaway_serfs_num_parties_returned", 1),
        (else_try),
          (party_slot_eq, "$qst_bring_back_runaway_serfs_party_2", slot_town_castle, 0),
      ...
      (try_begin),
        ...
        (else_try),
          ...
          (val_add, "$qst_bring_back_runaway_serfs_num_parties_returned", 1),
        (else_try),
          (party_slot_eq, "$qst_bring_back_runaway_serfs_party_3", slot_town_castle, 0),
  ...
  (1, 0, 90, [], [ #traits crunching
      ...
      (try_end),
      (try_begin), #reset berserker to original model, the new one didn't work properly
        (troop_slot_eq, "trp_traits", slot_trait_berserker, 0),
        (val_sub, "$new_berserker_kills", 10), #slight relaxation over time
        (val_max, "$new_berserker_kills", 0),
        (gt, "$new_berserker_kills", 100),
      ...
      (try_begin),
        ...
        (val_mul, ":check", 3),
        #(assign, "$trait_check_battle_scarred", 0), ##no the score accumulates
        (gt, ":check", 15),
        (store_random_in_range, ":rnd", 0, 100),
        (neg|ge, ":rnd", ":check"),
      ...
      (try_end),
      (try_begin),
        (troop_get_slot, ":counter", "trp_traits", slot_trait_warg_fiend),
        (neq, ":counter", 1),
        (val_sub, ":counter", 20), #slight relaxation over time
        (val_max, ":counter", 2),
        (troop_set_slot, "trp_traits", slot_trait_warg_fiend, ":counter"),
        # (assign, reg78, ":counter"),
        # (display_message, "@slot_trait_warg_fiend {reg78}"),
        (gt, ":counter", 200),
        (call_script, "script_gain_trait", slot_trait_warg_fiend),
        (troop_set_slot, "trp_player", slot_troop_trait_scares_mounts, 2), #scares wargs
      (try_end),
      (try_begin),
        (troop_get_slot, ":counter", "trp_traits", slot_trait_horse_fiend),
        (neq, ":counter", 1),
        (val_sub, ":counter", 30), #slight relaxation over time
        (val_max, ":counter", 2),
        (troop_set_slot, "trp_traits", slot_trait_horse_fiend, ":counter"),
        # (assign, reg78, ":counter"),
        # (display_message, "@slot_trait_horse_fiend {reg78}"),
        (gt, ":counter", 400),
        (call_script, "script_gain_trait", slot_trait_horse_fiend),
        (troop_set_slot, "trp_player", slot_troop_trait_scares_mounts, 3), #scares horses
      (try_end),
      (try_begin),
        (troop_get_slot, ":counter", "trp_traits", slot_trait_light_armor),
        (neq, ":counter", 1),
        (val_sub, ":counter", 4), #slight relaxation over time
        (val_max, ":counter", 2),
        (troop_set_slot, "trp_traits", slot_trait_light_armor, ":counter"),
        # (assign, reg78, ":counter"),
        # (display_message, "@slot_trait_light_armor {reg78}"),
        (gt, ":counter", 180),
        (call_script, "script_gain_trait", slot_trait_light_armor),
      (try_end),
      (try_begin),
        (troop_get_slot, ":counter", "trp_traits", slot_trait_ranger),
        (neq, ":counter", 1),
        (val_sub, ":counter", 4), #slight relaxation over time
        (val_max, ":counter", 2),
        (troop_set_slot, "trp_traits", slot_trait_ranger, ":counter"),
        # (assign, reg78, ":counter"),
        # (display_message, "@slot_trait_ranger {reg78}"),
        (gt, ":counter", 160),
        (call_script, "script_gain_trait", slot_trait_ranger),
      (try_end),
      (try_begin),
        (troop_get_type, ":player_race", "trp_player"),
        (neg|is_between, ":player_race", tf_elf_begin, tf_elf_end),
        (neg|is_between, ":player_race", tf_orc_begin, tf_orc_end),
        (neq, ":player_race", tf_dwarf),
        (troop_get_slot, ":counter", "trp_traits", slot_trait_night_fighter),
        (val_sub, ":counter", 40), #slight relaxation over time
        (val_max, ":counter", 2),
        (troop_set_slot, "trp_traits", slot_trait_night_fighter, ":counter"),
        (gt, ":counter", 1000),
        # (assign, reg78, ":counter"),
        # (display_message, "@slot_trait_night_fighter {reg78}"),
        (call_script, "script_gain_trait", slot_trait_night_fighter),
        (troop_set_slot, "trp_player", slot_troop_is_night_troop, 1),
      (try_end),
  ] or [])
  ),
  ...
  (0.5, 0.0, 0.0,
    [
      ...
      (try_begin),
        ...
        (neg|check_quest_concluded, "qst_defend_refugees"),
        (assign, ":quest", "qst_defend_refugees"),
        (assign, ":continue", 1),
      (else_try),
        (check_quest_active, "qst_hunt_down_refugees"),
        (neg|check_quest_concluded, "qst_hunt_down_refugees"),
      ...
      (try_begin),
        (eq, ":quest", "qst_hunt_down_refugees"),
      ...
      (else_try),
        ...
        #(add_quest_note_from_sreg, "qst_hunt_down_refugees", 3, s3, 0),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (call_script, "script_succeed_quest", "qst_defend_refugees"),
          (try_begin),
            (party_is_active, "$qst_raider_party_1"),
            (call_script, "script_safe_remove_party", "$qst_raider_party_1"),
          (try_end),
        ...
        (else_try),
          ...
          (call_script, "script_fail_quest", "qst_defend_refugees"),
          (try_begin),
            (party_is_active, "$qst_raider_party_1"),
            (call_script, "script_safe_remove_party", "$qst_raider_party_1"),
          (try_end),
        ...
        (else_try),
          ...
          (call_script, "script_conclude_quest", "qst_defend_refugees"),
          (try_begin),
            (party_is_active, "$qst_raider_party_1"),
            (call_script, "script_safe_remove_party", "$qst_raider_party_1"),
          (try_end),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (call_script, "script_succeed_quest", "qst_hunt_down_refugees"),
        (else_try),
          (ge, "$qst_refugees_escaped", 1),
          (call_script, "script_fail_quest", "qst_hunt_down_refugees"),
          (try_begin),
            (party_is_active, "$qst_refugee_party_1"),
            (call_script, "script_safe_remove_party", "$qst_refugee_party_1"),
          (try_end),
