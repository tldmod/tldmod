   ...
   [
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (party_is_active, "$qst_refugee_party_1"),
          (spawn_around_party,  "$qst_refugee_party_1", "pt_mordor_scouts"),
          (assign, "$qst_raider_party_1", reg0),
          (party_add_template, "$qst_raider_party_1", "pt_mordor_scouts"),
          (try_begin),
            (le, ":random", 50),
            (party_add_template, "$qst_raider_party_1", "pt_mordor_scouts"),
          (try_end),
        ...
        (else_try),
          ...
          (party_is_active, "$qst_refugee_party_2"),
          (spawn_around_party,  "$qst_refugee_party_2", "pt_mordor_scouts"),
          (assign, "$qst_raider_party_2", reg0),
          (party_add_template, "$qst_raider_party_2", "pt_mordor_scouts"),
          (try_begin),
            (le, ":random", 50),
            (party_add_template, "$qst_raider_party_2", "pt_mordor_scouts"),
          (try_end),
        ...
        (else_try),
          ...
          (party_is_active, "$qst_refugee_party_3"),
          (spawn_around_party,  "$qst_refugee_party_3", "pt_mordor_scouts"),
          (assign, "$qst_raider_party_3", reg0),
          (party_add_template, "$qst_raider_party_3", "pt_mordor_scouts"),
          (try_begin),
            (le, ":random", 50),
            (party_add_template, "$qst_raider_party_3", "pt_mordor_scouts"),
          (try_end),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_end),
        (else_try),
          (store_distance_to_party_from_party, ":cur_distance", "p_main_party", "$qst_refugee_party_1"),
          (gt, ":cur_distance", 3),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_end),
        (else_try),
          (store_distance_to_party_from_party, ":cur_distance", "p_main_party", "$qst_refugee_party_2"),
          (gt, ":cur_distance", 3),
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (try_end),
        (else_try),
          (store_distance_to_party_from_party, ":cur_distance", "p_main_party", "$qst_refugee_party_3"),
          (gt, ":cur_distance", 3),
