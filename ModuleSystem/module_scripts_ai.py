...
#          (faction_get_slot, ":original_faction_culture", ":original_faction", slot_faction_culture),
          ...
          (try_for_range, ":village_no", villages_begin, villages_end),
            ...
            (party_slot_eq, ":village_no", slot_center_original_faction, ":original_faction"),
    ...
    [   (store_script_param_1, ":troop_no"),
        ...
        # (else_try),
          ...
          # (try_for_range, ":enemy_village_no", villages_begin, villages_end),
            ...
            # (assign, ":selected_village", ":enemy_village_no"),            #CHANGE STATE TO RAID THIS VILLAGE
          # (try_end),
          # (try_begin),
            # (eq, ":selected_village", 0),
        ...
        # (else_try),
          ...
          # (try_begin),
            ...
            # (else_try),
              # (party_set_slot, ":party_no", slot_party_ai_substate, 0),              #if anything other than being_raided leave
            # (try_end),
          # (try_end),
        (else_try),
