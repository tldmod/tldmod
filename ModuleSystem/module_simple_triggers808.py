...
(try_begin),
    ...
    (else_try),
        ...
        (jump_to_menu, "menu_zendar"),
    (else_try),
        (eq, "$g_encountered_party", "p_salt_mine"),
        (jump_to_menu, "menu_salt_mine"),
    (else_try),
        (eq, "$g_encountered_party", "p_dhorak_keep"),
        (jump_to_menu, "menu_dhorak_keep"),
    (else_try),
        (eq, "$g_encountered_party", "p_four_ways_inn"),
        (jump_to_menu, "menu_four_ways_inn"),
    (else_try),
        (eq, "$g_encountered_party", "p_training_ground"),
        (jump_to_menu, "menu_training_ground"),
    (else_try),
        (eq, "$g_encountered_party", "p_eastfold_inn"),
        (jump_to_menu, "menu_eastfold_inn"),
    (else_try),
        (eq, "$g_encountered_party", "p_isengard"),
        (jump_to_menu, "menu_Isengard"),
    (else_try),
        (eq, "$g_encountered_party", "p_morannon"),
        (jump_to_menu, "menu_Morannon"),
    (else_try),
        (eq, "$g_encountered_party", "p_minas_morgul"),
        (jump_to_menu, "menu_Minas_Morgul"),
    (else_try),
        (eq, "$g_encountered_party", "p_osgiliath"),
        (jump_to_menu, "menu_Osgiliath"),
    (else_try),
        (eq, "$g_encountered_party", "p_moria"),
        (jump_to_menu, "menu_Moria"),
    (else_try),
        (eq, "$g_encountered_party", "p_dol_guldur"),
        (jump_to_menu, "menu_Dol_Guldur"),
    (else_try),
        (eq, "$g_encountered_party", "p_haradrim_camp"),
        (jump_to_menu, "menu_haradrim_camp"),
    (else_try),
        (eq, "$g_encountered_party", "p_corsair_camp"),
        (jump_to_menu, "menu_corsair_camp"),
    (else_try),
        (eq, "$g_encountered_party", "p_easterling_north_camp"),
        (jump_to_menu, "menu_easterling_north_camp"),
    (else_try),
        (eq, "$g_encountered_party", "p_easterling_south_camp"),
        (jump_to_menu, "menu_easterling_south_camp"),
    (else_try),
        (eq, "$g_encountered_party", "p_dunlander_camp"),
        (jump_to_menu, "menu_dunlander_camp"),
    (else_try),
        (eq, "$g_encountered_party", "p_orc_sentry_camp"),
        (jump_to_menu, "menu_orc_sentry_camp"),
    (else_try),
        (eq, "$g_encountered_party", "p_uruk_hai_outpost"),
        (jump_to_menu, "menu_uruk_hai_outpost"),
    (else_try),
        (eq, "$g_encountered_party", "p_uruk_hai_hunting_camp"),
        (jump_to_menu, "menu_uruk_hai_hunting_camp"),
    (else_try),
        (eq, "$g_encountered_party", "p_uruk_hai_river_camp"),
        (jump_to_menu, "menu_uruk_hai_river_camp"),
    (else_try),
        (eq, "$g_encountered_party", "p_caras_galadhon"),
        (jump_to_menu, "menu_caras_galadhon"),
    (else_try),
        (eq, "$g_encountered_party", "p_cerin_amroth"),
        (jump_to_menu, "menu_cerin_amroth"),
    (else_try),
        (eq, "$g_encountered_party", "p_cerin_dolen"),
        (jump_to_menu, "menu_cerin_dolen"),
    (else_try),
        (eq, "$g_encountered_party", "p_rivendell_elf_camp"),
        (jump_to_menu, "menu_rivendell_elf_camp"),
    (else_try),
        (eq, "$g_encountered_party", "p_woodelf_camp"),
        (jump_to_menu, "menu_woodelf_camp"),
    (else_try),
        (eq, "$g_encountered_party", "p_henneth_annun"),
        (jump_to_menu, "menu_henneth_annun"),
    (else_try),
        (eq, "$g_encountered_party", "p_anduin_river_village"),
        (jump_to_menu, "menu_anduin_river_village"),
    (else_try),
        (eq, "$g_encountered_party", "p_limlight_river_village"),
        (jump_to_menu, "menu_limlight_river_village"),
    (else_try),
        (eq, "$g_encountered_party", "p_hill_folk_village"),
        (jump_to_menu, "menu_hill_folk_village"),
    (else_try),
        (eq, "$g_encountered_party", "p_woodsman_village"),
        (jump_to_menu, "menu_woodsman_village"),
    (else_try),
        (eq, "$g_encountered_party", "p_ancient_ruins"),
        (jump_to_menu, "menu_ancient_ruins"),
    (else_try),
        (eq, "$g_encountered_party", "p_cair_andros"),
        (jump_to_menu, "menu_cair_andros"),
    (else_try),
        (eq, "$g_encountered_party", "p_cirith_ungol"),
        (jump_to_menu, "menu_cirith_ungol"),
    (else_try),
        (is_between, "$g_encountered_party", "p_mound_of_mablung", "p_end_mounds"),
        (jump_to_menu, "menu_burial_mound"),
    (else_try),
        (eq, "$g_encountered_party", "p_pyre_of_duessa"),
        (jump_to_menu, "menu_funeral_pyre_female"),
    (else_try),
        (is_between, "$g_encountered_party", "p_start_pyres", "p_end_pyres"),
        (jump_to_menu, "menu_funeral_pyre"),
    (else_try),
        (eq, "$g_encountered_party", "p_barad_dur"),
        (jump_to_menu, "menu_barad-dur"),
    (else_try),
        (jump_to_menu, "menu_simple_encounter"),
    (try_end),
(else_try),
    (try_begin),
