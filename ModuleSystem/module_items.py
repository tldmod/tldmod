...
#["mail_with_surcoat", "Mail with Surcoat", [("mail_long_surcoat",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 1544 , weight(22)|abundance(100)|head_armor(0)|body_armor(42)|leg_armor(14)|difficulty(7) ,imodbits_armor ],
#["surcoat_over_mail", "Surcoat over Mail", [("surcoat_over_mail",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 1720 , weight(22)|abundance(100)|head_armor(0)|body_armor(43)|leg_armor(14)|difficulty(7) ,imodbits_armor ],
...
#["brigandine_a", "Brigandine", [("brigandine_a",0)], itp_shop|itp_type_body_armor|itp_covers_legs,0,1830 , weight(19)|abundance(100)|head_armor(0)|body_armor(46)|leg_armor(12)|difficulty(0) ,imodbits_armor ],
#["lamellar_armor", "Lamellar Armor", [("lamellar_armor_b",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 2410 , weight(25)|abundance(100)|head_armor(0)|body_armor(48)|leg_armor(13)|difficulty(0) ,imodbits_armor ],
#["banded_armor", "Banded Armor", [("reinf_jerkin",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 2710 , weight(23)|abundance(100)|head_armor(0)|body_armor(49)|leg_armor(14)|difficulty(8) ,imodbits_armor ],
#["cuir_bouilli", "Cuir Bouilli", [("hard_lthr_a",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 3100 , weight(24)|abundance(100)|head_armor(0)|body_armor(50)|leg_armor(15)|difficulty(8) ,imodbits_armor ],
#["coat_of_plates", "Coat of Plates", [("coat_of_plates",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 500 , weight(25)|abundance(100)|head_armor(0)|body_armor(52)|leg_armor(16)|difficulty(8) ,imodbits_armor ],
#["plate_armor", "Plate Armor", [("plate_armor",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 6553 , weight(27)|abundance(100)|head_armor(0)|body_armor(55)|leg_armor(17)|difficulty(9) ,imodbits_plate ],
#["black_armor", "Black Armor", [("black_armor",0)], itp_type_body_armor  |itp_covers_legs ,0, 9496 , weight(28)|abundance(100)|head_armor(0)|body_armor(57)|leg_armor(18)|difficulty(10) ,imodbits_plate ],

#["heraldic_mail_with_surcoat", "Heraldic Mail with Surcoat", [("heraldic_armor_a",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 3454 , weight(22)|abundance(100)|head_armor(0)|body_armor(49)|leg_armor(17)|difficulty(7) ,imodbits_armor,
...
##["heraldic_mail_with_tunic", "Heraldic_Mail", [("heraldic_armor_b",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0,
...
##["heraldic_mail_with_tunic_b", "Heraldic_Mail", [("heraldic_armor_c",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0,
...
#["heraldic_mail_with_tabard", "Heraldic_Mail_with_Tabard", [("heraldic_armor_d",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 3654 , weight(21)|abundance(100)|head_armor(0)|body_armor(51)|leg_armor(15)|difficulty(7) ,imodbits_armor,
...
#["turret_hat_ruby", "Turret Hat", [("turret_hat_r",0)], itp_type_head_armor  |itp_fit_to_head ,0, 70 , weight(0.5)|abundance(100)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ], 
...
#["turret_hat_green", "Barbette", [("turret_hat_g",0)],itp_shop|itp_type_head_armor|itp_civilian|itp_fit_to_head,0,70, weight(0.5)|abundance(100)|head_armor(6)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth],
...
#["court_hat", "Turret Hat", [("court_hat",0)], itp_type_head_armor  |itp_civilian|itp_fit_to_head ,0, 80 , weight(0.5)|abundance(100)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ], 
#["wimple_a", "Wimple", [("wimple_a",0)],itp_shop|itp_type_head_armor|itp_civilian|itp_fit_to_head,0,10, weight(0.5)|abundance(100)|head_armor(4)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth],
#["wimple_with_veil", "Wimple with Veil", [("wimple_b",0)],itp_shop|itp_type_head_armor|itp_civilian|itp_fit_to_head,0,10, weight(0.5)|abundance(100)|head_armor(4)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth],
#["straw_hat", "Straw Hat", [("straw_hat",0)],itp_shop|itp_type_head_armor|itp_civilian,0,9, weight(1)|abundance(100)|head_armor(2)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth],
#["common_hood", "Hood", [("hood_a",0),("hood_b",0),("hood_c",0),("hood_d",0)],itp_shop|itp_type_head_armor|itp_civilian,0,9, weight(1)|abundance(100)|head_armor(10)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth],
...
#["woolen_hood", "Woolen Hood", [("woolen_hood",0)], itp_shop|itp_type_head_armor |itp_civilian  ,0, 4 , weight(1)|abundance(100)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
#["fur_hat", "Fur Hat", [("hat_fur_a",0)], itp_shop|itp_type_head_armor |itp_civilian  ,0, 4 , weight(0.5)|abundance(100)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
#["nomad_cap", "Nomad Cap", [("helmet_fur_a",0),("helmet_fur_a",imodbits_good)], itp_shop|itp_type_head_armor |itp_civilian  ,0, 6 , weight(0.75)|abundance(100)|head_armor(10)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
#["steppe_cap", "Steppe Cap", [("helmet_fur_b",0)], itp_shop|itp_type_head_armor  |itp_civilian ,0, 14 , weight(1)|abundance(100)|head_armor(12)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
#["padded_coif", "Padded Coif", [("padded_coif",0)], itp_shop|itp_type_head_armor   ,0, 6 , weight(1)|abundance(100)|head_armor(11)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
#["woolen_cap", "Woolen Cap", [("woolen_cap",0)], itp_shop|itp_type_head_armor  |itp_civilian ,0, 2 , weight(1)|abundance(100)|head_armor(6)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
...
#["leather_warrior_cap", "Leather Warrior Cap", [("skull_cap_new_b",0)], itp_shop|itp_type_head_armor  |itp_civilian ,0, 14 , weight(1)|abundance(100)|head_armor(18)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
...
#["mail_coif", "Mail Coif", [("mail_coif",0)], itp_shop|itp_type_head_armor   ,0, 71 , weight(1.25)|abundance(100)|head_armor(22)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_armor ],
#["footman_helmet", "Footman's_Helmet", [("skull_cap_new",0)], itp_shop|itp_type_head_armor   ,0, 95 , weight(1.5)|abundance(100)|head_armor(24)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_plate ],
#["nasal_helmet", "Nasal Helmet", [("nasal_helmet_b",0)], itp_shop|itp_type_head_armor   ,0, 121 , weight(1.25)|abundance(100)|head_armor(26)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
#["norman_helmet", "Helmet with Cap", [("norman_helmet_a",0)], itp_shop|itp_type_head_armor|itp_fit_to_head ,0, 147 , weight(1.25)|abundance(100)|head_armor(28)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
#["segmented_helmet", "Segmented Helmet", [("segmented_helm_new",0)], itp_shop|itp_type_head_armor   ,0, 174 , weight(1.25)|abundance(100)|head_armor(31)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
#["kettle_hat", "Kettle Hat", [("kettle_hat_new",0)], itp_shop|itp_type_head_armor,0, 193 , weight(1.5)|abundance(100)|head_armor(33)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
#["helmet_with_neckguard", "Helmet with Neckguard", [("neckguard_helm_new",0)], itp_shop|itp_type_head_armor   ,0, 233 , weight(1.75)|abundance(100)|head_armor(35)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
#["spiked_helmet", "Spiked Helmet", [("spiked_helmet_new",0)], itp_shop|itp_type_head_armor   ,0, 278 , weight(2)|abundance(100)|head_armor(38)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
#["nordic_helmet", "Nordic Helmet", [("helmet_w_eyeguard_new",0)], itp_shop|itp_type_head_armor   ,0, 340 , weight(2)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
#["flat_topped_helmet", "Flat Topped Helmet", [("flattop_helmet_new",0)], itp_shop|itp_type_head_armor   ,0, 411 , weight(2)|abundance(100)|head_armor(42)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
#TODO:
#["skullcap_b", "Skullcap_b", [("skull_cap_new_b",0)], itp_shop|itp_type_head_armor   ,0, 71 , weight(1.5)|abundance(100)|head_armor(20)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_plate ],
 
#["bascinet", "Bascinet", [("bascinet_avt_new",0),("bascinet_avt_new1",imodbit_crude|imodbit_rusty),("bascinet_avt_new2",imodbits_good)], itp_shop|itp_type_head_armor   ,0, 479 , weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
#["guard_helmet", "Guard Helmet", [("reinf_helmet_new",0)], itp_shop|itp_type_head_armor   ,0, 555 , weight(2.5)|abundance(100)|head_armor(47)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate ],
...
#["great_helmet", "Great Helmet", [("great_helm_a",0)], itp_shop|itp_type_head_armor|itp_covers_head,0, 980 , weight(2.75)|abundance(100)|head_armor(53)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate ],
#["winged_great_helmet", "Winged Great Helmet", [("maciejowski_helmet_new",0)], itp_shop|itp_type_head_armor|itp_covers_head,0, 1240 , weight(2.75)|abundance(100)|head_armor(55)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate ],
#WEAPONS
["wooden_stick",         "Wooden Stick", [("wooden_stick",0)], itp_type_one_handed_wpn|itp_shop|itp_primary|itp_wooden_parry|itp_wooden_attack, itc_scimitar, 4 , weight(2.5)|difficulty(0)|spd_rtng(99) | weapon_length(90)|swing_damage(13 , blunt) | thrust_damage(0 ,  pierce),imodbits_none ],
...
#["sword_khergit_1", "Nomad Sabre", [("khergit_sword_b",0),("khergit_sword_b_scabbard", ixmesh_carry)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
# 105 , weight(1.25)|difficulty(0)|spd_rtng(100) | weapon_length(97)|swing_damage(29 , cut),imodbits_sword_high ],
#["sword_khergit_2", "Sabre", [("khergit_sword_c",0),("khergit_sword_c_scabbard", ixmesh_carry)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
# 191 , weight(1.5)|difficulty(0)|spd_rtng(99) | weapon_length(97)|swing_damage(30 , cut),imodbits_sword_high ],
#["sword_khergit_3", "Sabre", [("khergit_sword_a",0),("khergit_sword_a_scabbard", ixmesh_carry)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
# 294 , weight(1.5)|difficulty(0)|spd_rtng(99) | weapon_length(98)|swing_damage(31 , cut),imodbits_sword_high ],
#["sword_khergit_4", "Heavy Sabre", [("khergit_sword_d",0),("khergit_sword_d_scabbard", ixmesh_carry)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
# 384 , weight(1.75)|difficulty(0)|spd_rtng(96) | weapon_length(96)|swing_damage(33 , cut),imodbits_sword_high ],

#["mace_1",         "spiked_club", [("mace_d",0)], itp_type_one_handed_wpn|itp_shop|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,
# 45 , weight(1.5)|difficulty(0)|spd_rtng(99) | weapon_length(62)|swing_damage(19 , pierce) | thrust_damage(0 ,  pierce),imodbits_mace ],
#["mace_2",         "Knobbed_Mace", [("mace_a",0)], itp_type_one_handed_wpn|itp_shop|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,
# 98 , weight(2.5)|difficulty(0)|spd_rtng(98) | weapon_length(60)|swing_damage(21 , blunt) | thrust_damage(0 ,  pierce),imodbits_mace ],
#["mace_3",         "Spiked Mace", [("mace_c",0)], itp_type_one_handed_wpn|itp_shop|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,
# 152 , weight(2.5)|difficulty(0)|spd_rtng(98) | weapon_length(62)|swing_damage(23 , blunt) | thrust_damage(0 ,  pierce),imodbits_mace ],
#["mace_4",         "Winged_Mace", [("mace_b",0)], itp_type_one_handed_wpn|itp_shop|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_mace_left_hip,
# 212 , weight(2.5)|difficulty(0)|spd_rtng(98) | weapon_length(60)|swing_damage(24 , blunt) | thrust_damage(0 ,  pierce),imodbits_mace ],
#["club_with_spike_head",  "Club_with_Spike", [("mace_e",0)],  itp_type_two_handed_wpn|itp_shop|itp_primary|itp_wooden_parry, itc_bastardsword|itcf_carry_axe_back,
...
#["kite_shield",         "Kite Shield", [("shield_kite_a",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
#["kite_shield_", "Kite Shield", [("shield_kite_b",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
#["large_shield", "Large Shield", [("shield_kite_c",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  165 , weight(2.5)|hit_points(520)|body_armor(1)|spd_rtng(80)|weapon_length(92),imodbits_shield ],
#["battle_shield", "Battle Shield", [("shield_kite_d",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  196 , weight(3)|hit_points(560)|body_armor(1)|spd_rtng(78)|weapon_length(94),imodbits_shield ],
...
#["heraldric_shield", "Heraldric Shield", [("shield_heraldic",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  301 , weight(3.5)|hit_points(640)|body_armor(1)|spd_rtng(83)|weapon_length(65),imodbits_shield ],
#["heater_shield", "Heater Shield", [("shield_heater_a",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  477 , weight(3.5)|hit_points(710)|body_armor(4)|spd_rtng(80)|weapon_length(60),imodbits_shield ],
#["steel_shield", "Steel Shield", [("shield_dragon",0)], itp_shop|itp_type_shield, itcf_carry_round_shield,  697 , weight(4)|hit_points(700)|body_armor(17)|spd_rtng(61)|weapon_length(40),imodbits_shield ],
#["nomad_shield", "Nomad Shield", [("shield_wood_b",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_round_shield,  12 , weight(2)|hit_points(260)|body_armor(6)|spd_rtng(110)|weapon_length(30),imodbits_shield ],
...
#["shield_heater_d", "Heater Shield", [("shield_heater_d",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  477 , weight(3.5)|hit_points(710)|body_armor(4)|spd_rtng(80)|weapon_length(60),imodbits_shield ],

#["shield_kite_g",         "Kite Shield g", [("shield_kite_g",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
#["shield_kite_h",         "Kite Shield h", [("shield_kite_h",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
#["shield_kite_i",         "Kite Shield i ", [("shield_kite_i",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
#["shield_kite_k",         "Kite Shield k", [("shield_kite_k",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
...
#["black_hood", "Black Hood", [("hood_black",0)], itp_type_head_armor|itp_shop   ,0, 193 , weight(2)|abundance(100)|head_armor(18)|body_armor(0)|leg_armor(0) ,imodbits_cloth ],
#["light_leather", "Light Leather", [("light_leather",0)], itp_type_body_armor|itp_covers_legs|itp_shop   ,0, 352 , weight(5)|abundance(100)|head_armor(0)|body_armor(26)|leg_armor(7)|difficulty(0) ,imodbits_armor ],
#["light_leather_boots",  "Light Leather Boots", [("light_leather_boots",0)], itp_type_foot_armor |itp_shop|itp_attach_armature,0, 91 , weight(1)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(15)|difficulty(0) ,imodbits_cloth ],
...
["gondor_ranger_hood", "Gondor Ranger Hood", [("gondor_ranger_hood",0)], 0|itp_shop|itp_type_head_armor,0,60, weight(0.5)|abundance(100)|head_armor(13)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth],
...
["gondorian_light_helm", "Gondorian_Footman_Helm", [("gondor_footman_helm",0)], itp_shop|itp_type_head_armor   ,0, 95 , weight(1.5)|abundance(100)|head_armor(24)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_plate ],
...
["gondor_auxila_helm", "Gondorian_Auxilia_Helm", [("gondor_auxila_helm",0)], itp_shop|itp_type_head_armor   ,0, 60 , weight(1.0)|abundance(100)|head_armor(20)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_plate],

["gondorian_light_helm_b", "Gondorian_Bowman_Helm", [("gondor_bowman_helm",0)], itp_shop|itp_type_head_armor   ,0, 90 , weight(1.5)|abundance(100)|head_armor(23)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_plate ],
...
["tower_archer_helm", "Tower_Guard_Helm", [("gondor_tower_archer_helm",0)],itp_shop|itp_type_head_armor   ,0, 511 , weight(2)|abundance(100)|head_armor(42)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate],
...
["gondor_dolamroth_helm", "Dol Amroth Helm,", [("gondor_dolamroth_helm",0)],  itp_shop|itp_type_head_armor   ,0, 555 , weight(2.5)|abundance(100)|head_armor(47)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate  ],
...
["gondor_courser","Gondor_Courser", [("gondor_horse02",0)], itp_shop|itp_type_horse, 0, 323,abundance(70)|body_armor(16)|difficulty(2)|horse_speed(43)|horse_maneuver(37)|horse_charge(11),imodbits_horse_basic|imodbit_champion],
...
["dol_amroth_warhorse2","Dol_Amroth_Haeavy_Warhorse", [("da_warhorse01",0)],itp_shop|itp_type_horse, 0, 1411,abundance(40)|hit_points(140)|body_armor(65)|difficulty(4)|horse_speed(35)|horse_maneuver(33)|horse_charge(25),imodbits_horse_basic|imodbit_champion],
...
["gondor_lance",   "Gondor Lance", [("amroth_lance",0)], itp_type_polearm|itp_shop|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_staff|itcf_carry_spear, 375 , weight(2.35)|difficulty(0)|spd_rtng(89) | weapon_length(204)|swing_damage(20 , blunt) | thrust_damage(34 ,  pierce),imodbits_polearm ],
...
["loss_war_axe",   "Lossarnach War Axe", [("loss_axe_2h",0)], itp_type_polearm|itp_shop|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back, 129 , weight(4.5)|difficulty(8)|spd_rtng(87) | weapon_length(75)|swing_damage(35 , cut) | thrust_damage(0 ,  bow_damage),imodbits_axe ],

["loss_throwing_axes", "Lossarnach Throwing Axes", [("loss_throwing_axe",0)], itp_type_thrown |itp_shop|itp_primary|itp_bonus_against_shield,itcf_throw_axe,241, weight(5)|difficulty(1)|spd_rtng(99) | shoot_speed(20) | thrust_damage(38,cut)|max_ammo(3)|weapon_length(53),imodbits_thrown ],
...
["tree_trunk_club_a", "Tree Trunk",  [("troll_club"  ,0)], itp_type_one_handed_wpn|itp_primary|itp_wooden_parry|itp_wooden_attack, itc_big_weapon, 11 , weight(250)|spd_rtng(87) | weapon_length(186)|swing_damage(75 , blunt) | thrust_damage(75,  blunt),imodbits_none,
 #[(ti_on_weapon_attack, [ (display_message,"@DEBUG: Troll hit!!!") ]) ]
],
...
########Orc Weapons
["bone_cudgel", "Bone_Cudgel", [("bone_cudgel",0)],itp_type_one_handed_wpn|itp_shop|itp_primary|itp_wooden_parry|itp_wooden_attack, itc_scimitar, 11 , weight(2.5)|difficulty(0)|spd_rtng(95) | weapon_length(53)|swing_damage(15 , blunt) | thrust_damage(0 ,  pierce),imodbits_none ],
["skull_club" , "Skull_Club" , [("skull_club" ,0)],itp_type_one_handed_wpn|itp_shop|itp_primary|itp_wooden_parry|itp_wooden_attack, itc_scimitar, 11 , weight(2.5)|difficulty(0)|spd_rtng(95) | weapon_length(55)|swing_damage(15 , blunt) | thrust_damage(0 ,  pierce),imodbits_none ],
...
["orc_sledgehammer", "Orc_Sledgehammer", [("orc_sledgehammer",0)],itp_type_polearm|itp_shop|itp_primary|itp_two_handed|itp_wooden_parry|itp_wooden_attack, itc_nodachi|itcf_carry_back, 101 , weight(7)|difficulty(12)|spd_rtng(82) | weapon_length(75)|swing_damage(35 , blunt) | thrust_damage(0 ,  pierce),imodbits_mace ],
["orc_simple_spear", "Orc_Spear"       , [("orc_simple_spear",0)],itp_type_polearm|itp_shop|itp_spear|itp_primary|itp_two_handed|itp_wooden_parry, itc_staff,90 , weight(2.5)|difficulty(0)|spd_rtng(96) | weapon_length(152)|swing_damage(20 , blunt) | thrust_damage(27 ,  pierce),imodbits_polearm ],
...
["orc_machete",   "Orc_Machete", [("orc_machete",0)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_scimitar|itcf_carry_sword_left_hip, 108 , weight(1.5)|difficulty(0)|spd_rtng(105) | weapon_length(55)|swing_damage(29 , cut) | thrust_damage(0 ,  pierce),imodbits_sword_high ],
...
["orc_throwing_axes", "Orc Throwing Axes", [("orc_throwing_axe",0)], itp_type_thrown |itp_shop|itp_primary|itp_bonus_against_shield,itcf_throw_axe,241, weight(5)|difficulty(1)|spd_rtng(99) | shoot_speed(20) | thrust_damage(38,cut)|max_ammo(7)|weapon_length(53),imodbits_thrown ],
...
#WORKING THIS SECTION	######HELMS##########
["mordor_helm_a", "Mordor Uruk Helm", [("uruk_helm_a",0)], itp_shop|itp_type_head_armor   ,0, 479 , weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate],
["mordor_helm_b", "Mordor Uruk Helm", [("uruk_helm_b",0)], itp_shop|itp_type_head_armor   ,0, 479 , weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate],
["mordor_helm_c", "Mordor Uruk Helm", [("uruk_helm_c",0)], itp_shop|itp_type_head_armor   ,0, 340 , weight(2)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
["mordor_helm_d", "Mordor Uruk Helm", [("uruk_helm_d",0)], itp_shop|itp_type_head_armor   ,0, 278 , weight(2)|abundance(100)|head_armor(38)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
["mordor_helm_e", "Mordor Uruk Helm", [("uruk_helm_e",0)], itp_shop|itp_type_head_armor   ,0, 555 , weight(2.5)|abundance(100)|head_armor(47)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate ],
["mordor_helm_f", "Mordor Uruk Helm", [("uruk_helm_f",0)], itp_shop|itp_type_head_armor   ,0, 505 , weight(2.5)|abundance(100)|head_armor(46)|body_armor(0)|leg_armor(0)|difficulty(9) ,imodbits_plate ],

["mordor_helm_g", "Mordor Orc Helm", [("orc_helm_c",0)],itp_shop|itp_type_head_armor   ,0, 174 , weight(1.25)|abundance(100)|head_armor(31)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate],
["mordor_helm_h", "Mordor Orc Helm", [("orc_helm_d",0)],itp_shop|itp_type_head_armor   ,0, 278 , weight(2)|abundance(100)|head_armor(38)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
["mordor_helm_i", "Mordor Orc Helm", [("orc_helm_e",0)],itp_shop|itp_type_head_armor   ,0, 278 , weight(2)|abundance(100)|head_armor(38)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
["mordor_helm_j", "Mordor Orc Helm", [("orc_helm_f",0)],itp_shop|itp_type_head_armor   ,0, 233 , weight(1.75)|abundance(100)|head_armor(35)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate],
["mordor_helm_k", "Mordor Orc Helm", [("orc_helm_g",0)],itp_shop|itp_type_head_armor   ,0, 233 , weight(1.75)|abundance(100)|head_armor(35)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate],
["mordor_helm_l", "Mordor Orc Helm", [("orc_helm_h",0)],itp_shop|itp_type_head_armor   ,0, 340 , weight(2)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
["mordor_helm_m", "Mordor Orc Helm", [("orc_helm_k",0)],itp_shop|itp_type_head_armor   ,0, 310 , weight(2)|abundance(100)|head_armor(38)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
...
["black_num_helm" , "Black Numenorean Helm", [("black_numenor_helmet",0)], itp_shop|itp_type_head_armor,0, 980 , weight(2.75)|abundance(100)|head_armor(43)|body_armor(0)|leg_armor(0)|difficulty(10) ,imodbits_plate ],
	...
	#######WEAPONS##########
["mordor_sword", "Mordor Sword", [("mordor_sword",0)], itp_type_two_handed_wpn|itp_shop|itp_primary, itc_bastardsword|itcf_carry_sword_back,
 294 , weight(2.25)|difficulty(9)|spd_rtng(98) | weapon_length(109)|swing_damage(37 , cut) | thrust_damage(26 ,  pierce),imodbits_sword_high ],
["mordor_longsword",         "Sword of Mordor", [("sword_of_mordor",0),("scab_sword_of_mordor", ixmesh_carry)], itp_type_two_handed_wpn|itp_shop|itp_two_handed|itp_primary, itc_greatsword|itcf_carry_sword_back|itcf_show_holster_when_drawn,
 423 , weight(2.75)|difficulty(10)|spd_rtng(95) | weapon_length(125)|swing_damage(39 , cut) | thrust_damage(31 ,  pierce),imodbits_sword_high ],
########Mordor horses
...
#["goblin_king_sword",         "Goblin King's Sword", [("orc_slasher",0)], itp_type_two_handed_wpn|itp_two_handed|itp_primary, itc_greatsword|itcf_carry_sword_back|itcf_show_holster_when_drawn,
# 423 , weight(2.75)|difficulty(10)|spd_rtng(95) | weapon_length(125)|swing_damage(39 , cut) | thrust_damage(31 ,  pierce),imodbits_sword_high ],
#["moria_sword", "Goblin Slasher", [("orc_slasher",0)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
# 162 , weight(1.25)|difficulty(0)|spd_rtng(103) | weapon_length(85)|swing_damage(28 , cut) | thrust_damage(21 ,  pierce),imodbits_sword_high ],


	#####HELMS##########
["moria_helm_a", "Moria Skullcap", [("orc_helm_a",0)],itp_shop|itp_type_head_armor   ,0, 60 , weight(1.0)|abundance(100)|head_armor(20)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_plate],
["moria_helm_b", "Moria Skullcap", [("orc_helm_b",0)],itp_shop|itp_type_head_armor  |itp_civilian ,0, 14 , weight(1)|abundance(100)|head_armor(18)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth],
["moria_helm_c", "Moria Helm"    , [("orc_helm_c",0)],itp_shop|itp_type_head_armor   ,0, 174 , weight(1.25)|abundance(100)|head_armor(31)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate],
["moria_helm_d", "Moria Helm"    , [("orc_helm_d",0)],itp_shop|itp_type_head_armor   ,0, 278 , weight(2)|abundance(100)|head_armor(38)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
["moria_helm_e", "Moria Helm"    , [("orc_helm_j",0)],itp_shop|itp_type_head_armor   ,0, 174 , weight(1.25)|abundance(100)|head_armor(31)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate],
...
["gundabad_helm_e", "Gundabad Helm", [("orc_wargrider_helm",0)],itp_shop|itp_type_head_armor|itp_fit_to_head ,0, 147 , weight(1.25)|abundance(100)|head_armor(28)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
	...
	#WEAPONS##########
#["gundabad_sabre", "Gundabad Sabre", [("orc_sabre",0),("scab_orc_sabre", ixmesh_carry)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
# 162 , weight(1.25)|difficulty(0)|spd_rtng(103) | weapon_length(85)|swing_damage(28 , cut) | thrust_damage(21 ,  pierce),imodbits_sword_high ],
...
#["dun_shield_g", "Dunnish Shield", [("dunland_shield_g",0)], itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
	...
	#WEAPONS##########
["dun_berserker"     , "Dunland Chieftain Sword", [("dunland_sword",0),("dunland_sword", ixmesh_carry)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 162 , weight(1.25)|difficulty(0)|spd_rtng(103) | weapon_length(98)|swing_damage(28 , cut) | thrust_damage(21 ,  pierce),imodbits_sword_high ],
["dunnish_antler_axe", "Dunnish Antler Axe"     , [("dunland_antleraxe",0)], itp_type_one_handed_wpn|itp_shop|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,
 524 , weight(2.0)|difficulty(9)|spd_rtng(97) | weapon_length(73)|swing_damage(40 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
["dunnish_war_axe"   , "Dunnish War Axe"        , [("dunland_axe_a",0)], itp_type_polearm|itp_shop|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,
 524 , weight(2.0)|difficulty(9)|spd_rtng(97) | weapon_length(47)|swing_damage(40 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
["dunnish_axe"       , "Dunnish Battle Axe"     , [("dunland_axe_b",0)], itp_type_one_handed_wpn|itp_shop|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,
 524 , weight(2.0)|difficulty(9)|spd_rtng(97) | weapon_length(34)|swing_damage(40 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
...
["rohan_shoes"         , "Rohan_Shoes"         , [("L_rohan_shoes"        ,0)], itp_shop|itp_type_foot_armor |itp_civilian  |itp_attach_armature,0, 34 , weight(1)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(10)|difficulty(0) ,imodbits_cloth ],

##WEAPONS##########
["rohan_cav_sword", "Rohan Riding Sword", [("rohan_sword_a",0),("scab_rohan_sword_a", ixmesh_carry)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 394 , weight(1.5)|difficulty(0)|spd_rtng(99) | weapon_length(95)|swing_damage(31 , cut) | thrust_damage(21 ,  pierce),imodbits_sword_high ],
["rohan_inf_sword", "Rohan Sword", [("rohan_sword_b",0),("scab_rohan_sword_b", ixmesh_carry)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
 280 , weight(1.25)|difficulty(0)|spd_rtng(100) | weapon_length(95)|swing_damage(29 , cut) | thrust_damage(22 ,  pierce),imodbits_sword_high ],
["rohan_spear",    "Rohan Spear", [("rohan_spear",0)], itp_type_polearm|itp_shop|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_rohan_spear,
 189 , weight(2.5)|difficulty(0)|spd_rtng(92) | weapon_length(172)|swing_damage(16 , blunt) | thrust_damage(27 ,  pierce),imodbits_polearm ],
["rohan_sword_c", "Rohan_Sword", [("rohan_sword_c",0),("scab_rohan_sword_c", ixmesh_carry)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,
...
["rohirrim_short_axe"      , "Rohirrim_Short_Axe"      , [("rohan_1haxe",0)], itp_type_one_handed_wpn|itp_shop|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,
 524 , weight(2.0)|difficulty(9)|spd_rtng(97) | weapon_length(50)|swing_damage(40,cut)|thrust_damage(0,pierce),imodbits_axe ],
["rohirrim_long_hafted_axe", "Rohirrim_Long_Hafted_Axe", [("rohan_2haxe",0)], itp_type_one_handed_wpn|itp_shop|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,
 524 , weight(2.0)|difficulty(9)|spd_rtng(97) | weapon_length(53)|swing_damage(40,cut)|thrust_damage(0,pierce),imodbits_axe ],
...
["mirkwood_leather_greaves", "mirkwood_leather_greaves", [("lthr_greaves",0)], itp_shop|itp_type_foot_armor |itp_attach_armature,0,
 760 , weight(3)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(24)|difficulty(0) ,imodbits_armor ],

  
	#WEAPONS##########
["mirkwood_great_spear","Mirkwood Great Spear", [("mirkwood_great_spear_large",0)], itp_type_polearm|itp_shop|itp_spear|itp_primary|itp_wooden_parry, itc_staff|itcf_carry_spear,
 90 , weight(2.5)|difficulty(0)|spd_rtng(101) | weapon_length(148)|swing_damage(20 , blunt) | thrust_damage(27 ,  pierce),imodbits_polearm ],
["mirkwood_war_spear"  ,"Mirkwood War Spear"  , [("mirkwood_war_spear",0)], itp_type_polearm|itp_shop|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_staff|itcf_carry_spear,
 290 , weight(2.5)|difficulty(0)|spd_rtng(99) | weapon_length(150)|swing_damage(20 , blunt) | thrust_damage(31 ,  pierce),imodbits_polearm ],
["mirkwood_short_spear","Mirkwood Spear"      , [("mirkwood_short_spear",0)], itp_type_polearm|itp_shop|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_staff|itcf_carry_spear,
 90 , weight(2.5)|difficulty(0)|spd_rtng(96) | weapon_length(117)|swing_damage(20 , blunt) | thrust_damage(27 ,  pierce),imodbits_polearm ],
...
["dale_shield_d", "Dale Shield", [("arena_shield_blue",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,42,weight(2)|hit_points(360)|body_armor(1)|spd_rtng(100)|weapon_length(60),imodbits_shield ],
 ...
 ##ARMOR##########
["umb_armor_a", "Corsair Armor", [("corsair_leather"         ,0)], itp_shop|itp_type_body_armor|itp_covers_legs,0,65 ,weight(7) |abundance(100)|head_armor(0)|body_armor(20)|leg_armor(6)|difficulty(0) ,imodbits_cloth ],
...
["umb_armor_g", "Corsair Hauberk w/ Pauldrons", [("corsair_chain_pauldron"  ,0)], itp_shop|itp_type_body_armor|itp_covers_legs,0,965,weight(7) |abundance(100)|head_armor(0)|body_armor(51)|leg_armor(9)|difficulty(0) ,imodbits_cloth ],
...
["corsair_boots", "Corsair_Boots", [("corsair_boots",0)], itp_shop|itp_type_foot_armor  |itp_civilian |itp_attach_armature,0, 174 , weight(1.25)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(16)|difficulty(0) ,imodbits_cloth ],
	...
	########SHIELDS##########
#["umb_shield_a", "Corsair Shield", [("corsair_buckler_long_a",0)], itp_shop|itp_type_shield,itp_wooden_parry,   218 , weight(1.5)|hit_points(380)|body_armor(1)|spd_rtng(100)|weapon_length(64),imodbits_shield ],
#["umb_shield_b", "Corsair Shield", [("corsair_buckler_round_a",0)], itp_shop|itp_type_shield,itp_wooden_parry,   218 , weight(1.5)|hit_points(380)|body_armor(1)|spd_rtng(100)|weapon_length(64),imodbits_shield ],
#["umb_shield_c", "Corsair Shield", [("corsair_buckler_round_b",0)], itp_shop|itp_type_shield,itp_wooden_parry,   118 , weight(1.5)|hit_points(380)|body_armor(1)|spd_rtng(100)|weapon_length(50),imodbits_shield ],
#["umb_shield_d", "Corsair Shield", [("corsair_buckler_round_c",0)], itp_shop|itp_type_shield,itp_wooden_parry,   118 , weight(1.5)|hit_points(380)|body_armor(1)|spd_rtng(100)|weapon_length(50),imodbits_shield ],
#["umb_shield_e", "Corsair Shield", [("corsair_buckler_long_b",0)], itp_shop|itp_type_shield,itp_wooden_parry,  118 , weight(1.5)|hit_points(380)|body_armor(1)|spd_rtng(100)|weapon_length(50),imodbits_shield ],
...
["northm_armor_c","Northman Armor", [("padded_leather",0)], itp_shop|itp_type_body_armor|itp_covers_legs, 0, 152,weight(15.0)|body_armor(20)|leg_armor(6),imodbits_none],
["northm_armor_d","Northman Armor", [("light_leather",0)], itp_shop|itp_type_body_armor|itp_covers_legs, 0, 152,weight(15.0)|body_armor(20)|leg_armor(6),imodbits_none],
...
["northm_armor_c","Beorning Padded Armor", [("beorn_padded",0)], itp_shop|itp_type_body_armor|itp_covers_legs, 0, 152,weight(15.0)|body_armor(20)|leg_armor(6),imodbits_none],
["northm_armor_d","Beorning Heavy Armor", [("beorn_heavy",0)], itp_shop|itp_type_body_armor|itp_covers_legs, 0, 152,weight(15.0)|body_armor(20)|leg_armor(6),imodbits_none],
["northm_armor_e","Beorning Berserker Armor", [("beorn_berserker",0)], itp_shop|itp_type_body_armor|itp_covers_legs, 0, 152,weight(15.0)|body_armor(20)|leg_armor(6),imodbits_none],

 
	######HELMS##########
["northm_helm_a", "Northmen Helm", [("skull_cap_new",0)], itp_shop|itp_type_head_armor   ,0, 340 , weight(2)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
["northm_helm_b", "Northmen Helm", [("skull_cap_new",0)], itp_shop|itp_type_head_armor   ,0, 340 , weight(2)|abundance(100)|head_armor(40)|body_armor(0)|leg_armor(0)|difficulty(7) ,imodbits_plate ],
	...
	#####SHIELDS##########
["northm_shield_a","Northmen Shield", [("shield_round_g",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
["northm_shield_b","Northmen Shield", [("shield_round_g",0)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
	...
	######WEAPONS###########
["northm_axe",  "Battle Axe", [("beorning_axe",0)], itp_type_polearm|itp_shop|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back, 240 , weight(5)|difficulty(9)|spd_rtng(88) | weapon_length(76)|swing_damage(41 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
["northm_sword", "Sword", [("sword_medieval_a",0),("sword_medieval_a_scabbard", ixmesh_carry)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 163 , weight(1.5)|difficulty(0)|spd_rtng(99) | weapon_length(95)|swing_damage(27 , cut) | thrust_damage(22 ,  pierce),imodbits_sword_high ],
["beorning_staff", "Woodman's Staff", [("woodman_staff",0)], itp_type_polearm|itp_shop|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_wooden_attack, itc_staff|itcf_carry_sword_back,
 60 , weight(2)|difficulty(0)|spd_rtng(104) | weapon_length(104)|swing_damage(20 , blunt) | thrust_damage(20 ,  blunt),imodbits_polearm ],
["beorning_stave", "Woodman's Stave", [("woodman_stave",0)], itp_type_polearm|itp_shop|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry|itp_wooden_attack, itc_staff|itcf_carry_sword_back,
 60 , weight(2)|difficulty(0)|spd_rtng(104) | weapon_length(100)|swing_damage(20 , blunt) | thrust_damage(20 ,  blunt),imodbits_polearm ],

#["beorn_axe",  "Beorning Axe", [("beorning_axe",0)], itp_type_two_handed_wpn|itp_shop|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back, 240 , weight(5)|difficulty(9)|spd_rtng(88) | weapon_length(108)|swing_damage(41 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
...
###TLD DWARF ITEMS##########
	########SHIELDS##########
["dwarf_shield_a", "Dwarven Shield", [("dwarf_shield_a",0),("dwarf_shield_b",imod_old),("dwarf_shield_c",imod_reinforced),("dwarf_shield_d",imod_battered)], itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
...
["dwarf_adz",          "Dwarf Adz"          , [("dwarf_adz"          ,0)],itp_type_polearm|itp_shop|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back, 264 , weight(5)|difficulty(10)|spd_rtng(86) | weapon_length(68)|swing_damage(43 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
["dwarf_great_axe",    "Dwarf Great Axe"    , [("dwarf_great_axe"    ,0)],itp_type_polearm|itp_shop|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back, 264 , weight(5)|difficulty(10)|spd_rtng(86) | weapon_length(102)|swing_damage(43 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
["dwarf_great_mattock","Dwarf Great Mattock", [("dwarf_great_mattock",0)],itp_type_polearm|itp_shop|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back, 264 , weight(5)|difficulty(10)|spd_rtng(86) | weapon_length(94)|swing_damage(43 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
["dwarf_great_pick",   "Dwarf Great Pick"   , [("dwarf_great_pick"   ,0)],itp_type_polearm|itp_shop|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back, 264 , weight(5)|difficulty(10)|spd_rtng(86) | weapon_length(93)|swing_damage(43 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
["dwarf_war_pick",     "Dwarf War Pick"     , [("dwarf_war_pick"     ,0)],itp_type_polearm|itp_shop|itp_two_handed|itp_primary|itp_bonus_against_shield|itp_wooden_parry, itc_nodachi|itcf_carry_axe_back, 264 , weight(5)|difficulty(10)|spd_rtng(86) | weapon_length(94)|swing_damage(43 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
["dwarf_mattock",      "Dwarf Mattock"      , [("dwarf_mattock"      ,0)],itp_type_polearm|itp_shop|itp_primary|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip, 27 , weight(3)|difficulty(0)|spd_rtng(96) | weapon_length(99)|swing_damage(19 , pierce) | thrust_damage(0 ,  pierce),imodbits_pick ],
["dwarf_hand_axe",     "Dwarf Short_Axe"    , [("dwarf_1h_axe"       ,0)],itp_type_one_handed_wpn|itp_shop|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip, 524 , weight(2.0)|difficulty(9)|spd_rtng(97) | weapon_length(54)|swing_damage(40 , cut) | thrust_damage(0 ,  pierce),imodbits_axe ],
...
["dwarf_spear",        "Dwarf Spear"        , [("dwarf_spear"        ,0)],itp_type_polearm|itp_shop|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_staff|itcf_carry_spear, 75 , weight(2.25)|difficulty(0)|spd_rtng(98) | weapon_length(140)|swing_damage(20 , blunt) | thrust_damage(26 ,  pierce),imodbits_polearm ],
...
["dwarf_short_bow","Dwarf Short Bow", [("dwarf_short_bow",0),("nomad_bow_case", ixmesh_carry)], itp_type_bow |itp_shop|itp_primary|itp_two_handed,itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn, 164 , weight(1.25)|difficulty(2)|spd_rtng(96) | shoot_speed(53) | thrust_damage(20 ,bow_damage),imodbits_bow ],
...
#["dwarf_helm_d", "Dwarf Helm", [("DwarfHelmConical_BChain",0)],   itp_shop|itp_type_head_armor   ,0, 479 , weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
#["dwarf_helm_e", "Dwarf Helm", [("DwarfHelmConical_BLeather",0)], itp_shop|itp_type_head_armor   ,0, 479 , weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
#["dwarf_helm_f", "Dwarf Helm", [("DwarfHelmConicalChain",0)],     itp_shop|itp_type_head_armor   ,0, 479 , weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
#["dwarf_helm_g", "Dwarf Helm", [("DwarfHelmConicalLeather",0)],   itp_shop|itp_type_head_armor   ,0, 479 , weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
...
#["dwarf_helm_s", "Dwarf Helm", [("DwarfHelmRoundChain",0)],       itp_shop|itp_type_head_armor   ,0, 479 , weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
#["dwarf_helm_t", "Dwarf Helm", [("DwarfHelmRoundLeather",0)],     itp_shop|itp_type_head_armor   ,0, 479 , weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
