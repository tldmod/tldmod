...
["ithilien_arrows"     ,"Ithilien Arrows" ,[("ilithien_arrow",0),("flying_missile",ixmesh_flying_ammo),("ithilien_quiver",ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_back       ,350,weight(3.0)|abundance(50) |weapon_length(91)|thrust_damage(3,bow_damage)|max_ammo(29),imodbits_missile],
...
["harad_short_spear","Harad Spear"      ,[("harad_short_spear",0)],itp_type_polearm|itp_shop|itp_cant_use_on_horseback|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear|itcf_carry_back, 125 , weight(3.0)|difficulty(0)|spd_rtng(81) | weapon_length(245)|swing_damage(16 , blunt) | thrust_damage(26 ,  pierce),imodbits_polearm ],
["harad_long_spear" ,"Harad Spear"      ,[("harad_long_spear" ,0)],itp_type_polearm|itp_shop|itp_cant_use_on_horseback|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear|itcf_carry_back, 125 , weight(3.0)|difficulty(0)|spd_rtng(81) | weapon_length(245)|swing_damage(16 , blunt) | thrust_damage(26 ,  pierce),imodbits_polearm ],
["eagle_guard_spear","Harasjala Polearm",[("eagle_guard_spear",0)],itp_type_polearm|itp_shop|itp_cant_use_on_horseback|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear|itcf_carry_back, 125 , weight(3.0)|difficulty(0)|spd_rtng(81) | weapon_length(245)|swing_damage(16 , blunt) | thrust_damage(26 ,  pierce),imodbits_polearm ],
	###########SHIELDS##########
