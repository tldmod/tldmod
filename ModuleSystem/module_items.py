...
###Items before this point are hardwired and their order should not be changed!
 ...
 ["arena_axe"             ,"Axe"             ,[("arena_axe",0)], itp_type_one_handed_wpn|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry, itc_scimitar|itcf_carry_axe_left_hip,137 , weight(1.5)|spd_rtng(100) | weapon_length(69)|swing_damage(23 , blunt) | thrust_damage(0 ,  pierce),imodbits_axe ],
 ["arena_sword"           ,"Sword"           ,[("arena_sword_one_handed",0),("sword_medieval_b_scabbard", ixmesh_carry),], itp_type_one_handed_wpn|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,243 , weight(1.5)|spd_rtng(99) | weapon_length(95)|swing_damage(21 , blunt) | thrust_damage(20 ,  blunt),imodbits_sword_high ],
 ["arena_sword_two_handed","Two Handed Sword",[("arena_sword_two_handed",0)], itp_type_two_handed_wpn|itp_two_handed|itp_primary, itc_greatsword|itcf_carry_sword_back,670 , weight(2.75)|spd_rtng(93) | weapon_length(110)|swing_damage(29 , blunt) | thrust_damage(24 ,  blunt),imodbits_sword_high ],
 ["arena_lance"           ,"Lance"           ,[("arena_lance",0)], itp_type_polearm|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_staff|itcf_carry_spear,90 , weight(2.5)|spd_rtng(96) | weapon_length(150)|swing_damage(20 , blunt) | thrust_damage(25 ,  blunt),imodbits_polearm ],
 ...
 ["practice_bow"          ,"Practice Bow"    ,[("small_bow",0), ("small_bow_carry",ixmesh_carry)], itp_type_bow |itp_primary|itp_two_handed,itcf_shoot_bow|itcf_carry_bow_back, 0, weight(1.5)|spd_rtng(90) | shoot_speed(40) | thrust_damage(19, blunt),imodbits_bow ],
...
###Carthorse, hunter, heavy hunter, hackney, palfrey, courser, destrier.
 ["sumpter_horse","Sumpter Horse",[("sumpter_horse",0)], itp_shop|itp_type_horse, 0,  64,abundance(90)| hit_points(40)|body_armor(1)|difficulty(1)|horse_speed(34)|horse_maneuver(33)|horse_charge(9),imodbits_horse_basic],
 ["saddle_horse" ,"Saddle Horse" ,[("saddle_horse" ,0),("horse_c",imodbits_horse_good)], itp_shop|itp_type_horse, 0, 112,abundance(90)|hit_points(70)|body_armor(10)|difficulty(1)|horse_speed(39)|horse_maneuver(36)|horse_charge(8),imodbits_horse_basic],
 ["steppe_horse" ,"Steppe Horse" ,[("steppe_horse" ,0)], itp_shop|itp_type_horse, 0,  92,abundance(80)| hit_points(70)|body_armor(10)|difficulty(2)|horse_speed(37)|horse_maneuver(41)|horse_charge(7),imodbits_horse_basic],
 ["courser"      ,"Courser"      ,[("courser"      ,0)], itp_shop|itp_type_horse, 0, 323,abundance(70)| hit_points(70)|body_armor(10)|difficulty(2)|horse_speed(43)|horse_maneuver(37)|horse_charge(11),imodbits_horse_basic|imodbit_champion],
 ["hunter"       ,"Hunter"       ,[("hunting_horse",0)], itp_shop|itp_type_horse, 0, 434,abundance(60)|hit_points(100)|body_armor(20)|difficulty(3)|horse_speed(40)|horse_maneuver(36)|horse_charge(18),imodbits_horse_basic|imodbit_champion],
	#ARNOR MOUNTS########
...
["rhun_horse_h","Rhun Horse", [("rhunhorseheav4" ,0)], itp_shop|itp_type_horse, 0, 1411,abundance(40)|hit_points(140)|body_armor(65)|difficulty(4)|horse_speed(35)|horse_maneuver(32)|horse_charge(25),imodbits_horse_basic|imodbit_champion],
    ##DALE MOUNTS##########
["dale_horse"   ,"Dale Horse"   , [("sumpter_horse",0)], itp_shop|itp_type_horse,0,724,abundance(50)|hit_points(60)|body_armor(10)|difficulty(4)|horse_speed(36)|horse_maneuver(34)|horse_charge(18),imodbits_horse_basic|imodbit_champion],
...
#BOW MISSILES
["arrows"              ,"Arrows"          ,[("plain_arrow"   ,0),("flying_missile",ixmesh_flying_ammo),("common_quiver"  ,ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_front_right, 72,weight(3.0)|abundance(160)|weapon_length(95)|thrust_damage(1,bow_damage)|max_ammo(30),imodbits_missile],
["gondor_arrows"       ,"Gondorian_Arrows",[("gondor_arrow"  ,0),("flying_missile",ixmesh_flying_ammo),("gondor_quiver"  ,ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_front_right, 72,weight(3.0)|abundance(160)|weapon_length(95)|thrust_damage(1,bow_damage)|max_ammo(30),imodbits_missile],
["gondor_auxila_arrows","Gondorian_Arrows",[("gondor_arrow"  ,0),("flying_missile",ixmesh_flying_ammo),("gondor_quiver"  ,ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_front_right, 72,weight(3.0)|abundance(160)|weapon_length(95)|thrust_damage(1,bow_damage)|max_ammo(30),imodbits_missile],
["khergit_arrows"      ,"Barbed_Arrows"   ,[("rohan_arrow2"  ,0),("flying_missile",ixmesh_flying_ammo),("rohan_quiver"   ,ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_front_right,410,weight(3.5)|abundance(30) |weapon_length(95)|thrust_damage(3,bow_damage)|max_ammo(30),imodbits_missile],
["rohan_arrows_2"      ,"Rohirrim_Arrows" ,[("rohan_arrow1"  ,0),("flying_missile",ixmesh_flying_ammo),("rohan_quiver2"  ,ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_front_right,410,weight(3.5)|abundance(30) |weapon_length(95)|thrust_damage(3,bow_damage)|max_ammo(30),imodbits_missile],
["harad_arrows"        ,"Haradrim_Arrows" ,[("harad_arrow"   ,0),("flying_missile",ixmesh_flying_ammo),("harad_quiver"   ,ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_front_right,124,weight(3.0)|abundance(70) |weapon_length(95)|thrust_damage(2,bow_damage)|max_ammo(30),imodbits_missile],
["corsair_arrows"      ,"Corsair_Arrows"  ,[("corsair_arrow" ,0),("flying_missile",ixmesh_flying_ammo),("corsair_quiver" ,ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_front_right,350,weight(3.0)|abundance(50) |weapon_length(91)|thrust_damage(3,bow_damage)|max_ammo(29),imodbits_missile],
["ithilien_arrows"     ,"Ithilien_Arrows" ,[("ilithien_arrow",0),("flying_missile",ixmesh_flying_ammo),("ithilien_quiver",ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_back_right ,350,weight(3.0)|abundance(50) |weapon_length(91)|thrust_damage(3,bow_damage)|max_ammo(29),imodbits_missile],
["woodelf_arrows"    ,"Woodelf_Arrows",[("mirkwood_arrow",0),("flying_missile",ixmesh_flying_ammo),("mirkwood_quiver_new",ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_back       ,350,weight(3.0)|abundance(50) |weapon_length(91)|thrust_damage(3,    pierce)|max_ammo(29),imodbits_missile],
["elven_arrows"        ,"Elven_Arrows", [("white_elf_arrow",0),("flying_missile",ixmesh_flying_ammo),("lothlorien_quiver",ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_back       ,350,weight(3.0)|abundance(50) |weapon_length(91)|thrust_damage(3,    pierce)|max_ammo(29),imodbits_missile],
...
["orc_hook_arrow"      ,"Orc_Hook_Arrows" ,[("orc_hook_arrow",0),("flying_missile",ixmesh_flying_ammo),("orc_quiver"     ,ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_back_right , 72,weight(3.0)|abundance(160)|weapon_length(95)|thrust_damage(1,    pierce)|max_ammo(30),imodbits_missile],
["isengard_arrow"      ,"Isengard_Arrows" ,[("isengard_arrow",0),("flying_missile",ixmesh_flying_ammo),("isengard_quiver",ixmesh_carry)],itp_type_arrows|itp_shop, itcf_carry_quiver_back_right , 72,weight(3.0)|abundance(160)|weapon_length(95)|thrust_damage(1,    pierce)|max_ammo(30),imodbits_missile],


["pilgrim_disguise", "Pilgrim_Disguise", [("tld_robe_generic_dress",0)], 0|itp_type_body_armor |itp_covers_legs |itp_civilian ,0, 25 , weight(2)|abundance(100)|head_armor(0)|body_armor(19)|leg_armor(8)|difficulty(0) ,imodbits_cloth ],
...
["leather_boots", "Leather Boots", [("boots",0)], itp_shop|itp_type_foot_armor  |itp_civilian |itp_attach_armature,0, 174 , weight(1.25)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(16)|difficulty(0) ,imodbits_cloth ],
...
["short_bow"      ,"Short Bow"      ,[("small_bow"     ,0),("small_bow_carry"  ,ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bow_back                                 , 17,weight(1.0)|difficulty(0)|spd_rtng(99)|shoot_speed(48)|thrust_damage(15,bow_damage),imodbits_bow ],
["short_bow"      ,"Short Bow"      ,[("small_bow"     ,0),("small_bow_carry"  ,ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bow_back                                 , 17,weight(1.0)|difficulty(0)|spd_rtng(99)|shoot_speed(48)|thrust_damage(15,bow_damage),imodbits_bow ],
["regular_bow"    ,"Bow"            ,[("regular_bow"   ,0),("regular_bow_carry",ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bow_back                                 , 58,weight(1.0)|difficulty(0)|spd_rtng(98)|shoot_speed(52)|thrust_damage(18,bow_damage),imodbits_bow ],
["nomad_bow"      ,"Nomad Bow"      ,[("nomad_bow"     ,0),("nomad_bow_case"   ,ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn,164,weight(1.3)|difficulty(0)|spd_rtng(96)|shoot_speed(53)|thrust_damage(20,bow_damage),imodbits_bow ],
["gondor_bow"     ,"Gondor Bow"     ,[("gondor_bow"    ,0),("gondor_bow_carry" ,ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bow_back                                 ,145,weight(1.8)|difficulty(0)|spd_rtng(82)|shoot_speed(54)|thrust_damage(22,bow_damage),imodbits_bow ],
["strong_bow"     ,"Rohan Bow"      ,[("strong_bow"    ,0),("strong_bow_case"  ,ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn,437,weight(1.3)|difficulty(0)|spd_rtng(94)|shoot_speed(57)|thrust_damage(23,bow_damage),imodbits_bow ],
...
["harad_bow"     ,"Harad Curved Bow",[("harad_bow"     ,0),("harad_bow"        ,ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn,269,weight(1.3)|difficulty(0)|spd_rtng(95)|shoot_speed(56)|thrust_damage(21,bow_damage),imodbits_bow ],
["lg_bow"         ,"Eagle Guard Bow",[("lg_bow"        ,0),("lg_bow"           ,ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn,269,weight(1.3)|difficulty(0)|spd_rtng(95)|shoot_speed(56)|thrust_damage(21,bow_damage),imodbits_bow ],
...
["lorien_bow"     ,"Galadhrim Bow"  ,[("Elfbow"        ,0),("Elfbow_carry"     ,ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bow_back                                 ,728,weight(1.5)|difficulty(0)|spd_rtng(93)|shoot_speed(58)|thrust_damage(25,    pierce),imodbits_bow ],
["isengard_large_bow","Isengard_Large_Bow",[("isengard_large_bow",0),("isengard_large_bow_carry",ixmesh_carry)],itp_shop|itp_type_bow|itp_primary|itp_two_handed,itcf_shoot_bow|itcf_carry_bow_back                  ,728,weight(1.5)|difficulty(0)|spd_rtng(93)|shoot_speed(58)|thrust_damage(25,    pierce),imodbits_bow ],
["dale_bow"       ,"Dale Bow"       ,[("dale_bow"      ,0),("dale_bow_carry"   ,ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bow_back                                 ,728,weight(1.5)|difficulty(0)|spd_rtng(93)|shoot_speed(58)|thrust_damage(25,bow_damage),imodbits_bow ],
["uruk_bow"       ,"Orc_Bow"        ,[("orc_bow"       ,0),("orc_bow_carry"    ,ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bowcase_left|itcf_show_holster_when_drawn,437,weight(1.3)|difficulty(0)|spd_rtng(94)|shoot_speed(57)|thrust_damage(23,bow_damage),imodbits_bow ],
["mirkwood_bow"   ,"Mirkwood Bow"   ,[("mirkwood_bow"  ,0),("mirkwood_bow_carry",ixmesh_carry)], itp_type_bow|itp_shop|itp_primary|itp_two_handed ,itcf_shoot_bow|itcf_carry_bow_back                                 ,728,weight(1.5)|difficulty(0)|spd_rtng(93)|shoot_speed(58)|thrust_damage(25,    pierce),imodbits_bow ],
...
["javelin"             ,"Javelin"                ,[("javelin"       ,0),("javelins_quiver"  ,ixmesh_carry)],itp_type_thrown |itp_shop|itp_primary|itp_bonus_against_shield ,itcf_throw_javelin|itcf_carry_quiver_back |itcf_show_holster_when_drawn, 75 , weight(5)|difficulty(1)|spd_rtng(91) | shoot_speed(28) | thrust_damage(28 ,  pierce)|max_ammo(3)|weapon_length(75),imodbits_thrown ],
["harad_javelin"       ,"Harad Javelin"          ,[("harad_javelin" ,0),("harad_javelins_quiver",ixmesh_carry)],itp_type_thrown |itp_shop|itp_primary|itp_bonus_against_shield ,itcf_throw_javelin|itcf_carry_quiver_back |itcf_show_holster_when_drawn,209 , weight(4)|difficulty(2)|spd_rtng(89) | shoot_speed(27) | thrust_damage(33 ,  pierce)|max_ammo(3)|weapon_length(65),imodbits_thrown ],
["gondor_javelin"      ,"Gondor Javelin"         ,[("gondor_javelin",0),("jarid_quiver", ixmesh_carry)], itp_type_thrown |itp_shop|itp_primary|itp_bonus_against_shield ,itcf_throw_javelin|itcf_carry_quiver_back |itcf_show_holster_when_drawn, 209 , weight(4)|difficulty(2)|spd_rtng(89) | shoot_speed(27) | thrust_damage(33 ,  pierce)|max_ammo(3)|weapon_length(65),imodbits_thrown ],
["rohirrim_throwing_axe","Rohirrim_Throwing_Axes",[("rohan_throwing_axe",0)], itp_type_thrown |itp_shop|itp_primary|itp_bonus_against_shield,itcf_throw_axe,241, weight(5)|difficulty(1)|spd_rtng(99) | shoot_speed(20) | thrust_damage(38,cut)|max_ammo(7)|weapon_length(53),imodbits_thrown ],
...
["evil_gauntlets_a","Gauntlets"  , [("gauntlet_a_L",0)], itp_shop|itp_type_hand_armor,0, 1940, weight(1.0)|abundance(100)|body_armor(6)|difficulty(0),imodbits_armor],
["evil_gauntlets_b","Gauntlets"  , [("gauntlet_b_L",0)], itp_shop|itp_type_hand_armor,0, 1940, weight(1.0)|abundance(100)|body_armor(6)|difficulty(0),imodbits_armor],
...
["m_uruk_light_a", "Mordor Uruk Light Armor", [("uruk_mordor_a",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 500 , weight(10)|abundance(100)|head_armor(0)|body_armor(45)|leg_armor(8)|difficulty(8) ,imodbits_armor ],
["m_uruk_light_b", "Mordor Uruk Light Armor", [("uruk_mordor_b",0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 500 , weight(10)|abundance(100)|head_armor(0)|body_armor(45)|leg_armor(8)|difficulty(8) ,imodbits_armor ],
...
["evil_light_armor","Sinister Garb"         , [("evil_light_armor"    ,0)], itp_shop|itp_type_body_armor  |itp_covers_legs ,0, 500 , weight(15)|abundance(100)|head_armor(0)|body_armor(45)|leg_armor(18)|difficulty(8) ,imodbits_armor ],
...
["mordor_longsword", "Sword of Mordor",[("sword_of_mordor",0),("scab_sword_of_mordor", ixmesh_carry)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_scimitar|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 423 , weight(2.75)|difficulty(10)|spd_rtng(95) | weapon_length(125)|swing_damage(39 , cut) | thrust_damage(31 ,  pierce),imodbits_sword_high ],
    ########MOUNTS
...
["dunland_armor_k", "Dun Chief Armor"  ,[("dunland_chieftain",0)], itp_shop|itp_type_body_armor|itp_covers_legs ,0, 1250 , weight(8)|abundance(100)|head_armor(0)|body_armor(49)|leg_armor(13)|difficulty(8) ,imodbits_armor ],
    #######HELMS##########
...
#["dun_shield_g", "Dunnish Shield", [("dunland_shield_g",0)], itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
	#WEAPONS##########
["dun_berserker"     ,"Dunland Chieftain Sword",[("dunland_sword"    ,0)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_longsword|itcf_carry_sword_left_hip, 162 , weight(1.25)|difficulty(0)|spd_rtng(103) | weapon_length(98)|swing_damage(28 , cut) | thrust_damage(21 ,  pierce),imodbits_sword_high ],
...
["harad_scale"      ,"Harad Scale Armor",[("harad_scale"      ,0)],itp_shop|itp_type_body_armor|itp_covers_legs,0,65, weight(7)|abundance(100)|head_armor(0)|body_armor(18)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
["harad_tiger_scale","Tiger Guard Armor",[("harad_tiger_scale",0)],itp_shop|itp_type_body_armor|itp_covers_legs,0,65, weight(7)|abundance(100)|head_armor(0)|body_armor(18)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
["harad_lion_scale" ,"Lion Guard Armor" ,[("harad_lion_scale" ,0)],itp_shop|itp_type_body_armor|itp_covers_legs,0,65, weight(7)|abundance(100)|head_armor(0)|body_armor(18)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
#["harad_armor_l", "Parsanah Armor", [("harad_padded",0)],itp_shop|itp_type_body_armor|itp_covers_legs,0,65, weight(7)|abundance(100)|head_armor(0)|body_armor(18)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
   ###########HELMS##########
			#HARONDOR
["harad_dragon_helm", "Kiloka Helm"  , [("harad_dragon_helm" ,0)],itp_shop|itp_type_head_armor,0,479, weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
...
["harad_cav_helm_a","Harondor Cavalry Helm",[("harad_cav_helm_a",0)],itp_shop|itp_type_head_armor,0,479, weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
["harad_cav_helm_b","Harondor Cavalry Helm",[("harad_cav_helm_b",0)],itp_shop|itp_type_head_armor,0,479, weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
["black_snake_helm","Maranka Helm"         ,[("black_snake_helm",0)],itp_shop|itp_type_head_armor,0,479, weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
			#GREAT HARAD
["harad_finhelm"       ,"Great Harad Helmet",[("harad_finhelm"       ,0)],itp_shop|itp_type_head_armor,0,479, weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
["harad_heavy_inf_helm","Great Harad Helmet",[("harad_heavy_inf_helm",0)],itp_shop|itp_type_head_armor,0,479, weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
["harad_wavy_helm"     ,"Great Harad Helmet",[("harad_wavy_helm"     ,0)],itp_shop|itp_type_head_armor,0,479, weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
...
["lion_helm"    , "Lion Guard Helm"    , [("lion_helm"   ,0)],itp_shop|itp_type_head_armor,0,479, weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
			#FAR HARAD
["harad_pantherhelm"    , "Panther Guard Cap"    , [("harad_pantherhelm"   ,0)],itp_shop|itp_type_head_armor,0,479, weight(2.25)|abundance(100)|head_armor(45)|body_armor(0)|leg_armor(0)|difficulty(8) ,imodbits_plate ],
	##########WEAPONS##########
...
["horandor_a"       ,"Harad Scimitar"      ,[("horandor_a",0)],        itp_type_one_handed_wpn|itp_shop|itp_primary, itc_scimitar|itcf_carry_sword_left_hip, 105 , weight(2.5)|difficulty(8)|spd_rtng(96) | weapon_length(90)|swing_damage(30 , cut) | thrust_damage(0 ,  pierce),imodbits_sword ],
...
["harad_mace"       ,"Far Harad Mace"      ,[("harad_mace",0)],        itp_type_one_handed_wpn|itp_shop|itp_primary, itc_scimitar|itcf_carry_sword_left_hip, 105 , weight(2.5)|difficulty(8)|spd_rtng(96) | weapon_length(73)|swing_damage(30 , cut) | thrust_damage(0 ,  pierce),imodbits_sword ],
["far_harad_2h_mace","Far Harad Two Handed Mace",[("far_harad_2h_mace",0)],itp_two_handed|itp_shop|itp_primary|itp_wooden_parry, itc_nodachi|itcf_carry_back, 7 , weight(2.0)|difficulty(0)|spd_rtng(100)| weapon_length(55)|swing_damage(14,blunt) | thrust_damage(0 ,  pierce),imodbits_mace ],
["harad_dagger"     ,"Harad Knife"         ,[("harad_dagger",0)], itp_type_one_handed_wpn|itp_shop|itp_primary|itp_secondary|itp_no_parry, itc_dagger|itcf_carry_dagger_front_left|itcf_show_holster_when_drawn, 17 , weight(0.75)|difficulty(0)|spd_rtng(112) | weapon_length(47)|swing_damage(22 , cut) | thrust_damage(19 ,  pierce),imodbits_sword_high ],

["harad_short_spear","Harad Spear"      ,[("harad_short_spear",0)],itp_type_polearm|itp_shop|itp_cant_use_on_horseback|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear, 125 , weight(3.0)|difficulty(0)|spd_rtng(81) | weapon_length(245)|swing_damage(16 , blunt) | thrust_damage(26 ,  pierce),imodbits_polearm ],
["harad_long_spear" ,"Harad Spear"      ,[("harad_long_spear" ,0)],itp_type_polearm|itp_shop|itp_cant_use_on_horseback|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear, 125 , weight(3.0)|difficulty(0)|spd_rtng(81) | weapon_length(245)|swing_damage(16 , blunt) | thrust_damage(26 ,  pierce),imodbits_polearm ],
["eagle_guard_spear","Harasjala Polearm",[("eagle_guard_spear",0)],itp_type_polearm|itp_shop|itp_cant_use_on_horseback|itp_spear|itp_primary|itp_penalty_with_shield|itp_wooden_parry, itc_cutting_spear, 125 , weight(3.0)|difficulty(0)|spd_rtng(81) | weapon_length(245)|swing_damage(16 , blunt) | thrust_damage(26 ,  pierce),imodbits_polearm ],
	###########SHIELDS##########
["harad_long_shield_a","Harad Leopard Shield",[("harad_long_shield_a",0)],itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_board_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
["harad_long_shield_b","Harad Bronze Shield" ,[("harad_long_shield_b",0)],itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_board_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
["harad_long_shield_c","Harad Sun Shield"    ,[("harad_long_shield_c",0)],itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_board_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
["harad_long_shield_d","Harad Snake Shield"  ,[("harad_long_shield_d",0)],itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_board_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
["harad_long_shield_e","Harad Snake Shield"  ,[("harad_long_shield_e",0)],itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_board_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],

["harad_shield_a","Harondor Shield" ,[("harad_shield_a",0)],itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
["harad_shield_b","Harondor Buckler",[("harad_shield_b",0)],itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
["harad_shield_c","Harondor Buckler",[("harad_shield_c",0)],itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
["harad_tribal_a" ,"Far Harad Shield", [("harad_tribal_a",0)],itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_board_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
["harad_tribal_b" ,"Far Harad Shield", [("harad_tribal_b",0)],itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_board_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
["harad_yellow_shield","Harad Shield", [("harad_yellow_shield",0)],itp_shop|itp_type_shield|itp_wooden_parry, itcf_carry_kite_shield,  118 , weight(2.5)|hit_points(480)|body_armor(1)|spd_rtng(82)|weapon_length(90),imodbits_shield ],
	############BOOTS##########
["desert_boots"          ,"Desert Boots" ,[("desert_boots"          ,0)], itp_shop|itp_type_foot_armor |itp_attach_armature,0, 760 , weight(3)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(24)|difficulty(0) ,imodbits_armor ],
["harad_leather_greaves" ,"Harad Greaves",[("harad_leather_greaves" ,0)], itp_shop|itp_type_foot_armor |itp_attach_armature,0, 760 , weight(3)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(24)|difficulty(0) ,imodbits_armor ],
["harad_scale_greaves"   ,"Harad Boots"  ,[("harad_scale_greaves"   ,0)], itp_shop|itp_type_foot_armor |itp_attach_armature,0, 760 , weight(3)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(24)|difficulty(0) ,imodbits_armor ],
["harad_lamellar_greaves","Harad Boots"  ,[("harad_lamellar_greaves",0)], itp_shop|itp_type_foot_armor |itp_attach_armature,0, 760 , weight(3)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(24)|difficulty(0) ,imodbits_armor ],
	############MOUNTS##########
...
["harad_horse"      ,"Harad Horse", [("harad_horse01",0)], itp_shop|itp_type_horse, 0, 724,abundance(50)|hit_points(135)|body_armor(52)|difficulty(4)|horse_speed(36)|horse_maneuver(34)|horse_charge(18),imodbits_horse_basic|imodbit_champion],
["harad_warhorse"   ,"Harad Warhorse", [("harad_horse02"      ,0)], itp_shop|itp_type_horse, 0, 724,abundance(50)|hit_points(135)|body_armor(52)|difficulty(4)|horse_speed(36)|horse_maneuver(34)|horse_charge(18),imodbits_horse_basic|imodbit_champion],
...
["khand_pitsword"   ,"Pit Fighter Sword",[("Khand_Weapon_Sword_Pit"  ,0)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,280 , weight(1.25)|difficulty(0)|spd_rtng(65) | weapon_length(66)|swing_damage(29 , cut) | thrust_damage(21 ,  pierce),imodbits_sword_high ],
["khand_tulwar"     ,"Khand Tulwar"     ,[("Khand_Weapon_Tulwar"     ,0)], itp_type_one_handed_wpn|itp_shop|itp_primary, itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn, 280 , weight(1.25)|difficulty(0)|spd_rtng(94) | weapon_length(94)|swing_damage(29 , cut) | thrust_damage(21 ,  pierce),imodbits_sword_high ],
...
["leather_dwarf_armor_b","Dwarven Tunic"        ,[("dwarf_tunic"       ,0)],itp_shop|itp_type_body_armor|itp_covers_legs ,0, 195 , weight(5)|abundance(100)|head_armor(0)|body_armor(16)|leg_armor(8)|difficulty(0) ,imodbits_cloth ],
["dwarf_vest_b"       ,"Iron Hills Tunic"    ,[("dwarf_tunic_ironhills",0)],itp_shop|itp_type_body_armor|itp_covers_legs ,0, 1370, weight(18)|abundance(100)|head_armor(0)|body_armor(46)|leg_armor(8)|difficulty(7) ,imodbits_cloth ],
