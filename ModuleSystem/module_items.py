...
imodbits_warg = imodbit_swaybacked | imodbit_lame | imodbit_heavy | imodbit_stubborn  | imodbit_heavy   | imodbit_champion | imodbit_timid 
#
...
["practice_staff","Wooden_Staff",[("wooden_staff",0)],itp_primary|itp_wooden_parry|itp_type_polearm|itp_two_handed|itp_no_blur|itp_spear|itp_penalty_with_shield|itp_wooden_attack, itc_staff|itcf_carry_sword_back,1,weight(2.5)|difficulty(0)|spd_rtng(103)|weapon_length(118)|swing_damage(16,blunt)|thrust_damage(12,blunt),0],
...
["wooden_javelin","Wooden_javelin",[("wooden_javelin",0)],itp_type_thrown|itp_primary|itp_bonus_against_shield,itcf_throw_javelin,100,weight(3)|abundance(0)|difficulty(0)|shoot_speed(27)|spd_rtng(89)|thrust_damage(25,blunt)|accuracy(100)|max_ammo(5)|weapon_length(65),imodbits_thrown],
#
...
["warg_1b","Warg",[("warg_1B",0)],itp_type_horse|itp_shop,0,600,hit_points(80)|body_armor(10)|difficulty(2)|horse_speed(36)|horse_maneuver(64)|horse_charge(25)|horse_scale(95)|abundance(90),imodbits_horse_basic|imodbits_warg,[]],
["warg_1c","Warg",[("warg_1C",0)],itp_type_horse|itp_shop,0,600,hit_points(80)|body_armor(10)|difficulty(2)|horse_speed(36)|horse_maneuver(64)|horse_charge(25)|horse_scale(95)|abundance(90),imodbits_horse_basic|imodbits_warg,[]],
["warg_1d","Warg",[("warg_1D",0)],itp_type_horse|itp_shop,0,600,hit_points(80)|body_armor(10)|difficulty(2)|horse_speed(36)|horse_maneuver(64)|horse_charge(25)|horse_scale(95)|abundance(90),imodbits_horse_basic|imodbits_warg,[]],
["wargarmored_1b","Armored_Warg",[("wargArmored_1B",0)],itp_type_horse|itp_shop,0,1200,hit_points(100)|body_armor(25)|difficulty(3)|horse_speed(33)|horse_maneuver(61)|horse_charge(28)|horse_scale(95)|abundance(92),imodbits_horse_basic|imodbits_warg,[]],
["wargarmored_1c","Armored_Warg",[("wargArmored_1C",0)],itp_type_horse|itp_shop,0,1200,hit_points(100)|body_armor(25)|difficulty(3)|horse_speed(33)|horse_maneuver(61)|horse_charge(28)|horse_scale(95)|abundance(92),imodbits_horse_basic|imodbits_warg,[]],
["wargarmored_2b","Armored_Warg",[("wargArmored_2B",0)],itp_type_horse|itp_shop,0,1500,hit_points(110)|body_armor(30)|difficulty(4)|horse_speed(33)|horse_maneuver(61)|horse_charge(30)|horse_scale(95)|abundance(93),imodbits_horse_basic|imodbits_warg,[]],
...
["warg_ghost_armour","{!}HIDEME_armour" ,[("dummy_mesh_skinned",0)],itp_unique|itp_no_pick_up_from_ground|itp_type_body_armor|itp_covers_head|itp_covers_legs,0,0,weight(0)|head_armor(2)|body_armor(2)|leg_armor(2)|difficulty(0),0],
...
["orc_hook_arrow","Orc_Hook_Arrows",[("orc_hook_arrow",0),("orc_hook_arrow_flying",ixmesh_flying_ammo),("orc_quiver",ixmesh_carry)],itp_type_arrows|itp_shop,itcf_carry_quiver_back_right,100,weight(3)|thrust_damage(1,pierce)|max_ammo(30)|weapon_length(95),imodbits_missile,[]],
...
###ARMOR
#handwear, boots
["leather_gloves","Leather_Gloves",[("CWE_gloves_a_L",imodbits_armor_bad),("CWE_gloves_a_h_L",0),("narf_leather_gauntlet_L",imodbit_thick), ("narf_demi_gauntlets_L",imodbit_reinforced),("undeadtest_handL",imodbit_poor)],itp_type_hand_armor|itp_shop,0,150,weight(0.2)|abundance(90)|body_armor(2)|difficulty(0),imodbits_armor,[]],
["mail_mittens","Mail_Mittens",[("CWE_gauntlets_crysader_L",0)],itp_type_hand_armor|itp_shop,0,600,weight(1)|abundance(90)|body_armor(4)|difficulty(0),imodbits_armor|imodbit_lordly,[]],
...
["rohan_shoes","Leather_Shoes",[("ankle_boots_a_new",imodbits_armor_bad),("wrapping_boots_a",0),("narf_rus_shoes",imodbit_fine)],itp_type_foot_armor|itp_shop|itp_attach_armature|itp_civilian,0,80,weight(1)|abundance(90)|leg_armor(8)|difficulty(0),imodbits_cloth],
        ] or [
...
["furry_boots","Nomad_Boots",[("furry_boots",imodbits_armor_bad),("nomad_boots_a",0),("hide_boots_a",imodbits_armor_good)],itp_type_foot_armor|itp_shop,0,200,weight(2)|abundance(90)|leg_armor(10)|difficulty(0),imodbits_orc_cloth],
...
["cloth_coif","Cloth_Cap",[("arming_cap_a_new",0),("padded_coif_a_new",imodbits_armor_good)],itp_type_head_armor|itp_shop|itp_fit_to_head,0,60,weight(2)|head_armor(10)|difficulty(0),imodbits_armor,[]],
...
["gondor_bow","Gondor_Bow",[("lav_long_bow_sar",0),("lav_long_bow_sar_carry",ixmesh_carry)],itp_type_bow|itp_primary|itp_two_handed|itp_shop|itp_cant_use_on_horseback,itcf_shoot_bow|itcf_carry_bow_back,600,weight(1.8)|difficulty(3)|shoot_speed(57)|spd_rtng(82)|thrust_damage(30,cut)|accuracy(88),imodbits_bow,[] ],
...
["elven_bow","Elven_Bow",[("GA_BowE_Medium_B",0),("GA_BowE_Medium_B_Carry_new",ixmesh_carry)],itp_type_bow|itp_primary|itp_shop|itp_cant_use_on_horseback,itcf_shoot_bow|itcf_carry_bow_back,1000,weight(1.5)|difficulty(3)|shoot_speed(65)|spd_rtng(93)|thrust_damage(20,pierce)|accuracy(93),imodbits_good_bow,[] ],
...
#
#RIVENDELL HELMS##########
["free_riv_helm_a","{!}Rivendell_Coif",[("rivendell_coif_new",0)],itp_type_head_armor,0,800,weight(1)|head_armor(24)|difficulty(0),imodbits_armor|imodbit_lordly,[]],
...
["gon_tower_guard","Gondor_Tower_Guard_Armor",[("armor_TG_CWE",0)],itp_type_body_armor|itp_covers_legs|0,0,3500,weight(36)|abundance(100)|head_armor(0)|body_armor(45)|leg_armor(14)|difficulty(20),imodbits_elf_armor,[]],
...
["gon_leader_surcoat_cloak","Gondor_Leader's_Surcoat",[("gon_leader_surcoat",0),("gon_leader_surcoat_cloak",imodbit_cloak|imodbit_lordly)],itp_type_body_armor|itp_covers_legs|itp_shop,0,2900,weight(36)|abundance(96)|head_armor(0)|body_armor(42)|leg_armor(12)|difficulty(19),imodbits_elf_armor|imodbit_cloak,[]],
...
["gondor_shield_d","Gondor_Kite_Shield",[("gondorian_kite_shield",0)],itp_type_shield|itp_wooden_parry|itp_shop,itcf_carry_kite_shield,400,weight(2.5)|abundance(91)|difficulty(1)|hit_points(290)|body_armor(17)|spd_rtng(90)|weapon_length(42),imodbits_shield,],
...
["gon_tab_shield_c","Heraldic_Gondor_Kite_Shield",[("tableau_shield_kite",0)],itp_type_shield|itp_wooden_parry|itp_shop,itcf_carry_kite_shield,400,weight(2.5)|abundance(91)|difficulty(1)|hit_points(270)|body_armor(16)|spd_rtng(90)|weapon_length(42),imodbits_shield,[(ti_on_init_item,[(store_trigger_param_1, ":agent_no"),(store_trigger_param_2, ":troop_no"),(call_script, "script_TLD_gondor_kite_shield_banner", "tableau_gon_shield_kite", ":agent_no", ":troop_no")])]],	
...
["orc_coif2","Orc_Skullcap",[("orc_skullcap_a",imodbits_orc_bad),("orc_skullcap_b",0),("orc_skullcap_c",imodbits_orc_good)],itp_type_head_armor|itp_shop|itp_fit_to_head,0,200,weight(2.3)|head_armor(16)|difficulty(0),imodbits_orc_armor],
...
["evil_gauntlets_a","Black_Gloves",[("CWE_gloves_a_black_L",imodbits_armor_bad),("CWE_gloves_a_black_h_L",0),("CWE_gloves_lord_black_L",imodbit_thick),("CWE_gauntlets_arabs_a_L",imodbit_reinforced)],itp_type_hand_armor|itp_shop,0,160,weight(0.4)|abundance(90)|body_armor(2)|difficulty(0),imodbits_armor],
["evil_gauntlets_b","Black_Gauntlets",[("narf_demi_gauntlets_L",imodbits_armor_bad),("narf_wisby_gauntlets_black_L",0),("narf_wisby_gauntlets_red_L",imodbits_armor_good|imodbit_lordly)],itp_type_hand_armor|itp_shop,0,600,weight(1.2)|abundance(90)|body_armor(4)|difficulty(0),imodbits_armor|imodbit_lordly,[]],
["orc_mittens","Orc_Mittens",[("CWE_gauntlets_crysader_orc_L",imodbit_plain),("CWE_gauntlets_crysader_orc_L",0),("CWE_gauntlets_crysader_orc_leather_L",imodbits_armor_bad),("narf_plate_mittens_L",imodbits_armor_good)],itp_type_hand_armor|itp_shop,0,500,weight(3)|abundance(90)|body_armor(4)|difficulty(0),imodbits_armor,[]],
###ISENGARD ITEMS##########
##########ARMORS##########
["isen_orc_light_a","Isengard_Orc_Light_Harness",[("orc_isen_light_1_b",imodbit_plain),("orc_isen_light_1_b",0),("orc_isen_light_1_a",imodbits_armor_bad),("orc_isen_light_1_c",imodbits_armor_good)],itp_type_body_armor|itp_covers_legs|itp_shop,0,81,weight(4)|abundance(90)|head_armor(0)|body_armor(7)|leg_armor(2)|difficulty(0),imodbits_orc_cloth,],
["isen_orc_light_b","Isengard_Orc_Light_Harness",[("orc_isen_light_2_b",imodbit_plain),("orc_isen_light_2_b",0),("orc_isen_light_2_a",imodbits_armor_bad),("orc_isen_light_2_c",imodbits_armor_good)],itp_type_body_armor|itp_covers_legs|itp_shop,0,201,weight(6)|abundance(91)|head_armor(0)|body_armor(13)|leg_armor(4)|difficulty(8),imodbits_orc_cloth,],
["isen_orc_pad_a","Isengard_Orc_Light_Segmented_Armor",[("orc_isen_pad_1_b",imodbit_plain),("orc_isen_pad_1_b",0),("orc_isen_pad_1_a",imodbits_armor_bad),("orc_isen_pad_1_c",imodbits_armor_good)],itp_type_body_armor|itp_covers_legs|itp_shop,0,401,weight(19)|abundance(92)|head_armor(0)|body_armor(15)|leg_armor(5)|difficulty(12),imodbits_orc_armor,],
...
["isen_orc_mail_b","Isengard_Orc_Heavy_Segmented_Armor",[("orc_isen_heavy_b",imodbit_plain),("orc_isen_heavy_b",0),("orc_isen_heavy_a",imodbits_armor_bad),("orc_isen_heavy_c",imodbits_armor_good)],itp_type_body_armor|itp_covers_legs|itp_shop,0,901,weight(36)|abundance(95)|head_armor(0)|body_armor(22)|leg_armor(9)|difficulty(18),imodbits_orc_armor,],
...
########Uruk Weapons
#unused ->#
["free_uruk_pike","{!}Orc_Cleaver",[("bb_fight_cleaver_b",0),("bb_war_cleaver_L82",imodbits_weapon_bad_heavy)],itp_type_two_handed_wpn|itp_primary|itp_two_handed|itp_shop,itc_nodachi|itcf_carry_axe_back,400,weight(3)|abundance(90)|difficulty(0)|spd_rtng(81)|weapon_length(227)|thrust_damage(26,pierce)|swing_damage(16,blunt),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["uruk_pike_b","Mordor_Pike",[("uruk_pike",0)],itp_type_polearm|itp_no_blur|itp_shop|itp_primary|itp_spear|itp_two_handed|itp_wooden_parry|itp_couchable,itc_lance_upstab,300,weight(3)|abundance(91)|difficulty(11)|spd_rtng(81)|weapon_length(200)|thrust_damage(29,pierce)|swing_damage(0,blunt),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["uruk_falchion_a","Uruk_Falchion",[("uruk_falchion_b2",0),("uruk_falchion_b",imodbits_weapon_bad_heavy)],itp_type_one_handed_wpn|itp_primary|itp_shop,itc_scimitar|itcf_carry_sword_left_hip,350,weight(2.5)|abundance(92)|difficulty(0)|spd_rtng(90)|weapon_length(70)|swing_damage(35,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["orc_bastard_scimitar","Orc_Great_Scimitar",[("khazad_orc_bastard_scimitar_3",0),("khazad_orc_bastard_scimitar_1",imodbits_weapon_bad),("khazad_orc_bastard_scimitar_2",imodbits_weapon_bad_heavy|imodbit_balanced)],itp_type_two_handed_wpn|itp_no_blur|itp_primary|itp_penalty_with_shield|itp_shop,itc_bastardfalchion|itcf_carry_sword_left_hip,400,weight(3)|abundance(94)|difficulty(11)|spd_rtng(99)|weapon_length(106)|swing_damage(37,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["orc_cleaver_a","Orc_Cleaver",[("bb_fight_cleaver_b",0),("bb_war_cleaver_L82",imodbits_weapon_bad_heavy)],itp_type_two_handed_wpn|itp_primary|itp_two_handed|itp_shop,itc_nodachi|itcf_carry_sword_left_hip,350,weight(4)|abundance(94)|difficulty(13)|spd_rtng(93)|weapon_length(94)|swing_damage(27,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["orc_scimitar_b","Orc_Scimitar",[("orc_scimitar",0),("uruk_falchion_a",imodbits_weapon_bad_heavy)],itp_type_one_handed_wpn|itp_primary|itp_crush_through|itp_shop,itc_scimitar|itcf_carry_sword_left_hip,300,weight(2)|abundance(92)|difficulty(0)|spd_rtng(96)|weapon_length(77)|swing_damage(24,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["orc_sabre_b","Orc_Sabre",[("orc_falchion",0),("orc_sabre",imodbits_weapon_bad_heavy)],itp_type_one_handed_wpn|itp_primary|itp_shop,itc_scimitar|itcf_carry_sword_left_hip,285,weight(2.5)|abundance(91)|difficulty(0)|spd_rtng(87)|weapon_length(74)|swing_damage(26,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["orc_mangler","Orc_Spiked_Staff",[("orc_club_a_long",0),("orc_club_b_long",imodbits_weapon_bad),("luc_morgenstern",imodbits_weapon_bad_heavy)],itp_type_polearm|itp_no_blur|itp_shop|itp_primary|itp_cant_use_on_horseback|itp_two_handed|itp_bonus_against_shield|itp_wooden_parry|itp_crush_through|itp_unbalanced,itc_staff|itcf_carry_sword_left_hip,600,weight(6)|abundance(93)|difficulty(13)|spd_rtng(80)|weapon_length(150)|swing_damage(25,pierce)|thrust_damage(28,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
...
["isengard_spear","Isengard_Spear",[("isengard_spear",0)],itp_type_polearm|itp_no_blur|itp_shop|itp_primary|itp_spear|itp_wooden_parry,itc_lance_upstab,300,weight(2.5)|abundance(90)|difficulty(9)|spd_rtng(96)|weapon_length(150)|thrust_damage(27,pierce)|swing_damage(0,blunt),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
...
["orc_simple_spear","Orc_Spear",[("orc_simple_spear",0),("uruk_spear",imodbits_weapon_bad_heavy)],itp_type_polearm|itp_no_blur|itp_shop|itp_primary|itp_spear,itc_lance_upstab,50,weight(2.5)|abundance(90)|difficulty(0)|spd_rtng(96)|weapon_length(152)|thrust_damage(22,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
...
["orc_slasher","Orc_Short_Sword",[("orc_machete",0),("orc_slasher",imodbits_weapon_bad_heavy)],itp_type_one_handed_wpn|itp_primary|itp_shop,itc_scimitar|itcf_carry_sword_left_hip,50,weight(1.5)|abundance(90)|difficulty(0)|spd_rtng(98)|weapon_length(56)|swing_damage(23,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["orc_falchion","Orc_Falchion",[("bb_falchion_b",0),("bb_falchion_a",imodbits_weapon_bad),("bb_fight_cleaver_b2",imodbits_weapon_bad_heavy)],itp_type_one_handed_wpn|itp_primary|itp_shop,itc_scimitar|itcf_carry_sword_left_hip,150,weight(1.5)|abundance(90)|difficulty(0)|spd_rtng(95)|weapon_length(70)|swing_damage(27,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["orc_scimitar","Orc_Scimitar",[("khazad_orc_scimitar_5",0),("khazad_orc_scimitar_1",imodbits_weapon_bad),("khazad_orc_scimitar_6",imodbits_weapon_bad_heavy)],itp_type_one_handed_wpn|itp_primary|itp_shop,itc_scimitar|itcf_carry_sword_left_hip,200,weight(2)|abundance(92)|difficulty(9)|spd_rtng(93)|weapon_length(89)|swing_damage(25,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["orc_sabre","Orc_Sabre",[("khazad_orc_scimitar_4",0),("khazad_orc_scimitar_2",imodbits_weapon_bad),("khazad_orc_scimitar_3",imodbits_weapon_bad_heavy)],itp_type_one_handed_wpn|itp_primary|itp_shop,itc_scimitar|itcf_carry_sword_left_hip,150,weight(2.5)|abundance(91)|difficulty(0)|spd_rtng(85)|weapon_length(78)|swing_damage(27,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["orc_battle_axe","Orc_Battle_Axe",[("khazad_orc_axe_2",0),("khazad_orc_axe_3",imodbits_weapon_bad_heavy)],itp_type_two_handed_wpn|itp_no_blur|itp_primary|itp_two_handed|itp_bonus_against_shield|itp_no_parry|itp_shop|itp_crush_through|itp_unbalanced,itc_cut_two_handed|itcf_carry_axe_back,400,weight(5)|abundance(93)|difficulty(11)|spd_rtng(90)|weapon_length(85)|swing_damage(38,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["orc_axe","Orc_Axe",[("orc_axe",0),("old_dunland_axe_a_orc",imodbits_weapon_bad_heavy)],itp_type_one_handed_wpn|itp_primary|itp_shop|itp_secondary|itp_bonus_against_shield|itp_no_parry,itc_cleaver|itcf_carry_axe_left_hip,150,weight(2)|abundance(90)|difficulty(0)|spd_rtng(85)|weapon_length(61)|swing_damage(28,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["orc_two_handed_axe","Orc_Great_Axe",[("orc_twohanded_axe",0),("uruk_heavy_axe",imodbits_weapon_bad_heavy)],itp_type_two_handed_wpn|itp_no_blur|itp_primary|itp_two_handed|itp_bonus_against_shield|itp_no_parry|itp_shop|itp_cant_use_on_horseback|itp_crush_through|itp_unbalanced,itc_cut_two_handed|itcf_carry_axe_back,400,weight(5)|abundance(94)|difficulty(12)|spd_rtng(87)|weapon_length(92)|swing_damage(35,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],

["orc_throwing_axes","Orc_Throwing_Axes",[("orc_throwing_axe",0),("orc_throwing_axe_quiver", ixmesh_carry),("orc_throwing_axe_inventory", ixmesh_inventory)],itp_type_thrown|itp_shop|itp_primary|itp_bonus_against_shield,itcf_throw_axe|itcf_carry_quiver_front_right|itcf_show_holster_when_drawn,200,weight(5)|abundance(90)|difficulty(1)|shoot_speed(20)|spd_rtng(99)|thrust_damage(38,cut)|accuracy(93)|max_ammo(4)|weapon_length(53),imodbits_thrown,[] ],
...
["orc_coif","Evil_Coif",[("maci_mail_coif_orc",0),("maci_mail_coif_orc",imodbit_plain),("orc_coif",imodbits_orc_bad),("crusader_koif_a_orc",imodbits_orc_good)],itp_type_head_armor|itp_shop|itp_fit_to_head,0,200,weight(2)|abundance(90)|head_armor(16)|body_armor(0)|difficulty(0),imodbits_orc_armor | imodbit_cracked],
["orc_skullcap","Orc_Skullcap",[("orc_skullcap_a",imodbits_orc_bad),("orc_skullcap_b",0),("orc_skullcap_c",imodbits_orc_good)],itp_type_head_armor|itp_shop|itp_fit_to_head,0,250,weight(2.3)|abundance(90)|head_armor(19)|body_armor(0)|difficulty(0),imodbits_orc_armor | imodbit_cracked],
["orc_skullhelm","Orc_Skullhelm",[("orc_gunda_helm_skull_2",0),("orc_gunda_helm_skull_2",imodbit_plain),("orc_gunda_helm_skull_1",imodbits_orc_bad),("spak_helm_skull",imodbits_orc_good)],itp_type_head_armor|itp_shop,0,250,weight(2.3)|abundance(91)|head_armor(19)|body_armor(0)|difficulty(0),imodbits_orc_armor | imodbit_cracked],
["orc_barbuta","Orc_Nosehelm",[("spak_sub_helm_2",0),("spak_sub_helm_2",imodbit_plain),("spak_sub_helm_1",imodbits_orc_bad),("spak_sub_helm_3",imodbits_orc_good)],itp_type_head_armor|itp_shop,0,600,weight(4)|abundance(91)|head_armor(24)|body_armor(0)|difficulty(11),imodbits_orc_armor | imodbit_cracked],
#MORDOR ITEMS##########
###ORC ARMORS##########
...
#######WEAPONS##########
["mordor_sword","Bastard_Sword_of_Mordor",[("mordor_sword_giles",0),("scab_mordor_sword_giles",ixmesh_carry)],itp_type_two_handed_wpn|itp_no_blur|itp_primary|itp_penalty_with_shield|itp_shop,itc_bastardsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,700,weight(2.25)|abundance(94)|difficulty(11)|spd_rtng(101)|weapon_length(109)|swing_damage(37,cut)|thrust_damage(26,pierce),imodbits_weapon_bad],
["mordor_longsword","Sword_of_Mordor",[("sword_of_mordor_giles",0),("scab_sword_of_mordor_giles",ixmesh_carry)],itp_type_one_handed_wpn|itp_no_blur|itp_primary|itp_shop,itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,650,weight(2.75)|abundance(96)|difficulty(10)|spd_rtng(97)|weapon_length(94)|swing_damage(34,cut)|thrust_damage(31,pierce),imodbits_weapon_bad],
...
["dunland_mail_1","Dunnish_Hauberk",[("dunland_hauberk_1b",imodbit_plain),("dunland_hauberk_1b",0),("dunland_hauberk_1a",imodbits_armor_bad),("dunland_hauberk_1c",imodbits_armor_good)],itp_type_body_armor|itp_covers_legs|itp_shop,0,800,weight(22)|abundance(92)|head_armor(2)|body_armor(22)|leg_armor(7)|difficulty(11),imodbits_armor,],
["dunland_mail_2","Dunnish_Hauberk",[("dunland_hauberk_2b",imodbit_plain),("dunland_hauberk_2b",0),("dunland_hauberk_2a",imodbits_armor_bad),("dunland_hauberk_2c",imodbits_armor_good)],itp_type_body_armor|itp_covers_legs|itp_shop,0,1200,weight(24)|abundance(92)|head_armor(2)|body_armor(25)|leg_armor(10)|difficulty(12),imodbits_armor,],
["dunland_chieftain","Dunnish_Chief_Armor",[("dunland_chieftain_b",imodbit_plain),("dunland_chieftain_b",0),("dunland_chieftain_a",imodbits_armor_bad),("dunland_chieftain_c",imodbits_armor_good), ("dunland_chieftain_spirit",imodbit_old),("barf_skeleton_greaves", imodbit_poor)],itp_type_body_armor|itp_covers_legs|itp_shop,0,1800,weight(26)|abundance(93)|head_armor(2)|body_armor(29)|leg_armor(13)|difficulty(14),imodbits_armor,],
#######HELMS##########
["dun_helm_a","Dunnish_Wolf_Cap",[("dunland_wolfcap",imodbits_armor_bad),("dunland_wolfcap_2",imodbit_plain),("dunland_wolfcap_2",0),("dunland_wolfcap_3",imodbits_armor_good)],itp_type_head_armor|itp_shop,0,600,weight(1)|abundance(92)|head_armor(25)|body_armor(0)|difficulty(12),imodbits_cloth],
["dun_helm_b","Dunnish_Fur_Cap",[("dunland_furcap_1",imodbits_armor_bad),("dunland_furcap_2",imodbit_plain),("dunland_furcap_2",0),("dunland_antlercap",imodbits_armor_good)],itp_type_head_armor|itp_shop,0,400,weight(1)|abundance(90)|head_armor(21)|body_armor(0)|difficulty(8),imodbits_cloth],
...
["dun_helm_d","Dunnish_Skullcap",[("dunland_cap_1",imodbits_armor_bad),("dunland_cap_2",imodbit_plain),("dunland_cap_2",0),("dunland_cap_3",imodbits_armor_good)],itp_type_head_armor|itp_shop,0,500,weight(2)|abundance(91)|head_armor(23)|body_armor(0)|difficulty(9),imodbits_armor | imodbit_cracked],
...
#WEAPONS##########
["dun_berserker","Dunland_Chieftain_Sword",[("dunland_longsword_1",0),("dunland_sword_1",imodbits_weapon_good),("dunland_sword_1_scab",ixmesh_carry),("dunland_sword_1_scab",ixmesh_carry|imodbits_weapon_good)],itp_type_one_handed_wpn|itp_no_blur|itp_primary,itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,540,weight(3)|abundance(95)|difficulty(12)|spd_rtng(97)|weapon_length(98)|swing_damage(32,cut)|thrust_damage(18,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["dunnish_antler_axe","Dunnish_Antler_Axe",[("dunland_antleraxe_long",0)],itp_type_polearm|itp_two_handed|itp_no_blur|itp_shop|itp_primary|itp_wooden_parry,itc_nodachi|itcf_carry_axe_back,450,weight(3)|abundance(91)|difficulty(10)|spd_rtng(95)|weapon_length(123)|swing_damage(35,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["dunnish_war_axe","Dunnish_War_Axe",[("dunland_axe_a",0),("dunland_axe_b",imodbits_weapon_bad_heavy)],itp_type_one_handed_wpn|itp_shop|itp_primary|itp_secondary|itp_bonus_against_shield|itp_wooden_parry,itc_scimitar|itcf_carry_axe_left_hip,360,weight(2)|abundance(92)|difficulty(11)|spd_rtng(97)|weapon_length(50)|swing_damage(40,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["dunnish_axe","Dunnish_Light_Axe",[("bb_serbian_fight_axe_b",0),("bb_serbian_fight_axe_b",imodbit_plain),("bb_serbian_fight_axe_a",imodbits_weapon_bad),("bb_slavic_axe_3",imodbits_weapon_bad_heavy)],itp_type_one_handed_wpn|itp_primary|itp_shop|itp_secondary|itp_wooden_parry,itc_scimitar|itcf_carry_axe_left_hip,320,weight(2)|abundance(91)|difficulty(0)|spd_rtng(100)|weapon_length(55)|swing_damage(35,cut)|thrust_damage(0,pierce),imodbits_weapon_bad],
...
["dunnish_long_axe","Dunnish_Long_Axe",[("bb_slavic_axe_1",0),("bb_slavic_axe_1",imodbit_plain),("bb_slavic_axe_2",imodbits_weapon_bad),("bb_slavic_two_handed_axe_b",imodbits_weapon_bad_heavy)],itp_type_two_handed_wpn|itp_two_handed|itp_no_blur|itp_shop|itp_primary|itp_bonus_against_shield|itp_wooden_parry,itc_nodachi|itcf_carry_axe_back,450,weight(3)|abundance(94)|difficulty(13)|spd_rtng(91)|weapon_length(103)|swing_damage(35,cut)|thrust_damage(0,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
["dun_shortsword","Dunnish_Short_Sword",[("dunland_shortsword_1",0),("dunland_shortsword_2",imodbits_weapon_bad_heavy),("dunland_shortsword_1",ixmesh_carry),("dunland_shortsword_2",ixmesh_carry|imodbits_weapon_bad_heavy)],itp_type_one_handed_wpn|itp_two_handed|itp_no_blur|itp_primary,itc_longsword|itcf_carry_sword_left_hip|itcf_show_holster_when_drawn,400,weight(3)|abundance(91)|difficulty(0)|spd_rtng(101)|weapon_length(71)|swing_damage(26,cut)|thrust_damage(21,pierce),imodbits_weapon_bad|imodbits_weapon_bad_heavy],
...
###TLD WOODELF ITEMS##########
#ARMORS##########
["mirkwood_leather","Woodelf_Leather_Armor",[("mirkwood_leather_b",0),("mirkwood_leather_a",imodbits_armor_bad),("mirkwood_leather_c",imodbits_armor_good|imodbit_lordly)],itp_type_body_armor|itp_covers_legs|itp_shop,0,150,weight(2)|head_armor(0)|body_armor(16)|leg_armor(2)|difficulty(0),imodbits_armor|imodbit_lordly,],
...
#WEAPONS##########
["mirkwood_axe_2h","Greenwood_Great_axe",[("mirkwood_axe_long",0)],itp_type_two_handed_wpn|itp_no_blur|itp_shop|itp_primary|itp_two_handed|itp_bonus_against_shield|itp_wooden_parry|itp_crush_through,itc_nodachi|itcf_carry_axe_back,500,weight(4)|abundance(95)|difficulty(13)|spd_rtng(96)|weapon_length(95)|swing_damage(39,cut)|thrust_damage(0,pierce),imodbits_weapon_good],
...
#HELMETS##########
["mirkwood_helm_a","Woodelf_Archer_Helm",[("mirkwood_helm_a",imodbits_armor_bad),("mirkwood_helm_b",imodbit_plain),("mirkwood_helm_b",0),("mirkwood_helm_c",imodbits_armor_good|imodbit_lordly)],itp_type_head_armor|itp_shop,0,600,weight(1)|abundance(92)|head_armor(25)|body_armor(0)|difficulty(0),imodbits_armor],
["mirkwood_helm_b","Greenwood_Helm",[("mirkwoodnormalspearman_a_light",imodbits_armor_bad),("mirkwoodnormalspearman_a",imodbit_plain),("mirkwoodnormalspearman_a",0),("mirkwoodnormalspearman_b",imodbits_armor_good|imodbit_lordly)],itp_type_head_armor|itp_shop,0,900,weight(1)|abundance(93)|head_armor(30)|body_armor(0)|difficulty(10),imodbits_armor],
["mirkwood_helm_c","Greenwood_Heavy_Helm",[("mirkwoodroyalspearman_a_light",imodbits_armor_bad),("mirkwoodroyalspearman_a",imodbit_plain),("mirkwoodroyalspearman_a",0),("mirkwoodroyalspearman_b",imodbits_armor_good|imodbit_lordly)],itp_type_head_armor|itp_shop,0,1200,weight(2)|abundance(94)|head_armor(34)|body_armor(0)|difficulty(12),imodbits_armor],
["mirkwood_helm_d","Greenwood_Royal_Helm",[("mirkwoodroyalarcher_a",imodbit_plain),("mirkwoodroyalarcher_a",0),("mirkwoodroyalarcher_b",imodbits_armor_good|imodbit_lordly)],itp_type_head_armor|itp_shop,0,1300,weight(3)|abundance(95)|head_armor(36)|body_armor(0)|difficulty(13),imodbits_elf_armor],
####BOOTS
...
["umb_armor_a","Corsair_Leather_Vest",[("corsair_light_leather_1",imodbit_plain),("corsair_light_leather_1",0),("corsair_light_leather_0",imodbits_armor_bad),("corsair_light_leather_2",imodbits_armor_good),("corsair_light_leather_1b",imodbit_cloak),("corsair_light_leather_cape_pauldron",imodbit_lordly)],itp_type_body_armor|itp_covers_legs|itp_shop,0,50,weight(4)|abundance(90)|head_armor(0)|body_armor(10)|leg_armor(4)|difficulty(0),imodbits_armor|imodbit_lordly|imodbit_cloak,],
["umb_armor_b","Corsair_Leather_Armor",[("corsair_leather_pad_1",imodbit_plain),("corsair_leather_pad_1",0),("corsair_leather_pad_0",imodbits_armor_bad),("corsair_leather_pad_2",imodbits_armor_good),("corsair_leather_pad_1b",imodbit_cloak)],itp_type_body_armor|itp_covers_legs|itp_shop,0,200,weight(8)|abundance(90)|head_armor(0)|body_armor(14)|leg_armor(5)|difficulty(0),imodbits_armor|imodbit_lordly|imodbit_cloak,],
["umb_armor_c","Corsair_Light_Scale",[("corsair_light_scale_1",imodbit_plain),("corsair_light_scale_1",0),("corsair_light_scale_0",imodbits_armor_bad),("corsair_light_scale_2",imodbits_armor_good),("corsair_light_scale_1b",imodbit_cloak),("corsair_light_leather_cape_pauldron",imodbit_lordly)],itp_type_body_armor|itp_covers_legs|itp_shop,0,480,weight(12)|abundance(91)|head_armor(0)|body_armor(18)|leg_armor(4)|difficulty(9),imodbits_armor|imodbit_lordly|imodbit_cloak,],
["umb_armor_d","Corsair_Scale",[("corsair_scale_pad_1",imodbit_plain),("corsair_scale_pad_1",0),("corsair_scale_pad_0",imodbits_armor_bad),("corsair_scale_pad_3",imodbits_armor_good),("corsair_scale_pad_cape_pauldron",imodbit_cloak)],itp_type_body_armor|itp_covers_legs|itp_shop,0,700,weight(14)|abundance(92)|head_armor(0)|body_armor(22)|leg_armor(5)|difficulty(9),imodbits_armor|imodbit_lordly|imodbit_cloak,],
["umb_armor_e","Corsair_Hauberk",[("corsair_mail_1",imodbit_plain),("corsair_mail_1",0),("corsair_mail_0",imodbits_armor_bad),("corsair_mail_3",imodbits_armor_good),("corsair_mail_1b",imodbit_cloak)],itp_type_body_armor|itp_covers_legs|itp_shop,0,900,weight(20)|abundance(93)|head_armor(0)|body_armor(26)|leg_armor(7)|difficulty(11),imodbits_armor|imodbit_lordly|imodbit_cloak,],
["umb_armor_f","Corsair_Noble_Armour",[("corsair_heavy_1",imodbit_plain),("corsair_heavy_1",0),("corsair_heavy_0",imodbits_armor_bad),("corsair_heavy_2",imodbits_armor_good),("corsair_heavy_cape",imodbit_cloak),("corsair_heavy_3",imodbit_lordly)],itp_type_body_armor|itp_covers_legs|itp_shop,0,1400,weight(24)|abundance(94)|head_armor(1)|body_armor(30)|leg_armor(8)|difficulty(12),imodbits_armor|imodbit_lordly|imodbit_cloak,],
...
########SHIELDS##########
["umb_shield_a","Corsair_Shell_Shield",[("corsair_buckler_long_a",0),("corsair_buckler_long_a_carry",ixmesh_carry),("corsair_buckler_long_b",imodbits_armor_good),("corsair_buckler_long_b_carry",ixmesh_carry|imodbits_armor_good)],itp_type_shield|itp_wooden_parry|itp_shop,itcf_carry_round_shield,300,weight(2)|abundance(92)|difficulty(1)|hit_points(240)|body_armor(16)|spd_rtng(92)|weapon_length(35),imodbits_shield,],
["umb_shield_b","Corsair_Buckler",[("corsair_buckler_round_b",0),("corsair_buckler_round_b",imodbit_plain),("corsair_buckler_round_b",ixmesh_carry),("corsair_buckler_round_a",imodbits_armor_bad),("corsair_buckler_round_a_carry",ixmesh_carry|imodbits_armor_bad),("corsair_buckler_round_c",imodbits_armor_good),("corsair_buckler_round_c_carry",ixmesh_carry|imodbits_armor_good)],itp_type_shield|itp_wooden_parry|itp_shop,itcf_carry_buckler_left,200,weight(1)|abundance(90)|difficulty(0)|hit_points(240)|body_armor(18)|spd_rtng(100)|weapon_length(20),imodbits_shield,],
["umb_shield_c","Corsair_Round_Shield",[("JFire_MBMC_nobleman_round_shield",0),],itp_type_shield|itp_wooden_parry|itp_shop,itcf_carry_round_shield,200,weight(2)|abundance(95)|difficulty(2)|hit_points(280)|body_armor(20)|spd_rtng(94)|weapon_length(30),imodbits_shield,],
["free_umb_shield_d","{!}Corsair_Buckler",[("corsair_buckler_round_c",0),("corsair_buckler_round_c_carry",ixmesh_carry)],itp_type_shield|itp_wooden_parry|itp_shop,itcf_carry_buckler_left,200,weight(1)|abundance(90)|difficulty(0)|hit_points(280)|body_armor(20)|spd_rtng(100)|weapon_length(20),imodbits_shield,],
##########WEAPONS##########
...
["corsair_throwing_dagger","Crooked_Throwing_Daggers",[("corsair_throwing_dagger",0)],itp_type_thrown|itp_shop|itp_primary|0,itcf_throw_knife,250,weight(3.5)|abundance(91)|difficulty(0)|shoot_speed(24)|spd_rtng(110)|thrust_damage(30,cut)|accuracy(100)|max_ammo(10)|weapon_length(0),imodbits_thrown],
...
["beorn_staff","Woodmen_Staff",[("woodman_staff",0),("gandstaff",imodbit_exquisite),("sarustaff",imodbit_tattered),],itp_type_polearm|itp_no_blur|itp_shop|itp_primary|itp_spear|itp_penalty_with_shield|itp_wooden_parry|itp_wooden_attack|itp_can_knock_down,itc_staff|itcf_carry_back,100,weight(2)|abundance(90)|difficulty(0)|spd_rtng(114)|weapon_length(104)|swing_damage(22,blunt)|thrust_damage(20,blunt),imodbits_weapon_wood],
...
["dwarf_shield_c","Dwarven_Fighting_Shield",[("dwarf_fighting_shield_a",0),("dwarf_fighting_shield_b",imodbits_shield_good)],itp_type_shield|itp_wooden_parry|itp_shop,itcf_carry_kite_shield,400,weight(2)|abundance(94)|difficulty(3)|hit_points(310)|body_armor(18)|spd_rtng(88)|weapon_length(42),imodbits_shield_good,],
...
["dwarf_throwing_axe_reward","Erebor_Flying_Axes",[("dwarf_throw_axe_2",0)],itp_type_thrown|itp_unique|itp_primary|itp_bonus_against_shield|itp_can_penetrate_shield,itcf_throw_axe,1000,weight(5)|abundance(90)|difficulty(4)|shoot_speed(34)|spd_rtng(99)|thrust_damage(55,pierce)|accuracy(97)|max_ammo(6)|weapon_length(37),imodbits_thrown,[] ],
...
["leather_dwarf_armor","Erebor_Padded_Coat",[("dwarven_paddedlongcoat",imodbit_plain)],itp_type_body_armor|itp_covers_legs|itp_shop,0,2208,weight(16)|abundance(94)|head_armor(0)|body_armor(38)|leg_armor(17)|difficulty(17),imodbits_armor|imodbit_lordly,],
...
["good_mace","Mace",[("bb_romeyan_mace_1",imodbit_plain),("bb_romeyan_mace_1",0),("bb_romeyan_mace_2",imodbits_weapon_good)],itp_type_one_handed_wpn|itp_primary|itp_shop|itp_wooden_parry|itp_wooden_attack,itc_scimitar|itcf_carry_mace_left_hip,250,weight(2.5)|abundance(91)|difficulty(11)|spd_rtng(90)|weapon_length(67)|swing_damage(25,blunt),imodbits_weapon_good],
...
["troll_head","{!}troll_head",[("ent_head2",0),("troll_head",imodbit_rotten),("troll_head_b",imodbit_two_day_old),("troll_head_c",imodbit_day_old),("gunda_troll_head",imodbit_smelling),("gunda_troll_head_b",imodbit_fresh),("gunda_troll_head_c",imodbit_large_bag),("mordor_troll_head",imodbit_thick),("mordor_troll_head_b",imodbit_hardened)],itp_type_head_armor|itp_unique,0,1,weight(50)|head_armor(40)|difficulty(30),0],
["troll_body","{!}troll_body",[("troll_body",0),("gunda_troll_body",imodbit_thick),("mordor_troll_body",imodbit_hardened),("troll_body",imodbit_day_old),("gunda_troll_body_berta",imodbit_rotten),],itp_no_pick_up_from_ground|itp_type_body_armor|itp_covers_legs|itp_unique,0,10,weight(50)|head_armor(0)|body_armor(40)|leg_armor(0)|difficulty(25),0,],
["ent_feet_boots","{!}Ent_Feet",[("ent_foot",0),("troll_feet",imodbit_cracked),("gunda_troll_feet",imodbit_rusty),("mordor_troll_feet",imodbit_bent),("olog_feet",imodbit_hardened),("olog_feet",imodbit_thick)],itp_type_foot_armor|itp_unique,0,1,weight(50)|head_armor(0)|body_armor(0)|leg_armor(60)|difficulty(30),0],
["ent_hands","{!}Ent_Hands",[("ent_hand_L",0),("olog_hand_L",imodbit_large_bag),("isen_olog_hand_L",imodbit_rotten),("troll_handL",imodbit_cracked),("gunda_troll_handL",imodbit_rusty),("mordor_troll_handL",imodbit_bent)],itp_type_hand_armor|itp_unique,0,1,weight(50)|body_armor(1)|difficulty(30),0],
["fur_gloves_reward","Hunter_Gloves",[("narf_demi_gauntlets_fur_L",0)],itp_type_hand_armor|itp_unique,0,2000,weight(0.2)|abundance(0)|body_armor(3)|difficulty(0),imodbits_none,[]],
...
["nazgul_sword","Wicked_Sword",[("nazgul_sword_giles",0),("scab_nazgul_sword_giles",ixmesh_carry)],itp_type_two_handed_wpn|itp_no_blur|itp_primary|itp_two_handed|itp_bonus_against_shield|itp_unique|itp_crush_through,itc_bastardsword|itcf_carry_sword_back|itcf_show_holster_when_drawn,3000,weight(4.5)|abundance(100)|difficulty(18)|spd_rtng(103)|weapon_length(112)|swing_damage(50,pierce)|thrust_damage(45,pierce),imodbits_weapon_good],
["cooking_cauldron","Cooking_Cauldron",[("cauldron_a",0)],itp_type_goods,0,1000,weight(3)|abundance(0)|0,imodbits_none],
["eorl_cavalry_sword","Sword_of_Eorl",[("eorl_cavalry_sword_b_longer",0)],itp_type_two_handed_wpn|itp_no_blur|itp_primary|itp_bonus_against_shield|itp_unique,itc_bastardsword|itcf_carry_sword_left_hip,3000,weight(3)|difficulty(18)|spd_rtng(97)|weapon_length(110)|swing_damage(52,cut)|thrust_damage(22,pierce),imodbits_weapon_good],
...
["orc_throwing_axes_reward","Gundabad_Flying_Axes",[("orc_throwing_axe",0)],itp_type_thrown|itp_unique|itp_primary|itp_bonus_against_shield|itp_can_penetrate_shield,itcf_throw_axe,150,weight(4)|abundance(90)|difficulty(1)|shoot_speed(30)|spd_rtng(103)|thrust_damage(55,cut)|accuracy(100)|max_ammo(6)|weapon_length(33),imodbits_thrown],
["corsair_throwing_dagger_reward","Poisoned_Throwing_Daggers",[("corsair_throwing_dagger",0)],itp_type_thrown|itp_unique|itp_primary|itp_can_penetrate_shield,itcf_throw_knife,200,weight(3.5)|abundance(90)|difficulty(0)|shoot_speed(26)|spd_rtng(110)|thrust_damage(50,cut)|accuracy(100)|max_ammo(10)|weapon_length(0),imodbits_thrown],
...
["leather_gloves_reward","Archer_Gloves",[("CWE_gloves_king_L",0),("CWE_gloves_a_black_L",imodbit_crude),("ent_hand_L",imodbit_tattered),("olog_hand_L",imodbit_rusty),("isen_olog_hand_L",imodbit_old)],itp_type_hand_armor|itp_unique,0,2000,weight(0.2)|abundance(0)|body_armor(3)|difficulty(0),imodbits_none,[]],
...
["hunter_boots","Hunter_Boots",[("hunter_boots_a",0), ("got_stark_hanter_boots",imodbit_lordly)],itp_type_foot_armor|itp_shop,0,200,weight(1)|leg_armor(14)|difficulty(0),imodbits_cloth], #turned into a shop item, reward is masterwork
...
["leather_jerkin_wb","Leather_Jerkin",[("ragged_leather_jerkin",0)],itp_type_body_armor|itp_covers_legs|itp_civilian,0,100,weight(6)|head_armor(0)|body_armor(10)|leg_armor(6)|difficulty(0),imodbits_cloth,[]],
...
["fur_coat_tld","Dale_Coat",[("dale_coat",0)],itp_type_body_armor|itp_covers_legs|itp_civilian,0,100,weight(6)|head_armor(0)|body_armor(13)|leg_armor(6)|difficulty(0),imodbits_cloth,[]],
...
# TLD civilian items
["black_dress_wb","Black_Dress",[("gondor_dress_a",0)],itp_type_body_armor|itp_covers_legs|itp_civilian,0,100,weight(3)|head_armor(0)|body_armor(10)|leg_armor(10)|difficulty(0),imodbits_cloth,[]],
["blackwhite_dress_wb","Lady_Dress",[("gondor_dress_b",0)],itp_type_body_armor|itp_covers_legs|itp_civilian,0,100,weight(3)|head_armor(0)|body_armor(10)|leg_armor(10)|difficulty(0),imodbits_cloth,[]],
...
["green_dress_wb","Green_Dress",[("rohan_dress",0)],itp_type_body_armor|itp_covers_legs|itp_civilian,0,100,weight(6)|head_armor(0)|body_armor(10)|leg_armor(6)|difficulty(0),imodbits_cloth,[]],
["gondor_fine_outfit_dress_wb","Fine_Outfit",[("gondor_fine_outfit_dress",0)],itp_type_body_armor|itp_covers_legs|itp_civilian,0,100,weight(3)|head_armor(0)|body_armor(10)|leg_armor(10)|difficulty(0),imodbits_cloth,[]],
["rohan_fine_outfit_dale_dress_wb","Fine_Outfit",[("rohan_fine_outfit_dale_dress",0)],itp_type_body_armor|itp_covers_legs|itp_civilian,0,100,weight(3)|head_armor(0)|body_armor(10)|leg_armor(10)|difficulty(0),imodbits_cloth,[]],
["robe_generic_dress_wb","Robe",[("tld_robe_generic_dress",0)],itp_type_body_armor|itp_covers_legs|itp_civilian,0,100,weight(3)|head_armor(0)|body_armor(10)|leg_armor(10)|difficulty(0),imodbits_cloth,[]],
["wimple_a_wb","Wimple",[("gondor_wimple_a",0)],itp_type_head_armor|itp_civilian|itp_fit_to_head,0,100,weight(0.5)|head_armor(4)|difficulty(0),imodbits_cloth,[]],
["wimple_with_veil_wb","Wimple",[("gondor_wimple_b",0)],itp_type_head_armor|itp_civilian|itp_fit_to_head,0,100,weight(0.5)|head_armor(4)|difficulty(0),imodbits_cloth,[]],
["fine_hat_wb","Fine_Hat",[("gondor_fine_fem_hat",0)],itp_type_head_armor|itp_civilian,0,100,weight(0.5)|head_armor(4)|difficulty(0),imodbits_cloth,[]],
...
["denethor_robe","Fine_Outfit",[("dno_priest_3_1_dark",0)],itp_type_body_armor|itp_covers_legs|itp_civilian,0,100,weight(3)|head_armor(0)|body_armor(10)|leg_armor(10)|difficulty(0),imodbits_cloth,[]],
...
["animal_big","Big_Animal", [
    ("bry_cow_a",0),("bry_cow_b",imodbit_cracked),("bry_cow_c",imodbit_rusty),("bry_cow_d",imodbit_bent),("CWE_cow_mod_a",imodbit_chipped),
    ("bry_wild_donkey",imodbit_rotten),("spak_yak1",imodbit_smelling),("spak_yak2",imodbit_large_bag)],
...
["animal_small","Small_Animal", [(
    "bry_goat",0),("bry_goat_c",imodbit_cracked),("CWE_sheep_mod_a",imodbit_rusty),("CWE_sheep_mod_b",imodbit_bent),("wolf_dog",imodbit_chipped),("pk_pig",imodbit_battered)],
...
#more vanilla outfits for civilians and bandits
["fur_coat", "Fur Coat", [("fur_coat",0)],  itp_type_body_armor  |itp_covers_legs |itp_civilian,0, 100 , weight(6)|abundance(100)|head_armor(0)|body_armor(13)|leg_armor(6)|difficulty(0) ,imodbits_armor ],
["leather_jacket", "Leather Jacket", [("leather_jacket_new",0)],  itp_type_body_armor | itp_covers_legs  |itp_civilian ,0, 100 , weight(3)|abundance(100)|head_armor(0)|body_armor(20)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],

["nomad_armor","Nomad Armor",[("nomad_armor_new",0)], itp_type_body_armor|itp_covers_legs,0,100,weight(4)|abundance(92)|head_armor(0)|body_armor(12)|leg_armor(4)|difficulty(0),imodbits_armor,],
["khergit_armor","Nomad Armor",[("khergit_armor_new",0)], itp_type_body_armor|itp_covers_legs,0,100,weight(4)|abundance(92)|head_armor(0)|body_armor(12)|leg_armor(4)|difficulty(0),imodbits_armor,],
["rawhide_coat","Rawhide Coat",[("coat_of_plates_b",0)], itp_type_body_armor|itp_covers_legs,0,100,weight(4)|abundance(92)|head_armor(0)|body_armor(8)|leg_armor(4)|difficulty(0),imodbits_armor,],
["leather_armor","Leather Armor",[("tattered_leather_armor_a",0)], itp_type_body_armor|itp_covers_legs,0,100,weight(4)|abundance(92)|head_armor(0)|body_armor(14)|leg_armor(8)|difficulty(0),imodbits_armor,],
["nomad_vest","Nomad Vest",[("nomad_vest_new",0)], itp_type_body_armor|itp_covers_legs,0,100,weight(4)|abundance(92)|head_armor(0)|body_armor(8)|leg_armor(4)|difficulty(0),imodbits_armor,],
["ragged_outfit","Ragged Outfit",[("ragged_outfit_a_new",0)], itp_type_body_armor|itp_covers_legs,0,100,weight(4)|abundance(92)|head_armor(0)|body_armor(11)|leg_armor(6)|difficulty(0),imodbits_armor,],
["padded_leather","Padded Leather",[("leather_armor_b",0)], itp_type_body_armor|itp_covers_legs,0,100,weight(4)|abundance(92)|head_armor(0)|body_armor(16)|leg_armor(2)|difficulty(0),imodbits_armor,],
["pelt_coat","Pelt Coat",[("thick_coat_a",0)], itp_type_body_armor|itp_covers_legs,0,100,weight(4)|abundance(92)|head_armor(0)|body_armor(8)|leg_armor(4)|difficulty(0),imodbits_armor,],
["leather_vest","Leather Vest",[("leather_vest_a",0)], itp_type_body_armor|itp_covers_legs,0,100,weight(4)|abundance(92)|head_armor(0)|body_armor(8)|leg_armor(6)|difficulty(0),imodbits_armor,],

["wimple_a", "Wimple", [("tld_wimple_a_new",0)],itp_type_head_armor|itp_civilian|itp_fit_to_head,0,100, weight(0.5)|abundance(100)|head_armor(4)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth],
["wimple_with_veil", "Wimple with Veil", [("tld_wimple_b_new",0)],itp_type_head_armor|itp_civilian|itp_fit_to_head,0,100, weight(0.5)|abundance(100)|head_armor(4)|body_armor(0)|leg_armor(0)|difficulty(0),imodbits_cloth],
["headcloth", "Headcloth", [("tld_headcloth_a_new",0)],  itp_type_head_armor  |itp_civilian ,0, 100 , weight(0.5)|abundance(100)|head_armor(4)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
#duplicate
["fur_hat", "Fur Hat", [("tld_fur_hat_a_new",0)],  itp_type_head_armor |itp_civilian |itp_doesnt_cover_hair  ,0, 100 , weight(0.5)|abundance(100)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
["nomad_cap_b", "Nomad Cap", [("tld_nomad_cap_b_new",0)],  itp_type_head_armor |itp_civilian    ,0, 100 , weight(0.75)|abundance(100)|head_armor(13)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
["felt_hat", "Felt Hat", [("tld_felt_hat_a_new",0)],  itp_type_head_armor |itp_civilian |itp_doesnt_cover_hair ,0, 100 , weight(1)|abundance(100)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
["felt_hat_b", "Felt Hat", [("tld_felt_hat_b_new",0)],  itp_type_head_armor |itp_civilian |itp_doesnt_cover_hair ,0, 100 , weight(1)|abundance(100)|head_armor(8)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
["leather_cap", "Leather Cap", [("tld_leather_cap_a_new",0)],  itp_type_head_armor|itp_civilian ,0, 100, weight(1)|abundance(100)|head_armor(18)|body_armor(0)|leg_armor(0)|difficulty(0) ,imodbits_cloth ],
["leather_steppe_cap_a", "Steppe Cap", [("tld_leather_steppe_cap_a_new",0)], itp_type_head_armor|itp_civilian    ,0, 100 , weight(1)|abundance(100)|head_armor(15)|body_armor(0)|leg_armor(0) ,imodbits_cloth ],

["civ_fine_shoes", "Fine Shoes", [("fi_boot14",0)],  itp_type_foot_armor  |itp_civilian | itp_attach_armature,0, 100 , weight(1.25)|abundance(100)|head_armor(0)|body_armor(0)|leg_armor(1)|difficulty(0) ,imodbits_cloth ],
...
["torch",         "Torch", [("orc_club_a",0)], itp_type_two_handed_wpn|itp_two_handed|itp_primary|itp_shop, itc_greatsword, 11 , weight(2.5)|difficulty(0)|spd_rtng(95) | weapon_length(95)|swing_damage(11 , blunt) | thrust_damage(0 ,  pierce),imodbits_none,
 [(ti_on_init_item, [(set_position_delta,0,60,0),(particle_system_add_new, "psys_torch_fire"),(particle_system_add_new, "psys_torch_smoke"),
